	...
	<Wrapper>
		<Container>
			<ContentCenter contentWidth={970} className="main-top-content">
				<Heading size={2} bottomMargin={24} maxWidth={770}>
					{content.header}
				</Heading>
				<Paragraph big bottomMargin={80} maxWidth={770}>
					{content.text}
				</Paragraph>
				...
				<GridContainer>
					...
					{content.types.map((type) => (
						<GridCard color={type.color}>
							...
							<Heading size={3} template={4} bottomMargin={32} center>
								{type.header}
							</Heading>
		...
		<Container style={{ "padding-top": "26px" }}>
			<LeftContentRightImage
				...
				contentPadding="29px"
			>
				<Heading size={2} bottomMargin={24} maxWidth={520} left>
					{content.header2}
				</Heading>
				<Paragraph big bottomMargin={32} maxWidth={530}>
					{content.text2}
				</Paragraph>
				<Buttonsbox>
