...
const AboutSection = ({ className, content, openHSForm }) => (
  <About className={className}>
    ...
    <ImageContent image="registered-agents-about-8281" alt="registered agent requirement">
      ...
      <LightBox alt="what is a registered agent" thumbnailVideo="what-is-a-registered-agent-7199" videoID="wSsZAvrT-IU" />
