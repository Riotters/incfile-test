...
const TypesOfTaxesSection = ({ className, content }) => (
    <TypesOfTaxes className={className}>
        <ObjectContent object={<ContactMe content={content.card}/>}>
            ...
            {/* {content.llcTAxes.list.map(item => (
              <IconTextColorBox color={color.yellow3} Icon={TaxesSVG} content={item} />
            ))} */}
            ...
            <Link big linkUrl={content.sCorpTaxes.link.url} linkText={content.sCorpTaxes.link.text} />
