...
const HelpSection = ({ className, content }) => (
    <Help className={className}>
        ...
        <ObjectContent className="help" headlineWidth="450" 
            object={<Card className="card" headline="Foreign Qualification" content={content2} dropdownOnePlaceholder="Select Entity Type" dropdownOneOptions={dropdownOneOptions} dropdownTwoPlaceholder="Select State" dropdownTwoOptions={dropdownTwoOptions} dropdownThreePlaceholder="Select State of Formation" dropdownThreeOptions={dropdownThreeOptions} />}
        >
            <TextWrapper>
                ...
                <Paragraph big bottomMargin="0" maxWidth="500">{content.text}</Paragraph>
                <ul className="numericlist">
                    {content.list.map(item => (
                        <li><CheckBlueSVG />{item}</li>
                    ))}
                </ul>
                <Paragraph big bottomMargin="0" maxWidth="500">{content.text2}</Paragraph>
                <ul className="numericlist">
