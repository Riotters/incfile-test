...
const SearchSection = ({ className, content, id }) => (
    <Search className={className} id={id}>
        ...
        <ContentObject object={<BusinessNameSearchForm propState="Virginia" curveColor={color.blue1} curvePosition="bottomRight" curveRotate="90" />} contentWidth="500" contentCenter>
