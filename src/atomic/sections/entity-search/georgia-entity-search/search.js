...
const SearchSection = ({ className, content, id }) => (
    <Search id={id} className={className}>
        ...
        <ContentObject object={<BusinessNameSearchForm propState="Georgia" curveColor={color.blue2} curvePosition="bottomRight" curveRotate="90" />} contentWidth="500" contentCenter>
