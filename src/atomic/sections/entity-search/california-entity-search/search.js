...
const SearchSection = ({ className, content, id }) => (
  <Search className={className} id={id}>
    ...
    <ContentObject object={<BusinessNameSearchForm propState="California" curveColor={color.blue2} curvePosition="bottomRight" curveRotate="90" />} contentWidth="500" contentCenter>
