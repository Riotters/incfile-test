  ...
  <Protect className={className}>
    ...
    <ContentImage image="mr-bulb-review-entity-type-5755" contentWidth="570">
      <TextWrapper>
        ...
        <Buttonsbox mediaSM>
            <Button content={content.button} theme="primary56" arrow margin="0" marginSM="0 16px 0 0" />
            <Button content={content.button2} theme="primary56" arrow margin="16px 0 0 0" marginSM="0 auto 0 0" />
        </Buttonsbox>
      </TextWrapper>
    </ContentImage>
  </Protect>
