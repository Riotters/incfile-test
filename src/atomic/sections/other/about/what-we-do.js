    ...
    <Wrapper>
        ...
        <ContentCenter contentWidth="970">
            <VisibilitySensor partialVisibility once>
                {({ isVisible }) => (
                    <Heading className={isVisible ? "slideUp enter" : "slideUp"} size={3} bottomMargin="80" style={{ textAlign: `center` }}>{content.header}</Heading>
                )}
        ...
        <Trust>
            ...
            <ContentCenter contentWidth="970">
                <RelativeElement>
                    ...
                    <Paragraph>
                        Trusted by over 250,000 business owners worldwide since 2004!
                    </Paragraph>
                </RelativeElement>
            </ContentCenter>
        </Trust>            
