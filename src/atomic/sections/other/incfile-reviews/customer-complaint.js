	...
	<Wrapper>
		...
		<Container>
			<RelativeElement className="complaint__content">
				...
				<Heading size={2}>
					Incfile Customer Complaints? Let Us Know How We Can Improve
				</Heading>
				<Paragraph big mixed={true}>
					We're entrepreneurs, just like you, so we're constantly looking for
					ways we can do better. In the past we've had negative reviews on our
					Facebook page highlight an issue that we’ve now addressed: slow or no
					response to inquiries from customers.
				</Paragraph>
				<Paragraph big mixed={true}>
					Our reviews on Yelp also highlight the same issue in the lack of
					feedback and communication from customer service. We completely
					understand how frustrating this was to our customers, which is why
					we’ve made changes to our customer support area. We believe that
					doubling the size of our support team, introducing live chat and
					providing a comprehensive knowledge base will all help improve
					customer satisfaction. We’re paying very close attention to our
					responsiveness, and we’ll continue to make changes to optimize the
					customer experience.
				</Paragraph>
			</RelativeElement>
		</Container>
		...
		<ContentCenter contentWidth="940">
			<Heading size={2} template={1} style={{ marginTop: `180px` }}>
				Useful Resources
			</Heading>
			<Paragraph big mixed={true}>
				Here’s a link to some useful resources to help you get the information
