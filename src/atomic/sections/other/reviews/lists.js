...
const ListReviews = () => {
	...
	React.useEffect(() => {
		getReviews(filters._currentPage, filters._limit, filters._sort).then(
			(data) => {
				const res = [];
				...
				<Container id="js_reviews_list">
					<RelativeElement>
						...
						<Footer>
							...
							<div className="right">
								<a
									href="https://www.shopperapproved.com/reviews/IncFile.com/"
									target="_blank"
									rel="noreferrer"
								>
									<Image
										filename="widgetfooter-darklogo-eng"
										alt="Incfile review in Shopper Approved"
									/>
								</a>
							</div>
						</Footer>
