...
const ClientDashboardSection = ({ className, content, isNewSale }) => (
    <Wrapper className={className}>
        ...
        <HeadingCenter
            ...
            headlineWidth="770"
            text={content.text}
            linkText={content.button ? content.button.text : ''}
            linkUrl={content.button ? content.button.url : ''}
        />
            ...
            {content.articles && (
                <div>
                    <IconWrapper>
                        ...
                        <Heading size="3" bottomMargin="0">Popular articles to help you get started</Heading>
                    </IconWrapper>
                        ...
                        <a href={item.url} style={{ width: `100%`, display: `block` }}>
                            <Whitebox className="article" flex bottomMargin="8px">
                                ...
                                <Content>
                                    ...
                                    <Paragraph mixed={true} style={{ marginBottom: `0` }}>{item.desc}</Paragraph>
                                </Content>
                    ...
                    <AlignCenter>
                        <Button to="/" theme="secondary56" arrow width="250px">Read our blog</Button>
                    </AlignCenter>
                </div>
            )}
