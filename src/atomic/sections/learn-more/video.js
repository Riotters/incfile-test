...
const Video = () => (
    <Wrapper>
        ...
        <HeadingCenter headline="See how easy it can be to get your business incorporated" textWidth="590" text="Take a moment to view our instructional video." bottomMargin="48"
                       bottomMarginLG="80" linkText="Learn more" linkUrl="/"/>
        <ContentCenter style={{marginBottom: "149px"}}>
            <Curve bottom="150" left="-160" color="#ede0fa">
                <Curve2SVG/>
            </Curve>
            <LightBoxVideo thumbnailVideo="video-learn-more" videoID="R_oIgzYh7NU"/>
        </ContentCenter>
    </Wrapper>
);
