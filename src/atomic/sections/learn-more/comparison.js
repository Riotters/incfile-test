...
const Comparison = () => (
    <Wrapper>
        <HeadingCenter headline="What's the difference between an LLC and a Corporation?" textWidth="590"
        ...
        <ContentCenter contentWidth={970}>
            <ComparisonWrapper>
                <ComparisonItem>
                    ...
                    <Heading size={4}
                             style={{fontSize: "24px", padding: "40px 40px 0 40px", marginBottom: 0}}>LLC</Heading>

                    <div>
                        <ContentBox>
                            <Title>
                                Ongoing File Requirements
                            </Title>
                            <Content>
                    ...
                    <LearnMoreLink content={{text: "Learn more about LLC", url: "/"}}/>
                </ComparisonItem>
                <ComparisonItem>
                    ...
                    <div>
                        <ContentBox>
                            ...
                            <Content>
                                The stricter formalities give investors the knowledge they desire about how your company
                                is run.
                            </Content>
                        </ContentBox>
                        ...
                        <ContentBox>
                            ...
                            <Content>
                                If you are planning to raise capital or to take the company public in the future the
                                corporation is structured for that purpose.
                            </Content>
                        </ContentBox>
                        ...
                        <ContentBox>
                            ...
                            <Content>
                                The corporation itself pays taxes, and any dividends paid to the shareholders are
                                treated as personal income and are subject to additional taxation at the individual
                                level.
                            </Content>
                        </ContentBox>
                    </div>
                    <LearnMoreLink content={{text: "Learn more about Corporation", url: "/"}}/>
                </ComparisonItem>
            </ComparisonWrapper>
        </ContentCenter>
    </Wrapper>
