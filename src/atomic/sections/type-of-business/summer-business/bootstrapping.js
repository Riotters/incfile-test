        ...
        <Container>
            <BusinessOwnerResponsibilities>
                <ImageContent image="summer-books" paddingTop="60">
                    <Paragraph big>
                        For people who know they’re not going to be as busy in the summer, like students or teachers, summer businesses are a great opportunity for
                    ...
                    <Colorbox curveColor={color.babyblue1} color={color.babyblue3} theme="icon" curve Icon={SunIcon}>
                        ...
                        <Paragraph style={{marginBottom: 0}}>
                            Since 2004, we’ve helped over 250,000 people become entrepreneurs, starting exciting businesses and bringing their ideas
                    ...
                    <Paragraph big style={{paddingTop: "120px"}} mixed={true}>
                        Here is our simple guide to launching a successful summer business. From exploring the types of business you can start to the legalities of setting
