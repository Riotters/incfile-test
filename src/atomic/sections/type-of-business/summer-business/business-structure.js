    ...
    <BusinessOwnerResponsibilities>
      <ImageContent image="unique-business-green" paddingTop="60">
        ...
        >
          ...
          <Paragraph big>This is a type of business that is formed when two or more people work together without creating a more formal business entity. Like a sole proprietorship, it may not give you all the protections your summer business may need.</Paragraph>
        </TextBlockWithImage>
        ...
        >
          ...
          <Paragraph big>The most common type of business entity, an LLC is fast, simple and inexpensive to set up and maintain. It protects your personal finances and assets and is a great way to start your summer business.</Paragraph>
        </TextBlockWithImage>
        ...
        <Paragraph big style={{ paddingTop: "48px", paddingBottom: 0 }} mixed={true}>
          In most cases, our recommendation for a summer business would be to create an LLC. We’ve <Link to="/">got a complete guide</Link> to everything you need to do, and we can even set one up for your business. <Link to="/">LLC formation does vary from state to state</Link>, but we’ve got you
