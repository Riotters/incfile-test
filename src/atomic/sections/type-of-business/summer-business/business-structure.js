        ...
        <BusinessOwnerResponsibilities>
            <ImageContent image="unique-business-green" paddingTop="60">
                ...
                <Paragraph big style={{paddingTop: "48px", paddingBottom: 0}} mixed={true}>
                    ...
                    be to create an LLC. We’ve <Link to="/">got a complete guide</Link> to everything you need to do,
                    and we can even
                    set one up for your business. <Link to="/">LLC formation does vary from state to state</Link>, but
                    we’ve got you
