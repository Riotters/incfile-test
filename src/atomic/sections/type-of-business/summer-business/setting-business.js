        ...
        <Container>
            ...
            <ImageBoxes>
                ...
                <TopImageBox image="display-ads" color={color.purple3}>
                    <h4>Marketing</h4>
                    <p>
                        Although most of your revenue will happen during the summer months, you should be marketing your business over a much longer period. You will want
                        to stay top-of-mind with parents, kids, tourists
                        or whatever target market you’ve chosen. You can
                        do this by having a great website, social media marketing, paid advertising, local flyers or whatever works for your business type. Remember to build excitement in the off months so you can add to your potential client list.
                    </p>
                </TopImageBox>
                ...
                <TopImageBox image="we-doubled-the-size-of-customer-service" color={color.orange3}>
                    <h4>Equipment</h4>
                    <p>
                        Depending on how busy your business is, you might need to hire some people over the summer months.
                        If so, you'll need systems to to pay them, provide employee insurance and submit payroll taxes.
                    </p>
                </TopImageBox>
                ...
                <TopImageBox image="software" color={color.blue3}>
                    ...
                    <p>
                        The right software can make it easier to run your summer business; see our great list of the top apps
                ...
                <TopImageBox image="state-filling-fees" color={color.yellow3}>
                    ...
                    <p>
                        If you start an LLC, you will need a separate business bank account for your summer business. You might also want to consider a business credit card. Additionally, you will also need to keep careful bookkeeping records and file business and personal taxes. Here at Incfile we can even help you file
                        your taxes.
                    </p>
                </TopImageBox>
