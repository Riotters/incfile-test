        ...
        <Container>
            <BusinessOwnerResponsibilities>
                <ImageContent image="unique-business-2" paddingTop="60">
                    ...
                    <Paragraph big style={{paddingTop: "48px", paddingBottom: 0}} mixed={true}>
                        In most cases our recommendation would be to create an LLC. We’ve <Link to="/">got
                        a complete guide to everything you need to do</Link> and we can set one up for your business. <Link to="/">LLC
