    ...
    <BusinessOwnerResponsibilities>
      <ImageContent image="unique-business-green" paddingTop="60">
        ...
        >
          ...
          <Paragraph big>This is the "default" business structure and is what your unique business will be if you decide not to create a more formal structure. We don't recommend this type of business as it doesn't give you the legal protections you need.</Paragraph>
        </TextBlockWithImage>
        ...
        >
          ...
          <Paragraph big>These are the largest and most complex types of businesses, and are typically far more than the average entrepreneur or unique business owner will need.</Paragraph>
        </TextBlockWithImage>
        ...
        <Paragraph big style={{ paddingTop: "48px", paddingBottom: 0 }} mixed={true}>
          We’ve got a <Link to="/form-an-llc/">complete guide to everything you need to do</Link>, and we can even start setting up an LLC for your photography business today. <Link to="/llc-state-information/">LLC formation does vary from state to state</Link>, but we’ve got you covered, wherever
          you are.
        </Paragraph>
