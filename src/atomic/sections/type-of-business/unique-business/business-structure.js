		...
		<BusinessOwnerResponsibilities>
			<ImageContent image="unique-business-green" paddingTop="60">
				...
				>
					...
					<Paragraph big>
						This is the "default" business structure and is what your unique
				...
				>
					...
					<Paragraph big>
						...
						finances and assets and is a great way to start your unique
						business.
					</Paragraph>
				</TextBlockWithImage>
				...
				>
					...
					<Paragraph big>
						...
						typically far more than the average entrepreneur or unique business
						owner will need.
					</Paragraph>
				</TextBlockWithImage>
				...
				<Paragraph
					...
					mixed={true}
				>
					In most cases our recommendation would be to create an LLC - they are
					quick to create, easy to manage and relatively inexpensive to run.
					They also provide you with liability protection and help you get taken
					more seriously by photography clients.
				</Paragraph>
				<Paragraph
					big
					style={{ paddingTop: "48px", paddingBottom: 0 }}
				...
				>
					...
					, and we can even start setting up an LLC for your photography
					business today.{" "}
