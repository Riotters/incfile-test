        ...
        <Container>
            ...
            <GridSection>
                <TitleBox>
                    ...
                    <Heading size={2} template={3} left>How to Make Your Unique Business Stand Out</Heading>
                    <Paragraph big>
                ...
                <GridSectionList>
                    ...
                    <TextBlockWithImage width={100} widthUnit="%" SvgImage={MarketIcon} imageBackgroundColor={color.red2}
