...
const Regulations = () => (
    <Wrapper>
        ...
        <Container width={770}>
            ...
            <Paragraph big mixed>
                It’s possible that your dog-related business will need licenses, permits and regulations. You should
                explore local, state and federal licenses and permits, and
                <Link to="/">we can also help out with researching your business licensing needs</Link>.
            </Paragraph>
            <Paragraph big>
