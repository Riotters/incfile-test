...
const Regulations = () => (
  <Wrapper>
    ...
    <Container width={770}>
      <Heading size={2} left>
        Rules, Regulations and Taxes for Your Dog Walking or Pet Sitting
        Business
      </Heading>
      <Paragraph big mixed>
        It’s possible that your dog-related business will need licenses, permits
        and regulations. You should explore local, state and federal licenses
        and permits, and{" "}
