        ...
        <Container>
            ...
            <GridSection>
                <TitleBox>
                    ...
                    <Heading size={2} template={3} left>Validating Your Dog Walking or Pet Sitting Business Idea</Heading>
                    <Paragraph big>
                ...
                <GridSectionList>
                    ...
                    <TextBlockWithImage width={100} widthUnit="%" SvgImage={MarketIcon} imageBackgroundColor={color.green2}
