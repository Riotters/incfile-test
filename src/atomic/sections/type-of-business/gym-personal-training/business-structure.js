...
const BusinessStructure = () => (
	<OrangeContainer>
		...
		<BusinessOwnerResponsibilities>
			<ImageContent image="unique-business-green" imageAlt="choose right gym business structure" paddingTop="60">
				...
				>
					...
					<Paragraph big>
						If you don’t choose to form a legal business entity for your gym,
						fitness or personal training business, you will be a sole proprietor
						by default. This won’t give you the legal protections you need, so
				...
				>
					...
					<Paragraph big>
						...
						protection, so we don’t recommend it for your gym or personal
						training business.
					</Paragraph>
				</TextBlockWithImage>
				...
				>
					...
					<Paragraph big>
						As the most common type of business entity, an LLC is fast, simple
						and inexpensive to set up and maintain. It protects your personal
						finances and assets and is a great way to start your personal
						training or gym business.
					</Paragraph>
				</TextBlockWithImage>
				...
				>
					...
					<Paragraph big>
						...
						typically far more than the average fitness entrepreneur will need.
					</Paragraph>
				</TextBlockWithImage>
				...
				>
					In most cases, our recommendation for a gym, fitness or personal
					training business would be to create an LLC. We’ve{" "}
