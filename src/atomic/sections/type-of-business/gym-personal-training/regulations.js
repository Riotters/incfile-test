...
const Regulations = () => (
  <Wrapper>
    ...
    <Container style={{ paddingTop: "100px", paddingBottom: "100px" }} width={750}>
      ...
      <Paragraph big mixed>
        All businesses will need to adhere to licenses, permits and regulations. You will need to explore local, state and federal licenses and permits, and <Link to="/business-license-research-package/">we can also help out with researching your business licensing needs</Link>. You may also want to
        look into relevant qualifications for personal trainers and others providing fitness services.
      </Paragraph>
      <Paragraph big>
