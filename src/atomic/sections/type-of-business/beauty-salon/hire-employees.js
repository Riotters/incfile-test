...
const HireEmployees = () => (
  <BlueContainer>
    ...
    <ContentCenter contentWidth={770}>
      ...
      <Paragraph big mixed>
        If you are hiring people to work at your beauty salon, you will need to know what to do. See our <Link to="/blog/post/avoid-confusion-when-hiring/">10 tips on hiring employees</Link>.
      </Paragraph>
    </ContentCenter>
