		...
		<LinksWrapper>
			...
			<Container>
				<LinksContainer>
					<LinkItem>
						<PathLink
							to="https://www.facebook.com/groups/digitalnomadentrepreneurs/"
					...
					<LinkItem>
						<PathLink
							to="https://www.facebook.com/groups/848894731872317/"
							textColor={color.blue1}
							hoverColor={color.orange1}
							arrowColor={color.blue1}
						>
					...
					<LinkItem>
						<PathLink
							to="https://www.facebook.com/groups/dannyveigahustlegroup/"
							textColor={color.blue1}
							hoverColor={color.orange1}
							arrowColor={color.blue1}
						>
					...
					<LinkItem>
						<PathLink
							to="https://www.facebook.com/groups/519961684685930/"
							textColor={color.blue1}
							hoverColor={color.orange1}
							arrowColor={color.blue1}
						>
					...
					<LinkItem>
						<PathLink
							to="https://www.facebook.com/groups/222995801385500/"
							textColor={color.blue1}
							hoverColor={color.orange1}
							arrowColor={color.blue1}
						>
					...
					<LinkItem>
						<PathLink
							to="https://www.facebook.com/groups/DigitalNomadsAroundTheWorld/?fref=nf"
							textColor={color.blue1}
							hoverColor={color.orange1}
							arrowColor={color.blue1}
						>
					...
					<LinkItem>
						<PathLink
							to="https://www.facebook.com/groups/803975783022624/"
							textColor={color.blue1}
							hoverColor={color.orange1}
							arrowColor={color.blue1}
						>
					...
					<LinkItem>
						<PathLink
							to="https://www.linkedin.com/uas/login?session_redirect=https%3A%2F%2Fwww.linkedin.com%2Fgroups%2F8429882%2Fprofile"
							textColor={color.blue1}
							hoverColor={color.orange1}
							arrowColor={color.blue1}
						>
							Digital Nomads And Location Independent People
						</PathLink>
					</LinkItem>

					<LinkItem>
						<PathLink
							to="https://www.facebook.com/groups/nomadicentrepreneur/"
							textColor={color.blue1}
							hoverColor={color.orange1}
							arrowColor={color.blue1}
						>
					...
					<LinkItem>
						<PathLink
							to="https://www.facebook.com/groups/756306204446638/"
							textColor={color.blue1}
							hoverColor={color.orange1}
							arrowColor={color.blue1}
						>
			...
			<Container>
				<LinksContainer>
					...
					<LinkItem>
						<PathLink
							to="https://remotive.io/community"
							textColor={color.blue1}
							hoverColor={color.orange1}
							arrowColor={color.blue1}
						>
					...
					<LinkItem>
						<PathLink
							to="https://www.facebook.com/groups/1428340887415620/"
							textColor={color.blue1}
							hoverColor={color.orange1}
							arrowColor={color.blue1}
						>
					...
					<LinkItem>
						<PathLink
							to="https://www.facebook.com/groups/digitalnomadsforum/"
							textColor={color.blue1}
							hoverColor={color.orange1}
							arrowColor={color.blue1}
						>
					...
					<LinkItem>
						<PathLink
							to="https://www.reddit.com/r/digitalnomad/"
							textColor={color.blue1}
							hoverColor={color.orange1}
							arrowColor={color.blue1}
						>
