...
const Taxes = () => (
    <Wrapper>
        ...
        <Service>
            <TextCenterLayout headlineWidth={770} textWidth={770} headline="Maintaining Your Online Business"
                              text="There are certain forms and legalities you need to follow to keep your internet business in good standing."/>
