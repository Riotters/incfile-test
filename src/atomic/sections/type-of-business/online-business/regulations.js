...
const Regulations = () => (
  <Wrapper>
    ...
    <Container style={{ paddingTop: "100px", paddingBottom: "100px" }} width={750}>
      ...
      <Paragraph big mixed>
        Even though you’re running an online business, you can’t escape real-world licenses, permits and regulations. You will need to explore local, state and federal licenses and permits, and{" "}
