            ...
            <BusinessOwnerResponsibilities>
                <ImageContent image="unique-business-green" paddingTop="60">
                    ...
                    <Paragraph big mixed={true}>
                        In most cases, our recommendation for an online business would be to create an LLC. We’ve got a complete guide to everything you need
                        to do, and we can even set one up for your business. LLC formation does vary from state to state, but we’ve got you covered, wherever you are.
                    </Paragraph>
