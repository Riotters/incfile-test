  ...
  <BlueContainerWrapper>
    ...
    <ContentCenter contentWidth={770}>
      <div>
        ...
        <Paragraph big>
          Compared to many other small businesses, microbreweries have high startup costs. A combination of a large building to brew in, the sophisticated equipment needed and special ingredients like hops, barley and malt all means a high initial capital expenditure. If you have a bar, brewpub or
          cafe as well, you can expect those costs to increase significantly. Here’s a (very) rough guide to what you can expect to pay:
        </Paragraph>
        <Paragraph big mixed={true}>
          <SpecialList>
            <li>Brewing equipment could cost anything between $100,000 and $1,000,000</li>
            <li>The lease or rent on your location varies widely between cities and lots, so inquire with local property owners</li>
            <li>
              Preparing your brewery and brewpub is also expensive — you will likely need special flooring for the brewery that could run to thousands of dollars, you may need to get special electrics and water lines put in and you will need to pay for construction, decoration and fixtures for your
              brewpub
            </li>
            <li>Overall, starting a brewery could cost you anywhere from $500,000 to $2.5 million or more depending on your desires, ambition and ability to negotiate</li>
            <li>You will need to pay alcohol tax and licenses and permits to brew and serve alcohol</li>
          </SpecialList>
        </Paragraph>
      </div>
    </ContentCenter>
