...
const SettingBusiness = () => (
  <WrapperContainer>
    ...
    <Container>
      <ImageBoxes>
        <TopImageBox image="location" imageAlt="location of your brewery" color={color.red3}>
        ...
        <TopImageBox image="display-ads" imageAlt="brewery marketing" color={color.purple3}>
        ...
        <TopImageBox image="software" imageAlt="software process" color={color.blue3}>
