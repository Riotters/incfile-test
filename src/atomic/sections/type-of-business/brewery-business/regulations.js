...
const Regulations = () => (
  <Wrapper>
    ...
    >
      ...
      <Paragraph big mixed>
        Breweries require extensive licenses and permits. In addition to
        standard local business licenses, you will also need permits to brew and
        sell alcohol, as well as meeting other federal, state and city
        regulations.{" "}
        <Link to="/business-license-research-package/">
          We can help out with researching your brewery business licensing needs
        </Link>
        .
      </Paragraph>
      <Heading size={3} left>
      ...
      <Paragraph big mixed>
        ...
        liable for sales and use tax. As a brewery, you will also need to pay
        taxes for every pint or glass that you sell. We can also{" "}
