  ...
  <Wrapper>
    ...
    <Container style={{ paddingTop: "100px", paddingBottom: "100px" }} width={750}>
      ...
      <Paragraph big mixed>
        ...
        use tax. As a brewery, you will also need to pay taxes for every pint or glass that you sell. We can also <Link to="https://www.incfile.com/business-accounting/">prepare and file your tax returns for you</Link>.
      </Paragraph>
    </Container>
  </Wrapper>
);
