  ...
  <Wrapper>
    ...
    <Container>
      <BusinessOwnerResponsibilities>
        ...
        <Paragraph big style={{ fontFamily: "MarkPro", color: color.black, fontSize: "24px" }}>
          You will also need a business model for your brewery.
        </Paragraph>

        <Paragraph big>This will detail where your revenue will come from, what your profit margins are, how quickly you will pay off debts and include a thorough accounting of all your initial and ongoing brewery costs.</Paragraph>
        <Paragraph big>Brewery business plans do vary slightly, but they should all cover the following areas:</Paragraph>
