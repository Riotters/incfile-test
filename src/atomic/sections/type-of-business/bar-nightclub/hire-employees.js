...
const HireEmployees = () => (
    <BlueContainer>
        ...
        <Container>
            <ContentCenter>
                <TextCenterLayout
                    headline="Hiring Employees for your Bar, Nightclub, Pub or Other Drinking Establishment" headlineWidth={770}/>
                ...
                <ImageBoxes>
                    ...
                    <TopImageBox image="tax-id" color={color.red3}>
                        ...
                        <p>
                            ...
                            number you will use to file and pay your taxes. We put together this guide to getting your
                            EIN.
                        </p>
                    </TopImageBox>
                    ...
                    <TopImageBox image="using-your-knowledge" color={color.orange3}>
                        ...
                        <p>
                            ...
                            certain other criteria. OSHA covers your health and safety requirements, while the U.S.
                            Department of Labor provides information on other responsibilities.
                        </p>
                    </TopImageBox>
                </ImageBoxes>
