...
const InsuranceBusiness = () => (
  <Wrapper>
    <div style={{ paddingBottom: "100px" }}>
      <TextCenterLayout
        headline="Insurance for Your Bar or Nightclub Business"
        text="Most bar or nightclub businesses should have comprehensive business insurance. There are various types."
      />
    </div>
