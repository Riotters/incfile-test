        ...
        <Wrapper layout={layout}>
          ...
          <PanelWrapper>
            ...
            <Paragraph big mixed={true}>
              Of course, along with running a business there are many rules,
            ...
            >
              <div id={ButtonList[0].tabId}>
                ...
                <Paragraph big mixed={true}>
                  Required licenses and permits for your bar or club business
                ...
                <CountingTextBoxed number={1}>
                  <div>
                    ...
                    <Paragraph bottomMargin={0}>
                      ...
                      licensing and permit requirements. In particular, you will
                      need to understand the laws around serving alcohol and
                      opening hours.
                    </Paragraph>
                  </div>
                </CountingTextBoxed>
                ...
                <CountingTextBoxed number={2}>
                  <div>
                    ...
                    <Paragraph bottomMargin={0} mixed>
                      You can find all the information you need on statewide
                      licenses and permits on the website for your Secretary of
                      State. You can find all those details in our{" "}
                ...
                >
                  When researching your licensing requirements, pay very careful
                ...
                <ListWrapper style={{ marginTop: "48px" }}>
                  <ListBox>
                    <CkeckText>
                      <Paragraph big>
                        Licenses to serve beer, wine or spirits for consumption
                        on the premises
                      </Paragraph>
                    </CkeckText>
                  </ListBox>
                  ...
                  <ListBox>
                    <CkeckText>
                      <Paragraph big>
                        Detailed records of all liquor, wine and beer received
                        from suppliers
                      </Paragraph>
                    </CkeckText>
                  </ListBox>
                  ...
                  <ListBox>
                    <CkeckText>
                      <Paragraph big>
                        Dealing with are the Alcohol and Tobacco Tax and Trade
                        Bureau (TTB) and your local Department of Alcoholic
                  ...
                  <ListBox>
                    <CkeckText>
                      <Paragraph big>
                        Licenses that regulate renovations, entertainment,
            ...
            >
              <div id={ButtonList[1].tabId}>
                <Heading
                  size={3}
                  style={{ marginTop: "140px", marginBottom: "24px" }}
                >
                  Business Insurance
                </Heading>
                <Paragraph big mixed={true}>
                  Most bar or club businesses should have comprehensive business
                  insurance. There are different types.
                </Paragraph>
                ...
                <CountingTextBoxed number={1}>
                  <div>
                    ...
                    <Paragraph bottomMargin={0} mixed>
                      ...
                      or injuries that affect employees. Regulations for this
                      insurance vary from state to state. It typically covers
                      areas like medical costs, loss of earnings, compensation
                      and retraining.
                    </Paragraph>
                  </div>
                </CountingTextBoxed>
                <CountingTextBoxed number={2}>
                  <div>
                    ...
                    <Paragraph bottomMargin={0}>
                      This insurance protects your business from claims due to
                      being sued and other legalities. This may include injury
                      to members of the public, property damage, personal
                      liabilities, legal defense and more. It can help protect
                      your business from financial penalties and bankruptcy;
                      this will be vital as you will be serving patrons on your
                      premises.
                    </Paragraph>
                  </div>
                </CountingTextBoxed>
            ...
            >
              <div id={ButtonList[2].tabId}>
                ...
                <Paragraph big mixed={true}>
                  ...
                  individuals or other businesses who can accept legal documents
                  on behalf of your bar or club company.
                </Paragraph>

                <Paragraph big mixed={true}>
                  Although you can act as your own{" "}
                  <Link to="/manage-your-company/registered-agent/">
                    Registered Agent
                  </Link>
                  , we recommend using a professional service. It ensures there
                ...
                <TextBoxed style={{ marginBottom: "8px" }}>
                  <div>
                    ...
                    <Paragraph style={{ marginBottom: 0 }}>
                      Unlike employees, the earnings from your business will be
                      taxed under a self-employment tax (FICA and Medicaid).
                      This is just over 15 percent of your earnings.
                    </Paragraph>
                  </div>
                </TextBoxed>
                ...
                <TextBoxed style={{ marginBottom: "8px" }}>
                  <div>
                    ...
                    <Paragraph style={{ marginBottom: 0 }}>
                      Most states do have a state income tax. If yours does, you
                      will be taxed on your earnings as normal. To register for
                      state tax, see your Secretary of State website.
                    </Paragraph>
                  </div>
                </TextBoxed>
                ...
                <TextBoxed style={{ marginBottom: "8px" }}>
                  <div>
                    ...
                    <Paragraph style={{ marginBottom: 0 }}>
                      You will need to pay income tax on any profits or earnings
                      you take from your business. In most cases, profits from
                      the business will “flow through” to your individual tax
                      return and you will be taxed there.
                    </Paragraph>
                  </div>
                </TextBoxed>
                ...
                <TextBoxed style={{ marginBottom: "8px" }}>
                  <div>
                    ...
                    <Paragraph style={{ marginBottom: 0 }}>
                      If you’re selling locally, you may also be liable for
                      collecting and paying sales tax. To register for sales
                      tax, see your Secretary of State website.
                    </Paragraph>
                  </div>
                </TextBoxed>
                ...
                <TextBoxed style={{ marginBottom: "8px" }}>
                  <div>
                    ...
                    <Paragraph style={{ marginBottom: 0 }}>
                      If you incorporate as a C Corporation, you will also need
                      to pay corporation tax — you will be taxed both on your
                      profits as a business and when you extract earnings from
                      your company. This “double taxation” is one of the reasons
                      we normally recommend LLCs as a good business structure,
                      since they avoid this.
                    </Paragraph>
                  </div>
                </TextBoxed>
                ...
                <TextBoxed style={{ marginBottom: "8px" }}>
                  <div>
                    ...
                    <Paragraph style={{ marginBottom: 0 }}>
                      In certain circumstances you may need to pay some other
                      types of taxes. Talk to your accountant to find out what
                      else you may be liable for.
                    </Paragraph>
                  </div>
                </TextBoxed>
              </div>
            ...
            <Paragraph big mixed style={{ marginTop: "48px" }}>
              As a rule of thumb, we recommend keeping back around a third of
              your earnings to pay your taxes. We can{" "}
