      ...
      <GridSection>
        <TitleBox>
          ...
          <Paragraph big>
            ...
            your bar or club business services, look at potential benefits and
          ...
          <Heading size={2} left style={{ marginTop: "100px" }}>
            Do Market Research and Validate Your Bar or Club Products and
            Services
          </Heading>

          <Paragraph big>
            Before you launch your bar or club business, you need to understand
        ...
        <GridSectionList>
          ...
          >
            ...
            <Paragraph bottomPadding={0} bottomMargin={0}>
              These types of businesses rely almost completely on locality and
              location, so understanding the residential and tourism markets in
              your region is critical.
            </Paragraph>
          </TextBlockWithImage>
          ...
          >
            ...
            <Paragraph bottomPadding={0} bottomMargin={0}>
              ...
              Additionally, in the bar and club scene there’s generally plenty
              of room for a niche establishment that provides a unique reason
              for customers to drink there.
            </Paragraph>
          </TextBlockWithImage>
          ...
          >
            ...
            <Paragraph bottomPadding={0} bottomMargin={0}>
              ...
              your bar or club and find out what’s currently missing in the
              local area
            </Paragraph>
          </TextBlockWithImage>
          ...
          >
            ...
            <Paragraph bottomPadding={0} bottomMargin={0}>
              ...
              encourage customers to come to you. This will mainly be driven by
              the type of bar or club you choose to run.
            </Paragraph>
          </TextBlockWithImage>
          ...
          >
            ...
            <Paragraph bottomPadding={0} bottomMargin={0}>
              Ask questions about bar or club businesses and meet up with other
              owners. You can find links to some excellent discussion groups
