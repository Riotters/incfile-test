    ...
    <BusinessOwnerResponsibilities>
      <ImageContent image="unique-business-2" paddingTop="60">
        ...
        >
          ...
          <Paragraph big>This is the "default" business structure and is what your travel agency business will be if you decide not to create a more formal structure. We don't recommend this type of business as it doesn't give you the legal protections you need.</Paragraph>
        </TextBlockWithImage>
        ...
        <Paragraph big style={{ paddingTop: "48px", paddingBottom: 0 }} mixed={true}>
          ...
          <Link to="/">please see our in-depth guide</Link>. If you’ve still got questions, <Link className="big blue">we’ve answered them to help you choose the right business structure</Link> for your travel agency business.
        </Paragraph>
        <Paragraph big style={{ paddingTop: "48px", paddingBottom: 0 }} mixed={true}>
          In most cases, our recommendation for your travel agency business would be to create an LLC. We’ve <Link to="/">got a complete guide</Link> to everything you need to do. <Link to="/">LLC formation does vary from state to state</Link>, but we’ve got you covered, wherever you are.
        </Paragraph>
