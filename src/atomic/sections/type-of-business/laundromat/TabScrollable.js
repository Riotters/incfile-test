                ...
                <Wrapper layout={layout}>
                    ...
                    <PanelWrapper>
                        ...
                        <Paragraph big mixed={true}>
                            ...
                            you need to be aware of. We can also help with researching your business licensing needs.
                        </Paragraph>
                                    ...
                                    <div id={ButtonList[5].tabId}>
                                        ...
                                        >
                                            ...
                                            <Paragraph big mixed={true} style={{marginTop: "48px"}}>
                                                ...
                                                earnings to pay
                                                your taxes. We can even prepare and file your tax returns for you.
                                            </Paragraph>
                                        </TextBlockWithImage>
                                    </div>
                                )
                                ...
                                return (
                                    <div id={ButtonList[7].tabId}>
                                        ...
                                        >
                                            ...
                                            <Paragraph big>
                                                You need money to run a successful laundromat business. Here are our
                                                tips on staying
                                                financially healthy.
                                            </Paragraph>
