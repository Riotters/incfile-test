...
const Links = () => (
  <Wrapper>
    <Container>
      <TextCenterLayout
        headline="Online Forums for Laundromat Owners"
      ...
      <LinksContainer>
        <LinkItem>
          ...
          <Paragraph style={{ marginTop: "20px" }} bottomMargin={0}>
            A group for laundromat owners to network, get ideas and solve
            problems
          </Paragraph>
        </LinkItem>
        ...
        <LinkItem>
          ...
          <Paragraph style={{ marginTop: "20px" }} bottomMargin={0}>
            A helpful community forum from the CLA providing advice on every
            aspect of owning and running a laundromat
          </Paragraph>
        </LinkItem>
        ...
        <LinkItem>
          ...
          <Paragraph style={{ marginTop: "20px" }} bottomMargin={0}>
            A comprehensive forum for laundry owners, including specific forums
