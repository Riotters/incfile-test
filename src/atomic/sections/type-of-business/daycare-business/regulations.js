    ...
    <Wrapper>
        ...
        <Container style={{paddingTop: "100px", paddingBottom: "100px"}} width={750}>
            ...
            <Paragraph big mixed={true}>
                ...
                of licenses, permits and regulations. You will need to explore local, state and federal licenses and
                permits for childcare and other aspects of your business. <Link to="/">We can help out with researching your business
