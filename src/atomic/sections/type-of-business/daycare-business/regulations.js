  ...
  <Wrapper>
    ...
    <Container style={{ paddingTop: "100px", paddingBottom: "100px" }} width={750}>
      ...
      <Paragraph big mixed={true}>
        Running a daycare business means you’ll probably need to satisfy a fair amount of licenses, permits and regulations. You will need to explore local, state and federal licenses and permits for childcare and other aspects of your business.{" "}
        <Link to="/business-license-research-package/">We can help out with researching your business licensing needs.</Link>
      </Paragraph>
      <Paragraph big>
