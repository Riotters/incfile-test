			...
			<GridSection>
				<TitleBox>
					...
					<Paragraph big>
						...
						types of publishing businesses. Once you’ve identified the areas
						you’d like to go into, you need to validate your publishing business
						idea.
					</Paragraph>
					...
					>
						Getting started in a publishing business is easy, but becoming a
						success is harder.
					</Paragraph>

					<Paragraph big>
						Before committing too much time, energy and money into your new
						publishing business, it’s important to test the marketplace.
					</Paragraph>
				</TitleBox>
				...
				<GridSectionList>
					...
					>
						...
						<Paragraph bottomPadding={0} bottomMargin={0}>
							For most publishers, your USPs will come from two areas: the niche
							you choose and the style/format that you present work in.
						</Paragraph>
					</TextBlockWithImage>
					...
					>
						...
						<Paragraph bottomPadding={0} bottomMargin={0}>
							Clearly identify their niche that you’re targeting and what they
							are likely to want from your content. This will be essential to
							your marketing, communications and promoting your content.
						</Paragraph>
					</TextBlockWithImage>
					...
					>
						...
						<Paragraph bottomPadding={0} bottomMargin={0}>
							There’s a lot of competition for eyeballs, and with the ability to
							publish worldwide on the web, it’s important to understand who is
							in a similar field to you and the approach they’re taking. This
							will help you make your publishing unique so you can attract and
							retain an audience.
						</Paragraph>
					</TextBlockWithImage>
					...
					>
						...
						<Paragraph bottomPadding={0} bottomMargin={0}>
							One of the great things about the publishing business is that
				...
				>
					...
					second or third publishing business ideas. Very few entrepreneurs get
					it right the first time. In fact, getting it wrong is often a badge of
