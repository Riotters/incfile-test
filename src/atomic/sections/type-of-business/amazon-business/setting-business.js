...
const SettingBusiness = () => (
  <GreenContainer>
    ...
    <Container>
      <TextCenterLayout headline="Setup & Maintain Your Amazon Business" headlineWidth="700" text="Once you've legally created your Amazon business you’ll need to get some other things in place." />
      <ImageBoxes>
        <TopImageBox image="location" color={color.red3}>
          <Heading size={3} template={4}>Business Location</Heading>
          <p>Where are you going to run your business? Will you work from home, get an office, use a shared working space or something else? In most cases, unless you are planning to store products, it’s best to start an Amazon business from your home.</p>
        </TopImageBox>
        ...
        <TopImageBox image="organization-change-02" color={color.green3}>
          ...
          <p>What business processes are you going to use to run your business efficiently and effectively? You will need efficient processes for managing inventory, dealing with suppliers, ordering stock, looking at competitors and completing market research.</p>
        </TopImageBox>
        ...
        <TopImageBox image="we-doubled-the-size-of-customer-service" color={color.orange3}>
          ...
          <p>Do you need to hire employees to help you out? This may change as your business grows, but try to think ahead about what sort of experts you may need.</p>
        </TopImageBox>
      ...
      <ContentCenter>
        <Button theme="primary56" marginMD="0 24px 0 0" arrow content={{ url: `${process.env.ORDER_URL}/form-order-now.php`, text: `Start your business with us, today!` }} />
      </ContentCenter>
    </Container>
  </GreenContainer>
);
