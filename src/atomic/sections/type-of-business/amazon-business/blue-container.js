    ...
    <Container>
      <GridSection>
        <TitleBox>
          ...
          <Heading size={3}>
            Validating Your Professional Amazon Business Idea
          </Heading>
          <Paragraph>
            Getting started in an Amazon business is easy, but becoming a
            success is harder. Before committing too much time, energy and money
            into your new Amazon business, it’s important to test the
            marketplace.
          </Paragraph>
        </TitleBox>
        ...
        <GridSectionList>
          ...
          >
            ...
            <Paragraph bottomPadding={0} bottomMargin={0}>
              Whether you’re competing on your niche, results, pricing or
              something else, your USPs set you apart from other coaches and
          ...
          >
            ...
            <Paragraph bottomPadding={0} bottomMargin={0}>
              ...
              Look into the other coaches operating in your niche and area.
            </Paragraph>
          </TextBlockWithImage>
          ...
          >
            ...
            <Paragraph bottomPadding={0} bottomMargin={0}>
              Clearly identify exactly who your clients are likely to be through
              the niches you serve. This will be essential to your marketing,
              communications, sales and client support.
            </Paragraph>
          </TextBlockWithImage>
          ...
          >
            ...
            <Paragraph bottomPadding={0} bottomMargin={0}>
              ...
              your coaching services, and validate this by asking if they would
      ...
      <TitleBox>
        <Paragraph big>
          Not every idea you have will make it through to becoming a coaching
