  ...
  <OrangeContainer>
    ...
    <BusinessOwnerResponsibilities>
      <ImageContent image="unique-business-2" paddingTop="60">
        ...
        <Paragraph big>Now that you have all the background information for your Amazon seller business, it’s time to make it into a reality. That starts by choosing the right structure or “legal entity” for your business. In the U.S., there are four main business structures. They are:</Paragraph>
        ...
        <Paragraph big style={{ paddingTop: "48px", paddingBottom: 0 }} mixed={true}>
          ...
          <Link to="/business-entity-comparison/">please see our in-depth guide</Link>. If you've still got questions, <Link to="https://grasshopper.com/blog/llc-vs-corporation-8-entrepreneur-questions-answered/">we've answered them to help you choose the right business structure.</Link>
        </Paragraph>
