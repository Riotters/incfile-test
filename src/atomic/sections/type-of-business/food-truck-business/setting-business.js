    ...
    <Container>
      <ImageBoxes>
        <TopImageBox image="display-ads" color={color.purple3}>
          <Heading size={3} template={4}>Marketing Your Food Truck Business</Heading>
          <p>
        ...
        <TopImageBox image="location" color={color.red3}>
          <Heading size={3} template={4}>Location of your Food Truck business</Heading>
          <p>
        ...
        <TopImageBox image="side-4" color={color.green3}>
          <Heading size={3} template={4}>Equipment for Your Food Truck</Heading>
          <p>
