    ...
    <Wrapper>
        ...
        <Container style={{paddingTop: "100px", paddingBottom: "100px"}} width={750}>
            ...
            <Paragraph big>
                ...
                them. This can include self-employment tax, state income tax and federal income tax. It’s also very
                likely that the food you sell will be subject to sales and use tax.
            </Paragraph>
            <Paragraph big mixed>
