...
const Regulations = () => (
  <Wrapper>
    ...
    <Container style={{ paddingTop: "100px", paddingBottom: "100px" }} width={750}>
      ...
      <Paragraph big mixed>
        You can’t escape real-world licenses, permits and regulations, and they’re particularly onerous for a food-based business. You will need to explore local, state and federal licenses and permits, and{" "}
        <Link to="/business-license-research-package/">we can also help out with researching your business licensing needs</Link>. Pay particular attention to any permits or licenses needed for safety and hygiene.
      </Paragraph>
      <Paragraph big>
