	...
	<Wrapper>
		...
		<Container>
			<BusinessOwnerResponsibilities>
				...
				>
					You will also need to look at financial projections for your food
					truck business.
				</Paragraph>
				...
				<Paragraph big>
					Food truck business plans do vary slightly, but they should all cover
					the following areas:
				</Paragraph>
				...
				<CountingTextBoxed number={2}>
					<Paragraph bottomPadding={0} bottomMargin={0}>
						Your goals and what you hope to achieve with your food truck
						business
					</Paragraph>
				</CountingTextBoxed>
				...
				<CountingTextBoxed number={3}>
					<Paragraph bottomPadding={0} bottomMargin={0}>
						A description of your food truck business, background information
						and context
					</Paragraph>
				</CountingTextBoxed>
				...
				<Paragraph big style={{ marginTop: "32px" }}>
					In particular, your food truck business plan should cover your startup
					and operational costs. You’ll need to work out how long it will be
					before you can turn a profit, bearing in mind the expense to buy a
					truck and equip it with specialized food facilities. Even after that,
					you’ll also need to put money toward ingredients, permits, wages,
					utility costs and more. Your food truck business will succeed or fail
					based on its profitability, so a rock solid understanding of your
					pricing and expenses is essential.
				</Paragraph>
