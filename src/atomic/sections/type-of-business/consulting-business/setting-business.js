...
const SettingBusiness = () => (
    <GreenContainer>
        ...
        <TextCenterLayout
            headline="Set up & Maintain Your Consulting Business"
            headlineWidth={770}
            textWidth={770}
        ...
        <Container>
            <ImageBoxes>
                ...
                <TopImageBox image="permits-licences" imageAlt="permit and license" color={color.blue3}>
                    ...
                    <p>
                        Running a consulting business comes with certain rules, regulations and legalities you need to be aware of. Incfile can conduct a <Link to="/business-license-research-package/">Business License Research package</Link> for you, or you can take the time to do the research yourself.
                    </p>
                </TopImageBox>
                ...
                <TopImageBox image="organization-change-02" imageAlt="Processes" color={color.green3}>
                ...
                <TopImageBox image="side-3" imageAlt="equipment" color={color.green3}>
