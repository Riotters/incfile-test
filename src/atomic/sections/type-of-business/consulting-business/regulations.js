...
const Regulations = () => (
  <Wrapper>
    ...
    <Container
      ...
      width={750}
    >
      <Heading size={2}>Rules, Regulations and Taxes for Your Business</Heading>
      <Paragraph big>
        Even though you’re running an online business, you can’t escape
        real-world licenses, permits and regulations. You will need to explore
        local, state and federal licenses and permits, and we can also help out
      ...
      <Paragraph big>
        ...
        on where you’re selling, you may also be liable for sales and use tax.
      </Paragraph>
      <Paragraph big mixed>
