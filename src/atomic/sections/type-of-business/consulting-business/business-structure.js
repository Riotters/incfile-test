    ...
    <BusinessOwnerResponsibilities>
      <ImageContent image="unique-business-2" imageAlt="" paddingTop="60">
        ...
        <Paragraph big style={{ paddingTop: "48px", paddingBottom: 0 }} mixed={true}>
          For most smaller consultant businesses, an LLC is the ideal business setup. It provides you with liability protection, is simple to administer and has some tax advantages over other business types. Additionally, if another consulting firm ever subcontracts to you (which does happen), they
          will definitely expect you to have a formal legal structure in place.
        </Paragraph>
        <Paragraph big style={{ paddingTop: "48px", paddingBottom: 0 }} mixed={true}>
        ...
        <Paragraph big style={{ paddingTop: "48px", paddingBottom: 0 }} mixed={true}>
          We’ve <Link to="/form-an-llc/">got a complete guide to everything you need to do to set up an LLC</Link>, and we can start one for your consulting business today. <Link to="/llc-state-information/">LLC formation does vary from state to state</Link>, but we’ve got you covered, wherever you
          are.
        </Paragraph>
