  ...
  <Wrapper>
    ...
    >
      ...
      <Paragraph big mixed>
        ...
        need to explore local, state and federal licenses and permits, and{" "}
        <Link to="/business-license-research-package/">
          we can also help out with researching your business licensing needs
        </Link>
        . Make sure you understand the permits, licenses and regulations you’ll
        need to follow as an event planner vs. the responsibilities of the
        vendors, third parties and locations that you’re working with.
      </Paragraph>
      <Heading size={3} left>
        Taxes
      </Heading>
