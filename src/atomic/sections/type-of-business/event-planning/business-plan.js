    ...
    <Wrapper>
        ...
        <Container>
            <BusinessOwnerResponsibilities>
                <TextCenterLayout headline="Your Event Planning Business Needs a Plan" text="Although party and event companies are all about managing plans on behalf of your clients, you also need your own business plan. This will help you define how you’re going to run your party or event planning business, market yourself, get sales, make a profit and grow. This can only come about through creating a watertight business plan. It will help you get your thinking in order and show your commitment to your party or event planning business." />

                <Colorbox className="box" theme="icon" Icon={BoxIcon} color={color.orange3} curve
                          curveColor={color.orange3}>
                    <Heading size={4}>
                        You will also need to look at financial projections
                        for your party or event planning business.
                    </Heading>
