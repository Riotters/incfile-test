  ...
  <Wrapper>
    ...
    <Container>
      <BusinessOwnerResponsibilities>
        <TextCenterLayout
          headline="Your Party or Event Planning Business Needs a Plan"
        ...
        <Colorbox
          ...
          color={color.orange3}
          curve
          curveColor={color.orange3}
        >
          <Heading size={3} template={4}>
            You will also need to look at financial projections for your party
            or event planning business.
          </Heading>
          <Paragraph bottomPadding={0} bottomMargin={0}>
            What are your expected sales and revenues? What is your
        ...
        <Paragraph big>
          ...
          setting up a party or event planning business in the first place, as
          well as factoring in utility, staff and other costs.
        </Paragraph>
        <Paragraph big>
        ...
        <CountingTextBoxed number={3}>
          <Paragraph bottomPadding={0} bottomMargin={0}>
            A description of your event planning company, background information
            and context
          </Paragraph>
        </CountingTextBoxed>
        ...
        <CountingTextBoxed number={5}>
          <Paragraph bottomPadding={0} bottomMargin={0}>
            An overview of how your party or event planning business is
            structured
          </Paragraph>
        </CountingTextBoxed>
