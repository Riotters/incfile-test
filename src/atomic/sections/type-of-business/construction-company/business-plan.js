    ...
    <Wrapper style={{position: "relative"}}>
        ...
        <Container>
            <BusinessOwnerResponsibilities>
                ...
                <Paragraph big>
                    It’s vital to take into account the cost of setting up a construction business in the first place, also factoring in utilities, staff and other costs. All of these details should
