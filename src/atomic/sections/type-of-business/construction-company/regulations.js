  ...
  <Wrapper>
    ...
    <Container style={{ paddingTop: "100px", paddingBottom: "100px" }} width={750}>
      ...
      <Paragraph big mixed={true}>
        Construction businesses will need to meet stringent rules and regulations, especially around building codes. You will also need to get licenses and permits. <Link to="/business-license-research-package/">We can help out with researching your construction business licensing needs.</Link>
      </Paragraph>
      <Paragraph big mixed={true}>
