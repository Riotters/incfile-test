  ...
  <OrangeContainer>
    ...
    <BusinessOwnerResponsibilities>
      <ImageContent image="unique-business-green" paddingTop="60">
        ...
        <Paragraph big>Now that you have all the background information for your photography business, it’s time to make it into a reality. That starts by choosing the right structure or “legal entity” for your business. In the U.S., there are four main business structures. They are:</Paragraph>
        ...
        <Paragraph big style={{ paddingTop: "48px", paddingBottom: 0 }} mixed={true}>
          We’ve <Link to="/form-an-llc/">got a complete guide to everything you need to do</Link>, and we can even start setting up an LLC for your photography business today. <Link to="/llc-state-information/">LLC formation does vary from state to state</Link>, but we’ve got you covered, wherever
          you are.
        </Paragraph>
