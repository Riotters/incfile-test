    ...
    <BusinessOwnerResponsibilities>
      <ImageContent image="unique-business-green" paddingTop="60">
        <Heading size={2} template={3} left>
          Choose the Right Business Structure and Register Your Photography
          Business
        </Heading>
        <Paragraph big>
          Now that you have all the background information for your photography
        ...
        >
          ...
          <Paragraph big>
            ...
            finances and assets and is a great way to start your photography
            business.
          </Paragraph>
        </TextBlockWithImage>
