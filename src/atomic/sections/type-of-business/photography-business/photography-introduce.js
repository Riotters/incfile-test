		...
		<BusinessOwnerResponsibilities>
			<ImageContent image="photography-business-boxes" paddingTop="60">
				<Paragraph big style={{ marginBottom: "48px", paddingBottom: 0 }}>
					From traditional wedding photography to photojournalism, family
					sessions, portraits, advertising, product shots, fashion or food, the
					photography industry has plenty of opportunities for you to carve out
					a niche. Great photographers can quickly build a reputation too,
					meaning that once you have a good portfolio together, you’ll likely
				...
				<Paragraph
					...
					mixed={true}
				>
					Although photography is an artform, running a successful business
					requires plenty of practical skills. You will need to use your
					creative drive to create a sustainable freelance photography business,
				...
				<ListWrapper>
					...
					<ListBox>
						<CkeckText>
							<Paragraph big>Resources for your photography business</Paragraph>
						</CkeckText>
					</ListBox>
				...
				<Paragraph big style={{ paddingTop: "48px" }} mixed={true}>
					By the time you’ve read through our complete photography business
					guide, you will have all the information you need to set up and manage
