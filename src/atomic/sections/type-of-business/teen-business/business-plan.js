    ...
    <Wrapper>
        ...
        <Container>
            <BusinessOwnerResponsibilities>
                <TextCenterLayout headline="Your Teen Business Might Need a Plan"
                                  text="Remember, the ideas above are just a starting point. You can define and tweak exactly what type of teen business you want to run by conducting your own research."/>
