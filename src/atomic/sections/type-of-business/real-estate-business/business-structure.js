  ...
  <OrangeContainer>
    ...
    <BusinessOwnerResponsibilities>
      <ImageContent image="unique-business-green" paddingTop="60">
        ...
        <Paragraph big>
          Series LLCs are ideal for real estate investors. A series LLC gives you all the same benefits as a regular LLC, but it serves as a sort of “umbrella company” with additional flexibility and protections for multiple companies or lines of business within your overall operation. For instance,
          a series LLC can give rental property owners a way to separate their real estate investments from one another.
        </Paragraph>
        <Paragraph big>Even though series LLCs were created to simplify investment portfolio management, this type of business structure is still a relatively new approach to LLCs. In addition, series LLCs are currently only available in eight states:</Paragraph>
        ...
        <Paragraph big style={{ paddingTop: "48px", paddingBottom: 0 }} mixed={true}>
          In most cases our recommendation would be to create an LLC. We have a <Link to="/form-an-llc/">complete guide to everything you need to do</Link>, and we can set one up for your real estate business. <Link to="/llc-state-information/">LLC formation does vary from state to state</Link>, but
