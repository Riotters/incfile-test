...
const ToolsAndLinks = () => (
  <Wrapper>
    <LinksWrapper>
      ...
      <Container>
        <TextCenterLayout
          headline="Discussion Groups and Forums for Your Real Estate Business"
      ...
      <Container>
        <TextCenterLayout
          headline="Conferences for Real Estate Investors"
        ...
        <LinksContainer>
          ...
          <LinkItem>
            <PathLink
              to="https://www.nar.realtor/convention.nsf/"
              textColor={color.blue1}
              hoverColor={color.orange1}
              arrowColor={color.blue1}
            >
