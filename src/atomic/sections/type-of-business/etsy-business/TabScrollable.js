		...
		<Wrapper>
			<Container>
				<Wrapper layout={layout}>
					...
					<PanelWrapper id="containmentWrapper">
						<Heading size={3}>
							Rules, Regulations and Laws for Your Etsy Business
						</Heading>
						<Paragraph big mixed={true}>
							...
							Most Etsy businesses will not have any significant permit and
							licensing needs beyond the basic licenses we cover below.
						</Paragraph>
						...
						>
							<div id={ButtonList[0].tabId}>
								...
								>
									...
									<Paragraph big>
										Your region, county or city may require you to have licenses
										or permits to operate a business. Talk to your city’s
										Chamber of Commerce to learn about your local licensing and
										permit requirements. If you’re running your Etsy business
										from home, you may need to declare that.
									</Paragraph>
								</TextBlockWithImage>
							</div>
						</InView>
							...
							<div id={ButtonList[1].tabId}>
								...
								>
									...
									<Paragraph big mixed={true}>
										...
										Alternatively, the Small Business Administration website has
										a{" "}
										<a
						...
						>
							<div id={ButtonList[2].tabId}>
								...
								>
									...
									<Paragraph big>
										The Small Business Administration provides details of any
										national or federal licenses and permits you might need.
									</Paragraph>
								</TextBlockWithImage>
							</div>
						</InView>
						...
						>
							<div id={ButtonList[3].tabId}>
								...
								>
									...
									<Paragraph big>
										Most Etsy businesses should have business insurance. There
										are various types:
									</Paragraph>
							...
							<div id={ButtonList[6].tabId}>
								...
								>
									<Paragraph
										...
										mixed={true}
									>
										Maintaining Your Etsy Business
									</Paragraph>

									<Paragraph big>
										There are certain forms and legalities you need to follow to
										keep your Etsy business in good standing.
									</Paragraph>
							...
							<div id={ButtonList[7].tabId}>
								...
								>
									<Paragraph
										...
										mixed={true}
									>
										Finances and Your Etsy Business
									</Paragraph>

									<Paragraph big>
										You need money to run a successful Etsy business. Here are
										our tips on staying financially healthy.
									</Paragraph>
