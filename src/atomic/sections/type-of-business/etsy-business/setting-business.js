            ...
            <ImageBoxes>
                <TopImageBox image="location" color={color.red3}>
                    ...
                    <p>
                        ...
                        take up a lot of space. As your business grows, you might think about getting a more
                        professional crafting space, complete with an area that's well lit for product photos.
                    </p>
                </TopImageBox>
                ...
                <TopImageBox image="software" color={color.blue3}>
                    ...
                    <p>
                        ...
                        social media posts, or take better photos. There are also software platforms that help you
                        cross-sell on other platforms, like Facebook. Explore whether these tools can help you run your
                ...
                <TopImageBox image="display-ads" color={color.purple3}>
                    ...
                    <p>
                        ...
                        results, or it could include email and social media marketing. You also might want to consider
                        paying for Etsy ads to get your listings more views. You'll find lots of great advice on these
                        topics in the "Etsy Business Resources" later in this guide.
                    </p>
                </TopImageBox>
                ...
                <TopImageBox image="side-4" color={color.green3}>
                    ...
                    <p>
                        ...
                        account for likely demand and possible waste. Understand exactly what you need to spend so you
                        can write it off against business expenses.
                    </p>
                ...
                <TopImageBox image="organization-change-02" color={color.green3}>
                    ...
                    <p>
                        ...
                        you here, but you'll want to make sure you know how to get these reports and that you look at
                        them regularly. Again, you'll find helpful advice on developing these processes in the "Etsy
                        Business Resources" later in this guide.
                        <br/><br/>
                        You'll also want to find ways to manage your finances carefully and create your products in a
                        cost-effective manner. Sometimes this can mean searching out cheaper resources for your raw
                        materials, or cutting down on the time it takes to craft each individual item.
                    </p>
                </TopImageBox>
            </ImageBoxes>
        </Container>
