...
const Regulations = () => (
    <Wrapper>
        ...
        <Container style={{paddingTop: "100px", paddingBottom: "100px"}} width={750}>
            ...
            <Paragraph big mixed>
                You can’t escape real-world licenses, permits and regulations. You will need
                to explore local, state and federal licenses and permits, and we can also help with <Link to="/">researching your business licensing needs</Link>.
            </Paragraph>
            <Paragraph big>
