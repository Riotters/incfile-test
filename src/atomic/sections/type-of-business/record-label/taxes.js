...
const Taxes = () => (
    <Wrapper>
        ...
        <Service>
            <TextCenterLayout headlineWidth={770} textWidth={770} headline="Maintaining Your Record Label Business"
            ...
            <Container>
                <AdventagesBox>
                    ...
                    <Adventages style={{textAlign: "center"}} url={`/`} urlText={`Annual Report`}
                                circleText={`1`} headline={`File an Annual Report`} text={`Depending on the state you’re located in, you will probably have to file a report every year. This report tells the state about any major changes to your business, and we can file your annual report on your behalf.`}
                                circlePosition="center" circleBackgroundColor={color.blue1}
                                circleBackgroundShadow={shadow.blue1}/>

                    <Adventages style={{textAlign: "center"}}
                                circleText={`2`}
