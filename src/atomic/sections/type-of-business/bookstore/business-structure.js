		...
		<BusinessOwnerResponsibilities>
			<ImageContent image="unique-business-green" paddingTop="60">
				<Heading size={2} template={3} left>
					Choose the Right Business Structure and Register Your Bookstore
					Business
				</Heading>
				<Paragraph big>
					Now that you have all the background information for your bookstore,
					it’s time to make it into a reality. That starts by choosing the right
				...
				>
					...
					<Paragraph big>
						...
						bookstore business, you will be a sole proprietor by default. This
				...
				>
					...
					<Paragraph big>
						...
						protections, so we don’t recommend it for your bookstore business.
					</Paragraph>
				</TextBlockWithImage>
				...
				>
					...
					<Paragraph big>
						This is the most common type of business entity. An LLC is fast,
						simple and inexpensive to set up and maintain. It protects your
						personal finances and assets and is a great way to start your
						bookstore business.
					</Paragraph>
				</TextBlockWithImage>
				...
				>
					...
					<Paragraph big>
						This is a more complex type of business that isn't generally
						recommended for smaller organizations, though you might explore the
						benefits if your bookstore business grows.
					</Paragraph>
				</TextBlockWithImage>
				...
				>
					...
					<Paragraph big>
						...
						typically far more than the average entrepreneur or bookstore owner
						will need.
					</Paragraph>
				</TextBlockWithImage>
				...
				<Paragraph big style={{ paddingTop: "120px" }} mixed={true}>
					...
					<Link to="https://grasshopper.com/blog/llc-vs-corporation-8-entrepreneur-questions-answered/">
						...
						for your bookstore business
					</Link>
					.
				</Paragraph>
				<Paragraph big mixed={true}>
					In most cases, our recommendation for your bookstore business would be
