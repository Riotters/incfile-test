...
const Regulations = () => (
    <Wrapper>
        ...
        <Container style={{paddingTop: "100px", paddingBottom: "100px"}} width={750}>
            ...
            <Paragraph big mixed>
                You will need to explore local, state and federal licenses and permits, especially around food preparation and hygiene. <Link to="https://www.incfile.com/business-license-research-package/">We can also help out with researching your business licensing needs.</Link>
            </Paragraph>
            <Paragraph big mixed>
            ...
            <Paragraph big mixed>
                As a rule of thumb, we recommend holding back around a third of your earnings to pay your taxes. We can also <Link to="https://www.incfile.com/business-accounting/">prepare and file your tax returns for you.</Link>
            </Paragraph>
        </Container>
    </Wrapper>
);
