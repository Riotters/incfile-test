...
const Regulations = () => (
  <Wrapper>
    ...
    <Container style={{ paddingTop: "100px", paddingBottom: "100px" }} width={750}>
      ...
      <Paragraph big mixed>
        You will need to explore local, state and federal licenses and permits, especially around food preparation and hygiene. <Link to="/business-license-research-package/">We can also help out with researching your business licensing needs.</Link>
      </Paragraph>
      <Paragraph big mixed>
