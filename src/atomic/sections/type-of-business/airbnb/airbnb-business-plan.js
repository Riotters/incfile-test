  ...
  <div style={{ position: "relative" }}>
    ...
    <Container>
      <BusinessOwnerResponsibilities>
        ...
        <Paragraph big>
          You might not think you need a business plan for your Airbnb
          business—after all, if you’re getting guests through Airbnb, and
          they’re paying, you don’t need a business plan, right? Wrong.
        </Paragraph>
        <Colorbox
          className="box"
          theme="icon"
        ...
        >
          ...
          <Paragraph bottomPadding={0} bottomMargin={0}>
            You need to define how you’re going to run your Airbnb business,
            market your property, get sales, make a profit and grow. This can
        ...
        <Paragraph big>
          You will also need to look at financial projections for your Airbnb
          business. What are your expected booking revenues? How much is it
          costing you to buy and maintain the property? What is your
