...
const SettingBusiness = () => (
  <GreenContainer>
    ...
    <TextCenterLayout headline="Setting Up Your Airbnb Business Operations" headlineWidth={770} textWidth={770} text="Once you've legally created your bar or club business you’ll need to get some other things in place." />
      ...
      <ImageBoxes>
        <TopImageBox image="state-filling-fees" color={color.yellow3}>
          ...
          <p>
            ...
            for your airbnb business. You might also want to consider a business credit card. Additionally, you will also need to keep careful bookkeeping records and file business and personal taxes. Here at Incfile <Link to="/business-accounting/">we can even help you file your taxes</Link>.
          </p>
        </TopImageBox>
