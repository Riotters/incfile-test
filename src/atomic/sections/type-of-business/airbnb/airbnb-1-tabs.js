          ...
          <Collapse isOpened={true}>
            <Panel>
              ...
              >
                ...
                <Paragraph big>
                  ...
                  straightforward, but setting yourself up for success requires
                  a little more work.
                </Paragraph>
                <Paragraph big style={{ marginBottom: "50px" }}>
                  ...
                  through what you need to know to start your Airbnb venture and
                ...
                <Paragraph big>
                  ...
                  you out. Read on for some insight into creating your own
                  Airbnb business and becoming an entrepreneur. In this guide we
                  will cover:
                </Paragraph>
            ...
            <Panel>
              <PanelWrapper className="panel2" layout={layout}>
                ...
                <Paragraph big style={{ marginBottom: "76px" }}>
                  ...
                  Airbnb is a ready-made marketplace for guests, with millions
                  of listings around the world. Here are some statistics on the
                  power of the Airbnb industry:
                </Paragraph>
                ...
                <Paragraph big>
                  This is why Airbnb businesses are so exciting — how can you be
                  a part of that success? We're here to help you figure that
                  out.
                </Paragraph>
              </PanelWrapper>
            </Panel>
            <Panel>
              <PanelWrapper className="panel3" layout={layout}>
                ...
                <Paragraph big style={{ marginBottom: "48px" }}>
                  Here are some of the typical tasks you’ll be performing for
                  your Airbnb business on a daily basis.
                </Paragraph>
                ...
                <div style={{ marginBottom: "76px" }}>
                  <CountingTextBoxed number={1}>
                    <Paragraph bottomPadding={0} bottomMargin={0}>
                      An executive summary with the most important points from
                      your business plan
                    </Paragraph>
                  </CountingTextBoxed>
                </div>
                ...
                <Paragraph big style={{ marginBottom: "48px" }}>
                  The following skills will be very useful in your role as an
                  Airbnb small business owner.
                </Paragraph>
