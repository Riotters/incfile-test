...
const BusinessStructure = () => (
    <OrangeContainer>
        ...
        <BusinessOwnerResponsibilities>
            <ImageContent image="unique-business-green" imageAlt="choose right restaurant business" paddingTop="60">
                <Heading size={2} template={3} left>
                    Choose the Right Business Structure and Register Your Restaurant
                    Business
        </Heading>
                <Paragraph big>
                    Now that you have all the background information for your restaurant
                ...
                >
                    ...
                    <Paragraph big>
                        ...
                        finances and assets and is a great way to start your restaurant
                        business.
          </Paragraph>
                </TextBlockWithImage>
          ...
          for your restaurant business.
                ...
                <Paragraph
                    ...
                    mixed={true}
                >
                    In almost every case, the right business entity for a restaurant is
                    going to be an LLC. It provides you with liability protection, is easy
                    to set up and run, has low administrative overhead and can be tax
          advantageous. We’ve{" "}
                    <Link to="/form-an-llc/">got a complete guide</Link> to everything you
          need to do here, and we can even set up an LLC for your restaurant
          business.{" "}
