        ...
        <BusinessOwnerResponsibilities>
            <ImageContent image="unique-business-green" paddingTop="60">
                ...
                <Paragraph big style={{paddingTop: "48px", paddingBottom: 0}} mixed={true}>
                    ...
                    administrative overhead and can be tax advantageous. We’ve <Link to="/">got a complete
                    guide</Link> to everything
                    you need to do here, and we can even set up an LLC for your restaurant business. <Link to="/">LLC
                    formation
