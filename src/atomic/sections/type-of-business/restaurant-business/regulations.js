...
const Regulations = () => (
  <Wrapper>
    ...
    >
      ...
      <Paragraph big>
        Even though you’re running a teen business, you need to know about
        licenses, permits and regulations. You will need to explore local, state
        and federal licenses and permits, and we can also help out with
        researching your business licensing needs.
      </Paragraph>
      <Paragraph big>
