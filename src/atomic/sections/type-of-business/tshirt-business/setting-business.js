...
const SettingBusiness = () => (
  <GreenContainer>
    ...
    <ContentCenter contentWidth={770}>
      <TextCenterLayout headline="The Next Steps: Running a T-Shirt Business" headlineWidth={770} textWidth={770} text="Once you've legally created your T-shirt business, you’ll need to get some other things in place." />
    </ContentCenter>
    ...
    <Container>
      <ImageBoxes>
        ...
        <TopImageBox image="measuring-business-success" color={color.babyblue3}>
          ...
          <p>
            Most states require businesses to file an <Link to="/">Annual Report</Link> once a year. You will also be expected to pay estimated taxes on what you plan to earn in the current business year. Your federal, state, regional and city <Link to="/">business licenses and permits</Link> may
            need to be renewed on a regular basis, typically once a year.
          </p>
        </TopImageBox>
      </ImageBoxes>
    </Container>
