...
const TypeBusiness = () => (
    <Wrapper>
            ...
            <ContentCenter>
                <GridSection>
                    <GridSectionList>
                        ...
                        <TextBlockWithImage SvgImage={Icon2} imageBackgroundColor={color.orange2}
                            ...
                            <Paragraph bottomPadding={0} bottomMargin={0}>
                                You don’t want too much risk in your business, so that means limiting both up-front and ongoing costs
                                as much as possible.
                            </Paragraph>
                        </TextBlockWithImage>
                        ...
                        <TextBlockWithImage SvgImage={Icon5} imageBackgroundColor={color.red2}
        ...
        <Container>
            <Service>
                <TextCenterLayout headline="Business Ideas for Women and Moms"
                ...
                <AdventagesBox>
                    ...
                    >
                        <Paragraph mixed={true}>
                            If you’d rather sell products than services, a third-party marketplace like Amazon or eBay could
                            be ideal. You’ll need to find the right niche, understand profit margins and ship products, but this can be a great way to get started with ecommerce and online retail.
                        </Paragraph>
                    </AdventagesWithLongText>
                    ...
                    >
                        <Paragraph mixed={true}>
                            If you have artistic talent, you can even sell products that you make yourself. You can do this through
                            a marketplace like Etsy, or create your own store
                            to sell art, prints and other creations. Websites like CafePress and Zazzle will even put your designs onto items and take care of everything else for you.
                        </Paragraph>
                    </AdventagesWithLongText>
                    ...
                    >
                        <Paragraph mixed={true}>
                            Home-based businesses aren’t just about selling products and skills, you can also provide other services. For example, you might have skills
                    ...
                    >
                        <Paragraph mixed={true}>
                            ...
                            to demonstrate some experience and expertise
                            in your topic, but it’s another low-cost business
                            to start - all you really need is yourself.
                        </Paragraph>
                    </AdventagesWithLongText>
                    ...
                    >
                        <Paragraph mixed={true}>
                            ...
                            as well. Perhaps you're a business coach, bookkeeper or accountant who can take client appointments around your own schedule.
                        </Paragraph>
                    </AdventagesWithLongText>
                </AdventagesBox>
            </Service>
