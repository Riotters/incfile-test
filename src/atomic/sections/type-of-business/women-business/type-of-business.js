...
const TypeBusiness = () => (
    <Wrapper>
        ...
        <TextCenterLayout headline="The Concerns of Female Founders - Moms and Women Entrepreneurs" headlineWidth={770}
                          textWidth={770}
                ...
                <AdventagesBox>
                    ...
                    >
                        <Paragraph mixed={true}>
                            ...
                            start and will easily fit around your schedule. You can write when you have time wherever
                            you are, and monetize your blog through advertising, affiliate marketing or selling products
                    ...
                    >
                        <Paragraph mixed={true}>
                            ...
                            creative skill you can sell, you can use a freelance marketplace like Upwork, Fiverr and
                            People Per Hour. On these sites, you can pick up as much work as you want, and setting up a
                            profile will allow you to list your services and attract potential clients.
                        </Paragraph>
                    </AdventagesWithLongText>
                    ...
                    >
                        <Paragraph mixed={true}>
                            ...
                            could
                            be ideal. You’ll need to find the right niche, understand profit margins and ship products,
                            but this can be a great way to get started with ecommerce and online retail.
                        </Paragraph>
                    </AdventagesWithLongText>
                    ...
                    >
                        <Paragraph mixed={true}>
                            ...
                            as well. Perhaps you're a business coach, bookkeeper or accountant who can take client
                            appointments around your own schedule.
                        </Paragraph>
                    </AdventagesWithLongText>
                </AdventagesBox>
            </Service>
