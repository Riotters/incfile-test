...
const AmazonLinks = () => (
  <Wrapper>
    ...
    <Container>
      <TextCenterLayout headline="Social Media Groups for Your Amazon Business" text="Connecting with other business owners in your industry can be incredibly helpful. Here are some of the best social media groups:" />
    ...
    <Container>
      <TextCenterLayout headline="Social Media and Discussion Groups for Your Etsy Business" text="Connecting with other business owners in your industry can be incredibly helpful. Here are some of the best social media and discussion groups:" />
