  ...
  <div style={{ position: "relative" }}>
    ...
    <Container>
      <BusinessOwnerResponsibilities>
        ...
        <Paragraph big>
          You need to define how you’re going to run your boutique clothing
          business, market yourself, get sales, make a profit and grow. This can
          only come about through creating a watertight retail clothing business
          plan. It will help you get your thinking in order and show your
          commitment to your business.
        </Paragraph>

        <Paragraph big>
          You will also need to look at financial projections for your boutique
          clothing business. What are your expected sales and revenues? What is
        ...
        <CountingTextBoxed number={2}>
          <Paragraph bottomPadding={0} bottomMargin={0}>
            Your goals and what you hope to achieve with your boutique clothing
            business
          </Paragraph>
        </CountingTextBoxed>
        ...
        <CountingTextBoxed number={3}>
          <Paragraph bottomPadding={0} bottomMargin={0}>
            A description of your retail clothing venture, background
