        ...
        <ReactTabs content={tabs}>
            <TabPanel>
                <PanelWrapper>
                    ...
                    <Paragraph big style={{marginBottom: "48px"}}>
                        The question is, just where do you start? Here at Incfile, we know the answer, and we’ve shared
                        it with more than 100,000 people who we've helped to form their businesses. Since 2004, we’ve
                        supported retail entrepreneurs just like you, and we’re proud to have been a part of the
                        business revolution.
                    </Paragraph>

                    <Heading size={3}>Botique Clothing Business formation guide</Heading>
                    <Paragraph big>
                        Here is our simple guide to starting up a successful boutique clothing business. From
                        researching the type of business you can start, through legalities of setting up your boutique
                        and managing your operations, this guide is here to help. Read on for some insight into creating
                    ...
                    <ListWrapper>
                        <ListBox>
                            <CkeckText>
                                <Paragraph big>Facts and figures on the success of boutique garment
                        ...
                        <ListBox>
                            <CkeckText>
                                <Paragraph big>How to choose whether your clothing business should be an LLC or
                        ...
                        <ListBox>
                            <CkeckText>
                                <Paragraph big>How to start your boutique business with information on equipment,
                        ...
                        <ListBox>
                            <CkeckText>
                                <Paragraph big>Ideas for the type of boutique clothing business that you could
                                    form</Paragraph>
                            </CkeckText>
                        </ListBox>
            ...
            <TabPanel>
                <PanelWrapper>
                    ...
                    <CircleWithText style={{marginBottom: "48px"}} textInsideCircle="9"
                                    ...
                                    withBg={true} SvgChart={CircleIcon} symbol="%"/>
                    ...
                    <Adventages headline="The average online customer spends between $280 and $300 a year on clothes"
                                width="100%"/>
                    ...
                    <Paragraph big style={{marginTop: "76px"}}>
                        This is why Airbnb businesses are so exciting — how can you be a part of that success? We're
            ...
            <TabPanel>
                <PanelWrapper>
                    ...
                    <Paragraph big style={{marginBottom: "48px"}}>
                        One of the biggest questions a boutique clothing entrepreneur will need to answer is whether to
                        start a traditional, in-person boutique, an online boutique or a combination of the two. Each of
                    ...
                    <Adventages headline="There’s likely to be less competition, depending on where you’re located"
                                width="100%"/>
                    ...
                    <Adventages circleBackgroundColor={color.red1} circleBackgroundShadow={shadow.red1}
                                disadventage={true}
                    ...
                    <Adventages circleBackgroundColor={color.red1} circleBackgroundShadow={shadow.red1}
                                disadventage={true}
                                headline="Ongoing bills can be high, especially for lighting and heating" width="100%"/>
                    ...
                    <Paragraph big style={{marginBottom: "48px"}}>
                        It’s vital to decide on the approach you want to take. The advice we present in the rest of this
                        guide can apply to either type of clothing boutique, so please bear in mind the type you want to
                        start when applying it to your own circumstances.
                    </Paragraph>
                    ...
                    <Paragraph big style={{marginBottom: "48px"}}>
                        Although it can be exciting to form a boutique clothing business, there will be significant
                    ...
                    <Paragraph big style={{marginBottom: "24px"}}>
                        Here are some of the typical tasks you’ll be performing for your boutique clothing business on a
                        daily basis.
                    </Paragraph>
                    ...
                    <Paragraph big style={{marginBottom: "48px"}}>
                        The following skills will be very useful in your role as a boutique clothing small business
                        owner.
                    </Paragraph>
                    ...
                    <Adventages headline="Excellent interpersonal skills to help you deal with and sell to customers"
                                width="100%"/>
                </PanelWrapper>
            </TabPanel>
        </ReactTabs>
