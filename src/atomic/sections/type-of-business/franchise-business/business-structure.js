...
const OrangeContainer = styled.div`
  ...
  position: relative;
  background-image: linear-gradient(to bottom, rgba(255, 255, 255, 0) 50%, #f2f8f3);
`;
  ...
  <OrangeContainer>
    ...
    <BusinessOwnerResponsibilities>
      <ImageContent image="unique-business-green" paddingTop="60">
        ...
        <Paragraph big>Now you have all the background information for your franchise business, it’s time to make it into a reality. That starts by choosing the right structure or “legal entity” for your business. In the U.S., there are four main business structures. They are:</Paragraph>
