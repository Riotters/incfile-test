        ...
        <Container>
            ...
            <ImageBoxes>
                ...
                <TopImageBox image="location" color={color.red3}>
                    ...
                    <p>
                        Your franchisor may have strict rules about exactly where you can set up and the location they
                        want to see you take over. You may be restricted from opening up too close to any other
                        franchisees.
                    </p>
                </TopImageBox>
                ...
                <TopImageBox image="side-4" color={color.green3}>
                    <h4>Equipment</h4>
                    <p>
                        The type of equipment you need depends on the franchise business you run. Your franchisor will
                        be able to provide guidance and recommendations on what to buy and may even have special
                        arrangements with major vendors who can supply you with the equipment you need. Make sure you
                        understand exactly what you’re spending money on so you can write it off against business
                        expenses.
                    </p>
                </TopImageBox>
                ...
                <TopImageBox image="display-ads" color={color.purple3}>
                    <h4>Marketing</h4>
                    <p>
                        Much of your marketing will be handled by the franchisor, so it’s important to understand
                        exactly what they will be doing and what you need to do. See if you are featured on their
                        overall website, or if you need to create a website or other marketing collateral of your own.
                    </p>
                </TopImageBox>
                ...
                <TopImageBox image="we-doubled-the-size-of-customer-service" color={color.orange3}>
                    <h4>Employees</h4>
                    <p>
                        It’s very likely you will need to hire several employees. Again, this is an area where the
                        franchisor can help as they probably have specialized recruitment, hiring, training and employee
                        management plans.
                    </p>
                </TopImageBox>
                ...
                <TopImageBox image="software" color={color.blue3}>
                    ...
                    <p>
                        The franchisor may have specific software (e.g. point of sale software) that they need you to
                        use. Make sure you understand software requirements and details.
                    </p>
                </TopImageBox>
