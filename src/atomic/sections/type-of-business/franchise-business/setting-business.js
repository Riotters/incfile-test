    ...
    <Container>
      <ImageBoxes>
        ...
        <TopImageBox image="permits-licences" color={color.blue3}>
          ...
          <p>
            In addition to the strict rules and agreements you will have with the franchisor, there are also federal, state, local and industry-specific permits, licenses and regulations you will need to follow. Incfile can conduct a <Link to="/">Business License Research</Link> package for you or
            you can take the time to do the research yourself.
          </p>
        </TopImageBox>
        ...
        <TopImageBox image="state-filling-fees" color={color.yellow3}>
          ...
          <p>
            ...
            for your franchise business. You might also want to consider a business credit card. Additionally, you will also need to keep careful bookkeeping records and file business and personal taxes. Here at Incfile{" "}
