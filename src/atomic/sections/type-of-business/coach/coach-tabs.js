        ...
        <ReactTabs content={tabs}>
            <TabPanel>
                <PanelWrapper>
                    ...
                    <Paragraph big>
                        If you can provide practical advice and guidance to help people change their perspective or
                        their business practices, you could have the makings of a great coach. Whether you decide to go
                        into life coaching or executive and business coaching, there are plenty of excellent
                        opportunities in this growing industry.
                    </Paragraph>
                    <Paragraph big style={{marginBottom: "50px"}}>
                        The value of life and business coaches is supported by the statistics. If you know what makes
                        people or organizations tick, you could turn that into pragmatic steps and help people reach
                        their potential. It’s important to set up your life or business coaching company in the right
                        way.
                    </Paragraph>
                    ...
                    <Colorbox className="box" theme="icon" Icon={MegafonIcon} color={color.green3} curve
                        ...
                        <Paragraph bottomPadding={0} bottomMargin={0}>
                            Since 2004, we’ve helped over 500,000 people start exciting businesses and bring their ideas
                    ...
                    <Paragraph big>
                        ...
                        business, this guide will help you out. Read on for some insight into creating your own life or
                        business coaching company and becoming an entrepreneur who helps people make the best
                    ...
                    <ListWrapper>
                        <ListBox>
                            <CkeckText>
                                <Paragraph big>Statistics on why you should start a life or executive coaching
                                    business</Paragraph>
                            </CkeckText>
                        </ListBox>
                        ...
                        <ListBox>
                            <CkeckText>
                                <Paragraph big>How to choose whether your coaching business should be an LLC or
                        ...
                        <ListBox>
                            <CkeckText>
                                <Paragraph big>Groups, forums and support for life or business coaching
                                    entrepreneurs</Paragraph>
                            </CkeckText>
                        </ListBox>
                        ...
                        <ListBox>
                            <CkeckText>
                                <Paragraph big>How to start your life or business coaching venture with information on
                                    equipment, employees, location, permits, finance, taxes and more</Paragraph>
                            </CkeckText>
                        </ListBox>
                    </ListWrapper>
                </PanelWrapper>
            ...
            <TabPanel>
                <PanelWrapper>
                    ...
                    <Paragraph big>
                        Life coaching is about helping people deal with what’s going on in their lives and assisting
                        them in creating a better present and future. It involves a mix of psychology, counseling,
                        interpersonal skills and understanding how you can help a client realize their potential.
                    </Paragraph>
                    ...
                    <Paragraph big style={{marginBottom: "76px"}}>
                        Business and executive coaching is very different from life coaching. When you’re working with
                        senior management, you need to have an excellent understanding of business, strategy,
                        financials, organization, culture and the unique pressures that face executives when making
                        major
                        decisions.
                    </Paragraph>
                    ...
                    <Paragraph big style={{marginBottom: "76px"}}>
                        This is why life or business coaching ventures are so exciting — how can you be part of that
                        success? We're here to help you figure that out.
                    </Paragraph>
                </PanelWrapper>
            </TabPanel>
            ...
            <TabPanel>
                <PanelWrapper>
                    ...
                    <Paragraph big style={{marginBottom: "48px"}}>
                        Although it can be exciting to become a life or business coach, there will be significant
                        demands on you. Here are some of the things you can expect.
                    </Paragraph>
                    ...
                    <CountingTextBoxed number={10}>
                        <Paragraph bottomPadding={0} bottomMargin={0}>
                            Business coaches: Learning about the business you’re providing coaching for, including
                            strategy, financials and the executive team
                        </Paragraph>
                    </CountingTextBoxed>
                    ...
                    <div style={{marginBottom: "76px"}}>
                        <CountingTextBoxed number={11} style={{marginBottom: "76px"}}>
                            <Paragraph bottomPadding={0} bottomMargin={0}>
                                Business coaches: Research into the sector or industry of the business you’re providing
                                coaching for
                            </Paragraph>
                        </CountingTextBoxed>
                    </div>
                    ...
                    <div style={{marginBottom: "30px"}}>
                        <Adventages headline="Powerful analysis and investigative skills to get to the root of an issue"
                                    width="100%"/>
                    </div>
                    ...
                    <div style={{marginBottom: "30px"}}>
                        <Adventages headline="Preparing them for the future and giving them useful tools and techniques"
                                    width="100%"/>
                    </div>
                    ...
                    <div style={{marginBottom: "30px"}}>
                        <Adventages headline="Detailed statistics on improvements as a result of business coaching"
                                    width="100%"/>
                    </div>
                </PanelWrapper>
            </TabPanel>
