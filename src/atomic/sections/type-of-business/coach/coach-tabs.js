              ...
              <Collapse isOpened={true}>
                <Panel>
                  <PanelWrapper className={isVisible ? "slideUp enter panel1" : "slideUp panel1"} layout={layout}>
                    ...
                    <Paragraph big>
                      From validating your business and doing the research to filing your paperwork and running your business, this guide will help you out. Read on for some insight into creating your own life or business coaching company and becoming an entrepreneur who helps people make the best
                      of themselves. In this guide we will cover:
                    </Paragraph>

                    <ListWrapper>
                      <ListBox>
                        <CkeckText>
                          <Paragraph big>Statistics on why you should start a life or executive coaching business</Paragraph>
                        </CkeckText>
                      </ListBox>

                      <ListBox>
                        <CkeckText>
                          <Paragraph big>How to choose whether your coaching business should be an LLC or corporation</Paragraph>
                        </CkeckText>
                      </ListBox>

                      <ListBox>
                        <CkeckText>
                          <Paragraph big>How to find out if life or business coaching is right for you</Paragraph>
                        </CkeckText>
                      </ListBox>

                      <ListBox>
                        <CkeckText>
                          <Paragraph big>Different types of life or business coaching ideas</Paragraph>
                        </CkeckText>
                      </ListBox>
                      ...
                      <ListBox>
                        <CkeckText>
                          <Paragraph big>How to validate your coaching business idea</Paragraph>
                        </CkeckText>
                      </ListBox>

                      <ListBox>
                        <CkeckText>
                          <Paragraph big>Useful online tools for life or business coaching individuals</Paragraph>
                        </CkeckText>
                      </ListBox>
                      ...
                      <ListBox>
                        <CkeckText>
                          <Paragraph big>How to start your life or business coaching venture with information on equipment, employees, location, permits, finance, taxes and more</Paragraph>
                        </CkeckText>
                      </ListBox>
                    </ListWrapper>
                  </PanelWrapper>
                ...
                <Panel>
                  <PanelWrapper className="panel2" layout={layout}>
                    ...
                    <BlueBoxWithAbsoluteText absoluteText="$1B" text="Generated revenue of life coaching in the U.S. each year, and this is expected to grow to around $1.3 billion in 2022." />
                    <BlueBoxWithAbsoluteText absoluteText="$62K" text="Average yearly income for life coaches a year, and some coaches can earn over $100,000 a year." />
                    ...
                    <div style={{ marginBottom: "30px" }}>
                      <Adventages headline="Many customers for life coaching businesses are located on the East or West Coast of the U.S." width="100%" />
                    </div>

                    <div style={{ marginBottom: "30px" }}>
                      <Adventages headline="The number of coaches in the world increased from 47,500 in 2011 to 53,300 in 2018" width="100%" />
                    </div>

                    <div style={{ marginBottom: "48px" }}>
                      <Adventages headline="There are currently around 18,300 life coaches in the U.S." width="100%" />
                    </div>

                    <div style={{ marginBottom: "48px" }}>
                      <Adventages headline="Life coaches normally have multiple clients and typically charge between $200 and $500 a month for services" width="100%" />
                    </div>
                    ...
                    <Paragraph big style={{ marginBottom: "76px" }}>
                      Business and executive coaching is very different from life coaching. When you’re working with senior management, you need to have an excellent understanding of business, strategy, financials, organization, culture and the unique pressures that face executives when making major
                      decisions.
                    </Paragraph>

                    <BlueBoxWithAbsoluteText absoluteText="$12B" text="Generated revenue of Business Coaching in the U.S. a year." />
                    <BlueBoxWithAbsoluteText absoluteText="55K" text="Number of business coaching organizations in the U.S. employing over 100,000 people" />

                    <div style={{ marginBottom: "30px" }}>
                      <Adventages headline="The main areas that business coaches help with are executive development and financial management" width="100%" />
                    </div>

                    <div style={{ marginBottom: "30px" }}>
                      <Adventages headline="Studies show that there is between a 500% and 700% return on investment for money spent on business and executive coaching services" width="100%" />
                    </div>

                    <div style={{ marginBottom: "48px" }}>
                      <Adventages headline="Business coaching helps executives increase their productivity by over 80 percent" width="100%" />
                    </div>

                    <div style={{ marginBottom: "48px" }}>
                      <Adventages headline="Executive coaching delivers improvements to areas like productivity, work quality, organizational strength, customer service, working relationships, cost reductions and profitability" width="100%" />
                    </div>
                ...
                <Panel>
                  <PanelWrapper className="panel3" layout={layout}>
                    ...
                    <div style={{ marginBottom: "30px" }}>
                      <Adventages headline="Excellent interpersonal and influencing skills to talk with and listen to clients" width="100%" />
                    </div>

                    <div style={{ marginBottom: "30px" }}>
                      <Adventages headline="Powerful analysis and investigative skills to get to the root of an issue" width="100%" />
                    </div>

                    <div style={{ marginBottom: "30px" }}>
                      <Adventages headline="Good marketing skills to promote your coaching business" width="100%" />
                    </div>

                    <div style={{ marginBottom: "48px" }}>
                      <Adventages headline="Strong administration skills so you can stay on top of your schedule and finances" width="100%" />
                    </div>

                    <div style={{ marginBottom: "48px" }}>
                      <Adventages headline="Strong research skills so you can understand the history and context of the individuals and businesses you’re helping" width="100%" />
                    </div>
                    ...
                    <div style={{ marginBottom: "30px" }}>
                      <Adventages headline="Helping them come to terms with their existing life circumstances and challenges" width="100%" />
                    </div>

                    <div style={{ marginBottom: "30px" }}>
                      <Adventages headline="Preparing them for the future and giving them useful tools and techniques" width="100%" />
                    </div>
                    ...
                    <div style={{ marginBottom: "30px" }}>
                      <Adventages headline="Proven return on investment for business coaching services" width="100%" />
                    </div>

                    <div style={{ marginBottom: "30px" }}>
                      <Adventages headline="Demonstrated understanding of their business and sector" width="100%" />
                    </div>

                    <div style={{ marginBottom: "30px" }}>
                      <Adventages headline="Strong expertise in dealing with specific needs (e.g., productivity, management styles, culture or organizational change)" width="100%" />
                    </div>

                    <div style={{ marginBottom: "30px" }}>
                      <Adventages headline="Detailed statistics on improvements as a result of business coaching" width="100%" />
                    </div>
                  </PanelWrapper>
                </Panel>
              </Collapse>
