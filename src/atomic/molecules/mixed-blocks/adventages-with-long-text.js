...
const AdventagesWithLongText = ({className, title, children, colorStroke, circleBackgroundColor, circleBackgroundShadow, circlePosition, circleText, url, urlText, style, width, imageName, disadventage}) => {
    return (
        <Wrapper className={className} headline={title} style={style} width={width}>
            <Box width={width}>
...
AdventagesWithLongText.defaultProps = {
...
export default AdventagesWithLongText
