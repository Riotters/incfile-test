...
const Adventages = ({ className, content, colorStroke, circleBackgroundColor, circleBackgroundShadow, circlePosition, circleText, url, urlText, style, width, imageName }) => {
  return (
    <Wrapper className={className} style={style}>
      <Whitebox className="box">
        <Circle position={circlePosition} circleBackgroundColor={circleBackgroundColor} circleBackgroundShadow={circleBackgroundShadow} colorStroke={colorStroke}>
          {!circleText && (
