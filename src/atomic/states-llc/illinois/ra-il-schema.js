...
const RASchemaIL = () => {
    return (
        <Helmet>
            ...
            <script type="application/ld+json">{`
                {
                    "@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Do I Need to Appoint a Illinois Registered Agent?","acceptedAnswer":{"@type":"Answer","text":"<p>Yes. All IL LLCs are required to have a Registered Agent. This is mandated by the Illinois Secretary of State.</p>"}},{"@type":"Question","name":"When Can I Assign a Illinois Registered Agent Service?","acceptedAnswer":{"@type":"Answer","text":"<p>You must assign a Registered Agent when you incorporate your Illinois business through paperwork filed with the IL Secretary of State. You can change your agent afterward by filing the correct form. If you form your business through Incfile, we will file all necessary forms on your behalf.</p>"}},{"@type":"Question","name":"Can I Be My Own Registered Agent in Illinois?","acceptedAnswer":{"@type":"Answer","text":"<p>Yes, but we don’t recommend it, for the reasons listed above. If you still want to be your own Registered Agent, you just need to fill in the correct forms and pay a fee to the Illinois Secretary of State.</p>"}},{"@type":"Question","name":"Does My IL Registered Agent Need to Have an Address in Illinois?","acceptedAnswer":{"@type":"Answer","text":"<p>Yes. Additionally, if they are a business providing Registered Agent services, they must be legally able to conduct business in your state.</p>"}}]
                }
            `}</script>
        </Helmet>
    )
