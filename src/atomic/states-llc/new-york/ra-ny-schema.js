...
const RASchemaNY = () => {
    return (
        <Helmet>
            ...
            <script type="application/ld+json">{`
                {
                    "@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Do I Need to Appoint a New York Registered Agent?","acceptedAnswer":{"@type":"Answer","text":"<p>Yes. All NY LLCs are required to have a Registered Agent. This is mandated by the New York Department of State.</p>"}},{"@type":"Question","name":"When Can I Assign a New York Registered Agent Service?","acceptedAnswer":{"@type":"Answer","text":"<p>You need to do so when you incorporate your New York business through paperwork filed with the NY Department of State. You can change your Registered Agent at a later date by filing the correct form. If you form your business through Incfile, we will file all necessary forms on your behalf.</p>"}},{"@type":"Question","name":"Can I Be My Own Registered Agent in NEw York?","acceptedAnswer":{"@type":"Answer","text":"<p>Yes, but we don’t recommend it, for the reasons listed above. If you still want to be your own Registered Agent, you need to fill in the correct forms and pay a fee to the New York Department of State.</p>"}},{"@type":"Question","name":"Does My NY Registered Agent Need to Have an Address in New York?","acceptedAnswer":{"@type":"Answer","text":"<p>Yes. Additionally, if they are a business providing Registered Agent services, they must be legally able to conduct business in your state.</p>"}}]
                }
            `}</script>
        </Helmet>
    )
