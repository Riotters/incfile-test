...
const RASchemaCA = () => {
    return (
        <Helmet>
            ...
            <script type="application/ld+json">{`
                {
                    "@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Do I Need to Appoint a California Registered Agent?","acceptedAnswer":{"@type":"Answer","text":"<p>Yes. All CA LLCs are required to have a Registered Agent/Agent for Service of Process. This is mandated by the California Secretary of State.</p>"}},{"@type":"Question","name":"When Can I Assign a California Registered Agent Service?","acceptedAnswer":{"@type":"Answer","text":"<p>You can either do it when you incorporate your business through paperwork filed with the CA Secretary of State or afterward by filing the correct form. If you form your business through Incfile, we will file all necessary forms on your behalf.</p>"}},{"@type":"Question","name":"Does My CA Registered Agent Need to Have an Address in California?","acceptedAnswer":{"@type":"Answer","text":"<p>Yes. Additionally, if they are a business providing Registered Agent services, they must be legally able to conduct business in your state.</p>"}}]
                }
            `}</script>
        </Helmet>
    )
