      ...
      <PanelsWrapper>
        ...
        <Panel>
          <Grid>
            ...
            <Card
              content={{
                header: "File S Corp Tax Election",
                text:
                  "Reduce the Tax You Pay by Having Your LLC Treated as an S Corp for Tax Purposes.",
                imgAlt: `file s corporation tax election`,
                link: { url: `/llc-s-corp-election/`, text: `Learn more` },
              }}
              color={color.babyblue3}
              image={"bc-15"}
            />
