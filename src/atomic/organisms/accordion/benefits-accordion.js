      ...
      <PanelsWrapper>
        ...
        <Panel>
          <Grid>
            ...
            <Card content={{ header: "Renew Registered Agent", text: "Click here if you have existing registered agent service and would like to renew it.", link: { url: `/dashboard/`, text: `Learn more` } }} color={color.green3} image={"bc-18"} />
