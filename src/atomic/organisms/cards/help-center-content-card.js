  ...
  return (
    <Wrapper className={className}>
      <Whitebox className="card" overflow>
        ...
        <LightBoxVideo thumbnailVideo="what-is-an-s-corp-7321" videoID="97238919" vimeo />
        <Heading size="3" topMargin="48" bottomMargin="48">
        ...
        <LightBoxVideo thumbnailVideo="how-to-start-a-consulting-business-9829" videoID="144693528" vimeo />
        <Heading size="3" topMargin="48" bottomMargin="48">
        ...
        <LightBoxVideo thumbnailVideo="starting-a-cashless-business-4929" videoID="117685402" vimeo />
      </Whitebox>
    </Wrapper>
  );
};
