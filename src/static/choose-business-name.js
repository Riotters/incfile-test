...
export const choseNameGuide = [
    {
        ...
        type: "text",
        content: "You might be one of those people who’ve had a name in their heads from day one. Sometimes it just clicks — the perfect name. Or, like many, you might be struggling with how to best represent what you do in a catchy, concise way.",
        marginBottom: 24
    },{
        type: "text",
        content: "Choosing the perfect name is a process and one that requires some forethought (even if you already think that “Blurp Inc.” is a winner). We’ve got you covered, so let’s walk through this process together.",
        marginBottom: 48
    },{
        type: "header",
        ...
        type: "text",
        content: "Even if you already have a name, you’ll need to consider it from all angles. The name you choose will be seen in many places. Can you picture it on signs and billboards? Stationery and email signatures? How about name tags for trade shows or conferences? You’ll want to make sure that your name represents your business in the best way possible and works from \n" +
        ...
        content: [
            {
                ...
                answer: [
                    {
                        type: "paragraph",
                        content: "You‘d probably be surprised if Vance Refrigeration was the name \n" +
    ...
    },
    {
        ...
        type: "text",
        content: "In the construction trade, many business owners will choose these types of “umbrella” names for that reason. Construction workers are often capable of completing various types of projects, so they typically use words like “construction” or “contracting” in their names.",
        marginBottom: 48
    },{
        type: "header",
        ...
        type: "text",
        content: "If you’re planning to use a longer name, or feel that snappy, one-word business names are too constricting, going with an acronym can be an excellent solution. There are numerous examples of companies that have used acronyms for their business name because when used correctly they can be quite memorable.",
        marginBottom: 24
    },{
        type: "text",
        content: "You’ve probably heard of JBL, a popular speaker manufacturer. When spelled out, JBL stands for James Bullough Lansing, the founder of the company. Now, “James Bullough Lansing” might not be a memorable household name, but JBL certainly is.",
        marginBottom: 24
    },{
        type: "text",
        content: "If you’re planning to use your own name or even a combination of two or more names in the case of a partnership, choosing an acronym might be a smart move — especially if you’re having trouble agreeing on a name with those involved. There’s almost a sense of importance with an acronym...an allure, perhaps. Be careful, though, “Sam Howard Information Technologies” might be best left alone.",
        marginBottom: 48
    },{
        type: "header",
        ...
        type: "text",
        content: "If you have a few ideas, share them with people you know to get some feedback. Your friends, family and business connections may be able \n" +
        ...
        type: "text",
        content: "Now’s the time to put some of these tools into action by coming up with five business name ideas that you think would label your brand \n" +
...
export const nameAvailability = [
    ...
    {
        type: "text",
        content: "Once you’ve whittled down your list of potential business names to a final few, it’s time to start searching the company registrar to see if the names on your list can be claimed and used legally. If you choose a name that’s too close to another business identity, how will your customers know who is who? By checking with the Secretary of State, you can find out which names are available in your formation state – this should help you make the final choice and officially register your business name.",
        marginBottom: 48,
    },
    {
        type: "header",
        content: (
            <span>
                ...
                <Link to="/">Incfile Business Name Search Tool</Link>
        ...
        content: [
            {
                ...
                icon: AvailabilitySVG,
                text: "See if your proposed business name is already in use by another entity"
            },{
                icon: NotepadSVG,
    ...
    {
        type: "text",
        content: "This is where you make the final decision on the name of your business. \n" +
...
export const security = [
    {
        ...
        type: "text",
        content: "The digital world – this is where things happen. Just about every business has a website, and most have made social media a top priority over the last decade as customers flock to new digital content. Maintaining \n" +
        ...
        type: "text",
        content: "An important first step is securing your domain name so that your website and email address identify your business to the market.",
        marginBottom: 48
    },
    {
        type: "header",
        ...
        type: "text",
        content: "Want to increase credibility with your audience? One of the most common ways is to send business emails from an “@yourcompany.com” address. This shows that you’ve dedicated the time to present your business formally instead of slapping components together and sticking \n" +
            "a cardboard sign out front.",
        marginBottom: 24
    }, {
        type: "text",
        content: "We provide you with an easy way to claim your business domain and create a familiar “yourname@yourbusiness.com” address. You’ll be able \n" +
    ...
    },
    {
        ...
        content: [
            {
                ...
                icon: CalendarSVG,
                text: "Calendar, Contacts and Tasks that allow you to track your appointments and access your business contacts from any device",
            },{
                icon: RocketSVG,
                text: "Cloud File Storage so you can store and access your files from any device",
            },
        ],
        marginBottom: 32
    }, {
        ...
        type: "text",
        content: "Next, we’ll walk through the setup of four different social media platforms – Facebook, Instagram, Twitter and LinkedIn – so that you can begin building trust with new customers through online content.",
        marginBottom: 48
    }, {
        type: "header",
        content: "Facebook",
    ...
    },
    {
        ...
        content: [
            {
                number: "1",
                text: "First, visit <a href='https://facebook.com/' rel='nofollow' target='_blank'>Facebook</a>. Below the big green “Sign Up” button is “<strong>Create a Page</strong>” That’s what you’ll want to click on. On mobile, you’ll tap the menu icon (or, “hamburger”, as some like to call it), and then <strong>Pages</strong>.",
            },
        ]
    }, {
        type: "image",
    ...
    },
    {
        ...
        content: [
            {
                number: "2",
                text: "Here you’ll be able to <strong>Get Started</strong> (desktop) or <strong>Create</strong> (mobile). You’ll have to sign in at this point, or you can create a new Facebook account \n" +
    ...
    },
    {
        ...
        content: [
            {
                number: "3",
                text: "Once you’ve logged in, you can enter your business name and some details about your location and contact information. After you’re finished, tap or click <strong>Next</strong> to continue to your new page.",
            },
        ]
    }, {
        type: "image",
    ...
    },
    {
        ...
        content: [
            {
                number: "4",
                text: "Once your business page is created you can add your profile and cover photos, edit Messenger settings, add services, and create your first post! Don’t forget to invite your Facebook friends to “Like” your page to get your first few followers.",
            },
        ]
    }, {
        type: "image",
    ...
    },
    {
        ...
        content: [
            {
                number: "1",
                text: "First, visit <a href='https://instagram.com/' target='_blank' rel='nofollow'>Instagram</a>. Tap or click <strong>Sign Up</strong> to get started.",
            },
        ]
    }, {
        type: "image",
    ...
    },
    {
        ...
        content: [
            {
                number: "2",
                text: "Type in your information and click <strong>Sign Up</strong> (desktop) or <strong>Next</strong> (mobile). Instagram prefers a phone number to sign up, but you can use your email as well. On mobile, you’ll see another screen where you can enter your desired password and confirm your account name.",
            },
        ]
    }, {
        type: "image",
    ...
    },
    {
        ...
        content: [
            {
                number: "3",
                text: "Once inside your brand-new account, you can tap or click on your profile icon to add a profile photo and some information about your company. Once you’re finished, just click <strong>Submit</strong> and you’re done!",
            },
        ]
    }, {
        type: "image",
        ...
        content: [
            {
                number: "4",
                text: "Now, to switch your Instagram account from personal to business, you’ll have to proceed on a mobile device. Tap the menu icon (mmm… burgers) and then tap <strong>Settings</strong> to access additional options.",
            },
        ]
    }, {
        type: "image",
    ...
    },
    {
        ...
        type: "text",
        content: "Twitter is intended for shorter posts that can feature photos or video \n" +
    ...
    },
    {
        ...
        content: [
            {
                number: "1",
                text: "First, visit Twitter. Tap or click <strong>Sign Up</strong> and you’ll be prompted to input your information.",
            },
        ]
    }, {
        type: "image",
        ...
        content: [
            {
                number: "2",
                text: "Enter your business name and the email address you wish to use for it. \n" +
        ...
        content: [
            {
                number: "3",
                text: "On the desktop site, you’ll be asked to enter some additional information about your company. This information will be displayed at the top of your profile, so be sure to tell people what you do and what you’re all about before you click <strong>Next!</strong>",
            },
        ]
    }, {
        type: "image",
        ...
        content: [
            {
                number: "4",
                text: "Once inside your account you can see your timeline, which will be empty. This would be a good time to follow some individuals and businesses that share your passion, so you can see what they’re up to. To edit your profile, tap or click on your profile icon.",
            },
        ]
    }, {
        type: "image",
        ...
        content: [
            {
                number: "5",
                text: "Inside your profile you can tap or click <strong>Edit profile</strong> to add a photo of your logo, set a cover photo image, and change settings. The only thing left to do is to start tweeting quality content that engages your target audience.",
            },
        ]
    }, {
        type: "image",
    ...
    },
    {
        ...
        content: [
            {
                number: "1",
                text: "First, visit <a href='https://linkedin.com/' rel='nofollow' target='_blank'>LinkedIn</a>. This will have to be done on desktop, as LinkedIn doesn’t offer the ability to <strong>create business pages</strong> on mobile. Click Create your page to get started.",
            },
        ]
    }, {
        type: "image",
        ...
        content: [
            {
                number: "2",
                text: "You’ll need to either sign in or create a new account if you aren’t already \n" +
                    "a LinkedIn user.",
            },
        ]
    }, {
        ...
        content: [
            {
                number: "3",
                text: "After you log in, you’ll see four options for creating a company page. Click <strong>Small business</strong> to continue.",
            },
        ]
    }, {
        type: "image",
        ...
        content: [
            {
                number: "5",
                text: "There you go – your business is now represented with its own LinkedIn company page that users can access to see your activity and find information about what your business does.",
            },
        ]
    },
    {
    ...
    {
        type: "text",
        content: "Once you have each of your social accounts secured with your new business name, you can link to them on your business website so that customers have easy access to your content. Creating these accounts serves as a big addition to your brand that will pay dividends as you grow your business and nurture your online reputation. Complete that, and we can move on to Chapter 4!",
        marginBottom: 56
    }, {
        type: "buttons",
        content: [
...
export const entityType = [
    {
        ...
        type: "text",
        content: "LLCs are by far the most popular type of entity and are extremely beneficial for small businesses. The setup is quick and easy, they have \n" +
        ...
        type: "text",
        content: "Just like C-Corps and S-Corps, LLC owners are protected with limited liability. This means that business assets are owned by the company itself. As an owner, your personal assets are not affected by any liability that your business incurs (debt, equipment costs, depreciation, lawsuits, etc.).",
        marginBottom: 24
    }, {
        type: "text",
        content: "When it comes to taxes, LLCs are similar to sole-proprietorships and partnerships. An LLC doesn’t pay federal income taxes itself, but instead any net profit or loss is passed through to the personal tax returns of the owner(s). The IRS then taxes this as personal income.",
        marginBottom: 24
    }, {
        type: "text",
        content: "LLCs themselves are liable for specific types of taxes so it’s crucial to have your paperwork in tip-top shape. These taxes are typically written off as business expenses and don’t actually affect your personal bottom line. \n" +
    ...
    },
    {
        ...
        type: "text",
        content: "Forming a legal business entity separates you from your business and there are significant perks that come with doing so. For homework, take the Business Type Quiz to determine the best entity option for your new company. We’ll then provide some tailored information based on your results!",
        marginBottom: 36
    }, {
        type: "button",
        content: {
...
export const diyLLC = [ 
    ...
    {
        type: "text",
        content: "The time has come to start making things official for your new business, and there are specific documents that need to be prepared based on your state of incorporation. To begin this process, you’ll select your state, get access to the Articles of Organization that apply to your business and then submit these documents to the state. It’s beginning to feel real now, right? That’s great! Plow ahead with these steps and your brand-new business will be up and running in no time.",
        marginBottom: 48
    },
    {
        type: "header",
    ...
    {
        type: "text",
        content: "Each state has different regulations and requirements for LLC formation, and you’ll want to make sure that you choose the correct state where your business will be physically located. If your business is online, choose the state where you permanently reside. Some states require you to have \n" +
    ...
    {
        type: "text",
        content: "Once you’ve provided your company name, address and details about the members of your new LLC, you’ll receive the Articles of Organization paperwork to complete and submit to the Secretary of State. Some states might use a different name for these, such as Certificate of Organization or Certificate of Formation, but they serve the same purpose in the formation of your business.",
        marginBottom: 48
    },
    {
        type: "header",
    ...
    {
        type: "text",
        content: "You’ll need to have all of your information handy to complete the required forms. <a href='/'>Articles of Organization</a> ask for specific details, such as:",
        marginBottom: 24
    },
    {
        type: "list-dot",
    ...
    {
        type: "text",
        content: "Once you have completed the forms, you can pay the fee and file your documents with the Secretary of State. If you partner with Incfile, we’ll handle the completion and filing of these documents on your behalf and track their status to let you know of any notifications.",
        marginBottom: 48
    },
    {
        type: "header",
    ...
    {
        type: "text",
        content: "When completing your Articles of Organization, you’ll need to name your designated Registered Agent. Incfile provides you with a free Registered Agent for your first year of business as part of our service, but if you’re using a third party, they’ll be the ones who receive and pass on any official tax or legal correspondence to your provided business address. Your company isn’t allowed to act as its own agent, but you can designate a member within your company to <a href='/'>act as your agent at an individual capacity.</a>",
        marginBottom: 24
    }, {
        type: "text",
        content: "Besides it being a requirement, having a Registered Agent is actually quite desirable as they enable you to focus all of your energy into building and scaling your business while they act as a gatekeeper for state and legal information that can cause distractions from your work.",
        marginBottom: 48
    },
    {
        type: "header",
...
export const afterFilling = [
    {
        type: "header",
        content: "Hold your horses for just a moment, there’s a little more to be done!",
        size: 4,
        marginBottom: 24,
    },
    {
        type: "text",
        content: "First of all...you did it! Congratulations on entering this exciting chapter — you probably feel proud, motivated and perhaps a little nervous, and there’s nothing wrong with that. You are in control now, and as you ramp up to start doing business, we want to make sure that you’re equipped to take on your first few customers. Here are some steps to take now that you’ve filed your new business:",
        marginBottom: 48,
    },
    {
        type: "header",
    ...
    {
        type: "text",
        content: "If you haven’t obtained your EIN yet, it’s time to get into gear! You’ll need to provide your EIN when setting up business accounts with your local bank so that everything is tied to your LLC and not to you. Incfile can help by handling the EIN paperwork and obtaining an EIN within just one day on your behalf.",
        marginBottom: 24
    }, {
        type: "text",
        ...
        type: "text",
        content: "You’ll also want to complete a Banking Resolution, and file a “Statement and Resignation of the Organizer.” These documents aren’t required by the state but will help your bank verify your authorization to control the accounts.",
        marginBottom: 48
    },
    {
        type: "list-dot",
    ...
    {
        type: "text",
        content: "We know that you’re excited to get moving and serve your first customers, and by following these steps, you’ll be fully equipped to begin your business on a solid footing. The effort that you put into preparation now will help save you from a rough start and set you on a course for stable success.",
        marginBottom: 24
    }, {
        type: "text",
        content: "Incfile is always here to provide support and help you navigate the LLC formation process. If you’re ever feeling stuck, reach out to us! We’re never more than a click or a phone call away.",
        marginBottom: 56
    },
    {
        type: "button",
