        ...
        answer: [
          {
            type: "paragraph",
            content:
              "Unique business names have a tendency to stick in your head and aren’t easy to forget. Names like “IKEA”, “Starbucks” and “Facebook” all have originality assigned to them that make them stand out.",
          },
        ],
      },
      {
        ...
        answer: [
          {
            type: "paragraph",
            content:
              "“Versierte Unternehmer LLC” might sound good to you, but can the average person say it without twisting their tongue into a knot?",
          },
        ],
      },
      {
        ...
        answer: [
          {
            type: "paragraph",
            content:
              "It’s okay to tailor your name to a specific niche. A name like “ClickFunnels” might not mean anything to some, but it’s extremely clear to those who work in digital marketing and advertising. Remember who you want to serve and choose a name that means something to them.",
          },
        ],
      },
    ],
...
export const entityType = [
  ...
  },
  {
    type: "button",
    content: {
      text: "Take Our Business Type Quiz",
...
export const diyLLC = [
  ...
  },
  {
    type: "text",
    content:
      "When completing your Articles of Organization, you’ll need to name your designated Registered Agent. Incfile provides you with a free Registered Agent for your first year of business as part of our service, but if you’re using a third party, they’ll be the ones who receive and pass on any official tax or legal correspondence to your provided business address. Your company isn’t allowed to act as its own agent, but you can designate a member within your company to <a href='/registered-agents/'>act as your agent at an individual capacity.</a>",
    marginBottom: 24,
  },
  {
    type: "text",
...
export const afterFilling = [
  ...
  },
  {
    type: "header",
    content:
      "<a href='/business-license-tool/'>Obtain Your Permits and Licenses</a>",
    size: 3,
    template: 4,
    marginBottom: 24,
  },
