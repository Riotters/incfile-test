  ...
  },
  {
    ...
    content: (
      <span>
        ...
        <Link to="/business-name-search/">Incfile Business Name Search Tool</Link>
...
export const entityType = [
  ...
  },
  {
    type: "list-dot",
    content: {
      list: ["They are easier than running a C-Corp or S-Corp", "They have fewer rules, regulations and legal compliance issues", "They are formed and regulated on a state level"],
    },
    color: color.blue3,
    marginBottom: 32,
    curve: true,
  ...
  },
  {
    type: "list-dot",
    content: {
      list: ["Payroll tax on salaries paid to employees (not you – owners pay self-employment tax on their personal tax returns)", "Sales tax on goods purchased by and for the business", "Property taxes on property that the business owns"],
    },
    color: color.orange3,
    marginBottom: 48,
    curve: false,
...
export const diyLLC = [
  ...
  },
  {
    type: "list-dot",
    content: {
      list: ["Your business name and address", "Details of your Registered Agent", "Who the governing authority is", "Purpose of the LLC", "Supplemental provisions", "Name of the organizer", "Whether your LLC will be <a href='/'>member-managed or manager-managed</a>"],
    },
    color: color.orange3,
    marginBottom: 32,
    curve: true,
