...
export const about = {
	...
	table3: {
		...
		rows: [
			...
			[
				...
				`<p>Includes everything in the Economy package, plus:</p>
                <ul>
                    <li>A corporate kit</li>
	...
	table4: {
		...
		rows: [
			...
			[
				`Whats Included`,
				`<p>Includes everything in the Silver and Gold packages, plus:</p>
                <ul>
				...
				`<p>Includes everything in the Economy and Standard packages, plus:</p>
                <ul>
	...
	service3: {
		...
		table: {
			headers: [`Incorporate Business`, `Cost`],
			rows: [`Incfile`, `$99 + state fees`],
			rows: [`LegalZoom`, `$99–$119 + state fees`],
		},
	},
	service4: {
		image: `bc-18`,
	...
	service5: {
		...
		table: {
			headers: [`Incorporate Business`, `Cost`],
			rows: [`Incfile`, `Included as part of the Gold and Platinum packages`],
			rows: [`LegalZoom`, `$99–$199`],
		},
	},
	service6: {
		image: `bc-18`,
	...
	service7: {
		...
		table: {
			...
			rows: [`LegalZoom`, `Not offered as a service`],
		},
	},
	service8: {
		image: `bc-18`,
