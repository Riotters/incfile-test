export const top = {
  header: `Form a Corporation in South Carolina.`,
  text: `$0 + State Fee & 1st Year FREE Registered Agent`,
  buttons: [
    {
      text: `Start my corporation`,
      url: `${process.env.ORDER_URL}/form-order-now.php?entityType=CCorporation&entityState=SC`,
    },
  ],
};
...
export const fillingRequirements = {
  ...
  tableScheme: "blue3",
  header1: "South Carolina Filing Time & Price",
  ...
  header2: "South Carolina Compliance Requirements",
  ...
  table2: {
    ...
    rows: [
      [
        ...
        {
          label: "Domestic (South Carolinan) Entities are required to file within 6 months of creation. Failure to file will cause non-compliance and may lead to administrative dissolution.",
          type: "label",
          textCenter: true,
          className: "text-left",
        },
...
export const questions = {
  header: `Commonly Asked Questions For Starting a South Carolina Corporation`,
  items: [
    {
...
export const articlesOfIncorporation = {
  ...
  box2: {
    header: `South Carolina law also allows (but does not require) optional items to be included in the articles of incorporation for those corporations who wish to formally specify additional information, such as:`,
    list: [
...
export const corporationName = {
  ...
  text: `A proposed corporate name may be registered for an annual fee of $25. It is important to note that South Carolina state law does not allow businesses to register fictitious or assumed (“doing business as”) names.`,
};
