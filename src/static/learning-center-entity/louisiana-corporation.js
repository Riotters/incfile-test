export const top = {
  header: `Form a Corporation in Louisiana.`,
  text: `$0 + State Fee & 1st Year FREE Registered Agent`,
  buttons: [
    {
      text: `Start my corporation`,
      url: `${process.env.ORDER_URL}/form-order-now.php?entityType=CCorporation&entityState=LA`,
    },
  ],
};
...
export const fillingRequirements = {
  ...
  tableScheme: "blue3",
  header1: "Louisiana Filing Time & Price",
  ...
  header2: "Louisiana Compliance Requirements",
  ...
  table2: {
    ...
    rows: [
      [
        ...
        {
          label: "Domestic (Louisianan) Entities are required to file within 6 months of creation. Failure to file will cause non-compliance and may lead to administrative dissolution.",
          type: "label",
          textCenter: true,
          className: "text-left",
        },
...
export const questions = {
  header: `Commonly Asked Questions For Starting a Louisiana Corporation`,
  items: [
    {
...
export const articlesOfIncorporation = {
  box1: {
    header: `Including the following information:`,
    list: [
  ...
  box2: {
    header: `Some other items that aren’t required-but which are allowed to be included in the articles of incorporation if desired-are:`,
    list: [
...
export const corporationName = {
  ...
  text: `A proposed corporate name may be registered for an annual fee of $25. It is important to note that Louisiana state law does not allow businesses to register fictitious or assumed (“doing business as”) names.`,
};
