...
export const top = {
  header: `Form a Corporation in Idaho.`,
  text: `$0 + State Fee & 1st Year FREE Registered Agent`,
  buttons: [
    {
      text: `Start my corporation`,
      url: `${process.env.ORDER_URL}/form-order-now.php?entityType=CCorporation&entityState=ID`,
    },
  ],
};
...
export const fillingRequirements = {
  ...
  tableScheme: "blue3",
  header1: "Idaho Filing Time & Price",
  ...
  header2: "Idaho Compliance Requirements",
  ...
  table2: {
    ...
    rows: [
      [
        ...
        {
          label: "Domestic (Idahon) Entities are required to file within 6 months of creation. Failure to file will cause non-compliance and may lead to administrative dissolution.",
          type: "label",
          textCenter: true,
          className: "text-left",
        },
...
export const questions = {
  header: `Commonly Asked Questions For Starting a Idaho Corporation`,
  items: [
    {
...
export const articlesOfIncorporation = {
  box1: {
    header: `With the following requirements:`,
    list: [`The incorporator signs and files the articles of incorporation with the Secretary of State.`, `The name and address of each incorporator.`, `The articles must specify the number of shares of each class that the corporation is authorized to issue.`],
  },
  box2: {
...
export const corporationName = {
  ...
  text: `A proposed corporate name may be registered for an annual fee of $25. It is important to note that Idaho state law does not allow businesses to register fictitious or assumed (“doing business as”) names.`,
};
