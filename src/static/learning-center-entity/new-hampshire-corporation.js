export const top = {
  header: `Form a Corporation in New Hampshire.`,
  text: `$0 + State Fee & 1st Year FREE Registered Agent`,
  buttons: [
    {
      text: `Start my corporation`,
      url: `${process.env.ORDER_URL}/form-order-now.php?entityType=CCorporation&entityState=NH`,
    },
  ],
};
...
export const fillingRequirements = {
  ...
  tableScheme: "blue3",
  header1: "New Hampshire Filing Time & Price",
  ...
  header2: "New Hampshire Compliance Requirements",
...
export const questions = {
  header: `Commonly Asked Questions For Starting a New Hampshire Corporation`,
  items: [
    {
...
export const corporationName = {
  ...
  text: `A proposed corporate name may be registered for an annual fee of $25. It is important to note that New Hampshire state law does not allow businesses to register fictitious or assumed (“doing business as”) names.`,
};
