...
export const choose = {
  ...
  text:
    "Before we get into the quiz itself, here’s a quick guide to business structures, and how your circumstances might influence you to choose one over another.",
  types: [
    {
