...
export const top = {
  header: `Form a Corporation in Connecticut.`,
...
export const questions = {
  header: `Commonly Asked Questions For Starting a Connecticut Corporation`,
  items: [
    {
...
export const corporationName = {
  ...
  text: `A proposed corporate name may be registered for an annual fee of $25. It is important to note that Connecticut state law does not allow businesses to register fictitious or assumed (“doing business as”) names.`,
};
