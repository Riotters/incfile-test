  ...
  buttons: [
    {
      ...
      url: `${process.env.ORDER_URL}/form-order-now.php?entityType=CCorporation&entityState=CT`,
    },
  ],
};
...
export const articlesOfIncorporation = {
  box1: {
    header: `Which must include the following::`,
    list: [`At least one incorporator must sign and file the articles of incorporation.`, `There must be at least one incorporator, either a natural person of legal age or a legal entity.`, `The number of shares that the corporation is authorized to issue`],
  },
  box2: {
    header: `Including:`,
    list: [`A corporate purpose`, `Names and addresses of initial directors`, `Regulations regarding the powers or authority of the corporation, board of directors, or shareholders`, `Shareholder liability for corporate debts under certain circumstances`],
  },
};
