...
export const fillingRequirements = {
  ...
  tableScheme: "blue3",
  header1: "Indiana Filing Time & Price",
  ...
  header2: "Indiana Compliance Requirements",
  ...
  table2: {
    ...
    rows: [
      [
        ...
        {
          label: "Domestic (Indianan) Entities are required to file within 6 months of creation. Failure to file will cause non-compliance and may lead to administrative dissolution.",
          type: "label",
          textCenter: true,
          className: "text-left",
        },
...
export const questions = {
  header: `Commonly Asked Questions For Starting a Indiana Corporation`,
  items: [
    {
...
export const articlesOfIncorporation = {
  box1: {
    ...
    list: [`The corporation’s name`, `The name and address of each incorporator`, `The street address of the corporation’s initial registered office`, `The name of the new corporation’s registered agent at that office`, `The number of shares the corporation is authorized to issue`],
  },
  box2: {
    header: `Such as:`,
    list: [
...
export const corporationName = {
  ...
  text: `A proposed corporate name may be registered for an annual fee of $25. It is important to note that Indiana state law does not allow businesses to register fictitious or assumed (“doing business as”) names.`,
};
