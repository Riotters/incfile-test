...
export const top = {
  header: `Form a Corporation in Massachusetts.`,
  text: `$0 + State Fee & 1st Year FREE Registered Agent`,
  buttons: [
    {
      text: `Start my corporation`,
      url: `${process.env.ORDER_URL}/form-order-now.php?entityType=CCorporation&entityState=MA`,
    },
  ],
};
...
export const fillingRequirements = {
  ...
  tableScheme: "blue3",
  header1: "Massachusetts Filing Time & Price",
  ...
  header2: "Massachusetts Compliance Requirements",
  ...
  table2: {
    ...
    rows: [
      [
        ...
        {
          label: "Domestic (Massachusettsn) Entities are required to file within 6 months of creation. Failure to file will cause non-compliance and may lead to administrative dissolution.",
          type: "label",
          textCenter: true,
          className: "text-left",
        },
...
export const questions = {
  header: `Commonly Asked Questions For Starting a Massachusetts Corporation`,
  items: [
    {
...
export const articlesOfIncorporation = {
  ...
  box2: {
    header: `Massachusetts law also permits additional provisions to be included in the corporation’s articles of organization, such as:`,
    list: [
...
export const corporationName = {
  ...
  text: `A proposed corporate name may be registered for an annual fee of $25. It is important to note that Massachusetts state law does not allow businesses to register fictitious or assumed (“doing business as”) names.`,
};
