...
export const top = {
  header: `Form a Corporation in Oklahoma.`,
  text: `$0 + State Fee & 1st Year FREE Registered Agent`,
  buttons: [
    {
      text: `Start my corporation`,
      url: `${process.env.ORDER_URL}/form-order-now.php?entityType=CCorporation&entityState=OK`,
    },
  ],
};
...
export const fillingRequirements = {
  ...
  tableScheme: "blue3",
  header1: "Oklahoma Filing Time & Price",
  ...
  header2: "Oklahoma Compliance Requirements",
...
export const questions = {
  header: `Commonly Asked Questions For Starting a Oklahoma Corporation`,
  items: [
    {
...
export const corporationName = {
  ...
  text: `A proposed corporate name may be registered for an annual fee of $25. It is important to note that Oklahoma state law does not allow businesses to register fictitious or assumed (“doing business as”) names.`,
};
