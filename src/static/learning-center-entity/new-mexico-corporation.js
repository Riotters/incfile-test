...
export const top = {
  header: `Form a Corporation in New Mexico.`,
  text: `$0 + State Fee & 1st Year FREE Registered Agent`,
  buttons: [
    {
      text: `Start my corporation`,
      url: `${process.env.ORDER_URL}/form-order-now.php?entityType=CCorporation&entityState=NM`,
    },
  ],
};
...
export const fillingRequirements = {
  ...
  tableScheme: "blue3",
  header1: "New Mexico Filing Time & Price",
  ...
  header2: "New Mexico Compliance Requirements",
  ...
  table2: {
    ...
    rows: [
      [
        ...
        {
          label: "Domestic (New Mexicon) Entities are required to file within 6 months of creation. Failure to file will cause non-compliance and may lead to administrative dissolution.",
          type: "label",
          textCenter: true,
          className: "text-left",
        },
...
export const questions = {
  header: `Commonly Asked Questions For Starting a New Mexico Corporation`,
  items: [
    {
...
export const articlesOfIncorporation = {
  ...
  box2: {
    ...
    list: [`The minimum consideration for any authorized shares or class of shares`, `The powers and constraints of the corporation, its board of directors, and shareholders`, `Provisions regarding the liability of directors in certain situations`],
  },
};

export const corporationName = {
  header: `An available corporate name may be reserved for up to 120 days for $25.`,
  text: `A proposed corporate name may be registered for an annual fee of $25. It is important to note that New Mexico state law does not allow businesses to register fictitious or assumed (“doing business as”) names.`,
};
