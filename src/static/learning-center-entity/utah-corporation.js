...
export const fillingRequirements = {
  ...
  tableScheme: "blue3",
  header1: "Utah Filing Time & Price",
  ...
  header2: "Utah Compliance Requirements",
  ...
  table2: {
    ...
    rows: [
      [
        ...
        {
          label: "Domestic (Utahn) Entities are required to file within 6 months of creation. Failure to file will cause non-compliance and may lead to administrative dissolution.",
          type: "label",
          textCenter: true,
          className: "text-left",
        },
...
export const articlesOfIncorporation = {
  box1: {
    ...
    list: [
      ...
      `Its business purpose, which can be the general statement: “the transaction of any lawful business allowed by the Utah Corporation Code”`,
...
export const corporationName = {
  ...
  text: `A proposed corporate name may be registered for an annual fee of $25. It is important to note that Utah state law does not allow businesses to register fictitious or assumed (“doing business as”) names.`,
};
