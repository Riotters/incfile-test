export const top = {
  header: `Form a Corporation in North Dakota.`,
  text: `$0 + State Fee & 1st Year FREE Registered Agent`,
  buttons: [
    {
      text: `Start my corporation`,
      url: `${process.env.ORDER_URL}/form-order-now.php?entityType=CCorporation&entityState=ND`,
    },
  ],
};
...
export const fillingRequirements = {
  ...
  tableScheme: "blue3",
  header1: "North Dakota Filing Time & Price",
  ...
  header2: "North Dakota Compliance Requirements",
  ...
  table2: {
    ...
    rows: [
      [
        ...
        {
          label: "Domestic (North Dakotan) Entities are required to file within 6 months of creation. Failure to file will cause non-compliance and may lead to administrative dissolution.",
          type: "label",
          textCenter: true,
          className: "text-left",
        },
...
export const questions = {
  header: `Commonly Asked Questions For Starting a North Dakota Corporation`,
  items: [
    {
...
export const articlesOfIncorporation = {
  box1: {
    header: `The articles must include the following information:`,
    list: [
  ...
  box2: {
    header: `It’s also permissible to include other, optional provisions into the articles of incorporation for those who want to formalize additional criteria, such as:`,
    list: [
...
export const corporationName = {
  ...
  text: `A proposed corporate name may be registered for an annual fee of $25. It is important to note that North Dakota state law does not allow businesses to register fictitious or assumed (“doing business as”) names.`,
};
