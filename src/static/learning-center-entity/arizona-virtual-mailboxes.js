export const top = {
  ...
  text:
    "If you want to do business in Arizona, it makes sense to have\n" +
...
export const advantages = {
  ...
  cards: [
    {
      text:
        "Receiving correspondence from the Arizona Secretary of State and the Arizona Department of Revenue",
    },
    {
      text:
        "Building credibility with suppliers who want \n" +
    ...
    {
      text:
        "Getting a presence in Arizona, even if you’re not there physically",
    },
    {
      text:
        "Reading the correspondence to your AZ address wherever you are in the world, via our mail scanning service and secure web portal",
    },
  ],
};
