...
export const top = {
  header: `Form a Corporation in Arizona.`,
...
export const fillingRequirements = {
  ...
  tableScheme: "blue3",
  header1: "Arizona Filing Time & Price",
...
export const questions = {
  header: `Commonly Asked Questions For Starting an Arizona Corporation`,
  items: [
    {
...
export const corporationName = {
  ...
  text: `A proposed corporate name may be registered for an annual fee of $25. It is important to note that Arizona state law does not allow businesses to register fictitious or assumed (“doing business as”) names.`,
};
