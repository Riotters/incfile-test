...
export const corporation = [
  ...
  {
    type: "text",
    content: `<b>General Comparison Between Business Entity Types in Wyoming</b>`,
    marginBottom: 24,
  },
  {
    type: "table",
  ...
  {
    type: "text",
    content: `<b>Stocks and Shares Comparison Between Business Entity Types in Wyoming</b>`,
    marginBottom: 24,
  },
  {
    type: "table",
  ...
  },
  {
    type: "text",
    content:
      "When a corporation is initially created, it is automatically assumed to be a C Corporation and only becomes an S Corporation (and will be taxed as such) if you file the <a href='https://www.irs.gov/forms-pubs/about-form-2553'>IRS Small Business Tax Election form 2553</a>. ",
    marginBottom: 24,
  },
  {
    type: "header",
  ...
  },
  {
    type: "text",
    content:
      "Now that you’ve decided a corporation is right for you, here’s how to form one. At Incfile, we make the corporation formation process easy, and with prices starting at just $0 plus the Wyoming filing fee, you get excellent value too.",
    marginBottom: 24,
  },
  {
    type: "arrow-link",
  ...
  },
  {
    ...
    content: {
      items: [
        {
          question: "Step One — Name Your Wyoming Corporation",
          list: [
            ...
            "See if the name is available by searching for it on the <a href='https://wyobiz.wy.gov/business/filingsearch.aspx'>Wyoming Secretary of State website</a>",
            ...
            "If you’re not forming the business right away, <a href='https://soswy.state.wy.us/Forms/Business/General/PROF/P-NameReservation.pdf'>you can reserve the name.</a>",
          ],
        },
        {
          question:
            "Step Two — Establish Street and Mailing Addresses for Your Wyoming Corporation",
          answer:
            "A Wyoming corporation must have a designated address. That could be your home address (if you’re running the company from your residence), where your office is located or any physical address of your preference — even outside of Wyoming. It can be a P.O. Box.",
        },
        {
          question:
            "Step Three — Appoint a Registered Agent for Your Wyoming Corporation",
          answer:
            "Every Wyoming corporation must have a “ <a href='/manage-your-company/registered-agent/'>Registered Agent</a> ” who receives official legal and tax correspondence and has responsibility for filing reports with the Wyoming Secretary of State. Your Registered Agent must have a physical street address in Wyoming. <br/><br>" +
          ...
          text:
            "At Incfile, all of our packages include a <a href='/manage-your-company/registered-agent/'>Registered Agent</a> service that is free for the first year and $99 per year thereafter. We also have a dashboard where you can log in and easily view any document your Registered Agent has received on your behalf. ",
        },
        {
        ...
        {
          question:
            "Step Six — Complete the Legal and Compliance Requirements for Your Wyoming Corporation",
          answer:
  ...
  },
  {
    ...
    content: {
      ...
      url: "http://soswy.state.wy.us/default.aspx",
    },
    marginBottom: 24,
  },
  {
    ...
    content: {
      ...
      url: "https://wyobiz.wy.gov/Business/Default.aspx",
    },
    marginBottom: 24,
  },
  {
...
export const naming = [
  ...
  },
  {
    ...
    content: {
      list: [
        "You can <a href='https://soswy.state.wy.us/Forms/Business/General/PROF/P-NameReservation.pdf'>reserve a name</a>. Please note that you do not need to reserve a name if you are forming a corporation right away.",
  ...
  },
  {
    type: "text",
    content:
      "The easiest way to see if your proposed business name infringes is to carry out a trademark search. You can do that via the United States Patent and Trademark Office, or Incfile can help you protect your business with our new <a href='/trademark-name-search/'>Trademark Search and Registration service</a>. You should also bear in mind that your Wyoming business entity name cannot be substantially similar to an existing trademark or service mark.",
    marginBottom: 48,
  },
  {
    type: "header",
...
export const agents = [
  ...
  },
  {
    type: "text",
    content:
      "Your Wyoming corporation needs to have a <a href='/manage-your-company/registered-agent/'>Registered Agent</a>. They’re chosen by you and can accept legal notices and other correspondence for your Wyoming corporation on your behalf. There are some rules on choosing Registered Agents:",
    marginBottom: 41,
  },
  {
    type: "list-dot",
  ...
  },
  {
    ...
    content: {
      list: [
        ...
        "Wyoming corporations need to remain in good standing with the Secretary of State. If correspondence is undeliverable, certain states may revoke your right to do business.",
        "A Registered Agent “proves” to the state that your business exists. Without it, you could lose your business entity protections and your Wyoming corporation may be dissolved.",
      ],
    },
    color: color.purple3,
    marginBottom: 48,
...
export const filing = [
  ...
  },
  {
    type: "text",
    content:
      "Depending on the type of Wyoming business you are running, you may need to get licenses and permits from the federal government and various national agencies. You can find a complete list on the U.S. Small Business Administration website.",
    marginBottom: 48,
  },
  {
    type: "header",
  ...
  },
  {
    type: "text",
    content:
      "Because permits vary widely depending on the type of Wyoming corporation you are operating and where you are located, we provide a comprehensive <a href='/business-license-research-package/'>Business License Research Package</a>. It’s designed to tell you all of the licenses and permits necessary for your new corporation. It includes:",
    marginBottom: 40,
  },
  {
    type: "list-dot",
  ...
  },
  {
    type: "text",
    content:
      "You may need to hire additional employees for your Wyoming corporation. You will need an <a href='/manage-your-company/tax-id-ein/'>Employer Identification Number (EIN)</a>. You may also need to get <a href='http://wyomingworkforce.org/businesses/workerscomp/'>Worker’s Compensation Insurance</a> and General Liability Insurance.",
    marginBottom: 41,
  },
  {
    type: "header",
    content: "Hold an Annual General Meeting for Your Wyoming Corporation",
    size: 3,
    template: 3,
    marginBottom: 24,
  },
  {
    type: "text",
    content:
      "ou must hold a yearly meeting that all directors, officers and shareholders of the corporation are invited to. The purpose of an AGM is generally to:",
    marginBottom: 41,
  },
  {
    type: "list-dot",
  ...
  },
  {
    type: "text",
    content:
      "You can find details on the <a href='http://revenue.wyo.gov/'> Wyoming Department of Revenue</a> website.",
    marginBottom: 24,
  },
  {
    type: "header",
  ...
  },
  {
    type: "text",
    content:
      "You must file an annual report with the Wyoming Secretary of State on an annual basis. If you do not file your annual report each year, you will be charged a late fee and your corporation may be dissolved. Here at Incfile, we can <a href='/manage-your-company/annual-report/'>file your annual report on your behalf.</a>",
    marginBottom: 24,
  },
  {
    type: "text",
  ...
  },
  {
    type: "text",
    content:
      "You may need a <a href='/manage-your-company/certificate-of-good-standing/'>Certificate of Good Standing</a> for your Wyoming corporation to carry out some business-related services like opening a bank account.",
    marginBottom: 24,
  },
  {
    type: "header",
...
export const taxes = [
  ...
  },
  {
    ...
    content: {
      list: [
        "Turnaround times for forming a corporation in Wyoming: You will normally have the option of a “Standard” turnaround time and an “Expedited” turnaround time for forming your corporation. <a href='/state-filing-times/'>You can learn about those times here.</a>",
        "Fees for forming a corporation in Wyoming: Learn about <a href='/state-filing-fees/'>standard filing costs here.</a>",
    ...
    content: {
      items: [
        ...
        },
        {
          ...
          answer: "Wyoming does not charge state income tax on earnings.",
        },
        {
          question: "Wyoming State Sales/Use Tax",
          answer:
            "If you’re selling products or services in Wyoming you may need to pay a state sales tax. You can <a href='http://revenue.wyo.gov/Excise-Tax-Division'>register and pay state sales tax here.</a>",
        },
        {
          question: "Wyoming Other Taxes",
          answer:
            "You may need to pay other taxes and fees, depending on the type of business you run. <a href='http://revenue.wyo.gov/home'>Learn about other Wyoming taxes.</a>",
        },
        {
          question: "Employee Insurance and Taxes",
          answer:
            "If you employ others, you will need to pay insurance and taxes to the state for each employee. Here’s <a href='http://www.wyomingworkforce.org/'>how to register for the various employee taxes, insurance and other costs.</a>",
        },
      ],
    },
    marginBottom: 52,
    ...
    content: [
      {
        ...
        text: `Because your Wyoming corporation income flows through to your personal tax return, you must pay self-employment tax (also known as FICA, Social Security or Medicare tax) on your earnings. This is typically at a rate of 15.3 percent. You will be able to deduct your business expenses from your income when working out how much self-employment tax you owe.<br /><br /> In some cases, part of the income from an S Corporation can be paid as a “distribution” rather than “salary,” so it would not be subject to self-employment tax. <a href='/s-corporation-tax-calculator/'>Find out how this can save you money.</a>`,
  ...
  },
  {
    type: "text",
    content:
      "Incfile provides a cost-effective service to help you create your Wyoming corporation. We guide you through the process and handle most of the administrative steps, such as filing the Articles of Incorporation/Certificate of Formation on your behalf. Our basic package also provides a free Registered Agent service for the first year.",
    marginBottom: 24,
  },
  {
    type: "buttons",
...
export const afterFormation = [
  ...
  },
  {
    type: "text",
    content:
      "Each state requires different forms such as your business <a href=" /
        manage -
      your -
      company / annual -
      report /
        ">annual reports</a>and state franchise tax reports to be filed at different times. It’s important to understand when each form needs to be filed and when you need to refile the form. Complying with the <a href=" /
        compliance -
      filing -
      requirement /
        ">form filing requirements</a> keeps your business in <a href=" /
        manage -
      your -
      company / certificate -
      of -
      good -
      standing /
        ">good standing</a> with the state. Failure to file these reports can lead to the company being revoked or administrative <a href=" /
        manage -
      your -
      company /
        dissolution /
  ...
  {
    type: "text",
    content: `<b>Wyoming's Ongoing Corporate File Requirements:</b>`,
    marginBottom: 24,
  },
  {
