...
export const fillingRequirements = {
  ...
  tableScheme: "blue3",
  header1: "Oregon Filing Time & Price",
  ...
  header2: "Oregon Compliance Requirements",
...
export const corporationName = {
  ...
  text: `A proposed corporate name may be registered for an annual fee of $25. It is important to note that Oregon state law does not allow businesses to register fictitious or assumed (“doing business as”) names.`,
};
