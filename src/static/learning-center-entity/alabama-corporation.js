...
export const top = {
  header: `Form a Corporation in Alabama.`,
...
export const fillingRequirements = {
  ...
  tableScheme: "blue3",
  header1: "Alabama Filing Time & Price",
  ...
  header2: "Alabama Compliance Requirements",
...
export const questions = {
  header: `Commonly Asked Questions For Starting a Alabama Corporation`,
  items: [
    {
...
export const corporationName = {
  ...
  text: `A proposed corporate name may be registered for an annual fee of $25. It is important to note that Alabama state law does not allow businesses to register fictitious or assumed (“doing business as”) names.`,
};
