export const top = {
    header: `So You Want to Start a Business?`,
    text: `We’ve Got You Covered—Everything You Need to Know to Launch Your New Venture`,
    buttons: [{
...
export const about = {
    ...
    text: `Starting a new business is one of the most powerful and exciting things you can do. You’ve got a great idea, unique products and valuable services that you want to share with the world. There’s just one small problem — where do you begin? There seems to be an almost endless list of tasks to get your business off the ground and money in the bank.`,
    box: {
        header: `Relax, we’ve got you covered.`,
        text: `We’re experts at incorporating LLCs and corporations, and we’ve learned a thing or two about starting and running businesses. That’s why we put together this complete and easy-to-understand business checklist — to make it faster and simpler for you to get stuff done.`,
    },
...
export const tableOfContent = {
    header: `What You’ll Find in the Guide`,
...
export const needMore = {
    ...
    text: `If that’s not enough, the guide also links to plenty of other in-depth resources to give you the expertise and confidence you need to start your business today. The time to start is now, download our guide to starting your business and start turning your vision into reality.`,
    link: {
        text: `Download the complete guide to starting a business now`,
        url: "/",
        onClick: `popup`,
    },
};
