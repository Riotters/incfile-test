...
export const top = {
  header: `Form a Corporation in Arkansas.`,
...
export const fillingRequirements = {
  ...
  tableScheme: "blue3",
  header1: "Arkansas Filing Time & Price",
  ...
  header2: "Arkansas Compliance Requirements",
  ...
  table2: {
    ...
    rows: [
      [
        ...
        {
          label: "Domestic (Arkansasn) Entities are required to file within 6 months of creation. Failure to file will cause non-compliance and may lead to administrative dissolution.",
          type: "label",
          textCenter: true,
          className: "text-left",
        },
...
export const questions = {
  header: `Commonly Asked Questions For Starting a Arkansas Corporation`,
  items: [
    {
...
export const articlesOfIncorporation = {
  box1: {
    header: `The articles must be delivered to the secretary of state by an incorporator:`,
    list: [
      `Corporation name`,
  ...
  box2: {
    header: `Other information that is not required to be listed in the articles-but which the corporation may decide to include:`,
    list: [
...
export const corporationName = {
  ...
  text: `A proposed corporate name may be registered for an annual fee of $25. It is important to note that Arkansas state law does not allow businesses to register fictitious or assumed (“doing business as”) names.`,
};
