...
export const mailboxes = {
	...
	box: {
		text:
			"<span>Welcome to Incfile’s Virtual Address service.</span> It gives you access to a genuine street address for your business, so you can enjoy the benefits of mail scanning and a virtual mailbox wherever you are.",
	},
};
...
export const advantages = {
	...
	cards: [
		...
		{
			header: "Professional image for your business",
			text:
				"A business address is more prestigious than a residential address and could enhance your reputation and marketing",
		},
		{
			header: "A low, fixed price regardless of mail volume",
			text: "Virtual Address is priced at just $29 per month",
		},
	],
