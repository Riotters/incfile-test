...
export const top = {
  header: `Form a Corporation in Ohio.`,
  text: `$0 + State Fee & 1st Year FREE Registered Agent`,
  buttons: [
    {
      text: `Start my corporation`,
      url: `${process.env.ORDER_URL}/form-order-now.php?entityType=CCorporation&entityState=OH`,
    },
  ],
};
...
export const fillingRequirements = {
  ...
  tableScheme: "blue3",
  header1: "Ohio Filing Time & Price",
  ...
  header2: "Ohio Compliance Requirements",
...
export const questions = {
  header: `Commonly Asked Questions For Starting a Ohio Corporation`,
  items: [
    {
...
export const corporationName = {
  ...
  text: `A proposed corporate name may be registered for an annual fee of $25. It is important to note that Ohio state law does not allow businesses to register fictitious or assumed (“doing business as”) names.`,
};
