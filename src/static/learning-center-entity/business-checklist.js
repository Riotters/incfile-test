    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: `<p>If you don’t already have money to start your business, you may need to borrow funds. There are several ways to raise cash, including:</p><br>
          <ul>
        ...
        },
        {
          ...
          description: `<p>Every business has to spend money to operate. These payments for the necessary goods and services to run your business are “expenses.” Expenses are typically deducted from your business revenue when working out your profit, and you won’t typically need to pay taxes on your expenses.</p><br>
            <p>Expenses can be complex, so it’s worth speaking with your accountant about details, but here are some of the more common ones you can claim:</p><br>
            <ul>
        ...
        },
        {
          ...
          description: `<p>There are plenty of taxes you will need to pay as a business owner. If you’re set up as an LLC, your business profits will flow through to your personal tax return, which is where you will pay taxes.</p><br>
              <p>The types of tax you will need to pay include:</p><br>
              <ul>
        ...
        },
        {
          ...
          name: "Understand Sales Tax",
            description: `<p>If your business sells physical products or certain types of services, you may need to collect sales tax and pay it to your state’s department of revenue. Sales tax is typically collected at the point of purchase when you sell the product or service to your customer. Sales tax rates do vary slightly depending on the region, county or city your business is located in.</p><br>
              <p>The types of offerings you need to collect sales tax on typically include:</p><br>
              <ul>
