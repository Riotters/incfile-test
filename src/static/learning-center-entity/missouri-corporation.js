...
export const top = {
  header: `Form a Corporation in Missouri.`,
  text: `$0 + State Fee & 1st Year FREE Registered Agent`,
  buttons: [
    {
      text: `Start my corporation`,
      url: `${process.env.ORDER_URL}/form-order-now.php?entityType=CCorporation&entityState=MO`,
    },
  ],
};
...
export const fillingRequirements = {
  ...
  tableScheme: "blue3",
  header1: "Missouri Filing Time & Price",
  ...
  header2: "Missouri Compliance Requirements",
  ...
  table2: {
    ...
    rows: [
      [
        ...
        {
          label: "Domestic (Missourin) Entities are required to file within 6 months of creation. Failure to file will cause non-compliance and may lead to administrative dissolution.",
          type: "label",
          textCenter: true,
          className: "text-left",
        },
...
export const questions = {
  header: `Commonly Asked Questions For Starting a Missouri Corporation`,
  items: [
    {
...
export const articlesOfIncorporation = {
  box1: {
    ...
    list: [
      ...
      `Its business purpose, which can be the general statement: “the transaction of any lawful business allowed by the Missouri Corporation Code”`,
...
export const corporationName = {
  ...
  text: `A proposed corporate name may be registered for an annual fee of $25. It is important to note that Missouri state law does not allow businesses to register fictitious or assumed (“doing business as”) names.`,
};
