...
export const top = {
  header: `Form a Corporation in Virginia.`,
...
export const fillingRequirements = {
  ...
  tableScheme: "blue3",
  header1: "Virginia Filing Time & Price",
  ...
  header2: "Virginia Compliance Requirements",
  ...
  table2: {
    ...
    rows: [
      [
        ...
        {
          label: "Domestic (Virginian) Entities are required to file within 6 months of creation. Failure to file will cause non-compliance and may lead to administrative dissolution.",
          type: "label",
          textCenter: true,
          className: "text-left",
        },
...
export const questions = {
  header: `Commonly Asked Questions For Starting a Virginia Corporation`,
  items: [
    {
...
export const corporationName = {
  ...
  text: `A proposed corporate name may be registered for an annual fee of $25. It is important to note that Virginia state law does not allow businesses to register fictitious or assumed (“doing business as”) names.`,
};
