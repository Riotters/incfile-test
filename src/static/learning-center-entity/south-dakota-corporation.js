  ...
  buttons: [
    {
      ...
      url: `${process.env.ORDER_URL}/form-order-now.php?entityType=CCorporation&entityState=SD`,
    },
  ],
};
...
export const articlesOfIncorporation = {
  ...
  box2: {
    header: `South Dakota law also allows (but does not require) optional items to be included in the articles of incorporation for those corporations who wish to formally specify additional information, such as:`,
    list: [
  ...
  box3: {
    header: `South Dakota also permits optional provisions to be included into the articles of incorporation, such as:`,
    list: [`The names and addresses of the initial directors`, `The corporate purpose(s)`, `Limitations on a director’s or officer’s liability for money damages to the corporation or its shareholders in certain situations`],
  },
};
