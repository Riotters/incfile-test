...
export const about = {
  header: `Your business needs a great name.`,
  text: `One that is unique and memorable while telling customers what you do and strengthening your brand. The question is: How do you find the perfect name while making sure it’s different from any other business name in your formation state?`,
  text2: `The answer is simple:`,
  header2: `With Incfile’s business name search and lookup tool.`,
  text3: `We’ve made it fast and easy to look up LLC and corporation names in some of the most popular U.S. states for LLC formation, so you can easily see if your proposed business name is available. And the best part is you can do it all from one place.`,
};
