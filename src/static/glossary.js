export const top = {
	header: "The Incfile Business Glossary",
	text: "",
};
...
export const glossary = {
	items: [
		...
		{
			question:
				"Application for Certificate of Authority / Foreign Qualification",
			answer:
		...
		},
		{
			...
			answer:
				"A binder usually containing essential items for the routine maintenance and administration of a corporation or limited liability company. Corporate kits provided by The Company Corporation include sample minutes and bylaws, stock certificates, a corporate seal and stock ledger.",
		},
		{
