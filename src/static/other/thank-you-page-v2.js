  ...
  cards: [
    {
      ...
      title: "Branching",
      text:
        "If so, you need a Doing Business As (DBA) name. This is a marketing name that can be used on business cards and more.",
      link: {
        text: "Learn more",
        url: "/",
      },
    },
    {
      ...
      title: "Handshake",
      text:
        "Our partnership with Bank of America gives you access to a dedicated specialist to setup your business bank account by phone.",
      link: {
        text: "Learn more",
        url: "/",
      },
...
export const dashboard = {
  ...
  text:
    "Twój pulpit stanie się centralnym repozytorium dokumentów i narzędziem do zarządzania, które pozwoli Ci aktywnie zarządzać swoją jednostką. Poniżej znajdują się pomocne linki do orientacji w funkcjach pulpitu.",
  items: [
    {
    ...
    },
    {
      ...
      text:
        "Review and obtain pertinent company information. (Please remember to always keep a valid email address on file as this will be the primary method \n" +
        "of contact)",
    ...
    },
    {
      ...
      text:
        "Obtain the name and address of your designated Registered Agent and review important documents. (Documents received by the your agent will be uploaded to the Registered Agent tab and \n" +
    ...
    },
    {
      ...
      text:
        "Always be in the know of the ongoing requirements such as annual reports or other obligatory filing requirements associated with your entity. \n" +
    ...
    items: [
      {
        ...
        answer:
          "We typically file your order next business day therefore we urge our clients to carefully review the information submitted on the order review tab of the client dashboard and update information if changes are required. Upon forwarding the documents to the state it is impossible for us to make changes to an existing order.",
      },
      {
      ...
      {
        question:
          "What is the best method of contact if I need to reach a representative?",
        answer: "",
      },
      {
        question:
          "If an issue with my filing should occur how will it be handled?",
        answer: "",
      },
    ],
  },
