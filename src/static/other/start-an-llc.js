    ...
    items: [
      {
        ...
        answer: `For federal income tax purposes the profits of an LLC (Limited Liability Company) "pass through" to the personal income of the members/owners. In the case of a single member LLC it is taxed the same as a sole proprietorship (i.e. typically filed on the schedule C of the owner's personal income tax filing). In the case of a multi member member it is taxed the same as a partnership (i.e. a 1065 partnership return is filed with the IRS, with a schedule K-1 being supplied to each partner/member showing the proportional profit/loss allocated to them, with this being filed on the schedule C or E). NOTE: These are general tax explanations and may not apply to everyone. You should confer with the appropriate accounting/tax specialists to make sure you understand your personal tax liability.`,
      },
      {
        question: `What is the Management Structure of an LLC?`,
