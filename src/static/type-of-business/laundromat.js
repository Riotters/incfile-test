...
export const RingText = {
  title: "The major segments of the population using laundromats are:",
  list: [
    {
      color: color.blue1,
      boldText: "39%",
      text: "Renters using offsite laundry facilities",
    },
    {
      color: color.green1,
      boldText: "22%",
      text: "Renters using onsite laundry facilities",
    },
    {
      color: color.red1,
      boldText: "17%",
      text: "Commercial, industrial & service industries",
    },
    {
      color: color.purple1,
      boldText: "13%",
...
export const RingText2 = {
  title: "Products and services creating revenue for laundromats include:",
  list: [
    {
      color: color.blue1,
      boldText: "58%",
      text: "Washer receipts",
    },
    {
      color: color.green1,
      boldText: "34%",
    ...
    },
    {
      color: color.red1,
      boldText: "4%",
      text: "Self-service dry cleaning receipts",
    },
    {
      color: color.purple1,
      boldText: "1.4%",
      text: "Commercial laundry services",
    },
    {
      color: color.yellow1,
      boldText: "1.4%",
  ...
  items: [
    {
      ...
      answer: [
        {
          text:
            "Contact the IRS and let them know you will need an EIN for your laundromat business. This is a number you will use to file and pay your taxes. We put together this",
        },
        {
...
export const TaxesAccordionContent = {
  items: [
    ...
    },
    {
      ...
      answer:
        "You will need to pay income tax on any profits or earnings you take from your laundromat business. In most cases, profits from the business will “flow through” to your individual tax return and you will be taxed there.",
    },
    {
      question: "Self-employment tax",
      answer:
        "Unlike employees, the earnings from your laundromat business will be taxed under a self-employment tax (FICA and Medicaid). This is just over 15 percent of your earnings.",
    },
    {
      question: "State tax",
      answer:
  ...
  items: [
    {
      ...
      answer: [
        ...
        {
          text: `for your laundromat company.`,
        },
      ],
    },
    {
    ...
    },
    {
      ...
      answer: [
        {
          text: `Bookkeeping and accounting software is essential for keeping track of your laundromat business finances. Good financial management is vital to your peace of mind and online accounting software will give you the insight you need. There are plenty of options to choose from, with some popular ones being:`,
        },
        {
          text: `QuickBooks,`,
