    ...
    items: [
        {
            ...
            text: "Many large employers provide daycare services to their employees, either onsite or remotely. Understanding the services that employers need and getting in touch with their HR departments could be a great way to get a foot in the door."
        },
        {
            circleText: 2,
            imageName: "speciaized-daycare-for-children-with-uniquel-needs",
            headline: "Specialized Daycare for Children With Unique Needs",
            text: "You might consider running a specialized daycare center for particular children. For example, you might offer daycare for children with special dietary needs like being gluten-intolerant or vegetarian. You could also offer daycare services for children with mild learning or physical disabilities, if you have the right training."
        },
        {
            circleText: 3,
            imageName: "franchise",
