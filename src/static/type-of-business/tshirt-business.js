...
export const BusinessInsuranceAccordionContent = {
    items: [
        ...
        },
        {
            ...
            answer: "If you are working from home, check whether your existing home policy covers you for work use of your home. If not, you should either expand your policy so you’re covered or get dedicated business insurance."
        }
    ]
}
...
export const TaxesAccordionContent = {
    items: [
        ...
        },
        {
            ...
            answer: "Unlike employees, the earnings from your T-shirt business will be taxed under a self-employment tax (FICA and Medicaid). This is just over 15 percent of your earnings."
        },
        {
            question: "State tax",
    ...
    items: [
        {
            ...
            answer: [
                {
                    text: "Most states require businesses to file a report once a year. This report has details of any major changes to who owns a business and other significant impacts on a business’s legal status."
                },
                {
        ...
        },
        {
            ...
            answer: "As shown above, you will need to file your taxes once a year."
        },
        {
...
export const FinancesAccordionContent = {
    items: [
        {
    ...
    items: [
        {
            ...
            answer: [
                {
                    text: "Contact the IRS and let them know you will need an EIN for your T-shirt business. This is a number you will use to file and pay your taxes. We put together this"
                },
                {
...
export const AccordionCounting = {
    items: [
        {
            count: 1,
            question: "Come up with the niche and idea",
            answer: "Do your research and understand the niche you want to go into. Validate this niche with your potential customers to check that there’s interest."
        },
        {
            count: 2,
            question: "Create T-shirt designs",
            answer: "You will need to create designs yourself, partner with a designer or source designs from elsewhere for all your T-shirts. You should come up with several original designs for when you launch your T-shirt ecommerce store."
        },
        {
            count: 3,
            question: "Setup a T-shirt ecommerce store",
            answer: "You will need to create an online store to sell your T-shirt products through. Shopify is a great place to start; it automatically has integrations with several print-on-demand services. Alternatively, you could try an online web builder like Wix or Squarespace, or Wordpress paired with WooCommerce."
        },
        {
            count: 4,
            question: "Find a print-on-demand provider",
            answer: "We recommend using a provider who can handle the printing and distribution of T-shirts on your behalf. There won’t be any upfront expenditure for you; you don’t need to hold stock and the provider will take care of everything. Shirts.io, Merchify, Zazzle, Cafepress, Print Aura, Printify and Printful are all good services."
        },
        {
            count: 5,
            question: "Link everything together",
            answer: "Build your website, upload your designs, link it to your print-on-demand provider and launch your business."
        },
        {
            count: 6,
            question: "Get your branding and marketing right",
            answer: "Once you have launched your store, you will need to market and brand it properly. Use whatever type of marketing works, take advantage of social media and engage with influencers."
        },
        {
            count: 7,
            question: "Run your business",
            answer: "You will need to continue marketing, handling customer service and coming up with new designs. Keep a close eye on your analytics so you can see what designs are selling."
        }
    ]
}

export const toolsList = {
    headlineText: "Useful Online Resources for T-Shirt Entrepreneurs",
    description: "Here are some really great online tools for managing your T-shirt business. They will reduce the time you spend on administration, help you collaborate with others and free up your time to grow and manage your new venture.",
    tools: [
        {
...
export const RingText = {
    title: "Statistics about T-shirt businesses",
    list: [
        {
            color: color.blue1,
            text: "The industry has grown by nearly 9% a year between 2011 and 2016"
        },
        {
            color: color.yellow1,
            text: "The top four online T-shirt businesses generated just over 35% of all revenue between them, with the remainder being split among the other, smaller businesses"
        }
    ]
}
