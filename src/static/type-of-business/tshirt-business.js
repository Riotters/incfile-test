...
export const RingText = {
  ...
  list: [
    ...
    },
    {
      color: color.yellow1,
      text:
        "The top four online T-shirt businesses generated just over 35% of all revenue between them, with the remainder being split among the other, smaller businesses",
    },
  ],
};
