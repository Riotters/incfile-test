export const adventages2 = {
    items: [
        ...
        },
        {
            ...
            text: "Your business will need to renew your licenses, permits and other regulations every year."
        },
        {
            circleText: 4,
...
export const toolsList = {
    headlineText: "Useful Online Tools for Female Entrepreneurs",
    description: "Here are some really great online tools for managing your woman-owned business. They will reduce the time you spend on administration, help you to collaborate with others and free up your time to grow and manage your new venture.",
    tools: [
        {
