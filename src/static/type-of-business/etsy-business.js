...
export const TaxesAccordionContent = {
    items: [
        ...
        },
        {
            ...
            answer: "Unlike employees, the earnings from your Etsy business will be taxed under a self-employment tax (FICA and Medicaid). This is just over 15 percent of your earnings."
        },
        {
            question: "State tax",
...
export const MaintainingAccordionContent = {
    items: [
        ...
        },
        {
            ...
            answer: "Your business will probably have several licenses, permits and other regulations. These typically need to be renewed every year."
        },
        {
