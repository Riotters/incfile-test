...
export const InfoCards = {
    title: `Insurance for Your Bookstore`,
    description: `Most bookstore businesses should have comprehensive business insurance. There are various types.`,
    items: [
        {
        ...
        },
        {
            ...
            title: "Home and Auto Insurance for Your Bookstore Business",
            content: "If you are working from home on the administration of your bookstore business or driving a vehicle for work, check whether your existing home and auto policies cover you for work use of your home or car. If not, you should either expand your policy so you’re covered or get dedicated business insurance."
        }
    ]
};
