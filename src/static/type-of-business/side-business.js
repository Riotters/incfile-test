...
export const toolsList = {
    headlineText: "Useful Online Tools for Your Side Business",
    description: "Here are some really great online tools for managing your side business. They will reduce the time you spend on administration, help you to collaborate with others and free up your time to grow and manage your new venture.",
    tools: [
        {
    ...
    items: [
        {
            ...
            headline: "Start Blogging and Writing",
            text: "If you can find a subject you’re knowledgeable about and can create exciting, engaging content, you might be able to make it as a blog writer. You can write when you have the time and monetize your blog through advertising, affiliate marketing or selling products you’ve created yourself."
        },
        {
            circleText: 2,
            imageName: "retail-construction-02",
            headline: "Provide Freelance Services Through a Marketplace",
            text: "Becoming a completely independent freelancer can be tough, as there’s a lot of competition. One great way to build up experience and see if its right for you is to provide creative services through a freelance marketplace. Services like Upwork, Fiverr and People Per Hour will allow you to list your services and attract potential clients."
        },
        {
            circleText: 3,
            imageName: "etsy-image",
            headline: "Sell Products Via a Marketplace",
            text: "If you’d rather sell products than services, a third-party marketplace like Amazon, eBay or Etsy could be ideal. You’ll need to find the right niche, understand profit margins and ship products, but this can be a great way to get started with ecommerce and online retail."
        },
        {
            circleText: 4,
            imageName: "offer-driving-services-through-lyft-or-uber-01",
            headline: "Offer Driving Services Through Lyft or Uber",
            text: "Uber and Lyft provide a good way to earn some side income, and their reach and influence is increasing. Although the money you’ll get won’t be a huge income, driving for one of these services is a useful way to learn about self-employment."
        },
        {
            circleText: 5,
            imageName: "real-estate",
            headline: "Rent Property",
            text: "Whether you rent a spare room via Airbnb or have apartments that you lease to renters, property management can be a lucrative side business. There can be a lot of work involved in managing a rental property, and it can be capital intensive, so it's not for everyone."
        },
        {
            circleText: 6,
            imageName: "use-an-incfile-network-atorney-02",
            headline: "Offer Tutoring and Coaching",
            text: "If you’ve got some skill at helping others, tutoring and coaching are in demand. You’ll need to demonstrate experience and expertise in your topic, but it’s a low-cost business to start."
        }
    ]
}
