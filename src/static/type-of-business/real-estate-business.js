...
export const toolsList = {
    headlineText: "Useful Online Tools for Your Real Estate Business",
    description: "Here are some really great online tools for managing your real estate business. They will reduce the time you spend on administration, help you to collaborate with others and free up your time to grow and manage your new venture.",
    tools: [
        {
...
export const RingText = {
    ...
    list: [
        {
            color: color.blue1,
            text: "The industry has been growing by 9% year on year over the last five years."
        },
        {
            color: color.yellow1,
            text: "The sale and rental of residential property accounts for around 72% of real estate business income in the US."
        }
    ]
}
