...
export const typeBusiness = {
    items: [
        ...
        },
        {
            ...
            text: "Many teenagers provide tutoring and lessons to their peers and younger kids. If you’ve got some skill at helping others, tutoring and coaching are in demand."
        },
        {
            circleText: 5,
...
export const adventages2 = {
    items: [
        ...
        },
        {
            ...
            text: "If you earn more than $400, you will be expected to pay estimated taxes on what you plan to earn in the current business year. Typically, you will need to pay estimated taxes in April, June, September and January (of the following year)."
        },
        {
            circleText: 3,
