...
export const toolsList = {
    headlineText: "Useful Online Tools for Your Consulting Business",
    description: "Here are some really great online tools for managing your consulting business. They will reduce the time you spend on administration, help you to collaborate with others and free up your time to grow and manage your new venture.",
    tools: [
        {
...
export const adventages2 = {
    items: [
        ...
        },
        {
            ...
            text: "Most states require you to have a registered agent on file for your business. This is a party available at a physical address (not a P.O. Box) who can sign for and receive legal notices and documents on your behalf.",
            url: "/manage-your-company/annual-report",
        ...
        },
        {
            ...
            text: "You will be expected to pay estimated taxes on what you plan to earn in the current business year. You will need to pay estimated taxes in April, June, September and January (of the following year)."
        },
        {
            circleText: 4,
