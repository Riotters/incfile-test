	...
	items: [
		{
			...
			answer: [
				{
					text:
						"Contact the IRS and let them know you will need an EIN for your T-shirt business. This is a number you will use to file and pay your taxes. We put together this",
				},
				{
...
export const TaxesAccordionContent = {
	items: [
		...
		},
		{
			...
			answer:
				"You will need to pay income tax on any profits or earnings you take from your bakery business. In most cases, profits from the business will “flow through” to your individual tax return and you will be taxed there.",
		},
		{
			question: "Self-employment tax",
			answer:
				"Unlike employees, the earnings from your T-shirt business will be taxed under a self-employment tax (FICA and Medicaid). This is just over 15 percent of your earnings.",
		},
		{
			question: "State tax",
			answer:
