  ...
  items: [
    {
      ...
      answer:
        "Most states require businesses to file a report once a year. This report has details of any major changes to who owns a business and other significant impacts on a business’s legal status. We can file your Annual Report on your behalf",
    },
    {
...
export const toolsList = {
  ...
  description:
    "Here are some really great online tools for managing your handyman business. They will reduce the time you spend on administration, help you to collaborate with others and free up your time to grow and manage your new venture.",
  tools: [
    {
...
export const adventages = {
  items: [
    ...
    },
    {
      ...
      headline: "Franchise Handyman Business",
      text:
  ...
  items: [
    {
      ...
      text:
        "Most states require all businesses to file a report once a year. This report has details of any changes to who owns a business and other major impacts on a business’ legal status. We can file your Annual Report on your behalf.",
...
export const InfoCards = {
  ...
  description: `Most handyman businesses should have comprehensive business insurance. There are various types.`,
  items: [
    {
