...
export const FinancesAccordionContent = {
    items: [
        ...
        },
        {
            ...
            answer: [
                {
                    text: `In some cases you may need to get financing to start your beauty salon business. Your best option is probably to go to your bank and ask for a loan. If you decide to do this, you must have a solid business plan, revenue and finance projections and a plan to pay back any money you borrow. The`
                },
                {
...
export const toolsList = {
    headlineText: "Useful Online Tools for Your Beauty Salon Business",
    description: "Here are some really great online tools for managing your beauty salon business. They will reduce the time you spend on administration, help you collaborate with others and free up your time to grow and manage your new venture.",
    tools: [
        {
...
export const RingText = {
    title: "Statistics about Beauty Salon businesses",
    list: [
        {
            color: color.blue1,
            text: "79% of people employed in the beauty salon industry are hairstylists, hairdressers or cosmetologist"
        },
        {
            color: color.yellow1,
            text: "Only 10% of workers in beauty salons are men"
        }
    ]
}
