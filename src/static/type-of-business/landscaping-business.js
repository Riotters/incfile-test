...
export const toolsList = {
  headlineText: "Useful Online Tools for Your Landscaping Business",
  description:
...
export const typeBusiness = {
  items: [
    {
      circleText: 1,
      imageName: "boutique-hotel-for-tourists",
      headline: "Boutique Hotel for Tourists",
      text:
    ...
    },
    {
      ...
      headline: "Easy Accommodations for Business Travelers",
      text:
    ...
    {
      circleText: 4,
      imageName: "college-or-university-town-rooms",
...
export const RingText = {
  title: "Most landscapers...",
  list: [
    {
      color: color.blue1,
      boldText: "65%",
      text: "work for single-family residential clients",
    },
    {
      color: color.yellow1,
      boldText: "42%",
      text: "Design/Building",
    },
  ],
};

export const RingText2 = {
  title: "More specialties include...",
  list: [
    {
      color: color.blue1,
      boldText: "23%",
    ...
    },
    {
      color: color.purple1,
      boldText: "6%",
      text: "Tree/snow care or Irrigation (each)",
    },
  ],
};
  ...
  items: [
    {
      ...
      answer: [
        {
          text:
            "Contact the IRS and let them know you will need an EIN for your landscaping business. This is a number you will use to file and pay your taxes. We put together this",
        },
        {
...
export const BusinessInsuranceAccordionContent = {
  items: [
    ...
    },
    {
      ...
      answer:
        "This insurance protects your business from claims due to being sued. This may include injury to members of the public, property damage, personal liabilities, legal defense and more. It can help protect your business from financial penalties and bankruptcy.",
    },
    {
      question: "Professional Liability/Indemnity Insurance",
      answer:
        "If you provide professional services, professional liability insurance can protect you from malpractice allegations and other issues as a result of providing work.",
    },
    {
      question: "Home and Auto Insurance",
      answer:
        "If you are working from home, check whether your existing home policy covers you for work use of your home. If not, you should either expand your policy so you’re covered or get dedicated business insurance.",
    },
  ],
};
...
export const TaxesAccordionContent = {
  items: [
    ...
    },
    {
      ...
      answer:
        "You will need to pay income tax on any profits or earnings you take from your landscaping business. In most cases, profits from the business will “flow through” to your individual tax return and you will be taxed there.",
    },
    {
      question: "Self-employment tax",
      answer:
        "Unlike employees, the earnings from your landscaping business will be taxed under a self-employment tax (FICA and Medicaid). This is just over 15 percent of your earnings.",
    },
    {
      question: "State tax",
      answer:
        "Most states have a state income tax. If yours does, you will be taxed on your earnings as normal. To register for state tax, see your Secretary of State website.",
    },
    {
  ...
  items: [
    {
      ...
      answer: [
        {
          text:
            "Most states require businesses to file a report once a year. This report has details of any major changes to who owns a business and other significant impacts on a business’s legal status.",
        },
        {
    ...
    },
    {
      ...
      answer:
        "You will need to make payroll and sales tax payments on a regular basis.",
    },
    {
      question: "Prepare Your Taxes",
      answer:
        "Your federal, state, regional and city licenses and permits may need to be renewed on a regular basis, typically once",
    },
  ],
};
  ...
  items: [
    {
      ...
      answer: [
        ...
        {
          text: `for your landscaping company.`,
        },
      ],
    },
    {
    ...
    },
    {
      ...
      answer: [
        {
          text: `Bookkeeping and accounting software is essential for keeping track of your landscaping business finances. Good financial management is vital to your peace of mind, and online accounting software will give you the insight you need. There are plenty of options to choose from, with some popular ones being:`,
        },
        {
          text: `QuickBooks,`,
        ...
        {
          text: `Some of these will integrate directly with your landscaping software.`,
        },
      ],
    },
  ],
