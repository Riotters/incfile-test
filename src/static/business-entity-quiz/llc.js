...
export const types = {
	...
	text2: `Check out our <a href="#">LLC information by state</a> for more details on your state.`,
	button: {
		text: `Form Your LLC Today For $0 + State Fee`,
		url: `#`,
	},
	...
	boxes: [
		{
			...
			text: `
            <ul class="list-unstyled advantages-items">
                <li>
                <span class="dot"></span>
                <div>
                <b>Limited Liability Protection</b> By forming an LLC, only the LLC is liable for the debts and liabilities incurred by the business — not the members. The members liability is limited to the personal interest they have invested in the company thus protecting the personal assets of the individual member that are separate from the LLC.
                </div>
                </li>
                <li>
                <span class="dot"></span>
                <div>
                <b>Pass Through Taxation</b> The LLC typically does not pay taxes for itself. Instead, the net income/loss is "passed through" to the personal income of the owner(s)
