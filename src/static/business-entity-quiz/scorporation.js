...
export const characteristics = {
  ...
  button: {
    text: "Form Your S Corp Today!",
    url: `${process.env.ORDER_URL}/form-order-now.php?entityType=SCorporation&utm_campaign=Lead%20Gen%20-%20Business%20Entity%20Quiz&utm_source=On_Page_Click&utm_medium=SCorp%20Results%20Page&utm_term=Order%20Form&__hstc=130298704.32fc0eba9220f4e025b2993633a3fc59.1608037619246.1608105146418.1608288037481.3&__hssc=130298704.1.1608288037481&__hsfp=3825543753`,
  },
};

export const differences = {
  header: `How Is an S Corp Different From a C Corp or an LLC?`,
  text: `Unlike traditional <a href="/what-is-c-corporation/" target="_blank">C Corporations, also called C Corps</a>, the S Corporation is not subject to corporate income taxes. Instead, the S Corporation receives different treatment for tax purposes that is generally more favorable to the business owner. The S Corp is a pass-through entity for tax purposes, similar to the <a href="/limited-liability-company/" target="_blank">LLC</a>. This means that the income generated by an S Corporation will flow through to the personal income tax returns of the shareholders, and the S Corp itself generally does not owe any tax liability.`,
  ...
  text3: `Another area of concern for business owners is reducing their liability for self-employment taxes, and an S Corporation can have an advantage over an LLC in this area as well. To visualize how much an S Corporation can save you in taxes, check out our <a href="/s-corporation-tax-calculator/" target="_blank">S Corporation Tax Calculator</a>.`,
  ...
  text5: `Although the S Corporation offers significant tax advantages and ownership flexibility, it is not the right choice for every business. There are a few restrictions as well.`,
  box: {
  ...
  text8: `The corporation must also submit <a href="/s-corp-election-form?action=new&type=24" target="_blank" rel="noopener noreferrer">Form 2553</a> to elect S Corporation status for tax purposes.`, // forms
};

export const prosAndCons = {
  header: `The Advantages & Disadvantages of an S Corporation`,
  boxes: [
    {
      disadventage: false,
      circleBackgroundColor: color.green1,
      ...
      text: `
            <ul>
                <li>
                    <span>Tax advantages</span> S Corporations are exempt from federal income tax except for certain capital gains and passive income. Similar to the LLC, the S Corporation allows profit to pass through to its shareholders, and the income is then taxed on the shareholders’ personal tax returns at each shareholder’s individual tax rates. Because the S Corporation is a pass-through entity, this ensures that the corporation’s profits are only taxed once – at the shareholder level. This means that S Corporations avoid having to pay what is often referred to as “double taxation” of dividends. See how much you can save with our <a href="/s-corporation-tax-calculator/" target="_blank">S Corporation Tax Calculator</a>.
                </li>
                <li>
                ...
                <li>
                    <span>Flexible characterization of income</span> Being an owner of an S Corporation gives you flexibility in how to characterize your income for tax purposes. As the owner/shareholder of an S Corp, you can be an employee of the business and pay yourself a salary. In addition to your salary, you can also pay yourself dividends from the S Corporation or distributions that are generally tax-free or taxed at a lower rate than the employee’s salary. This helps you reduce your self-employment tax liability, as long as you are characterizing your salary and dividends/distributions in a reasonable way. The IRS does not want to see you paying yourself an artificially low salary in order to avoid paying self-employment taxes on the “dividend/distribution” portion of your income.
                </li>
                <li>
  ...
  text: `Would you like to set up your business as an S Corporation, or set up your LLC to file as an S Corporation? If so, you can choose S Corporation status for tax purposes by filing <a href="/s-corp-election-form?action=new&type=24" target="_blank">IRS Form 2553</a> within 75 days of the filing date of the company or by filing IRS Form 2553 by March 15 of the tax year the election is to take effeFt, or any time during the tax year prior to the tax year it is to take effect.`,
};
