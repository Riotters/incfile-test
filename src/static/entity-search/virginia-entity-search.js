...
export const about = {
	text: `<span>The Commonwealth of Virginia is one of the most friendly states to start a small business.</span> It features a strong statewide economy, a highly educated population and great transportation links with Washington, D.C., Maryland, West Virginia and North Carolina. It’s also well-placed internationally, with several good options for traveling outside the US.`,
