...
export const about = {
	text: `<span>When you have a unique name for your Florida corporation or LLC, we’ll help you legally form your business through our quick, easy and inexpensive FL entity formation process.</span> To search for Florida business entities, just enter your details in the box below, and we’ll take care of everything else.`,
	box: {
	...
	items: [
        ...
        you'll want to choose a name that will:`,
			list: [
				...
				`Not be used by another business in Florida`,
			],
		},
		{
