export const top = {
	header: `Complete New Jersey Business Name Search Service for Corporations and LLCs`,
	text: `Carry Out a New Jersey Entity Search Before Creating Your Business`,
	button: [
		{
...
export const about = {
	...
	text2: `Once you've found the right New Jersey business name, you can quickly register your NJ LLC or corporation through us for one low fee. To search for New Jersey business entities, just enter your details in the box below, and we'll take care of everything else.`,
};
...
export const specificRules = {
	header: `Other New Jersey Business Naming Rules`,
	list: [
...
export const faq = {
	header: `Common Questions About New Jersey Entity Searches`,
	items: [
		{
		...
		},
		{
			...
			list: [
				...
				`Help people remember your compaNJ`,
