  ...
  tabs: {
    ...
    content: [
      ...
      },
      {
        ...
        text3: [
          {
            text: `To learn more about annual reports (or to have Incfile file yours for you),`,
          },
          {
            text: ` click here,`,
            url: `/`,
          ...
          {
            text: `or view our LLC state guides to learn about specific requirements for your state.`,
          },
        ],
        link: {
