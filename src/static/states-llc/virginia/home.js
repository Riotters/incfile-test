...
export const howToGuide = [
      ...
      items: [
        ...
        },
        {
          ...
          answer: `<p>If your business is already operating in another state and expanding to Virginia, you’ll need to form a foreign LLC.</p></br>
              <a href="/Virginia-llc/fees-filing-requirements/" target="_blank">More information on Virginia filing and licensing requirements here.</a>`,
        },
      ],
    },
    marginBottom: 48,
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `Naming Your Virginia LLC`,
      url: `/virginia-llc/how-to-name-your-llc/`,
    },
    marginBottom: 16,
  },
  {
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `Virginia Registered Agents for LLCs`,
      url: `/virginia-llc/registered-agents-virginia-llc/`,
    },
    marginBottom: 16,
  },
  {
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `Fees and Requirements for Virginia LLCs`,
      url: `/virginia-llc/form-filling-permit-requirements/`,
    },
    marginBottom: 16,
  },
  {
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `Federal, State, Sales and Other Taxes for Your Virginia LLC`,
      url: `/virginia-llc/business-taxes/`,
    },
    marginBottom: 16,
  },
  {
...
export const namingYourBusiness = [
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `Virginia State Corporation Commission business name search tool`,
      url: `https://sccefile.scc.virginia.gov/NameAvailability`,
    },
    marginBottom: 48,
  },
  {
...
export const feesAndRequirments = [
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `Learn about your ongoing Virginia LLC filing requirements and business filing deadlines with our helpful Virginia ongoing filing lookup tool.`,
...
export const businessTaxes = [
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `Get details on the Virginia sales tax online here.`,
  ...
  },
  {
    ...
    content: {
      ...
      list: [`Federal income tax`, `Federal self-employment tax`, `Virginia state tax`],
    },
    marginBottom: 16,
    color: color.green3,
  },
