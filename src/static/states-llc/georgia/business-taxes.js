...
export const businessTaxesPageContent = {
  ...
  content: [
    ...
    {
      type: `paragraph`,
      content: `If you sell physical products or certain types of services, you may need to collect sales tax (also known as sales and use tax) and then pay it to the GA Department of Revenue (through the <a href="https://gtc.dor.ga.gov/" target="_blank" rel="noopener noreferrer">Georgia Tax Center</a>). Georgia sales tax is collected at the point of purchase. Georgia sales tax rates do vary depending on the region, county or city where you are located. `,
    },
    {
      type: "paragraph",
    ...
    {
      type: `paragraph`,
      content: `Sales tax rates do vary between states, counties and cities. Typically, the state will set a base sales tax rate, then specific counties and cities may levy small additional sales tax amounts on top of that. Here are the sales tax rates for the major cities in Georgia:`,
    },
    {
      type: `iconListColorBox`,
      ...
      content: {
        list: [
          `<strong>Atlanta</strong> sales tax rate is <strong>8.9 percent</strong>`,
          `<strong>Marietta</strong> sales tax rate is <strong>6 percent</strong>`,
          `<strong>Sandy Springs</strong> sales tax rate is <strong>7.75 percent</strong>`,
          `<strong>Lawrenceville</strong> sales tax rate is <strong>6 percent</strong>`,
        ],
      },
    },
    {
    ...
    {
      type: `paragraph`,
      content: `You use the State Taxpayer Identification Number (STIN) as a reference for your business tax licenses, liabilities and credits. You can get a number by submitting a State Tax Registration Application (form CRF-002) online at the <a href="https://gtc.dor.ga.gov/"target="_blank" rel="noopener noreferrer">Georgia Tax Center</a>.`,
    },
    ...
    {
      type: `paragraph`,
      content: `All Georgia LLC business members or managers who take profits out of the LLC will need to pay self-employment tax. This tax is also known as FICA, Social Security or Medicare tax. It applies to all the earnings you withdraw from your Georgia business. The current self-employment tax rate is 15.3 percent.`,
    },
    {
      type: `paragraph`,
