  ...
  content: [
    ...
    },
    {
      ...
      content: {
        ...
        list: [`Tangible, personal property and goods that you sell like furniture, cars, electronics, appliances, books, raw materials, etc.`, `Certain services that your Georgia business might provide`],
      },
    },
    {
      type: `paragraph`,
    ...
    },
    {
      ...
      content: {
        ...
        list: [`<strong>Atlanta</strong> sales tax rate is <strong>8.9%</strong>`, `<strong>Marietta</strong> sales tax rate is <strong>6%</strong>`, `<strong>Sandy Springs</strong> sales tax rate is <strong>7.75%</strong>`, `<strong>Lawrenceville</strong> sales tax rate is <strong>6%</strong>`],
      },
    },
    {
      type: `heading`,
          ...
          },
          {
            ...
            answer2: [
              ...
              },
              {
                ...
                color: color.orange3,
                content: [`Federal income tax`, `Federal self-employment tax`, `Georgia state tax`],
              },
              {
                type: `paragraph`,
