  ...
  buttons: [
    {
      ...
      url: `${process.env.ORDER_URL}/form-order-now.php?entityType=LLC&entityState=SD`,
    },
  ],
};
...
export const howToGuide = [
  ...
  {
    type: `text`,
    content: `Briefly, the benefits of starting a South Dakota LLC include:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
      ...
      items: [
        ...
        },
        {
          ...
          <ul>
            ...
            <p><a href="${process.env.ORDER_URL}/form-order-now.php?entityType=LLC&entityState=SD" target="_blank">Form your LLC now</a></p>`,
        },
      ],
    },
    marginBottom: 48,
  ...
  {
    type: `text`,
    content: `The Secretary of State has plenty of information on forming and running a business in South Dakota. These are all the basic steps for forming an LLC in South Dakota. You’ll find other useful information below:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
      ...
      items: [
        {
          ...
          answer: `<p>Some states, including South Dakota, allow certain occupations to form “Professional LLCs.” These types of businesses typically have special requirements and licensing. <a href="https://sdsos.gov/Business-Services/corporations/corporate-forms/limited-liability-companies.aspx" target="_blank" rel="noopener noreferrer">You can find more information here.</a></p>`,
        },
        {
          ...
          answer: `<p>If your business is already operating in another state and expanding to South Dakota, you’ll need to form a foreign LLC.</p></br>
            <a href="/south-dakota-llc/form-filling-permit-requirements/">More information on South Dakota filing and licensing requirements here.</a>`,
        },
      ],
    },
    marginBottom: 48,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/south-dakota-llc/how-to-name-your-llc/">Naming Your South Dakota LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/south-dakota-llc/registered-agents-south-dakota-llc/">South Dakota Registered Agents for Your LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/south-dakota-llc/form-filling-permit-requirements/">Fees and Requirements for Your South Dakota LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/south-dakota-llc/business-taxes/">Federal, State, Sales and Other Taxes forYour South Dakota LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
...
export const namingYourBusiness = [
  ...
  {
    type: `text`,
    content: `<a href="https://sosenterprise.sd.gov/BusinessServices/Business/FilingSearch.aspx" target="_blank" rel="noopener noreferrer">South Dakota Secretary of State business name search tool.</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `It’s not enough for your LLC name to be unique. It also cannot be similar to the name of a corporation or LLC in South Dakota. For example, you cannot use the following factors to say your name is different from the name of another business:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
    ...
    content: [
      ...
      },
      {
        text: `If you’re ready to start your LLC, you can formally file your Articles of Organization with the South Dakota SOS, or
          <a href="${process.env.ORDER_URL}/form-order-now.php?entityType=LLC&entityState=SD" target="_blank">let Incfile take care of it for you.</a>`,
      },
    ],
    marginBottom: 48,
  },
...
export const registeredAgent = [
  ...
  {
    type: `text`,
    content: `There are certain rules that you must follow when you’re appointing a South Dakota Registered Agent service for your business. They are:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `Your South Dakota Registered Agent carries out several valuable services for your business. They accept official communications and documents from the Secretary of State on your behalf. This may include:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `We are authorized to conduct business in South Dakota and can legally act as your Registered Agent. Here’s what you need to know about Incfile’s Registered Agent service:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `What happens if you choose not to assign or provide details of a Registered Agent to the South Dakota Secretary of State? There are several possible ramifications, including:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
    content: {
      list: [
        ...
        `<b>Falling out of good standing with the South Dakota Secretary of State:</b> If you don’t respond to certain correspondence (like the request for your annual report), certain states may revoke your right to do business.`,
        `<b>Losing your status as a South Dakota LLC:</b> A Registered Agent “proves” to the state that your business exists. Without it, you could lose your business entity protections and your South Dakota LLC may be dissolved.`,
      ],
    },
    marginBottom: 48,
    color: color.purple3,
  ...
  {
    type: `text`,
    content: `If you have an address in South Dakota, you can choose to be the Registered Agent for your LLC. We don’t recommend this approach as there can be some drawbacks:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  },
  {
    ...
    content: {
      list: [
        `<a href="/research-topics/registered-agent/registered-agent-function/" target="_blank">The Main Functions of a South Dakota Registered Agent</a>`,
        `<a href="/manage-your-company/change-of-registered-agent/" target="_blank" >Changing Your South Dakota Registered Agent</a>`,
        `<a href="/research-topics/registered-agent/registered-agent-tasks/" target="_blank" >What a South Dakota Registered Agent Does</a>`,
      ],
    },
    marginBottom: 0,
    color: color.blue3,
...
export const feesAndRequirments = [
  ...
  {
    type: `text`,
    content: `Some SD LLCs will need certain business licenses and permits from federal, state and regional organizations. These permits and licenses will have associated fees that you should pay on a one-off or regular basis. Permits and licenses vary based on:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `Our Business License Research Package tells you about all of the licenses and permits you will need for your South Dakota LLC. It includes:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `Areas you might want to file South Dakota Articles of Amendment for include:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
...
export const businessTaxes = [
  ...
  {
    type: `text`,
    content: `You will typically need to collect South Dakota sales tax on:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
    content: {
      list: [
        ...
        `Certain services that your South Dakota business might provide`,
      ],
    },
    marginBottom: 16,
    color: color.purple3,
  ...
  {
    type: `text`,
    content: `<a href="https://dor.sd.gov/businesses/taxes/" target="_blank" rel="noopener noreferrer">Get details on the South Dakota sales tax here.</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
  ...
  },
  {
    ...
    content: {
      items: [
        ...
        {
          question: `South Dakota LLC Employee Insurance and Other Requirements`,
          answer2: [
            {
              type: `paragraph`,
            ...
            {
              type: `paragraph`,
              content: `<a href="https://dlr.sd.gov/" target="_blank" rel="noopener noreferrer">Get more requirements from the South Dakota Department of Labor and Regulation website.</a>`,
            },
          ],
        },
        {
          question: `Other Taxes and Duties for Your South Dakota LLC`,
          answer: `Depending on the industry you are in, your South Dakota LLC may be liable for certain other taxes and duties. For example, if you sell gasoline you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
        },
        {
          question: `Estimated Taxes for Your South Dakota LLC`,
          answer2: [
            {
              type: `paragraph`,
