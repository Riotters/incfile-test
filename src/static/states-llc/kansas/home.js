...
export const registeredAgent = [
  ...
  {
    type: `header`,
    content: `Services Provided by a Kansas Registered Agent`,
    size: 3,
    marginBottom: 16,
  },
  {
      ...
      items: [
        {
          ...
          answer: `YYes. All KS LLCs are required to have a Registered Agent. This is mandated by the Kansas Secretary of State.`,
        },
        {
...
export const feesAndRequirments = [
  ...
  },
  {
    ...
    content: {
      ...
      rows: [[`$160`, `5 Business Days`, `1 Business Day`]],
    },
  },
  {
    type: `arrow-link`,
  ...
  {
    type: `header`,
    content: `The Incfile Business License Research Package for Your Kansas LLC`,
    size: 4,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `Our Business License Research Package tells you about all of the licenses and permits you will need for your Kansas LLC. It includes:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
  ...
  },
  {
    type: `button`,
    content: {
      text: `Incfile's Kansas business license research package`,
...
export const businessTaxes = [
  ...
  {
    type: `header`,
    content: `Employer Payroll Tax Withholding for Your Kansas LLC`,
    size: 4,
    marginBottom: 16,
  },
  {
  ...
  {
    type: `header`,
    content: `Kansas LLC Federal and State Tax Withholding`,
    size: 4,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `You may also choose to withhold federal and Kansas state income tax on the wages you pay to employees. Speak to your accountant for more information.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Get more requirements from the <a href="https://www.dol.ks.gov/KansasEmployer.aspx" target="_blank" rel="noopener noreferrer"> Kansas Department of Labor website.</a>`,
    marginBottom: 24,
  },
  {
    type: `header`,
    content: `Other Taxes and Duties for Your Kansas LLC`,
    size: 4,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `Depending on the industry you are in, your Kansas LLC may be liable for certain other taxes and duties. For example, if you sell gasoline you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
    marginBottom: 32,
  },
  {
    type: `header`,
    content: `Estimated Taxes for Your Kansas LLC`,
    size: 4,
    marginBottom: 16,
  },
  {
