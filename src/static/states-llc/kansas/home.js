...
export const howToGuide = [
	...
	},
	{
		type: `header`,
		size: 3,
		content: `<a href="/kansas-llc/how-to-name-your-llc/">Naming Your Kansas LLC</a>`,
		marginBottom: 16,
	},
	{
		type: `text`,
	...
	},
	{
		type: `header`,
		size: 3,
		content: `<a href="/kansas-llc/registered-agents-kansas-llc/">Kansas Registered Agents for LLCs</a>`,
		marginBottom: 16,
	},
	{
		type: `text`,
...
export const namingYourBusiness = [
	...
	{
		type: `text`,
		content: `You should start naming your business by completing a “Kansas business entity search” with the secretary of state. They have a helpful tool on their website that lets you search the register of KS LLCs and corporations to see if someone already has your desired business name. Just visit the <a href="https://www.kansas.gov/bess/flow/main;jsessionid=D0BE88DF786FA26AF59B2FE5FB0B9A2F.aptcs03-inst0?execution=e1s1" target="_blank" rel="noopener noreferrer">Business Search Tool</a> on the Kansas SOS website and enter the KS business name you want to search for.`,
		marginBottom: 16,
	},
	{
		type: `text`,
