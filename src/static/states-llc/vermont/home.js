...
export const howToGuide = [
  ...
  {
    type: `text`,
    content: `Located in the heart of New England in the Northeast U.S., Vermont is a beautiful state with an economy based around manufacturing, real estate, healthcare and retail.`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  {
    type: `text`,
    content: `We’ve got lots of useful information on starting a business in VT. On this page, you’ll find the basic steps for starting a Vermont LLC, with more in-depth content throughout the rest of our guide.`,
    marginBottom: 32,
  },
  {
    type: `accordion`,
    ...
    content: {
      items: [
        ...
        },
        {
          ...
          answer: `Every Vermont LLC must have a designated street address. That could be your home address (if you’re running the company from your residence), your company’s office building or any physical address of your preference. The address must be inside the state of Vermont, but it cannot be a P.O. Box.`,
        },
        {
          question: `STEP 4: Assign a Vermont Registered Agent`,
          answer: `<p>Every LLC must have a “Registered Agent.” This is an official position; the Registered Agent is someone who receives official legal and tax correspondence and has responsibility for filing reports with the Vermont Secretary of State. In VT, Registered Agents can also be known as an Agent of Process.
          </p></br>

          <p>This position can be filled by you, another manager in the business or a dedicated Registered Agent service. Your Registered Agent must have a physical street address in Vermont and must be present to receive important documents for your company during business hours.</p></br>
          
          <p>At Incfile, all of our packages include a Vermont Registered Agent service that is free for the first year and just $119 per year afterward. We also have a dashboard where you can log in and easily view any document your Registered Agent has received on your behalf.</p></br>
          <a href="/vermont-llc/registered-agents-vermont-llc/">Learn more about Vermont Registered Agents.</a>`,
        },
        {
          question: `STEP 5: Get an Employer Identification Number (EIN) from the Internal Revenue Service`,
          answer: `You will need an EIN to identify your business with the IRS. You use this number when filing and paying taxes or when submitting payroll information and payments for your employees. You can obtain one directly from the IRS, or we can get one for you as part of the Vermont LLC business formation process.`,
        },
        {
          question: `STEP 6: File Articles of Organization with the Vermont Secretary of State`,
          answer: `<p> Once you've gathered all the information for your LLC, you’ll need to file a formal document with the VT Secretary of State. This document is known as your “Articles of Organization,” and filing the document creates your Vermont LLC. Here’s what is typically included:</p></br>
                   <ul>
  ...
  {
    type: `text`,
    content: `The Secretary of State has plenty of other information on forming and running a business in Vermont. You’ll find other useful information below.`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `A regular Vermont LLC is suitable for most business needs, but you also have a few other options to incorporate a special type of LLC.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/vermont-llc/how-to-name-your-llc/">Naming Your Vermont  LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `How to search the Vermont business registry of the Secretary of State and find the right name. Includes information on naming rules, fictitious names, reserving a Vermont LLC name and more.`,
    marginBottom: 32,
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/vermont-llc/registered-agents-vermont-llc/">Vermont Registered Agents</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `How to appoint a Registered Agent to your new LLC or change to a different Registered Agent. Includes information on Registered Agent rules and searching for Vermont Registered Agents.`,
    marginBottom: 32,
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/vermont-llc/form-filling-permit-requirements/">Fees and Requirements for Vermont LLCs</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `How to understand the various fees you’ll need to pay and the requirements you’ll need to meet for both federal and Vermont rules. Includes details of Employer Identification Numbers (EINs), Vermont and federal business licenses, annual reports and more.`,
    marginBottom: 32,
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/vermont-llc/business-taxes/">Federal, State, Sales and Other Taxes for Your Vermont LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `How to understand the various taxes you will need to pay to the federal and Vermont government. Includes details of federal taxes like income and self-employment, and Vermont taxes like sales tax and income tax.`,
    marginBottom: 32,
  },
];
...
export const namingYourBusiness = [
  ...
  {
    type: `text`,
    content: `Whether you’re searching for the right Vermont business name or registering your LLC with the VT Secretary of State, we can help. We’ve got all the information you need on a Vermont business entity search, LLC naming rules, fictitious names and registering your business.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `You need to check whether there’s already another Vermont LLC registered with your desired business name. That means searching the Vermont Secretary of State website using their business search tool. You can easily look up LLCs and corporations by name and other details.`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  {
    type: `text`,
    content: `<a href="https://bizfilings.vermont.gov/online/BusinessInquire/" target="_blank" rel="noopener noreferrer">Vermont Secretary of State business name search tool</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `The business name you have chosen cannot be used by any other LLC or corporation in the state of Vermont. This is why you should check business name availability on the VT SOS website.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `It’s not enough for your VT LLC name to be unique. It also cannot be similar to the name of a corporation or LLC in Vermont. For example, you cannot use the following factors to say your name is different from the name of another business:`,
    marginBottom: 32,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `You might choose to do business under a different name from your legal LLC name. In Vermont, doing business under a different name is known as a “Trade” or “Doing Business As” name. You might choose to use a different name from your formal LLC name for a variety of reasons.`,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `For example, your LLC might be called Vermont Maple Syrup Tapping Company LLC and you have a chain called Miraculous Maple. You should file a Trade/DBA form to let the Vermont Secretary of State know.`,
    marginBottom: 16,
  },
  {
    type: `button`,
  ...
  {
    type: `text`,
    content: `Once you’ve searched for your Vermont business name, checked availability, followed the naming rules and decided whether you need a fictitious name, you can register your VT LLC name. There are a couple of ways to do this.`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  },
  {
    ...
    content: {
      items: [
        {
          question: `How Do I Search for My Vermont LLC Business Name?`,
          answer: `Just go to the <a href="https://bizfilings.vermont.gov/online/BusinessInquire/" target="_blank" rel="noopener noreferrer">business name search tool</a> and enter your proposed business name. You can search the register of the Vermont Secretary of State, which will tell you if there are any VT corporations or LLCs with that name.`,
        },
        {
          question: `Are There Any Rules on Naming My Vermont LLC?`,
          answer: `Yes. Most LLCs will be bound by general rules (applicable to all LLCs) and specific rules (applicable in the state of Vermont). We’ve detailed these rules above.`,
        },
        {
          question: `Can I Do Business Under a Different Name Than My LLC Name in Vermont?`,
        ...
        {
          question: `Can I Reserve a Name for My Vermont LLC?`,
          answer: `Yes. The Vermont Secretary of State allows you to reserve a name if you don’t want to start your business immediately. Details are above. If you are ready to start your business now, you do not need to reserve a name.`,
        },
      ],
    },
    marginBottom: 48,
...
export const registeredAgent = [
  ...
  {
    type: `text`,
    content: `Every business entity formed in Vermont needs to formally appoint a person or business to act as a Registered Agent. Your Vermont Registered Agent provides various services to VT LLCs, including the acceptance of formal documents and correspondence from the Vermont Secretary of State.`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  {
    type: `text`,
    content: `Here’s some important information from the Vermont Secretary of State on Registered Agent services.`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  {
    type: `text`,
    content: `Note that the Registered Agent address does not need to be the same as your Vermont LLC business address.`,
    marginBottom: 48,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Your Vermont Registered Agent carries out several valuable services for your business. They accept official communications and documents from the VT Secretary of State on your behalf. This may include:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `If you have an LLC that’s incorporated in Vermont and you need a Registered Agent, we can help. Your Registered Agent is completely free for the first year and only $119 a year after that.`,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `We are authorized to conduct business in Vermont and can legally act as your Registered Agent. Here’s what the Incfile Vermont Registered Agent service provides for your VT LLC:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  },
  {
    type: `button`,
    content: {
      text: `Order Incfile's Vermont registered agent service`,
  ...
  {
    type: `text`,
    content: `You can appoint a Registered Agent when you first incorporate your Vermont LLC or at any point after that. Here’s how to go about it.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Your business needs to have a Vermont Registered Agent Service as soon as it’s formed. You can achieve this through one of the following methods.`,
    marginBottom: 16,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Once you’ve chosen a new Vermont Registered Agent, you can complete a form. Once you’ve filled it out, send it to the Secretary of State so they can update your records.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `In some situations, you might want to know the name of the Registered Agent that represents another Vermont LLC. If you do, you can search the business database of the Vermont Secretary of State, which will often provide details of a specific business’s Registered Agent.`,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `If the Registered Agent isn’t available from the searchable business registry, contact the Vermont Secretary of State requesting the information.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  },
  {
    ...
    content: {
      items: [
        {
          question: `Do I Need to Appoint a Vermont Registered Agent?`,
          answer: `Yes. All LLCs are required to have a Registered Agent. This is mandated by the Vermont Secretary of State.`,
        },
        {
          question: `When Can I Assign a Vermont Registered Agent Service?`,
          answer: `You can either do it when you incorporate your Vermont business through paperwork filed with the Secretary of State or afterward by filing the correct form. If you form your business through Incfile, we will file all necessary forms on your behalf.`,
        },
        {
          question: `Can I Be My Own Registered Agent in Vermont?`,
          answer: `Yes, but we don’t recommend it for the reasons listed above. If you still want to be your own Registered Agent, you need to fill in the correct forms and pay a fee to the Vermont Secretary of State.`,
        },
        {
          question: `Does My Registered Agent Need to Have an Address in Vermont?`,
  ...
  },
  {
    ...
    content: {
      list: [
        `<a href="/research-topics/registered-agent/registered-agent-function/">The Main Functions of a Vermont Registered Agent</a>`,
        `<a href="/manage-your-company/change-of-registered-agent/">Changing Your Vermont Registered Agent</a>`,
        `<a href="/research-topics/registered-agent/registered-agent-tasks/">What a Vermont Registered Agent Does</a>`,
      ],
    },
    marginBottom: 48,
    color: color.babyblue3,
...
export const feesAndRequirments = [
  ...
  {
    type: `text`,
    content: `Note that Vermont business licenses and permits might need to be paid when you first form your business, on an ongoing schedule or on an ad hoc basis. Find more details below.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `When you first incorporate your business in Vermont, you’ll need to file an LLC with the VT Secretary of State and pay a filing fee. Here are the current fees and filing times for Vermont:`,
    marginBottom: 32,
  },
  {
    type: `dynamic_ar_box`,
  ...
  {
    type: `text`,
    content: `When you form your LLC through Incfile, we automatically forward this fee to the Vermont Secretary of State when we file your incorporation paperwork.`,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `Some states allow you to form your LLC more quickly by paying a rush fee. You can <a href="/state-filing-times/">compare state filing times and fees here, including expedited fees for Vermont.</a>`,
    marginBottom: 24,
  },
  {
    type: `button`,
  ...
  {
    type: `text`,
    content: `Every Vermont LLC should have a unique Employer Identification Number (EIN). These are provided by the Internal Revenue Service, and you use them when filing taxes, opening a business bank account and paying employees. You can get one yourself at no cost from the IRS or have Incfile obtain one on your behalf.`,
    marginBottom: 16,
  },
  {
    type: `button`,
    content: {
      text: `Get and EIN for your Vermont LLC through Incfile`,
  ...
  {
    type: `text`,
    content: `Most states need to file an annual (or other periodic) report with their department of state. When you file your VT LLC annual report, you may need to pay a fee. Here are the annual filing requirements for Vermont:`,
    marginBottom: 48,
  },
  {
  ...
  },
  {
    type: `button`,
    content: {
      text: `Incfile's Vermont annual report filing service`,
  ...
  {
    type: `text`,
    content: `Some Vermont LLCs will need certain business licenses and permits from federal, state and regional organizations. These permits and licenses will have associated fees that you should pay on a one-off or regular basis. Permits and licenses vary based on:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `header`,
    content: `The Incfile Business License Research Package for Your Vermont LLC`,
    size: 3,
    marginBottom: 24,
  },
  {
    type: `text`,
    content: `Our Business License Research Package tells you about all of the licenses and permits you will need for your Vermont LLC. It includes:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `Remember that operating your business without the required licenses can expose you to risks and fines from federal, Vermont and local governments.`,
    marginBottom: 16,
  },
  {
    type: `button`,
    content: {
      text: `Incfile's Vermont business license research package`,
  ...
  },
  {
    type: `button`,
    content: {
      text: `Incfile's Vermont fictitious name service`,
      url: `/fictitious-business-or-trade-name/`,
    },
    theme: `primary48`,
    marginBottom: 32,
  ...
  },
  {
    type: `button`,
    content: {
      text: `Incfile's Vermont registered agent service`,
      url: `/manage-your-company/registered-agent/`,
    },
    theme: `primary48`,
    marginBottom: 32,
  ...
  },
  {
    type: `button`,
    content: {
      text: `Incfile's Vermont articles of amendment service`,
  ...
  },
  {
    type: `button`,
    content: {
      text: `Incfile's Vermont certificate of good standing service`,
  ...
  {
    type: `text`,
    content: `The fees listed above detail all the charges that a standard Vermont LLC will be required to pay. In some unusual circumstances, there may be other one-off, periodic or ad hoc fees not listed above.`,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `Of course, your Vermont LLC will also probably need to pay self-employment, payroll, federal, state and sales taxes, but we will cover that when we talk about taxes for Vermont LLCs.`,
    marginBottom: 48,
  },
  {
    type: `header`,
  ...
  },
  {
    ...
    content: {
      items: [
        {
          question: `What Happens to the State Fees That I Am Charged When Forming My Vermont LLC?`,
          answer: `We charge you for this fee at cost and then pay the fee to the secretary of state on your behalf when forming your Vermont business.`,
        },
        {
          question: `Do I Need to Pay an Annual Report Fee Every Year?`,
          answer: `Yes. Most states, including VT, require you to file a report for your LLC every year.  You can find out more on the <a href="/compliance-filing-requirement/">compliance page for your state.</a>`,
        },
        {
          question: `Who Will I Need to Get Business Licenses and Permits From for My Vermont LLC?`,
          answer: `<p>It depends on various factors including:</p></br>
                  ...
                  That’s why our <a href="/business-license-research-package/">business license research package</a> is so useful. It explores all of these areas for you and provides a comprehensive overview of exactly what your Vermont LLC needs to be compliant.`,
        },
      ],
    },
    marginBottom: 48,
...
export const businessTaxes = [
  ...
  {
    type: `text`,
    content: `Business taxes are a fact of life, and your LLC will need to pay a variety of taxes to both the federal and Vermont governments. We’ll cover all the main taxes in Vermont, including self-employment, payroll, federal, Vermont state tax and Vermont sales tax.`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    ...
    content: [
      {
        text: `Vermont LLC owners pay self-employment tax on business profits`,
      },
      {
        text: `Vermont LLC owners pay VT state tax on any profits, less state allowances or deductions`,
      },
      {
  ...
  {
    type: `text`,
    content: `Items 1, 2 and 3 are taxed as “pass-through” income for any LLC owners, managers or members who receive profits from the business. Any profits are reported on federal and Vermont personal tax returns, and that’s where you will pay those taxes.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `As a Vermont business owner, you will need to pay state tax on any money you pay to yourself. These earnings flow through to your personal tax return, which is where you will pay income tax. You will be taxed at the standard rates for Vermont state taxes, and you will also get to apply regular allowances and deductions.`,
    marginBottom: 32,
  },
  {
    type: `text`,
  ...
  {
    type: `text`,
    content: `The Vermont state tax rates are between 3.55 percent and 9.4 percent, depending on your income.`,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `Get details on the <a href="https://myvtax.vermont.gov/_/" target="_blank" rel="noopener noreferrer" >Vermont state tax here.</a>`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `If you sell physical products or certain types of services, you may need to collect sales tax (also known as sales and use tax) and then pay it to the VT Department of Revenue. Vermont sales tax is collected at the point of purchase. Sales tax rates do vary depending on the region, county or city where you are located. You will typically need to collect Vermont sales tax on:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `Get details on the <a href="https://tax.vermont.gov/business-and-corp/sales-and-use-tax" target="_blank" rel="noopener noreferrer">Vermont sales and use tax online here.</a>.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `There are a couple of different federal taxes that every LLC will need to pay, including Vermont LLCs. These are self-employment tax and federal income tax, which are taxed as “pass-through” income via your tax return forms.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `All Vermont LLC business members or managers who take profits out of the LLC will need to pay self-employment tax. This tax is also known as FICA, Social Security or Medicare tax. It applies to all the earnings you withdraw from your Vermont business. The current self-employment tax rate is 15.3 percent.`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  {
    type: `text`,
    content: `Speak to your accountant for more information on reducing your Vermont LLC self-employment tax through an S Corporation tax election.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `You must also pay regular federal income tax on any earnings you take out of your Vermont LLC. The amount of income tax you pay depends on your earnings, current income tax brackets, deductions and how you file.`,
    marginBottom: 16,
  },
  {
    type: `text`,
    ...
    content: {
      items: [
        ...
        },
        {
          ...
          answer: `You may also choose to withhold federal and Vermont state income tax on the wages you pay to employees. Speak to your accountant for more information.`,
        },
        {
          question: `Employees May Need to File Tax Returns`,
          answer: `Regardless of whether you withhold federal and Vermont state income tax, your employees may need to file their own tax returns.`,
        },
        {
          ...
          answer2: [
            ...
            {
              type: `paragraph`,
              content: `<a href="https://labor.vermont.gov/" target="_blank" rel="noopener noreferrer">Get more requirements from the Vermont Department of Labor website.</a>`,
            },
          ],
        },
        {
          question: `Other Taxes and Duties for Your Vermont LLC`,
          answer: `Depending on the industry you are in, your Vermont LLC may be liable for certain other taxes and duties. For example, if you sell gasoline you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
        },
        {
          question: `Estimated Taxes for Your Vermont LLC`,
          answer2: [
            {
              type: `paragraph`,
            ...
            {
              type: `paragraph`,
              content: `Most Vermont LLCs will pay estimated taxes four times a year. Speak to your accountant for more information.`,
            },
          ],
        },
      ],
  ...
  {
    type: `header`,
    content: `FAQs on Vermont LLC Business Taxes`,
    size: 2,
    template: 3,
    style: { fontSize: `28px`, lineHeight: `36px` },
    marginBottom: 32,
  },
  {
    ...
    content: {
      items: [
        {
          question: `Does Vermont Have Sales Tax?`,
          answer: `Yes. Vermont does have a sales tax, which may vary among cities and counties.`,
        },
        {
          question: `Does Vermont Have a State Tax?`,
          answer: `Yes. Vermont does have a general state income tax. You can find more information above.`,
        },
        {
          question: `Do I Need to Pay Estimated Taxes?`,
          answer: `Yes. In most cases, you must pay estimated taxes on your Vermont tax, federal income tax and self-employment tax. Speak to your accountant for more information.`,
        },
      ],
    },
    marginBottom: 24,
