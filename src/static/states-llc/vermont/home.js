...
export const namingYourBusiness = [
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`If you don’t want to form your LLC right now, you can reserve the business name with the Vermont Secretary of State. You will need to complete a “Application to Reserve a Specified Business Name” and file it with the VT SOS. You do not need to reserve a name if you are forming your business right away.
              <a href="https://sos.vermont.gov/" target="_blank" rel="noopener noreferrer">Vermont SOS LLC name reservation</a>
              If you’re ready to start your LLC, you can formally file your Articles of Organization with the Vermont SOS, or <a href="/form-order-now.php?entityType=LLC&entityState=VT/">let Incfile take care of it for you</a>.`],
    },
    marginBottom: 40,
    color: color.purple3,
  },
...
export const registeredAgent = [
  ...
  {
    type: `text`,
    content: `We are authorized to conduct business in Vermont and can legally act as your Registered Agent.`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
...
export const feesAndRequirments = [
  ...
  {
    type: `text`,
    content: `<b>Due Date:</b> Calender Year: March 31 </br>
              <b>Fiscal Year:</b> Within 2½ months after end of fiscal year.`,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `<b>Filing Fee:</b> $35`,
    marginBottom: 32,
  },
  {
    type: `text`,
...
export const businessTaxes = [
  ...
  {
    type: `header`,
    content: `Employer Federal and State Tax Withholding `,
    size: 4,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `You may also choose to withhold federal and Vermont state income tax on the wages you pay to employees. Speak to your accountant for more information.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Regardless of whether you withhold federal and Vermont state income tax, your employees may need to file their own tax returns.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Get more requirements from <a href="https://labor.vermont.gov/" target="_blank" rel="noopener noreferrer">the Vermont Department of Labor website.</a>`,
    marginBottom: 24,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Depending on the industry you are in, your Vermont LLC may be liable for certain other taxes and duties. For example, if you sell gasoline you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
    marginBottom: 32,
  },
  {
    type: `header`,
