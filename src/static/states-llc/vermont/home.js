...
export const howToGuide = [
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/vermont-llc/how-to-your-name-llc/">Naming Your Vermont  LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
...
export const businessTaxes = [
  ...
  {
    type: `text`,
    content: `Get details on the <a href="https://myvtax.vermont.gov/GetWlbToken?WLB_REDIRECT=_%2F&WLB_SIG=UlR49vvrUcmVgHS95%2BHz9aZM2bQ2CfsRKK9g%2Fj5e7Vo%3D" target="_blank" rel="noopener noreferrer" >Vermont state tax here.</a>`,
    marginBottom: 32,
  },
  {
    type: `header`,
