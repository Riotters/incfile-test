...
export const howToGuide = [
        ...
        items: [
          ...
          },
          {
            ...
            answer: `<p>Once you've gathered all the information for your Nebraska LLC, you’ll need to file a formal document with the NE Secretary of State. This document is known as your “Certificate of Organization,” and filing the document creates your Nebraska LLC. Here’s what is typically included:</p></br>
                     ...
                     <a href="/form-order-now.php?entityType=LLC&entityState=NE/"> Form your LLC now </a>`,
          },
        ],
      },
      marginBottom: 48,
    ...
    },
    {
      ...
      content: {
        ...
        list: [`<a href="https://sos.nebraska.gov/business-services/new-business-information" target="_blank" rel="noopener noreferrer">Nebraska Secretary of State for forming and running your NE LLC</a>`,
  ...
  export const namingYourBusiness = [
    ...
    },
    {
      ...
      content: {
        header: ``,
        list: [`Are very similar to the name of a federal or NE agency or organization (e.g., FBI, FDA, Nebraska Department of Revenue, Nebraska Police, Treasury, etc.)`,
    ...
    },
    {
      ...
      content: {
        header: ``,
        list: [`<p>If you don’t want to form your Nebraska LLC right now, you can reserve the business name with the Nebraska Secretary of State. You will need to complete an Application for Reservation of Limited Liability Company Name and file it with the NE SOS. You do not need to reserve a name if you are forming your business right away.</p></br>
                ...
                <p>If you’re ready to start your Nebraska LLC, you can formally file your Certificate of Organization with the Nebraska SOS, or <a href="/form-order-now.php?entityType=LLC&entityState=NE/">let Incfile take care of it for you</a>.</p>`],
      },
      marginBottom: 32,
      color: color.purple3,
    },
  ...
  export const registeredAgent = [
    ...
    },
    {
      ...
      content: {
        header: ``,
        list: [`If the Registered Agent is a person, they must reside in Nebraska.`,
    ...
    },
    {
      ...
      content: {
        header: ``,
        list: [`Correspondence from the Nebraska Secretary of State, like a notice to file reports and other forms`,
    ...
    },
    {
      ...
      content: {
        header: ``,
        list: [`An always-available Nebraska Registered Agent who can receive correspondence, documents and legal proceedings on your LLC’s behalf`,
    ...
    },
    {
      ...
      content: {
        ...
        url: `/form-order-now.php?entityType=LLC&entityState=NE/`,
      },
      theme: `primary48`,
      marginBottom: 32,
    },
    ...
    },
    {
      ...
      content: {
        header: ``,
        list: [`The NE Registered Agent must have a physical street address in Nebraska. If you’re forming an LLC outside NE, you will need to use an in-state Registered Agent. You always need to have someone on hand during business hours at the Nebraska address to sign for important documents.`, 
    ...
    },
    {
      ...
      content: {
        ...
        list: [`<a href="/research-topics/registered-agent-help/what-is-the-main-function-of-the-registered-agent/">The Main Functions of a Nebraska Registered Agent</a>`,
  ...
  export const feesAndRequirments = [
    ...
    },
    {
      ...
      content: {
        ...
        list: [`The industry your Nebraska LLC operates in (e.g., restaurants will need health permits)`, 
    ...
    },
    {
      ...
      content: {
        header: ``,
        list: [`A complete report on all the licenses, permits and tax registrations your Nebraska LLC will need`,
    ...
    },
    {
      type: `list-dot`,
      content: {
        header: `Areas you might want to file Nebraska Articles of Amendment for include:`,
        list: [`Adding, removing or changing a Nebraska LLC member or manager`,
  ...
  export const businessTaxes = [
    ...
    },
    {
      type: `list-dot`,
      content: {
        header: `You will typically need to collect Nebraska sales tax on:`,
    ...
    {
      type: `text`,
      content: `You may also choose to withhold federal and Nebraska state income tax on the wages you pay to employees. Speak to your accountant for more information.`,
      marginBottom: 32,
    },
    {
      type: `header`,
    ...
    {
      type: `text`,
      content: `Regardless of whether you withhold federal and Nebraska state income tax, your employees may need to file their own tax returns.`,
      marginBottom: 32,
    },
    {
      type: `header`,
    ...
    {
      type: `text`,
      content: `Get more requirements from <a href="https://dol.nebraska.gov/" target="_blank" rel="noopener noreferrer">the Nebraska Department of Labor website.</a>`,
      marginBottom: 24,
    },
    {
      type: `header`,
      content: `Other Taxes and Duties for Your Nebraska  LLC`,
      size: 4,
      marginBottom: 16,
    },
    {
      type: `text`,
      content: `Depending on the industry you are in, your Nebraska LLC may be liable for certain other taxes and duties. For example, if you sell gasoline you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
      marginBottom: 32,
    },
    {
      type: `header`,
      content: `Estimated Taxes for Your Nebraska LLC`,
      size: 4,
      marginBottom: 16,
    },
    {
      type: `text`,
      content: `Most Nebraska LLCs will need to pay estimated taxes throughout the year, depending on the amount of income and profit you expect to make. The most common types of estimated tax are:`,
      marginBottom: 16,
    },
    {
      type: `list-dot`,
