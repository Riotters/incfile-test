      ...
      items: [
        ...
        },
        {
          ...
          answer: `
            ...
            <p>That’s why our <a href="/business-license-research-package/" target="_blank"> is so useful. It explores all of these areas for you and provides a comprehensive overview of exactly what your Pennsylvania LLC needs to be compliant.</p>`,
        },
      ],
    },
    marginBottom: 0,
...
export const businessTaxes = [
  ...
  {
    type: `header`,
    content: `Pennsylvania LLC Federal and State Tax Withholding`,
    size: 4,
    marginBottom: 24,
  },
  {
    type: `text`,
    content: `You may also choose to withhold federal and Pennsylvania state income tax on the wages you pay to employees. Speak to your accountant for more information.`,
    marginBottom: 48,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Regardless of whether you withhold federal and Pennsylvania state income tax, your employees may need to file their own tax returns.`,
    marginBottom: 48,
  },
  {
    type: `header`,
    content: `Pennsylvania LLC Employee Insurance and Other Requirements`,
    size: 4,
    marginBottom: 24,
  },
  {
  ...
  {
    type: `header`,
    content: `Other Taxes and Duties for Your Pennsylvania LLC`,
    size: 4,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `Depending on the industry you are in, your Pennsylvania LLC may be liable for certain other taxes and duties. For example, if you sell gasoline you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
    marginBottom: 24,
  },
  {
    type: `header`,
    content: `Estimated Taxes for Your Pennsylvania LLC`,
    size: 4,
    marginBottom: 16,
  },
  {
