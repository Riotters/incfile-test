export const HomePageContent = {
    ...
    content: {
        whyChoose: {
            ...
            text1: "The Empire State is a fantastic place to build the company of your dreams. A combination of rich cultures, diverse cities and a healthy economy makes New York State a center of opportunity. New York is the fourth most populous state in the union, with very strong industries in the technology, finance, investment, media, entertainment and tourism sectors.",
            text2: "If you want to start your own business in New York, one of the best ways to do so is by forming a New York LLC. Limited liability companies (LLCs) are a business entity designed for startups and small- and medium-sized businesses. New York LLCs give you many of the protections and advantages of larger corporations without all the rules, regulations and compliance issues common to larger business entities.",
