...
export const howToGuide = [
  ...
  {
    type: `text`,
    content: `The MA Corporations Division has plenty of information on forming and running a business in Massachusetts. We’ve covered the basic steps for filing an LLC in Massachusetts, but you’ll find other useful information below.`,
    marginBottom: 32,
  },
  {
    type: `list-dot`,
  ...
  },
  {
    ...
    content: `<p>If your business is already operating in another state and expanding to Massachusetts, you’ll need to form a foreign LLC.</p></br>
              <p><a href="/massachusetts-llc/form-filling-permit-requirements/">More information on Massachusetts filing and licensing requirements here.</a></p>`,
    marginBottom: 40,
  },
  {
    type: `header`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/massachusetts-llc/how-to-name-your-llc/">Naming Your Massachusetts LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/massachusetts-llc/registered-agents-massachusetts-llc/">Massachusetts Resident Agents for Your LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/massachusetts-llc/form-filling-permit-requirements/">Fees and Requirements for Your Massachusetts LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/massachusetts-llc/business-taxes/">Federal, State, Sales and Other Taxes for Your Massachusetts LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
...
export const namingYourBusiness = [
  ...
  {
    type: `text`,
    content: `<a href="https://www.sec.state.ma.us/cor/corsearch.htm/" target="_blank" rel="noopener noreferrer">Massachusetts Corporations Division business name search tool</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
...
export const registeredAgent = [
  ...
  {
    type: `text`,
    content: `Here’s what the Incfile Massachusetts Registered Agent service provides for your MA LLC:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
...
export const feesAndRequirments = [
  ...
  {
    type: `text`,
    content: `Areas you might want to file Massachusetts Articles of Amendment for include:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
...
export const businessTaxes = [
  ...
  {
    type: `text`,
    content: `You will typically need to collect Massachusetts sales tax on:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
      ...
      items: [
        ...
        },
        {
          ...
          answer2: [
            ...
            {
              type: `paragraph`,
              content: `<a href="https://www.mass.gov/orgs/department-of-labor-standards" target="_blank" rel="noopener noreferrer">Get more requirements from the Massachusetts Department of Labor Standards website.</a>`,
              marginBottom: 48,
            },
          ],
        },
