...
export const top = {
	header: `Forming an LLC in Massachusetts`,
...
export const feesAndRequirments = [
	...
	{
		type: `text`,
		content: `Your Massachusetts LLC may need certain licenses and permits to comply with specific requirements. These business permits and licenses might be issued by Massachusetts, regional or federal organizations. Some of the associated fees only need to be paid once, while others have ongoing charges. Permits and licenses vary based on:`,
		marginBottom: 24,
	},
	{
		type: `list-dot`,
	...
	{
		type: `text`,
		content: `Your business formation documents state certain facts about your Massachusetts business when it was originally formed. Over time, these facts might change — if they do, you need to file “Articles of Amendment” with the Massachusetts Corporations Division. You can do this yourself or have Incfile complete the filing on your behalf. Areas you might want to file Massachusetts Articles of Amendment for include:`,
		marginBottom: 24,
	},
	{
		type: `list-dot`,
...
export const businessTaxes = [
	...
	{
		type: `text`,
		content: `If you sell physical products or certain types of services, you may need to collect sales tax (also known as sales and use tax) and then pay it to the MA Department of Revenue. Massachusetts sales tax is collected at the point of purchase. Massachusetts sales tax rates do vary depending on the region, county or city where you are located. You will typically need to collect Massachusetts sales tax on:`,
		marginBottom: 24,
	},
	{
		type: `list-dot`,
