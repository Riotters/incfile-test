...
export const howToGuide = [
  ...
  {
    type: `text`,
    content: `Briefly, the benefits of starting a Massachusetts LLC include:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
...
export const namingYourBusiness = [
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`<p>If you don’t want to form your Massachusetts LLC right now, you can reserve the business name with the Massachusetts Corporations Division. You do not need to reserve a name if you are forming your business right away.</p></br>
             ...
             `<p>If you’re ready to start your Massachusetts LLC, you can formally file your Certificate of Organization with the Massachusetts Corporations Division, or <a href="/form-order-now.php?entityType=LLC&entityState=MA/">let Incfile take care of it for you</a>.</p>`],
    },
    marginBottom: 32,
    color: color.purple3,
  },
...
export const feesAndRequirments = [
  ...
  },
  {
    ...
    content: {
      ...
      rows: [[`$520`, `5 Business Days`, `1 Business Day`]],
    },
  },
  {
    type: `arrow-link`,
  ...
  {
    type: `text`,
    content: `<b>Due Date:</b> Anniversary date of formation or registration.`,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `<b>Filing Fee:</b> $500`,
    marginBottom: 32,
  },
  {
    type: `text`,
  ...
  {
    type: `header`,
    content: `TTo Amend Certain Facts About Your Massachusetts LLC`,
    size: 4,
    marginBottom: 16,
  },
  {
...
export const businessTaxes = [
  ...
  {
    type: `header`,
    content: `Employer Payroll Tax Withholding for Your Massachusetts LLC `,
    size: 4,
    marginBottom: 16,
  },
  {
  ...
  {
    type: `header`,
    content: `Employer Federal and State Tax Withholding for Your Massachusetts LLC`,
    size: 4,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `You may also choose to withhold federal and Massachusetts state income tax on the wages you pay to employees. Speak to your accountant for more information.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Regardless of whether you withhold federal and Massachusetts state income tax, your employees may need to file their own tax returns.`,
    marginBottom: 32,
  },
  {
    type: `header`,
    content: `Massachusetts LLC Employee Insurance and Other Requirements`,
    size: 4,
    marginBottom: 16,
  },
  {
  ...
  {
    type: `text`,
    content: `Get more requirements from <a href="https://www.mass.gov/orgs/department-of-labor-standards/" target="_blank" rel="noopener noreferrer">the Massachusetts Department of Labor Standards website.</a>`,
    marginBottom: 24,
  },
  {
    type: `header`,
    content: `Other Taxes and Duties for Your Massachusetts LLC`,
    size: 4,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `Depending on the industry you are in, your Massachusetts LLC may be liable for certain other taxes and duties. For example, if you sell gasoline you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods, you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
    marginBottom: 32,
  },
  {
    type: `header`,
    content: `Estimated Taxes for Your Massachusetts LLC`,
    size: 4,
    marginBottom: 16,
  },
  {
