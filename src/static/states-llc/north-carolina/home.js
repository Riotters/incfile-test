...
export const howToGuide = [
        ...
        items: [
          ...
          },
          {
            ...
            answer: `<p> Once you've gathered all the information for your North Carolina LLC, you’ll need to file a formal document with the NC Secretary of State. This document is known as your “Articles of Organization,” and filing the document creates your North Carolina LLC. Here’s what is typically included:</p></br>
                     ...
                     <a href="/form-order-now.php?entityType=LLC&entityState=NC/"> Form your LLC now </a>`,
          },
        ],
      },
      marginBottom: 48,
    ...
    },
    {
      ...
      content: {
        ...
        list: [`<a href="https://www.sosnc.gov/divisions/business_registration" target="_blank" rel="noopener noreferrer">North Carolina Secretary of State for forming and running your NC LLC</a>`,
    ...
    },
    {
      type: `arrow-link`,
      content: {
        text: `Naming Your North Carolina LLC`,
        url: `/north-carolina-llc/how-to-name-your-llc/`,
      },
      marginBottom: 16,
    },
    {
    ...
    },
    {
      type: `arrow-link`,
      content: {
        text: `North Carolina Registered Agents`,
        url: `/north-carolina-llc/registered-agents-north-carolina-llc/`,
      },
      marginBottom: 16,
    },
    {
    ...
    },
    {
      type: `arrow-link`,
      content: {
        text: `Fees and Requirements for North Carolina LLCs`,
        url: `/north-carolina-llc/form-filling-permit-requirements/`,
      },
      marginBottom: 16,
    },
    {
    ...
    },
    {
      type: `arrow-link`,
      content: {
        text: `Federal, State, Sales and Other Taxes for Your North Carolina LLC`,
        url: `/north-carolina-llc/business-taxes/`,
      },
      marginBottom: 16,
    },
    {
  ...
  export const namingYourBusiness = [
    ...
    },
    {
      ...
      content: {
        header: ``,
        list: [`Are very similar to the name of a federal or NC agency or organization (e.g., FBI, FDA, North Carolina Department of Revenue, North Carolina Police, Treasury, etc.)`,
  ...
  export const registeredAgent = [
    ...
    },
    {
      ...
      content: {
        ...
        list: [`An individual who resides in North Carolina and whose business address is identical to the registered office;`,
    ...
    },
    {
      ...
      content: {
        header: ``,
        list: [`If the Registered Agent is a person, they must reside in North Carolina.`,
    ...
    },
    {
      ...
      content: {
        header: ``,
        list: [`Correspondence from the North Carolina Secretary of State`,
    ...
    }, 
    {
      ...
      content: {
        header: ``,
        list: [`An always-available North Carolina Registered Agent who can receive correspondence, documents and legal proceedings on your LLC’s behalf`,
    ...
    },
    {
      ...
      content: {
        header: ``,
        list: [`The NC Registered Agent must have a physical street address in North Carolina. If you’re forming an LLC outside NC, you will need to use an in-state Registered Agent.`, 
    ...
    },
    {
      ...
      content: {
        ...
        list: [`<a href="/research-topics/registered-agent-help/what-is-the-main-function-of-the-registered-agent/">The Main Functions of a North Carolina Registered Agent</a>`,
               `<a href="/manage-your-company/change-of-registered-agent/">Changing Your North Carolina Registered Agent</a>`,
               `<a href-"/research-topics/registered-agent-help/what-does-a-registered-agent-do/">What a North Carolina Registered Agent Does</a>`],
      },
      marginBottom: 48,
      color: color.babyblue3,
    },
  ...
  export const feesAndRequirments = [
    ...
    {
      type: `text`,
      content: `<b>Due Date:</b> April 15th`,
      marginBottom: 16,
    },
    {
      type: `text`,
      content: `<b>Filing Fee:</b> $200`,
      marginBottom: 32,
    },
    {
      type: `text`,
    ...
    },
    {
      ...
      content: {
        ...
        list: [`The industry your North Carolina LLC operates in (e.g., restaurants will need health permits)`, 
    ...
    },
    {
      ...
      content: {
        header: ``,
        list: [`A complete report on all the licenses, permits and tax registrations your North Carolina LLC will need`,
    ...
    },
    {
      ...
      content: {
        ...
        list: [`Adding, removing or changing a North Carolina LLC member or manager`,
  ...
  export const businessTaxes = [
    ...
    {
      type: `text`,
      content: `You may also choose to withhold federal and North Carolina state income tax on the wages you pay to employees. Speak to your accountant for more information.`,
      marginBottom: 32,
    },
    {
      type: `header`,
    ...
    {
      type: `text`,
      content: `Regardless of whether you withhold federal and North Carolina state income tax, your employees may need to file their own tax returns.`,
      marginBottom: 32,
    },
    {
      type: `header`,
      content: `North Carolina LLC Employee Insurance and Other Requirements`,
      size: 4,
      marginBottom: 16,
    },
    {
    ...
    {
      type: `text`,
      content: `Get more requirements from <a href="https://www.labor.nc.gov/" target="_blank" rel="noopener noreferrer"> the North Carolina Department of Labor website.</a>`,
      marginBottom: 24,
    },
    {
      type: `header`,
    ...
    {
      type: `text`,
      content: `Depending on the industry you are in, your North Carolina LLC may be liable for certain other taxes and duties. For example, if you sell gasoline you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
      marginBottom: 32,
    },
    {
      type: `header`,
