...
export const howToGuide = [
  ...
  {
    type: `text`,
    content: `These are all the basic steps for forming an LLC in Rhode Island. You’ll find other useful information below.`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
    content: {
      list: [
        ...
        `<a href="https://dlt.ri.gov/employer.htm" target="_blank" rel="noopener noreferrer">Rhode Island Department of Labor and Training for employers and hiring</a>`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/rhode-island-llc/how-to-name-your-llc/">Naming Your Rhode Island LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/rhode-island-llc/registered-agents-rhode-island-llc/">Rhode Island Registered Agents</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/rhode-island-llc/form-filling-permit-requirements/">Fees and Requirements for Rhode Island LLCs</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/rhode-island-llc/business-taxes/">Federal, State, Sales and Other Taxes for Your Rhode Island LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
...
export const namingYourBusiness = [
  ...
  {
    type: `text`,
    content: `<a href="http://business.sos.ri.gov/CorpWeb/CorpSearch/CorpSearch.aspx/" target="_blank" rel="noopener noreferrer">Rhode Island Secretary of State business name search tool.</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
...
export const registeredAgent = [
  ...
  {
    type: `text`,
    content: `When you incorporate through us, we complete and file your Articles of Organization based on the information you’ve provided. Additionally, we give you a free Rhode Island Registered Agent service for the first year, and we’ll include details of your Registered Agent in the form that we file.`,
    marginBottom: 24,
  },
  {
    type: `button`,
    ...
    content: {
      items: [
        ...
        },
        {
          ...
          answer: `Yes, but we don’t recommend it for the reasons listed above. If you still want to be your own Registered Agent, you need to fill in the correct forms and pay a fee to the Rhode Island Secretary of State.`,
        },
        {
...
export const feesAndRequirments = [
  ...
  {
    type: `text`,
    content: `Our Business License Research Package tells you about all of the licenses and permits you will need for your Rhode Island LLC. It includes:`,
    marginBottom: 32,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `Areas you might want to file Rhode Island Articles of Amendment for include:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
...
export const businessTaxes = [
  ...
  {
    type: `text`,
    content: `You will typically need to collect Rhode Island sales tax on:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
      ...
      items: [
        ...
        },
        {
          ...
          answer2: [
            ...
            {
              type: `paragraph`,
              content: `<a href="https://dlt.ri.gov/" target="_blank" rel="noopener noreferrer">Get more requirements from the Rhode Island Department of Labor and Regulation website.</a>`,
            },
          ],
        },
        {
