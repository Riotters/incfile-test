...
export const feesAndRequirments = [
  ...
  {
    type: `text`,
    content: `<b>Due Date:</b> September 1st`,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `<b>Filing Fee:</b> $53`,
    marginBottom: 32,
  },
  {
    type: `text`,
...
export const businessTaxes = [
  ...
  {
    type: `header`,
    content: `Rhode Island LLC Employee Insurance and Other Requirements`,
    size: 4,
    marginBottom: 16,
  },
  {
  ...
  {
    type: `text`,
    content: `Get more requirements from <a href="https://dlt.ri.gov/" target="_blank" rel="noopener noreferrer"> the Rhode Island Department of Labor and Regulation website.</a>`,
    marginBottom: 24,
  },
  {
    type: `header`,
