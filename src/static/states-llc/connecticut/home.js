...
export const businessTaxes = [
  ...
  {
    type: `header`,
    content: `Employer Payroll Tax Withholding for Your Connecticut LLC `,
    size: 4,
    marginBottom: 16,
  },
  {
  ...
  {
    type: `header`,
    content: `Employer Federal and State Tax Withholding for Your Connecticut LLC`,
    size: 4,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `You may also choose to withhold federal and Connecticut state income tax on the wages you pay to employees. Speak to your accountant for more information.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Regardless of whether you withhold federal and Connecticut state income tax, your employees may need to file their own tax returns.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Depending on the industry you are in, your Connecticut LLC may be liable for certain other taxes and duties. For example, if you sell gasoline you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods, you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
    marginBottom: 32,
  },
  {
    type: `header`,
