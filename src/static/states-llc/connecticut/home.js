...
export const howToGuide = [
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/connecticut-llc/how-to-name-your-llc/">Naming Your Connecticut LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/connecticut-llc/registered-agents-connecticut-llc/">Connecticut Registered Agents for Your LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/connecticut-llc/form-filling-permit-requirements/">Fees and Requirements for Connecticut LLCs</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/connecticut-llc/business-taxes/">Federal, State, Sales and Other Taxes for Your Connecticut LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
...
export const namingYourBusiness = [
  ...
  {
    type: `text`,
    content: `<a href="https://www.concord-sots.ct.gov/CONCORD/online?sn=PublicInquiry&eid=9740" target="_blank" rel="noopener noreferrer">Connecticut Secretary of State business name search tool.</a>`,
    marginBottom: 40,
  },
  {
    type: `header`,
    ...
    content: {
      list: [
        `If you don’t want to form your Connecticut LLC right now, you can reserve the business name with the Connecticut Secretary of State. You will need to complete an “Application for reservation of name” form and file it with the CT SOS. You do not need to reserve a name if you are forming your business right away.
              <a href="https://portal.ct.gov/en/404error/" target="_blank" rel="noopener noreferrer">Connecticut SOS LLC name reservation form.</a>`,
      ...
      items: [
        ...
        },
        {
          ...
          answer2: [
            ...
            {
              type: `paragraph`,
              content: `<a href="https://www.ctdol.state.ct.us/" target="_blank" rel="noopener noreferrer">Get more requirements from the Connecticut Department of Labor website.</a>`,
            },
          ],
        },
        {
