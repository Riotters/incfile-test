...
export const feesAndRequirments = [
  ...
  },
  {
    ...
    content: {
      ...
      list: [`Frequency:  Annually`, `Due Date:  Due by the last day of the anniversary month of filing.`, `Filing Fee:  $15`],
    },
    marginBottom: 16,
    color: color.blue2,
  },
...
export const businessTaxes = [
  ...
  },
  {
    ...
    content: {
      ...
      list: [`Federal income tax`, `Federal self-employment tax`, `Utah state tax`],
    },
    marginBottom: 16,
    color: color.green3,
  },
