...
export const howToGuide = [
  ...
  {
    type: `text`,
    content: `Briefly, the benefits of starting a Utah LLC include:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `The Division of Corporations has plenty of other information on forming and running a business in Utah. You’ll find other useful information below:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
      ...
      items: [
        ...
        },
        {
          ...
          answer: `<p>If your business is already operating in another state and expanding to Utah, you’ll need to form a foreign LLC.</p></br>
            <a href="/utah-llc/form-filling-permit-requirements/">More information on Utah filing and licensing requirements here.</a>`,
        },
      ],
    },
    marginBottom: 48,
...
export const namingYourBusiness = [
  ...
  {
    type: `text`,
    content: `It’s not enough for your UT LLC name to be unique. It also cannot be similar to the name of a corporation or LLC in Utah. For example, you cannot use the following factors to say your name is different from the name of another business:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
...
export const registeredAgent = [
  ...
  {
    type: `text`,
    content: `There are certain rules that you must follow when you’re appointing a Utah Registered Agent service for your business. They are:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `Your Utah Registered Agent carries out several valuable services for your business. They accept official communications and documents from the UT Division of Corporations on your behalf. This may include:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `What happens if you choose not to assign or provide details of a Registered Agent to the Utah Division of Corporations? There are several possible ramifications, including:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `If you have an address in Utah, you can choose to be the Registered Agent for your LLC. We don’t recommend this approach as there can be some drawbacks:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  },
  {
    ...
    content: {
      list: [
        `<a href="/research-topics/registered-agent-help/what-is-the-main-function-of-the-registered-agent/" target="_blank">The Main Functions of a Utah Registered Agent</a>`,
        `<a href="/manage-your-company/change-of-registered-agent/" target="_blank" >Changing Your Utah Registered Agent</a>`,
        `<a href="/research-topics/registered-agent-help/what-does-a-registered-agent-do/" target="_blank" >What a Utah Registered Agent Does</a>`,
      ],
    },
    marginBottom: 0,
    color: color.blue3,
...
export const feesAndRequirments = [
  ...
  {
    type: `text`,
    content: `Some Utah LLCs will need certain business licenses and permits from federal, state and regional organizations. These permits and licenses will have associated fees that you should pay on a one-off or regular basis. Permits and licenses vary based on:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `Our Business License Research Package tells you about all of the licenses and permits you will need for your Utah LLC. It includes:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
    content: {
      list: [
        `A complete report on all the licenses, permits and tax registrations your Utah LLC will need`,
        `The application forms you will need to file with the Utah, regional and federal licensing authorities`,
      ],
    },
    marginBottom: 16,
    color: color.green3,
  ...
  },
  {
    ...
    content: {
      list: [
        `Adding, removing or changing a Utah LLC member or manager`,
        `Changing the business address of your LLC`,
        `Altering the stated business activities of your Utah LLC`,
      ],
    },
    marginBottom: 16,
    color: color.orange3,
...
export const businessTaxes = [
  ...
  {
    type: `text`,
    content: `If you sell physical products or certain types of services, you may need to collect sales tax (also known as sales and use tax) and then pay it to the UT Commission of Revenue. Utah sales tax is collected at the point of purchase. Sales tax rates do vary depending on the region, county or city where you are located. You will typically need to collect Utah sales tax on:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
