...
export const howToGuide = [
  ...
  {
    type: `text`,
    content: `Briefly, the benefits of starting an Alabama LLC include:`,
    marginBottom: 32,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `The AL Secretary of State has plenty of information on forming and running a business in Alabama. <br> These are all the basic steps for forming an LLC in Alabama. You’ll find other useful information below.`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
...
export const namingYourBusiness = [
  ...
  {
    type: `text`,
    content: `Once you’ve searched for your Alabama business name, checked availability, followed the naming rules and decided whether you need a fictitious name, you can register your AL LLC name. There are a couple of ways to do this.`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
...
export const feesAndRequirments = [
  ...
  },
  {
    ...
    content: {
      list: [
        `Adding, removing or changing a Alabama LLC member or manager`,
...
export const businessTaxes = [
  ...
  },
  {
    ...
    content: {
      list: [
        ...
        `Certain services that your Alabama business might provide`,
      ],
    },
    marginBottom: 16,
    color: color.blue3,
  ...
  },
  {
    ...
    content: {
      items: [
        {
          question: `Employer Payroll Tax Withholding for Your Alabama LLC`,
        ...
        {
          question: `Employer Federal and State Tax Withholding for Your Alabama LLC`,
        ...
        {
          question: `Alabama LLC Employee Insurance and Other Requirements`,
          answer2: [
            {
              type: `paragraph`,
        ...
        {
          question: `Other Taxes and Duties for Your Alabama LLC`,
          answer: `Depending on the industry you are in, your Alabama LLC may be liable for certain other taxes and duties. For example, if you sell gasoline you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
        },
        {
          question: `Estimated Taxes for Your Alabama LLC`,
          answer2: [
            {
              type: `paragraph`,
