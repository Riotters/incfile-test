...
export const howToGuide = [
  ...
  },
  {
    ...
    content: {
      items: [
        ...
        {
          question: `<b>STEP 2:</b> Search for and Choose a Unique Business Name for Your Washington  LLC`,
        ...
        {
          question: `<b>STEP 3:</b> Provide an Official Address for Your LLC`,
        ...
        {
          question: `<b>STEP 4:</b> Assign a Registered Agent for Your Washington LLC`,
        ...
        {
          question: `<b>STEP 6:</b> File Articles of Organization with the Washington Department of Consumer and Regulatory Affairs`,
  ...
  },
  {
    ...
    content: {
      ...
      list: [`<a href="https://www.sos.wa.gov/corps/limitedliabilitycompaniesllconlineandpaperregistrations.aspx" target="_blank" rel="noopener noreferrer">Washington Secretary of State for forming and running your LLC</a>`, 
...
export const namingYourBusiness = [
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`Are very similar to the name of a federal or DC agency or organization (e.g., FBI, FDA, Washington DC Office of Tax and Revenue, Washington DC Police, Treasury, etc.)`,
  ...
  content: {
    header: ``,
    list: [`If you don’t want to form your LLC right now, you can reserve the business name with the Washington Secretary of State. You will need to complete a Name Reservation form and file it with the WA SOS. You do not need to reserve a name if you are forming your business right away.</br>
...
export const registeredAgent = [
  ...
  },
  {
    type: `list-dot`,
    content: {
      header: `There are certain rules that you must follow when you’re appointing a Washington Registered Agent service for your business. They are:`,
      list: [`If the Registered Agent is a person, they must reside in Washington.`, 
  ...
  },
  {
    type: `list-dot`,
    content: {
      header: `What happens if you choose not to assign or provide details of a Registered Agent to the Washington Secretary of State? There are several possible ramifications, including:`,
...
color: color.yellow3,
  ...
  {
    type: `text`,
    cotent: `You might find these resources helpful:`,
    marginBottom: 0,
  },
  {
    type: `list-dot`,
    content: {
      header: ``,
      list: [`<a href="/research-topics/registered-agent-help/what-is-the-main-function-of-the-registered-agent/">The Main Functions of a Washington Registered Agent</a>`, 
...
export const feesAndRequirments  = [
  ...
  },
  {
    ...
    content: {
        ...
        rows: [
            [`$220`, `15 Business Days`, `5 Business days`]
        ],
    },
},
{
