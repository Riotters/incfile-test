...
export const howToGuide = [
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/washington-llc/how-to-name-your-llc/">Naming Your Washington LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/washington-llc/registered-agents-washington-llc/">Washington Registered Agents for LLCs</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/washington-llc/form-filling-permit-requirements/">Fees and Requirements for Washington LLCs</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/washington-llc/business-taxes/">Federal, State, Sales and Other Taxes for Your Washington LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
...
export const namingYourBusiness = [
  ...
  {
    type: `text`,
    content: `<a href="https://ccfs.sos.wa.gov/#/" target="_blank" rel="noopener noreferrer">Washington Secretary of State business entity search tool</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `<a href="https://app.leg.wa.gov/RCW/default.aspx?cite=23.95.305" target="_blank" rel="noopener noreferrer">More on Washington Secretary of State business naming rules.</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
...
export const registeredAgent = [
  ...
  {
    type: `header`,
    content: `FAQs About Washington Registered Agents`,
    size: 2,
    template: 3,
    style: { fontSize: `28px`, lineHeight: `36px` },
    marginBottom: 16,
  },
  {
    ...
    content: {
      items: [
        {
          question: `Do I Need to Appoint a Washington Registered Agent?`,
          answer: `Yes. All LLCs are required to have a Registered Agent. This is mandated by the Washington Secretary of State.`,
        },
        {
          question: `When Can I Assign a Washington Registered Agent Service?`,
          answer: `You can either do it when you incorporate your Washington business through paperwork filed with the Secretary of State or afterward by filing the correct form. If you form your business through Incfile, we will file all necessary forms on your behalf.`,
        },
        {
          question: `Can I Be My Own Registered Agent in Washington?`,
          answer: `Yes, but we don’t recommend it for the reasons listed above. If you still want to be your own Registered Agent, you need to fill in the correct forms and pay a fee to the Washington Secretary of State.`,
        },
        {
...
export const feesAndRequirments = [
  ...
  },
  {
    type: `button`,
    content: {
      text: `Get an EIN for Your Washington LLC Through Incfile`,
      ...
      items: [
        ...
        },
        {
          ...
          answer: `It depends on various factors including:
            ...
            <p>That’s why our <a href="/business-license-research-package/">Business License Research Package</a> is so useful. It explores all of these areas for you and provides a comprehensive overview of exactly what your Washington LLC needs to be compliant.</p>`,
        },
      ],
    },
    marginBottom: 48,
...
export const businessTaxes = [
  ...
  {
    type: `text`,
    content: `Get details on the <a href="https://dor.wa.gov/taxes-rates/sales-and-use-tax-rates" target="_blank" rel="noopener noreferrer">Washington sales tax here</a>.`,
    marginBottom: 48,
  },
  {
    type: `header`,
    content: `Federal Taxes for Your Washington LLC`,
    size: 2,
    template: 3,
    style: { fontSize: `28px`, lineHeight: `36px` },
    marginBottom: 24,
  ...
  {
    type: `text`,
    content: `There are a couple of different federal taxes that every LLC will need to pay, including Washington LLCs. These are self-employment tax and federal income tax, which are taxed as “pass-through” income via your tax return forms.`,
    marginBottom: 16,
  },
  {
    type: `header`,
      ...
      items: [
        ...
        },
        {
          ...
          answer2: [
            ...
            {
              type: `text`,
              content: `<a href="https://www.lni.wa.gov/" target="_blank" rel="noopener noreferrer">Get more requirements from the Washington Department of Labor & Industries website.</a>`,
            },
          ],
        },
        {
