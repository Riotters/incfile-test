...
export const filingFeeAndRequirementContent = {
  ...
  content: [
    ...
    },
    {
      ...
      content: [`A complete report on all the licenses, permits and tax registrations your California LLC will need`, `The application forms you will need to file with the California, regional and federal licensing authorities`],
    },
    {
      type: `button`,
      theme: `primary56`,
    ...
    },
    {
      ...
      content: {
        ...
        list: [`Adding, removing or changing a California LLC member or manager`, `Changing the business address of your LLC`, `Altering the stated business activities of your California LLC`, `Changing the management structure of your LLC`, `Changing the name of your LLC`],
      },
    },
    {
      type: `button`,
