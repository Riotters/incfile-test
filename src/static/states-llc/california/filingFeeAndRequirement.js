...
export const filingFeeAndRequirementContent = {
  ...
  content: [
    ...
    {
      type: `paragraph`,
      content: `Your California LLC may need certain licenses and permits to comply with specific requirements. These business permits and licenses might be issued by California, regional or federal organizations. Some of the associated fees only need to be paid once, while others have ongoing charges. Permits and licenses vary based on:`,
    },
    {
    ...
    {
      type: `paragraph`,
      content: `Your business formation documents state certain facts about your California business when it was originally formed. Over time, these facts might change — if they do, you need to file a “Certificate of Amendment” with the California Secretary of State. You can do this yourself or have Incfile complete the filing on your behalf. Areas you might want to file a California Certificate of Amendment for include:`,
    },
    {
      type: `iconListColorBox`,
      styles: { marginBottom: `55px` },
