export const HomePageContent = {
  ...
  content: {
    whyChoose: {
      ...
      lists: [`Separating and limiting your personal liability from your business liability and debts`, `Quick and simple filing, management, compliance, regulations and administration of your California LLC`, `Easy tax filing and potential advantages for tax treatment`],
    ...
    mainSteps: {
      ...
      step4: {
        ...
        lists: {
          ...
          list: [`Your business name and address`, `Details of your Agent for Service of Process`, `Management structure`, `Name of the incorporator`],
        },
        dowload_205_button: {
