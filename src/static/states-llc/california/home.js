export const HomePageContent = {
    ...
    content: {
        whyChoose: {
            ...
            text1: "California is a center of technology, entertainment, innovation and businesses that is changing the world. Some of the biggest brand names have started their business in California — from Dollar Shave Club and Snapchat to the big tech giants Facebook, Apple and Google. California is at the forefront of technology, and it’s brimming with top employee talent and beautiful locations to live.",
            ...
            heading4: `Briefly, the benefits of starting a California LLC include:`,
            lists: [
        ...
        mainSteps: {
            ...
            step4: {
                ...
                text1: `Once you've gathered all the information for your California LLC, you’ll need to file a formal document (Form LLC-1) with the CA Secretary of State. This document is known as your “Articles of Organization,” and filing the document creates your California LLC.`,
                lists: {
                ...
                annualReport: [{
                    ...
                    },
                    {
                        ...
                        items: [{
                            ...
                            {
                                text1: `Due Date:`,
                                text2: `During six-month period ending on last day of anniversary month of incorporation or qualification.`,
                            },
                            {
                                text1: `Filing Fee:`,
                                text2: `$20`,
