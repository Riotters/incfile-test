...
export const namingYourBusiness = [
  ...
  {
    type: `text`,
    content: `It’s not enough for your WY LLC name to be unique. It also cannot be similar to the name of a corporation or LLC in Wyoming.`,
    marginBottom: 0,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `The perfect business name can be elusive. `,
    marginBottom: 0,
  },
  {
    type: `list-dot`,
    content: {
      header: `We have a complete guide to choosing the right business name, but basically, you'll want to choose a name that will:`,
...
export const registeredAgent = [
  ...
  {
    type: `text`,
    content: `Your Wyoming Statutory/Registered Agent carries out several valuable services for your business. They accept official communications and documents from the AZ Corporation Commission on your behalf. This may include:`,
    marginBottom: 20,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `Incfile is authorized to conduct business in Wyoming and can legally act as your Registered Agent. Here’s what the Infile Wyoming Registered Agent service provides for your AZ LLC:`,
    marginBottom: 20,
  },
  {
    type: `list-dot`,
...
export const feesAndRequirments = [
  ...
  {
    type: `header`,
    content: `Wyoming Affidavit of Publication`,
    size: 3,
    marginBottom: 20,
  },
  {
    type: `text`,
    content: `Many states require that you file an annual (or other periodic) LLC report; however, Wyoming does not. Instead, Wyoming requires that you publish a notice of filing of your Articles of Organization — or alternatively, you may publish the Articles of Organization in their entirety. The publication must be in a newspaper in general circulation in the county of the known place of business in Wyoming for three consecutive publications. The publication must be filed within 60 days of the date of organization. The LLC may be subject to administrative dissolution if it fails to publish.`,
    marginBottom: 20,
  },
  {
    type: `text`,
  ...
  {
    type: `text`,
    content: `Your Wyoming LLC may need certain licenses and permits to comply with specific requirements. These business permits and licenses might be issued by Wyoming, regional or federal organizations. Some of the associated fees only need to be paid once, while others have ongoing charges.`,
    marginBottom: 20,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `Your business formation documents state certain facts about your Wyoming business when it was originally formed. Over time, these facts might change — if they do, you need to file “Articles of Amendment” with the Wyoming Corporation Commission. You can do this yourself or have Incfile complete the filing on your behalf.`,
    marginBottom: 0,
  },
  {
    type: `list-dot`,
    ...
    content: {
      items: [
        ...
        },
        {
          ...
          answer: `No. Most states require you to file a report for your LLC every year, but Wyoming has no annual reporting requirements. `,
        },
        {
...
export const businessTaxes = [
  ...
  {
    type: `text`,
    content: `Get details on the Wyoming Transaction Privilege Tax online here.`,
    marginBottom: 40,
  },
  {
    type: `header`,
