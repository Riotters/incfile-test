...
export const howToGuide = [
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/michigan-llc/how-to-name-your-llc/">Naming Your Michigan LLC</a>`,
    marginBottom: 16,
  },
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/michigan-llc/registered-agents-michigan-llc/">Michigan Registered Agents for Your LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/michigan-llc/form-filling-permit-requirements/">Fees and Requirements for Your Michigan LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/michigan-llc/business-taxes/">Federal, State, Sales and Other Taxes for Your Michigan LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  {
    type: `header`,
    content: `More Information From the Michigan Department of Licensing and Regulatory Affairs`,
    size: 2,
    template: 3,
    style: { fontSize: `28px`, lineHeight: `36px` },
    marginBottom: 24,
...
export const namingYourBusiness = [
  ...
  {
    type: `text`,
    content: `<a href="https://www.michigan.gov/corpentitysearch" target="_blank" rel="noopener noreferrer">Michigan Department of Licensing and Regulatory Affairs business name search tool.</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `<a href="https://www.michigan.gov/lara/0,4601,7-154-89334_61343_35413_35429-120095--,00.html" target="_blank" rel="noopener noreferrer">More on Michigan Department of Licensing and Regulatory Affairs business naming rules</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
...
export const registeredAgent = [
  ...
  {
    type: `text`,
    content: `Here’s some important information from the Michigan Department of Licensing and Regulatory Affairs on MI Resident Agent services:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `Here’s what you need to know about Incfile’s MI Registered Agent service:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  },
  {
    ...
    content: {
      list: [
        ...
        `<a href="/research-topics/registered-agent/registered-agent-tasks/" target="_blank" >What a Michigan Registered Agent Does</a>`,
      ],
    },
    marginBottom: 0,
    color: color.blue3,
...
export const feesAndRequirments = [
  ...
  {
    type: `text`,
    content: `Areas you might want to file Michigan Articles of Amendment for include:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
...
export const businessTaxes = [
  ...
  {
    type: `text`,
    content: `<a href="https://www.michigan.gov/taxes/" target="_blank">Get details on the Michigan state tax here.</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `You will typically need to collect Michigan sales tax on:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `<a href="https://www.michigan.gov/taxes/0,4676,7-238-43519_43529---,00.html" target="_blank" rel="noopener noreferrer">Get details on the Michigan sales tax here.</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
    ...
    content: {
      items: [
        ...
        },
        {
          ...
          answer: `You may also choose to withhold federal and Michigan state income tax on the wages you pay to employees. Speak to your accountant for more information.`,
        },
        {
          question: `Employees May Need to File Tax Returns`,
          answer: `Regardless of whether you withhold federal and Michigan state income tax, your employees may need to file their own tax returns.`,
        },
        {
          question: `Michigan LLC Employee Insurance and Other Requirements`,
          answer2: [
            {
              type: `paragraph`,
            ...
            {
              type: `paragraph`,
              content: `<a href="https://www.michigan.gov/lara/0,4601,7-154-89334_17485---,00.html" target="_blank" rel="noopener noreferrer">Get more requirements from the Michigan Bureau of Employment Relations website.</a>`,
              marginBottom: 48,
            },
          ],
        },
        {
          question: `Other Taxes and Duties for Your Michigan LLC`,
          answer: `Depending on the industry you are in, your Michigan LLC may be liable for certain other taxes and duties. For example, if you sell gasoline, you may need to pay a tax on any fuel you sell. If you import or export goods, you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
        },
        {
          question: `Estimated Taxes for Your Michigan LLC`,
          answer2: [
            {
              type: `paragraph`,
