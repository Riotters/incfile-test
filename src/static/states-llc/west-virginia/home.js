...
export const registeredAgent = [
  ...
  {
    header: ``,
    list: [`If the Registered Agent is a person, they must reside in West Virginia`,
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`Correspondence from the West Virginia Secretary of State, like a notice to file reports and other forms`,
  ...
  }, 
  {
    ...
    content: {
      header: ``,
      list: [`An always-available West Virginia Registered Agent who can receive correspondence, documents and legal proceedings on your LLC’s behalf`,
  ...
  },
  {
    ...
    content: {
      ...
      url: `/form-order-now.php?entityType=LLC&entityState=WV/`,
    },
    theme: `primary48`,
    marginBottom: 32,
  },
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`The Registered Agent must have a physical street address in West Virginia. If you’re forming an LLC outside WV, you will need to use an in-state Registered Agent. You always need to have someone on hand during business hours at the West Virginia address to sign for important documents.`, 
...
export const feesAndRequirments = [
  ...
  },
  {
    ...
    content: {
      ...
      rows: [[`$125`, `5 weeks`, `15 Business Days`]],
    },
  },
  {
    type: `arrow-link`,
  ...
  {
    type: `text`,
    content: `<b>Due Date:</b> June 30th`,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `<b>Filing Fee:</b> $52`,
    marginBottom: 32,
  },
  {
    type: `text`,
  ...
  },
  {
    ...
    content: {
      ...
      list: [`The industry your West Virginia LLC operates in (e.g., restaurants will need health permits)`, 
  ...
  },
  {
    ...
    content: {
      ...
      list: [`Adding, removing or changing a West Virginia LLC member or manager`,
...
export const businessTaxes = [
  ...
  {
    type: `text`,
    content: `Get more requirements from <a href="https://labor.wv.gov/Pages/default.aspx" target="_blank" rel="noopener noreferrer"> Get more requirements from the West Virginia Division of Labor website.</a>`,
    marginBottom: 24,
  },
  {
    type: `header`,
    content: `Other Taxes and Duties for Your West Virgina LLC`,
    size: 4,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `Depending on the industry you are in, your West Virginia LLC may be liable for certain other taxes and duties. For example, if you sell gasoline you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
    marginBottom: 32,
  },
  {
    type: `header`,
    content: `Estimated Taxes for Your West Virginia LLC`,
    size: 4,
    marginBottom: 16,
  },
  {
