...
export const namingYourBusiness = [
  ...
  {
    type: `header`,
    content: `Register an LLC Business Name in Wisconsin`,
    size: 3,
    marginBottom: 20,
  },
  {
    type: `text`,
    content: `Once you’ve searched for your Wisconsin business name, checked availability, followed the naming rules and decided whether you need a fictitious name, you can register your WI LLC name. There are a couple of ways to do this.`,
    marginBottom: 20,
  },
  {
    type: `numeric-list`,
    content: [
      {
        text: `<p>If you don’t want to form your Wisconsin LLC right now, you can reserve the business name with the Wisconsin Corporation Commission online. You will need to complete an application and file it with the WI CC. You do not need to reserve a name if you are forming your business right away.</p></br>
               <a href="https://azcc.gov/corporations/name-reservations" target="_blank" rel="noopener noreferrer">Wisconsin CC LLC name reservation form</a>`,
      },
      {
        text: `If you’re ready to start your Wisconsin LLC, you can formally file your Articles of Organization with the Wisconsin CC, or <a href="/form-order-now.php?entityType=LLC&entityState=WI/"> let Incfile take care of it for you.</a>`,
      },
    ],
    marginBottom: 30,
  },
      ...
      items: [
        {
          ...
          answer: `Just go to the <a href="https://ecorp.azcc.gov/EntitySearch/Index" target="_blank" rel="noopener noreferrer">Wisconsin business search tool</a> and enter your proposed business name. You can search the register of the Wisconsin Corporation Commission, which will tell you if there are any WI corporations or LLCs with that name.`,
        },
        {
        ...
        },
        {
          ...
          answer: `Yes. The Wisconsin Corporation Commission allows you to reserve a name if you don’t want to start your business immediately. Details are above. If you are ready to start your business now, you do not need to reserve a name.`,
        },
      ],
    },
    marginBottom: 30,
...
export const registeredAgent = [
  {
    type: `header`,
    content: `Wisconsin Statutory Agents & Your LLC`,
    size: 2,
    marginBottom: 20,
  },
  {
    type: `text`,
    content: `The Wisconsin Corporation Commission requires every WI LLC to have a Statutory Agent, or as it’s referred to in other states, a Registered Agent. We’ll use those names interchangeably in this guide, since their functions and requirements are identical. `,
    marginBottom: 20,
  },
  {
    type: `text`,
    content: `Once you have assigned an Wisconsin Statutory Agent, they can receive official correspondence and documents on behalf of your WI business. Statutory Agents can be individuals or other specialized Statutory/Registered Agent service organizations. `,
    marginBottom: 20,
  },
  {
    type: `text`,
    content: `Your LLC must have an Wisconsin Statutory Agent at all times. You can appoint a one when you first start your business, and you can also replace your existing WI Statutory Agent at a later date, provided there is a smooth transition between the old and new Statutory Agent service. `,
    marginBottom: 30,
  },
  {
    type: `header`,
    content: `Wisconsin LLC Statutory Agent Service Rules`,
    size: 3,
    marginBottom: 20,
  },
  {
    type: `text`,
    content: `There are certain rules that you must follow when you’re appointing an Wisconsin Statutory Agent service for your business. They are:`,
    marginBottom: 20,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `Note that the WI Statutory Agent address does not need to be the same as your Wisconsin LLC business address. `,
    marginBottom: 30,
  },
  {
    type: `header`,
    content: `The Purpose of an Wisconsin Statutory Agent`,
    size: 3,
    marginBottom: 20,
  },
  {
    type: `text`,
    content: `Your Wisconsin Statutory/Registered Agent carries out several valuable services for your business. They accept official communications and documents from the WI Corporation Commission on your behalf. This may include:`,
    marginBottom: 20,
  },
  {
    type: `list-dot`,
