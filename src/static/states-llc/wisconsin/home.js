...
export const howToGuide = [
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/wisconsin-llc/how-to-name-your-llc/">Naming Your Wisconsin LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/wisconsin-llc/registered-agents-wisconsin-llc/">Wisconsin Registered Agents for Your LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/wisconsin-llc/form-filling-permit-requirements/">Fees and Requirements for Your Wisconsin LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/wisconsin-llc/business-taxes/">Federal, State, Sales and Other Taxes for Your Wisconsin LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
...
export const namingYourBusiness = [
  ...
  {
    type: `text`,
    content: `<a href="https://www.wdfi.org/apps/CorpSearch/Search.aspx?" target="_blank" rel="noopener noreferrer">Wisconsin Department of Financial Institutions business name search tool</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `<a href="https://www.wdfi.org/corporations/faqs.htm#nameAvailability" target="_blank" rel="noopener noreferrer">Wisconsin Department of Financial Institutions business naming rules</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
  ...
  },
  {
    type: `button`,
    content: {
      text: `Incfile's Trade Name Services SERVICE`,
...
export const registeredAgent = [
  ...
  {
    type: `text`,
    content: `Here’s what the Incfile Wisconsin Registered Agent service provides for your WI LLC:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `header`,
    content: `Assign Your Wisconsin Registered Agent When You Form Your WI LLC`,
    size: 3,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `Your business needs to have a Wisconsin Registered Agent Service as soon as it’s formed. You can achieve this through one of the following methods.`,
    marginBottom: 32,
  },
  {
    type: `header`,
    content: `File Articles of Organization with the Wisconsin Department of Financial Institutions`,
    size: 4,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `You will need to include details of your Registered Agent in your Articles of Organization. This is the form that you file with the WI Department of Financial Institutions to formally create your business.`,
    marginBottom: 32,
  },
  {
    type: `header`,
    content: `Incorporate Through Incfile and Get a Free Wisconsin Registered Agent`,
    size: 4,
    marginBottom: 16,
  },
  {
    ...
    content: {
      items: [
        ...
        },
        {
          ...
          answer: `Yes. Most states, including Wisconsin, require you to file a report for your LLC every year. You can find out more on the <a href="/compliance-filing-requirement/> compilance page for your state</a>.`,
        },
        {
...
export const businessTaxes = [
  ...
  },
  {
    ...
    content: {
      items: [
        {
          question: `Employer Payroll Tax Withholding for Your Wisconsin LLC `,
        ...
        {
          question: `Employer Federal and State Tax Withholding for Your Wisconsin LLC`,
          answer: `You may also choose to withhold federal and Wisconsin state income tax on the wages you pay to employees. Speak to your accountant for more information.`,
        },
        {
          question: `Employees May Need to File Tax Returns`,
          answer: `Regardless of whether you withhold federal and Wisconsin state income tax, your employees may need to file their own tax returns.`,
        },
        {
          question: `Wisconsin LLC Employee Insurance and Other Requirements`,
          answer2: [
            {
              type: `paragraph`,
            ...
            {
              type: `text`,
              content: `<a href="https://dwd.wisconsin.gov/" target="_blank" rel="noopener noreferrer">Get more requirements from the Wisconsin Department of Workforce Development website.</a>`,
            },
          ],
        },
        {
          question: `Other Taxes and Duties for Your Wisconsin LLC`,
          answer: `Depending on the industry you are in, your Wisconsin LLC may be liable for certain other taxes and duties. For example, if you sell gasoline, you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods, you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
        },
        {
          question: `Estimated Taxes for Your Wisconsin LLC`,
          answer2: [
            {
              type: `paragraph`,
