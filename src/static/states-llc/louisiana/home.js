...
export const howToGuide = [
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/louisiana-llc/how-to-name-your-llc/">Naming Your Louisiana LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/louisiana-llc/registered-agents-louisiana-llc/">Louisiana Registered Agents for LLCs</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/louisiana-llc/form-filling-permit-requirements/">Fees and Requirements for Louisiana LLCs</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/louisiana-llc/business-taxes/">Federal, State, Sales and Other Taxes for Your Louisiana LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
...
export const namingYourBusiness = [
  ...
  {
    type: `text`,
    content: `<a href="https://coraweb.sos.la.gov/commercialsearch/commercialsearch.aspx" target="_blank" rel="noopener noreferrer">Louisiana Secretary of State business search tool</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
  ...
  },
  {
    ...
    content: {
      list: [
        ...
        `<a href="/research-topics/registered-agent/registered-agent-tasks/">What a Louisiana Registered Agent Does</a>`,
      ],
    },
    marginBottom: 48,
    color: color.babyblue3,
...
export const businessTaxes = [
  ...
  },
  {
    ...
    content: {
      items: [
        {
          question: `Louisiana LLC Employer Payroll Tax Withholding`,
        ...
        {
          question: `Employer Federal and State Tax Withholding for Your Louisiana LLC`,
          answer: `You may also choose to withhold federal and Louisiana state income tax on the wages you pay to employees. Speak to your accountant for more information.`,
        },
        {
          question: `Employees May Need to File Tax Returns`,
          answer: `Regardless of whether you withhold federal and Louisiana state income tax, your employees may need to file their own tax returns.`,
        },
        {
          question: `Louisiana LLC Employee Insurance and Other Requirements`,
          answer2: [
            {
              type: `paragraph`,
            ...
            {
              type: `text`,
              content: `<a href="http://www.laworks.net/" target="_blank" rel="noopener noreferrer">Get more requirements from the Louisiana Workforce Commission website.</a>`,
              marginBottom: 48,
            },
          ],
        },
        {
          question: `Other Taxes and Duties for Your Louisiana LLC`,
          answer: `Depending on the industry you are in, your Louisiana LLC may be liable for certain other taxes and duties. For example, if you sell gasoline, you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods, you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
        },
        {
          question: `Estimated Taxes for Your Louisiana LLC`,
          answer2: [
            {
              type: `paragraph`,
