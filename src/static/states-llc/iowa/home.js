...
export const howToGuide = [
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `Decide if an Iowa Series LLC is right for your new business.`,
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `Naming Your Iowa LLC`,
      url: `/iowa-llc/how-to-name-your-llc/`,
    },
    marginBottom: 16,
  },
  {
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `Iowa Registered Agents for Your LLC`,
      url: `/iowa-llc/registered-agents-iowa-llc/`,
    },
    marginBottom: 16,
  },
  {
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `Fees and Requirements for Your Iowa LLC`,
      url: `/iowa-llc/form-filling-permit-requirements/`,
    },
    marginBottom: 16,
  },
  {
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `Federal, State, Sales and Other Taxes for Your Iowa LLC`,
      url: `/iowa-llc/business-taxes/`,
    },
    marginBottom: 16,
  },
  {
...
export const namingYourBusiness = [
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `Iowa Secretary of State business name search tool.`,
...
export const businessTaxes = [
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `Get details on the Iowa state tax here.`,
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `Get details on the Iowa sales tax here.`,
      url: `https://tax.iowa.gov/efile-pay-sales-and-retailers-use-taxes`,
    },
    marginBottom: 48,
  },
  {
  ...
  {
    type: `text`,
    content: `You may also choose to withhold federal and Iowa state income tax on the wages you pay to employees. Speak to your accountant for more information.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Regardless of whether you withhold federal and Iowa state income tax, your employees may need to file their own tax returns.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Get more requirements from the <a href="https://www.iowadivisionoflabor.gov/" target="_blank" rel="noopener noreferrer">Iowa Division of Labor website.</a>`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Depending on the industry you are in, your Iowa LLC may be liable for certain other taxes and duties. For example, if you sell gasoline you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
    marginBottom: 32,
  },
  {
    type: `header`,
