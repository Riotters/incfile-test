...
export const howToGuide = [
      ...
      items: [
        ...
        },
        {
          ...
          answer: `<p> Once you've gathered all the information for your LLC, you’ll need to file a formal document with the SC Secretary of State. This document is known as your “Articles of Organization,” and filing the document creates your South Carolina LLC. Here’s what is typically included:</p></br>
                   ...
                   <a href="/form-order-now.php?entityType=LLC&entityState=SC/"> Form your LLC now </a>`,
        },
      ],
    },
    marginBottom: 48,
  ...
  },
  {
    ...
    content: {
      ...
      list: [`<a href="https://sos.sc.gov/online-filings/business-entities" target="_blank" rel="noopener noreferrer">South Carolina Secretary of State for forming and running your LLC</a>`,
...
export const namingYourBusiness = [
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`Are very similar to the name of a federal or South Carolina agency or organization (e.g., FBI, FDA, South Carolina Department of Revenue, South Carolina Police, Treasury, etc.)`,
...
export const registeredAgent = [
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`If the Registered Agent is a person, they must reside in South Carolina.`,
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`Correspondence from the Secretary of State, such as a notice to file reports and other forms`,
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`The Registered Agent must have a physical street address in South Carolina. If you’re forming an LLC outside of SC, you will need to use an in-state Registered Agent. You always need to have someone on hand during business hours at the South Carolina address to sign for important documents.`, 
  ...
  },
  {
    ...
    content: {
      ...
      list: [`<a href="/research-topics/registered-agent-help/what-is-the-main-function-of-the-registered-agent/">The Main Functions of a South Carolina Registered Agent</a>`,
...
export const feesAndRequirments = [
  ...
  },
  {
    ...
    content: {
      ...
      list: [`The industry your South Carolina LLC operates in (e.g., restaurants will need health permits)`, 
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`A complete report on all the licenses, permits and tax registrations your South Carolina LLC will need`,
  ...
  },
  {
    ...
    content: {
      ...
      list: [`Adding, removing or changing a South Carolina LLC member or manager`,
...
export const businessTaxes = [
  ...
  {
    type: `text`,
    content: `You may also choose to withhold federal and South Carolina state income tax on the wages you pay to employees. Speak to your accountant for more information.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Regardless of whether you withhold federal and South Carolina state income tax, your employees may need to file their own tax returns.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Get more requirements from <a href="https://dew.sc.gov/" target="_blank" rel="noopener noreferrer"> the South Carolina Department of Employment and Workforce website.</a>`,
    marginBottom: 24,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Depending on the industry you are in, your South Carolina LLC may be liable for certain other taxes and duties. For example, if you sell gasoline you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
    marginBottom: 32,
  },
  {
    type: `header`,
