...
export const howToGuide = [
  ...
  {
    type: `text`,
    content: `The Secretary of State has plenty of other information on forming and running a business in South Carolina. You’ll find other useful information below.`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/south-carolina-llc/how-to-name-your-llc/">Naming Your South Carolina LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/south-carolina-llc/registered-agents-south-carolina-llc/">South Carolina Registered Agents</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/south-carolina-llc/form-filling-permit-requirements/">Fees and Requirements for South Carolina LLCs</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/south-carolina-llc/business-taxes/">Federal, State, Sales and Other Taxes for Your South Carolina LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
...
export const namingYourBusiness = [
  ...
  {
    type: `text`,
    content: `<a href="https://businessfilings.sc.gov/BusinessFiling/Entity/Search/" target="_blank" rel="noopener noreferrer">South Carolina Secretary of State business entity search</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
  ...
  {
    type: `header`,
    content: `Fictitious/Assumed Names`,
    size: 2,
    template: 3,
    style: { fontSize: `28px`, lineHeight: `36px` },
    marginBottom: 32,
...
export const feesAndRequirments = [
  ...
  {
    type: `text`,
    content: `Some South Carolina LLCs will need certain business licenses and permits from federal, state and regional organizations. These permits and licenses will have associated fees that you should pay on a one-off or regular basis. Permits and licenses vary based on:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `Our Business License Research Package tells you about all of the licenses and permits you will need for your South Carolina LLC. It includes:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `Areas you might want to file South Carolina Articles of Amendment for include:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
...
export const businessTaxes = [
  ...
  {
    type: `text`,
    content: `You will typically need to collect South Carolina sales tax on:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
      ...
      items: [
        ...
        },
        {
          ...
          answer2: [
            ...
            {
              type: `paragraph`,
              content: `<a href="https://dew.sc.gov/" target="_blank" rel="noopener noreferrer">Get more requirements from the South Carolina Department of Employment and Workforce website.</a>`,
            },
          ],
        },
        {
