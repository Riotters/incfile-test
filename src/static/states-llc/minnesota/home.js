...
export const howToGuide = [
      ...
      items: [
        ...
        },
        {
          ...
          answer: `<p> Once you've gathered all the information for your Minnesota LLC, you’ll need to file a formal document with the MN Secretary of State. This document is known as your “Articles of Organization,” and filing the document creates your Minnesota LLC. Here’s what is typically included:</p></br>
                   ...
                   <a href="/form-order-now.php?entityType=LLC&entityState=MN/"> Form your LLC now </a>`,
        },
      ],
    },
    marginBottom: 48,
  ...
  },
  {
    type: `list-dot`,
    content: {
      header: `The MN Secretary of State has plenty of information on forming and running a business in Minnesota. These are all the basic steps for forming an LLC in Minnesota. You’ll find other useful information below.`,
      list: [`<a href="https://www.sos.state.mn.us/business-liens/business-help/" target="_blank" rel="noopener noreferrer">Minnesota Secretary of State for forming and running your MN LLC</a>`,
...
export const namingYourBusiness = [
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`Are very similar to the name of a federal or MN agency or organization (e.g., FBI, FDA, Minnesota Department of Revenue, Minnesota Police, Treasury, etc.)`,
...
export const registeredAgent = [
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`If the Registered Agent is a person, they must reside in Minnesota.`,
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`Correspondence from the Minnesota Secretary of State`,
  ...
  {
    type: `text`,
    content: `We are authorized to conduct business in Minnesota and can legally act as your Registered Agent.`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`The MN Registered Agent must have a physical street address in Minnesota. If you’re forming an LLC outside MN, you will need to use an in-state Registered Agent. `, 
  ...
  },
  {
    ...
    content: {
      ...
      list: [`<a href="/research-topics/registered-agent-help/what-is-the-main-function-of-the-registered-agent/">The Main Functions of a Minnesota Registered Agent</a>`,
...
export const feesAndRequirments = [
  ...
  {
    type: `text`,
    content: `<b>Due Date:</b> December 31st`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    ...
    content: {
      ...
      list: [`The industry your Minnesota LLC operates in (e.g., restaurants will need health permits)`, 
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`A complete report on all the licenses, permits and tax registrations your Minnesota LLC will need`,
  ...
  },
  {
    ...
    content: {
      ...
      list: [`Adding, removing or changing a Minnesota LLC member or manager`,
...
export const businessTaxes = [
  ...
  {
    type: `header`,
    content: `Employer Payroll Tax Withholding for Your Minnesota LLC`,
    size: 4,
    marginBottom: 16,
  },
  {
  ...
  {
    type: `header`,
    content: `Employer Federal and State Tax Withholding for Your Minnesota LLC`,
    size: 4,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `You may also choose to withhold federal and Minnesota state income tax on the wages you pay to employees. Speak to your accountant for more information.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Regardless of whether you withhold federal and Minnesota state income tax, your employees may need to file their own tax returns.`,
    marginBottom: 32,
  },
  {
    type: `header`,
    content: `Minnesota LLC Employee Insurance and Other Requirements`,
    size: 4,
    marginBottom: 16,
  },
  {
  ...
  {
    type: `text`,
    content: `Get more requirements from <a href="https://www.dli.mn.gov/" target="_blank" rel="noopener noreferrer"> the Minnesota Department of Labor and Industry website.</a>`,
    marginBottom: 24,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Depending on the industry you are in, your Minnesota LLC may be liable for certain other taxes and duties. For example, if you sell gasoline you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
    marginBottom: 32,
  },
  {
    type: `header`,
