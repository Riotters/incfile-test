...
export const howToGuide = [
  ...
  {
    type: `text`,
    content: `The MN Secretary of State has plenty of information on forming and running a business in Minnesota.`,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `These are all the basic steps for forming an LLC in Minnesota. You’ll find other useful information below.`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/minnesota-llc/how-to-name-your-llc/">Naming Your Minnesota LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/minnesota-llc/registered-agents-minnesota-llc/">Minnesota Registered Agents for Your LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/minnesota-llc/form-filling-permit-requirements/">Fees and Requirements for Your Minnesota LLCs</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/minnesota-llc/business-taxes/">Federal, State, Sales and Other Taxes for Your Minnesota LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
...
export const namingYourBusiness = [
  ...
  {
    type: `text`,
    content: `<a href="https://mblsportal.sos.state.mn.us/Business/Search" target="_blank" rel="noopener noreferrer">Minnesota Secretary of State business name search tool</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
...
export const feesAndRequirments = [
  ...
  {
    type: `text`,
    content: `Areas you might want to file Minnesota Articles of Amendment for include:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
...
export const businessTaxes = [
  ...
  {
    type: `text`,
    content: `You will typically need to collect Minnesota sales tax on:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
      ...
      items: [
        ...
        },
        {
          ...
          answer2: [
            ...
            {
              type: `paragraph`,
              content: `<a href="https://www.dli.mn.gov/" target="_blank" rel="noopener noreferrer">Get more requirements from the Minnesota Department of Labor and Industry website.</a>`,
              marginBottom: 48,
            },
          ],
        },
