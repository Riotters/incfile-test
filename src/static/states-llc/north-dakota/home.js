...
export const howToGuide = [
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/north-dakota-llc/registered-agents-north-dakota-llc/">North Dakota Registered Agents for Your LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/north-dakota-llc/form-filling-permit-requirements/">Fees and Requirements for Your North Dakota LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/north-dakota-llc/business-taxes/">Federal, State, Sales and Other Taxes forYour North Dakota LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
...
export const namingYourBusiness = [
  ...
  {
    type: `text`,
    content: `<a href="https://firststop.sos.nd.gov/search/business" target="_blank" rel="noopener noreferrer">North Dakota Secretary of State business name search tool.</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
...
export const registeredAgent = [
  ...
  {
    type: `text`,
    content: `<b>Commercial Registered Agent:</b>`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `<b>Noncommercial Registered Agent:</b>`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `Here’s what the Incfile North Dakota Registered Agent service provides for your LLC:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
...
export const feesAndRequirments = [
  ...
  {
    type: `text`,
    content: `Areas you might want to file North Dakota Articles of Amendment for include:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
...
export const businessTaxes = [
  ...
  {
    type: `text`,
    content: `<a href="https://www.nd.gov/tax/" target="_blank" rel="noopener noreferrer">Get details on the North Dakota state tax here.</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `You will typically need to collect North Dakota sales tax on:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `<a href="https://www.nd.gov/tax/user/businesses/formspublications/sales-use-tax" target="_blank" rel="noopener noreferrer">Get details on the North Dakota sales tax here.</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
      ...
      items: [
        ...
        },
        {
          ...
          answer2: [
            ...
            {
              type: `paragraph`,
              content: `<a href="https://www.nd.gov/labor/" target="_blank" rel="noopener noreferrer">Get more requirements from the North Dakota Department of Labor and Human Rights website.</a>`,
              marginBottom: 48,
            },
          ],
        },
