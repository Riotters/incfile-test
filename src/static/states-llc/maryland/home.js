...
export const howToGuide = [
        ...
        items: [
          ...
          },
          {
            ...
            answer: `<p> Once you've gathered all the information for your Maryland LLC, you’ll need to file a formal document with MD Business Express. This document is known as your “Articles of Organization,” and filing the document creates your Maryland LLC. Here’s what is typically included:</p></br>
                     ...
                     <a href="/form-order-now.php?entityType=LLC&entityState=MD/"> Form your LLC now </a>`,
          },
        ],
      },
      marginBottom: 48,
    ...
    },
    {
      ...
      content: {
        ...
        list: [`<a href="https://egov.maryland.gov/businessexpress" target="_blank" rel="noopener noreferrer">Maryland Business Express for forming and running your MD LLC</a>`,
  ...
  export const namingYourBusiness = [
    ...
    },
    {
      ...
      content: {
        header: ``,
        list: [`Are very similar to the name of a federal or MD agency or organization (e.g., FBI, FDA, Maryland Comptroller, Maryland Police, Treasury, etc.)`,
  ...
  export const registeredAgent = [
    ...
    },
    {
      ...
      content: {
        header: ``,
        list: [`If the Registered Agent is a person, they must reside in Maryland.`,
    ...
    },
    {
      ...
      content: {
        header: ``,
        list: [`Correspondence from Maryland Business Express, like a notice to file reports and other forms`,
    ...
    },
    {
      ...
      content: {
        header: ``,
        list: [`The MD Registered Agent must have a physical street address in Maryland. If you’re forming an LLC outside MD, you will need to use an in-state Registered Agent.`, 
    ...
    },
    {
      ...
      content: {
        ...
        list: [`<a href="/research-topics/registered-agent-help/what-is-the-main-function-of-the-registered-agent/">The Main Functions of a Maryland Registered Agent</a>`,
  ...
  export const feesAndRequirments = [
    ...
    },
    {
      ...
      content: {
        ...
        list: [`The industry your Maryland LLC operates in (e.g., restaurants will need health permits)`, 
    ...
    },
    {
      ...
      content: {
        header: ``,
        list: [`A complete report on all the licenses, permits and tax registrations your Maryland LLC will need`,
    ...
    },
    {
      ...
      content: {
        ...
        list: [`Adding, removing or changing a Maryland LLC member or manager`,
  ...
  export const businessTaxes = [
    ...
    },
    {
      ...
      content: {
        ...
        list: [`On profits of $70,000, you would pay self-employment tax of $10,710.`,
