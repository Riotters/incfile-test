...
export const howToGuide = [
	...
	{
		type: `text`,
		content: `The MD Business Express website has plenty of information on forming and running a business in Maryland. These are all the basic steps for forming an LLC in Maryland. You’ll find other useful information below.`,
		marginBottom: 24,
	},
	{
		type: `list-dot`,
...
export const feesAndRequirments = [
	...
	{
		type: `text`,
		content: `Some MD LLCs will need certain business licenses and permits from federal, state and regional organizations. These permits and licenses will have associated fees that you should pay on a one-off or regular basis. Permits and licenses vary based on:`,
		marginBottom: 24,
	},
	{
		type: `list-dot`,
	...
	{
		type: `text`,
		content: `Your business formation documents state certain facts about your Maryland business when it was originally formed. Over time, these facts might change — if they do, you need to file “Articles of Amendment” with Maryland Business Express. You can do this yourself or have Incfile complete the filing on your behalf. Areas you might want to file Maryland Articles of Amendment for include:`,
		marginBottom: 24,
	},
	{
		type: `list-dot`,
