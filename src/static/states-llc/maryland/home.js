...
export const howToGuide = [
  ...
  {
    type: `text`,
    content: `The MD Business Express website has plenty of information on forming and running a business in Maryland.`,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `These are all the basic steps for forming an LLC in Maryland. You’ll find other useful information below.`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/maryland-llc/how-to-name-your-llc/">Naming Your Maryland LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/maryland-llc/registered-agents-maryland-llc/">Maryland Resident Agents for Your LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/maryland-llc/form-filling-permit-requirements/">Fees and Requirements for Your Maryland LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/maryland-llc/business-taxes/">Federal, State, Sales and Other Taxes for Your Maryland LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
...
export const namingYourBusiness = [
  ...
  {
    type: `text`,
    content: `<a href="https://egov.maryland.gov/businessexpress/entitysearch" target="_blank" rel="noopener noreferrer">Maryland Business Express business search tool</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
...
export const registeredAgent = [
  ...
  },
  {
    ...
    content: {
      list: [
        `<a href="/research-topics/registered-agent-help/what-is-the-main-function-of-the-registered-agent/">The Main Functions of a Maryland Registered Agent</a>`,
        `<a href="/manage-your-company/change-of-registered-agent/">Changing Your Maryland Registered Agent</a>`,
        `<a href="/research-topics/registered-agent-help/what-does-a-registered-agent-do/">What a Maryland Registered Agent Does</a>`,
      ],
    },
    marginBottom: 48,
    color: color.babyblue3,
...
export const feesAndRequirments = [
  ...
  },
  {
    ...
    content: {
      list: [
        `A complete report on all the licenses, permits and tax registrations your Maryland LLC will need`,
        `The application forms you will need to file with the Maryland, regional and federal licensing authorities`,
      ],
    },
    marginBottom: 24,
    color: color.purple3,
  ...
  {
    type: `text`,
    content: `Areas you might want to file Maryland Articles of Amendment for include:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
    content: {
      list: [
        `Adding, removing or changing a Maryland LLC member or manager`,
...
export const businessTaxes = [
  ...
  {
    type: `text`,
    content: `If you sell physical products or certain types of services, you may need to collect sales tax (also known as sales and use tax) and then pay it to the MD Comptroller. Maryland sales tax is collected at the point of purchase. Maryland sales tax rates do vary depending on the region, county or city where you are located. You will typically need to collect Maryland sales tax on:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
    content: {
      list: [
        ...
        `Certain services that your Maryland business might provide`,
      ],
    },
    marginBottom: 16,
    color: color.blue3,
  ...
  {
    type: `text`,
    content: `<a href="https://www.marylandtaxes.gov/business/sales-use/index.php/" target="_blank" rel="noopener noreferrer">Get details on the Maryland sales tax here.</a>`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `<a href="https://www.dllr.state.md.us/" target="_blank" rel="noopener noreferrer">Get more requirements from the Maryland Department of Labor website.</a>`,
    marginBottom: 24,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Most Maryland LLCs will need to pay estimated taxes throughout the year, depending on the amount of income and profit you expect to make. The most common types of estimated tax are:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
