...
export const businessTaxes = [
  ...
  },
  {
    ...
    content: {
      items: [
        {
          question: `Maryland LLC Employer Payroll Tax Withholding`,
        ...
        {
          question: `Employer Federal and State Tax Withholding for Your Maryland LLC`,
          answer: `You may also choose to withhold federal and Maryland state income tax on the wages you pay to employees. Speak to your accountant for more information.`,
        },
        {
          question: `Employees May Need to File Tax Returns`,
          answer: `Regardless of whether you withhold federal and Maryland state income tax, your employees may need to file their own tax returns.`,
        },
        {
          question: `Maryland LLC Employee Insurance and Other Requirements`,
          answer2: [
            {
              type: `paragraph`,
              ...
              content: [
                {
                  ...
                  text: `Get more requirements from the Maryland Department of Labor website.`,
        ...
        {
          question: `Other Taxes and Duties for Your Maryland LLC`,
          answer: `Depending on the industry you are in, your Maryland LLC may be liable for certain other taxes and duties. For example, if you sell gasoline, you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods, you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
        },
        {
          question: `Estimated Taxes for Your Maryland LLC`,
          answer2: [
            {
              type: `paragraph`,
            ...
            },
            {
              ...
              content: [`Federal income tax`, `Federal self-employment tax`, `Maryland state tax`],
            },
            {
              type: `paragraph`,
