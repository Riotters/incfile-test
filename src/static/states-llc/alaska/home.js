...
export const howToGuide = [
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/alaska-llc/how-to-name-your-llc/">Naming Your Alaska LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/alaska-llc/registered-agents-alaska-llc/">Alaska Registered Agents for LLCs</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/alaska-llc/form-filling-permit-requirements/">Fees and Requirements for Alaska LLCs</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/alaska-llc/business-taxes/">Federal, State, Sales and Other Taxes for Your Alaska LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
...
export const namingYourBusiness = [
  ...
  {
    type: `text`,
    content: `<a href="https://www.commerce.alaska.gov/cbp/main/search/entities" target="_blank" rel="noopener noreferrer">Alaska Division of Corporations business search tool</a>`,
    marginBottom: 40,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `<a href="https://www.commerce.alaska.gov/web/cbpl/BusinessLicensing/SelectaBusinessName.aspx" target="_blank" rel="noopener noreferrer">More on Alaska Division of Corporations business naming rules</a>`,
    marginBottom: 40,
  },
  {
    type: `header`,
      ...
      items: [
        ...
        },
        {
          ...
          answer2: [
            ...
            {
              type: `paragraph`,
              content: `<a href="https://labor.alaska.gov/" target="_blank" rel="noopener noreferrer">Get more requirements from the Alaska Department of Labor and Workforce Development website.</a>`,
            },
          ],
        },
        {
