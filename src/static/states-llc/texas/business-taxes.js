...
export const businessTaxesPageContent = {
  ...
  content: [
    ...
    },
    {
      ...
      content: {
        list: [
          `<strong>Houston, TX</strong> sales tax rate is <strong>8.25 percent</strong>`,
          `<strong>San Antonio, TX</strong> sales tax rate is <strong>8.25 percent</strong>`,
          `<strong>Dallas, TX</strong> sales tax rate is <strong>8.25 percent</strong>`,
          `<strong>Austin, TX</strong> sales tax rate is <strong>8.25 percent</strong>`,
        ],
      },
    },
    ...
    {
      type: `paragraph`,
      content: `All Texas LLC business members or managers who take profits out of the LLC will need to pay self-employment tax. This tax is also known as FICA, Social Security or Medicare tax. It applies to all the earnings you withdraw from your Texas business. The current self-employment tax rate is 15.3 percent.`,
    },
    {
      type: `paragraph`,
