...
export const businessNamesContent = {
  ...
  content: [
    ...
    {
      type: `paragraph`,
      content: `The Texas Secretary of State search tool lets you enter details and search for your TX LLC by the following fields:`,
    },
    {
        ...
        items: [
          {
            ...
            answer: `Just go to the <a href="https://mycpa.cpa.state.tx.us/coa/Index.html" target="_blank" rel="noopener noreferrer">business name search tool</a> and enter your proposed business name. You can search the register of the Texas Secretary of State, which will tell you if there are any TX corporations or LLCs with that name.`,
          },
          {
