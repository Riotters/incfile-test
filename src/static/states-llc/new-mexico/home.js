...
export const namingYourBusiness = [
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `New Mexico Secretary of State business entity search`,
...
export const registeredAgent = [
  ...
  {
    type: `header`,
    content: `How to Appoint a New Mexico Registered Agent for Your LLC`,
    size: 3,
    marginBottom: 24,
  },
  {
  ...
  {
    type: `header`,
    content: `Assign Your New Mexico Registered Agent When You Form Your LLC`,
    size: 3,
    marginBottom: 16,
  },
  {
  ...
  {
    type: `header`,
    content: `File Certificate of Formation with the New Mexico Secretary of State`,
    size: 4,
    marginBottom: 16,
  },
  {
  ...
  {
    type: `header`,
    content: `Incorporate Through Incfile and Get a Free New Mexico Registered Agent`,
    size: 4,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `When you incorporate through us, we complete and file your Articles of Organization based on the information you've provided. Additionally, we give you a free New Mexico Resident Agent Service for the first year, and we'll include details of your New Mexico Resident Agent in the form that we file.`,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `Registered Agent Service for the first year, and we’ll include details of your New Mexico Registered Agent in the form that we file.`,
    marginBottom: 16,
  },
  {
    type: `button`,
  ...
  {
    type: `header`,
    content: `Change Your New Mexico Registered Agent After Your LLC Is Formed`,
    size: 3,
    marginBottom: 16,
  },
  {
  ...
  {
    type: `header`,
    content: `Choose a Registered Agent Service and File a Form With the New Mexico Secretary of State`,
    size: 4,
    marginBottom: 16,
  },
  {
  ...
  {
    type: `header`,
    content: `Sign Up for Incfile's New Mexico Resident Agent Service and We'll File the Change on Your Behalf`,
    size: 4,
    marginBottom: 16,
  },
  {
  ...
  {
    type: `header`,
    content: `New Mexico Resident Agent Search`,
    size: 3,
    marginBottom: 24,
  },
  {
    type: `text`,
    content: `In some situations, you might want to know the name of the Registered Agent that represents another New Mexico LLC. If you do, you can search the business database of the New Mexico Secretary of State, as these will often provide details of a specific business’s Registered Agent.`,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `If the MT Registered Agent isn’t available from the searchable business registry, contact the New Mexico Secretary of State requesting the information.`,
    marginBottom: 32,
  },
  {
    type: `header`,
    content: `Possible Outcomes of Not Assigning a Registered Agent for Your New Mexico LLC`,
    size: 3,
    marginBottom: 24,
  },
  {
  ...
  },
  {
    ...
    content: {
      items: [
        ...
        {
          question: `Does My Registered Agent Need to Have an Address in New Mexico?`,
...
export const businessTaxes = [
  ...
  {
    type: `header`,
    content: `New Mexico LLC Employer Payroll Tax Withholding`,
    size: 4,
    marginBottom: 16,
  },
  {
  ...
  {
    type: `header`,
    content: `New Mexico LLC Federal and State Tax Withholding`,
    size: 4,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `You may also choose to withhold federal and New Mexico state income tax on the wages you pay to employees. Speak to your accountant for more information.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Get more requirements from the <a href="https://www.dws.state.nm.us/en-us/" target="_blank" rel="noopener noreferrer"> New Mexico Department of Employment and Workforce website.</a>`,
    marginBottom: 24,
  },
  {
    type: `header`,
    content: `Other Taxes and Duties for Your New Mexico LLC`,
    size: 4,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `Depending on the industry you are in, your New Mexico LLC may be liable for certain other taxes and duties. For example, if you sell gasoline you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
    marginBottom: 32,
  },
  {
    type: `header`,
    content: `Estimated Taxes for Your New Mexico LLC`,
    size: 4,
    marginBottom: 16,
  },
  {
