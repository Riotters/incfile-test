...
export const howToGuide = [
      ...
      items: [
        ...
        },
        {
          ...
          answer: `<p> Once you've gathered all the information for your LLC, you’ll need to file a formal document with the Montana Secretary of State. This document is known as your “Articles of Organization,” and filing the document creates your Montana LLC. Here’s what is typically included:</p></br>
                   ...
                   <a href="/form-order-now.php?entityType=LLC&entityState=MT/"> Form your LLC now </a>`,
        },
      ],
    },
    marginBottom: 48,
  ...
  },
  {
    ...
    content: {
      ...
      list: [`<a href="https://app.mt.gov/businesschecklist" target="_blank" rel="noopener noreferrer">Montana Secretary of State for forming and running your LLC</a>`,
...
export const namingYourBusiness = [
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`Are very similar to the name of a federal or AK agency or organization (e.g. FBI, FDA, Montana Department of Revenue, Montana Police, Treasury, etc)`,
...
export const registeredAgent = [
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`If the Registered Agent is a person, they must reside in Montana.`,
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`Correspondence from the Montana Secretary of State, like a notice to file reports and other forms`,
  ...
  {
    type: `header`,
    content: `Change Your Montana Registered Agent After Your LLC Is Formed`,
    size: 3,
    marginBottom: 16,
  },
  {
  ...
  {
    type: `header`,
    content: `Choose a Registered Agent Service and File a Form With the Montana Secretary of State`,
    size: 4,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `Once you’ve chosen a new Montana Registered Agent, you can complete a form. Once you’ve filled it out, send it to the secretary of state so they can update your records. The Montana SOS may charge a nominal fee to assign or change a Registered Agent, and we do pass that fee on to you.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `header`,
    content: `Montana Resident Agent Search`,
    size: 3,
    marginBottom: 24,
  },
  {
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`The Registered Agent must have a physical street address in Montana. If you’re forming an LLC outside Montana, you will need to use an in-state Registered Agent.`, 
  ...
  },
  {
    ...
    content: {
      ...
      list: [`<a href="/research-topics/registered-agent-help/what-is-the-main-function-of-the-registered-agent/">The Main Functions of a Montana Registered Agent</a>`,
...
export const feesAndRequirments = [
  ...
  {
    type: `text`,
    content: `Your Montana LLC may need certain licenses and permits to comply with specific requirements. These business permits and licenses might be issued by Montana, regional or federal organizations. Some of the associated fees only need to be paid once, while others have ongoing charges.`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
    content: {
      ...
      list: [`The industry your Montana LLC operates in (e.g., restaurants will need health permits)`, 
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`A complete report on all the licenses, permits and tax registrations your Montana LLC will need`,
  ...
  },
  {
    ...
    content: {
      ...
      list: [`Adding, removing or changing a Montana LLC member or manager`,
...
export const businessTaxes = [
  ...
  {
    type: `header`,
    content: `Montana LLC Employer Payroll Tax Withholding`,
    size: 4,
    marginBottom: 16,
  },
  {
  ...
  {
    type: `header`,
    content: `Montana LLC Federal and State Tax Withholding`,
    size: 4,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `You may also choose to withhold federal and Montana state income tax on the wages you pay to employees. Speak to your accountant for more information.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Get more requirements from the <a href="http://dli.mt.gov" target="_blank" rel="noopener noreferrer"> Montana Department of Labor & Industry website.</a>`,
    marginBottom: 24,
  },
  {
    type: `header`,
    content: `Other Taxes and Duties for Your Montana LLC`,
    size: 4,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `Depending on the industry you are in, your Montana LLC may be liable for certain other taxes and duties. For example, if you sell gasoline you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
    marginBottom: 32,
  },
  {
    type: `header`,
    content: `Estimated Taxes for Your Montana LLC`,
    size: 4,
    marginBottom: 16,
  },
  {
