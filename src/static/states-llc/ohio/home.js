...
export const top = {
	header: `How to Start an LLC in Ohio`,
...
export const namingYourBusiness = [
	...
	},
	{
		type: `arrow-link`,
		content: {
			text: `More on Ohio Secretary of State business naming rules`,
			url: `https://www.sos.state.oh.us/businesses/information-on-starting-and-maintaining-a-business/guide-to-name-availability/`,
		},
		marginBottom: 32,
	},
	{
	...
	{
		type: `header`,
		content: `Additional Resources for Naming Your Ohio LLC`,
		size: 4,
		marginBottom: 16,
	},
	{
...
export const registeredAgent = [
	...
	{
		type: `text`,
		content: `Your LLC must have an Ohio Statutory Agent at all times. You can appoint a Statutory Agent when you first start your business. You can also replace your existing OH Statutory Agent at a later date, provided there is a smooth transition between the old and new Statutory Agent service. Here’s what we cover:`,
		marginBottom: 32,
	},
	{
		type: `list-dot`,
	...
	{
		type: `header`,
		content: `Useful Resources for Ohio Registered Agent Services`,
		size: 3,
		marginBottom: 24,
	},
	{
...
export const feesAndRequirments = [
	...
	{
		type: `text`,
		content: `Your Ohio LLC may need certain licenses and permits to comply with specific requirements. These business permits and licenses might be issued by Ohio, regional or federal organizations. Some of the associated fees only need to be paid once, while others have ongoing charges. Permits and licenses vary based on:`,
		marginBottom: 16,
	},
	{
		type: `list-dot`,
	...
	{
		type: `text`,
		content: `Your business formation documents state certain facts about your Ohio business when it was originally formed. Over time, these facts might change — if they do, you need to file a “Certificate of Amendment” with the Ohio Secretary of State. You can do this yourself or have Incfile complete the filing on your behalf. Areas you might want to file Ohio Articles of Amendment for include:`,
		marginBottom: 16,
	},
	{
		type: `list-dot`,
