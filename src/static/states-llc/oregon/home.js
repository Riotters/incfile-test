...
export const top = {
	header: `Filing in Oregon: Starting an Oregon LLC `,
...
export const namingYourBusiness = [
	...
	{
		type: `text`,
		content: `Whether you’re searching for the right Oregon business name or registering your LLC with the OH Secretary of State, we can help. We’ve got all the information you need on a Oregon business entity search, LLC naming rules, fictitious names and registering your business.`,
		marginBottom: 32,
	},
	{
		type: `header`,
	...
	{
		type: `text`,
		content: `You should start naming your business by completing a Oregon business entity search with the Secretary of State. They have a helpful tool on their website that lets you search the register of OH LLCs and corporations to see if someone already has your desired business name.`,
		marginBottom: 16,
	},
	{
		type: `text`,
	...
	{
		type: `text`,
		content: `The business name you have chosen cannot be used by any other LLC or corporation in the state of Oregon. This is why you should check business name availability on the OH SOS website.`,
		marginBottom: 40,
	},
	{
		type: `header`,
	...
	{
		type: `text`,
		content: `ou might choose to do business under a different name from your legal LLC name. In Oregon, doing business under a different name is known as an “Assumed” or “Doing Business As (DBA)” name. You might choose to use a different name from your OR formal LLC name for a variety of reasons.
...
export const registeredAgent = [
	...
	{
		type: `text`,
		content: `The Oregon Secretary of State requires every OR LLC to have a Registered Agent, also referred to as a registered Agent. Once you have assigned an Oregon registered Agent, they can receive official correspondence and documents on behalf of your OH business. registered Agents can be individuals or other specialized Registered/registered Agent service businesses. `,
		marginBottom: 16,
	},
	{
		type: `text`,
		content: `Your LLC must have an Oregon registered Agent at all times. You can appoint a registered Agent when you first start your business. You can also replace your existing OH registered Agent at a later date, provided there is a smooth transition between the old and new registered Agent service.`,
		marginBottom: 32,
	},
	{
		type: `header`,
	...
	{
		type: `text`,
		content: `Here’s some important information from the Oregon Secretary of State on OH Registered Agent services.`,
		marginBottom: 16,
	},
	{
		type: `text`,
	...
	{
		type: `text`,
		content: `Your Oregon Registered Agent carries out several valuable services for your business. They accept official communications and documents from the OH Secretary of State on your behalf. This may include:`,
		marginBottom: 16,
	},
	{
		type: `list-dot`,
	...
	{
		type: `text`,
		content: `Incfile is authorized to conduct business in Oregon and can legally act as your Registered Agent. Here’s what the Infile Oregon Registered Agent service provides for your OR LLC:`,
		marginBottom: 16,
	},
	{
		type: `list-dot`,
	...
	{
		type: `text`,
		content: `You will need to include details of your Registered Agent in your Certificate of Organization. This is the form that you file with the OH Secretary of State to formally create your business.`,
		marginBottom: 24,
	},
	{
		type: `header`,
	...
	{
		type: `header`,
		content: `What Happens If You Don’t Have an Oregon registered Agent?`,
		size: 3,
		marginBottom: 24,
	},
	{
	...
	{
		type: `header`,
		content: `You Can Appoint Yourself as Your Own Oregon Registered Agent`,
		size: 3,
		marginBottom: 24,
	},
	{
			...
			items: [
				{
					...
					answer: `Yes. All OH LLCs are required to have a Registered Agent. This is mandated by the Oregon Secretary of State.`,
				},
				{
...
export const feesAndRequirments = [
	...
	{
		type: `text`,
		content: `Your Oregon LLC may need certain licenses and permits to comply with specific requirements. These business permits and licenses might be issued by Oregon, regional or federal organizations. Some of the associated fees only need to be paid once, while others have ongoing charges. Permits and licenses vary based on:`,
		marginBottom: 16,
	},
	{
		type: `list-dot`,
	...
	{
		type: `header`,
		content: `Create an Operating Agreement for Your Oregon LLC`,
		size: 4,
		marginBottom: 16,
	},
	{
	...
	{
		type: `text`,
		content: `Your business formation documents state certain facts about your Oregon business when it was originally formed. Over time, these facts might change — if they do, you need to file a “Certificate of Amendment” with the Oregon Secretary of State. You can do this yourself or have Incfile complete the filing on your behalf. Areas you might want to file Oregon Articles of Amendment for include:`,
		marginBottom: 16,
	},
	{
		type: `list-dot`,
