...
export const howToGuide = [
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `Arizona Business Search and Naming`,
      url: `/arizona-llc/how-to-name-your-llc/`,
    },
    marginBottom: 16,
  },
  {
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `Arizona Statutory Agents for LLCs`,
      url: `/arizona-llc/registered-agents-arizona-llc/`,
    },
    marginBottom: 16,
  },
  {
  ...
  },
  {
    ...
    content: {
      ...
      url: `/arizona-llc/form-filling-permit-requirements/`,
    },
    marginBottom: 16,
  },
  {
  ...
  },
  {
    ...
    content: {
      ...
      url: `/arizona-llc/business-taxes/`,
    },
    marginBottom: 16,
  },
  {
...
export const namingYourBusiness = [
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `Arizona Corporation Commission LLC name search tool`,
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `More on Arizona Corporation Commission business naming rules`,
...
export const businessTaxes = [
  ...
  {
    type: `text`,
    content: `Get details on the Arizona Transaction Privilege Tax online here.`,
    marginBottom: 40,
  },
  {
    type: `header`,
  ...
  {
    type: `header`,
    content: `Employer Federal and State Tax Withholding for Your Arizona LLC`,
    size: 4,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `You may also choose to withhold federal and Arizona state income tax on the wages you pay to employees. Speak to your accountant for more information.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Regardless of whether you withhold federal and Arizona state income tax, your employees may need to file their own tax returns.`,
    marginBottom: 32,
  },
  {
    type: `header`,
    content: `Arizona LLC Employee Insurance and Other Requirements`,
    size: 4,
    marginBottom: 16,
  },
  {
