...
export const namingYourBusiness = [
  ...
  {
    type: `header`,
    content: `Mississippi Business Name LLC Lookup`,
    size: 3,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `You should start naming your business by completing a Mississippi business entity search” with the secretary of state. They have a helpful tool on their website that lets you search the register of Mississippi LLCs and corporations to see if someone already has your desired business name. Just visit the Business Search Tool on the Mississippi SOS website and enter the KS business name you want to search for.`,
    marginBottom: 16,
  },
  {
    type: `text`,
...
export const registeredAgent = [
  ...
  {
    type: `text`,
    content: `What can you expect from your Mississippi Registered Agent? Their main function is to accept official documents and correspondence. This includes:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `header`,
    content: `A Complete Mississippi Resident Agent Service From Incfile`,
    size: 3,
    marginBottom: 24,
  },
  {
  ...
  {
    type: `text`,
    content: `We are authorized to conduct business in Mississippi and can legally act as your Registered Agent. We also have an address in Mississippi, which is required to operate as a Registered Agent. Here's what the Infile Mississippi Resident Agent service provides for your MS LLC.`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  {
    type: `header`,
    content: `Appointing a Registered Agent Service for Your Mississippi LLC`,
    size: 3,
    marginBottom: 24,
  },
  {
  ...
  {
    type: `header`,
    content: `Mississippi Resident Agent Search`,
    size: 3,
    marginBottom: 24,
  },
  {
      ...
      items: [
        {
          ...
          answer: `YYes. All KS LLCs are required to have a Registered Agent. This is mandated by the Mississippi Secretary of State.`,
        },
        {
...
export const feesAndRequirments = [
  ...
  },
  {
    ...
    content: `Our <a href="/business-license-research-package/">Business License Research Package</a>
     tells you about all of the licenses and permits you will need for your Mississippi LLC. It includes:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `Of course, your Mississippi LLC will also probably need to pay self-employment, payroll, federal, state and sales taxes, but we will cover that when we talk about taxes for KS LLCs.`,
    marginBottom: 48,
  },
  {
    type: `header`,
...
export const businessTaxes = [
  ...
  {
    type: `header`,
    content: `Mississippi LLC Employer Payroll Tax Withholding`,
    size: 4,
    marginBottom: 16,
  },
  {
  ...
  {
    type: `header`,
    content: `Mississippi LLC Federal and State Tax Withholding`,
    size: 4,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `You may also choose to withhold federal and Mississippi state income tax on the wages you pay to employees. Speak to your accountant for more information.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Get more requirements from the <a href="https://mdes.ms.gov" target="_blank" rel="noopener noreferrer"> Mississippi Department of Employment Security website..</a>`,
    marginBottom: 24,
  },
  {
    type: `header`,
    content: `Other Taxes and Duties for Your Mississippi LLC`,
    size: 4,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `Depending on the industry you are in, your Mississippi LLC may be liable for certain other taxes and duties. For example, if you sell gasoline you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
    marginBottom: 32,
  },
  {
    type: `header`,
    content: `Estimated Taxes for Your Mississippi LLC`,
    size: 4,
    marginBottom: 16,
  },
  {
