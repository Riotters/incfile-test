...
export const howToGuide = [
  ...
  },
  {
    ...
    content: {
      list: [
        ...
        `<a href="https://tax.colorado.gov/" target="_blank" rel="noopener noreferrer">Colorado Department of Revenue for CO taxes</a>`,
      ],
    },
    marginBottom: 48,
    color: color.blue3,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/colorado-llc/how-to-name-your-llc/">Naming Your Colorado LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/colorado-llc/registered-agents-colorado-llc/">Colorado Registered Agents for Your LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/colorado-llc/form-filling-permit-requirements/">Fees and Requirements for Your Colorado LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/colorado-llc/business-taxes/">Federal, State, Sales and Other Taxes for Your Colorado LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
...
export const namingYourBusiness = [
  ...
  {
    type: `text`,
    content: `<a href="https://www.sos.state.co.us/biz/BusinessEntityCriteriaExt.do" target="_blank" rel="noopener noreferrer">Colorado Secretary of State business name search tool.</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
...
export const businessTaxes = [
  ...
  {
    type: `text`,
    content: `You can get a Colorado tax withholding ID number from the <a href="https://tax.colorado.gov/" target="_blank" rel="noopener noreferrer">CO Department of Revenue</a>.`,
    marginBottom: 48,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Get details on the <a href="https://tax.colorado.gov/" target="_blank" rel="noopener noreferrer">Colorado state tax online here</a>.`,
    marginBottom: 48,
  },
  {
    type: `header`,
      ...
      items: [
        ...
        },
        {
          ...
          answer2: [
            ...
            {
              type: `paragraph`,
              content: `<a href="https://cdle.colorado.gov/" target="_blank" rel="noopener noreferrer">Get more requirements from the Colorado Department of Labor and Employment website.</a>`,
            },
          ],
        },
        {
