...
export const howToGuide = [
      ...
      items: [
        ...
        },
        {
          ...
          answer: `<p>Once you've gathered all the information for your LLC, you’ll need to file a formal document with the NH Secretary of State. This document is known as your “Articles of Organization,” and filing the document creates your New Hampshire LLC. Here’s what is typically included:</p></br>
                   ...
                   <a href="/form-order-now.php?entityType=LLC&entityState=NH/"> Form your LLC now </a>`,
        },
      ],
    },
    marginBottom: 48,
  ...
  },
  {
    ...
    content: {
      ...
      list: [`<a href="https://sos.nh.gov/nhllcforms.aspx" target="_blank" rel="noopener noreferrer">New Hampshire Secretary of State for forming and running your LLC</a>`,
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `Naming Your New Hampshire LLC`,
      url: `/new-hampshire-llc/how-to-name-your-llc/`,
    },
    marginBottom: 16,
  },
  {
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `New Hampshire Registered Agents for LLCs`,
      url: `/new-hampshire-llc/registered-agents-new-hampshire-llc/`,
    },
    marginBottom: 16,
  },
  {
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `Fees and Requirements for New Hampshire LLCs`,
      url: `/new-hampshire-llc/form-filling-permit-requirements/`,
    },
    marginBottom: 16,
  },
  {
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `Federal, State, Sales and Other Taxes for Your New Hampshire LLC`,
      url: `/new-hampshire-llc/business-taxes/`,
    },
    marginBottom: 16,
  },
  {
...
export const namingYourBusiness = [
  ...
  },
  {
    type: `arrow-link`,
    content: {
      text: `New Hampshire SoS business search tool`,
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`Are very similar to the name of a federal or NH agency or organization (e.g., FBI, FDA, New Hampshire Department of Revenue Administration, New Hampshire Police, Treasury, etc.)`,
...
export const registeredAgent = [
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`If the Registered Agent is a person, they must reside in New Hampshire.`,
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`Correspondence from the New Hampshire Secretary of State`,
  ...
  }, 
  {
    ...
    content: {
      header: ``,
      list: [`An always-available New Hampshire Registered Agent who can receive correspondence, documents and legal proceedings on your LLC’s behalf`,
  ...
  },
  {
    ...
    content: {
      ...
      url: `/form-order-now.php?entityType=LLC&entityState=NH/`,
    },
    theme: `primary48`,
    marginBottom: 32,
  },
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`The Registered Agent must have a physical street address in New Hampshire. If you’re forming an LLC outside NH, you will need to use an in-state Registered Agent.`, 
  ...
  },
  {
    ...
    content: {
      ...
      list: [`<a href="/research-topics/registered-agent-help/what-is-the-main-function-of-the-registered-agent/">The Main Functions of a New Hampshire Registered Agent</a>`,
...
export const feesAndRequirments = [
  ...
  },
  {
    ...
    content: {
      ...
      list: [`The industry your New Hampshire LLC operates in (e.g., restaurants will need health permits)`, 
  ...
  },
  {
    ...
    content: {
      header: ``,
      list: [`A complete report on all the licenses, permits and tax registrations your New Hampshire LLC will need`,
  ...
  },
  {
    ...
    content: {
      ...
      list: [`Adding, removing or changing a New Hampshire LLC member or manager`,
...
export const businessTaxes = [
  ...
  {
    type: `text`,
    content: `Get more requirements from <a href="https://www.nh.gov/labor/" target="_blank" rel="noopener noreferrer"> the New Hampshire Department of Labor website.</a>`,
    marginBottom: 24,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `Depending on the industry you are in, your New Hampshire LLC may be liable for certain other taxes and duties. For example, if you sell gasoline you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
    marginBottom: 32,
  },
  {
    type: `header`,
