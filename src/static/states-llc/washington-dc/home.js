...
marginBottom: 0,
},
  {
    ...
    content: {
      header: ``,
      list: [`<a href="https://dcra.dc.gov/service/domestic-limited-liability-company" target="_blank" rel="noopener noreferrer">Washington DC Department of Consumer and Regulatory Affairs for forming and running your LLC</a>`, 
...
export const registeredAgent = [
  ...
  },
  {
    type: `list-dot`,
    content: {
      header: `There are certain rules that you must follow when you’re appointing a Washington DC Registered Agent service for your business. They are:`,
      list: [`If the Registered Agent is a person, they must reside in Washington DC.`, 
  ...
  },
  {
    ...
    content: {
      ...
      list: [`An always-available Washington DC Registered Agent who can receive correspondence, documents and legal proceedings on your LLC’s behalf`, 
  ...
  },
  {
    ...
    content: {
      header: ``,
  list: [`The Registered Agent must have a physical street address in Washington DC. You always need to have someone on hand during business hours at the Washington DC address to sign for important documents.`, 
...
{
    type: `text`,
    content: `Any salaried employees will also need to pay personal income taxes.`,
    marginBottom: `The Washington DC tax rates are between 4 and 8.95 percent, depending on your earnings.`,
},
{
  type: `arrow-link`,
  content: {
...
{
    type: `text`,
    content: `Most Washington DC LLCs will need to pay estimated taxes throughout the year, depending on the amount of income and profit you expect to make. The most common types of estimated tax are:`,
    marginBottom: 20,
},
{
    type: `list-dot`,
