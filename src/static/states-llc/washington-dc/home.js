...
export const howToGuide = [
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/washington-dc-llc/how-to-name-your-llc/">Naming Your Washington DC LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/washington-dc-llc/registered-agents-washington-dc-llc/">Washington DC Registered Agents for Your LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/washington-dc-llc/form-filling-permit-requirements/">Fees and Requirements for Your Washington DC LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/washington-dc-llc/business-taxes/">Federal, State, Sales and Other Taxes for Your Washington DC LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
...
export const namingYourBusiness = [
  ...
  {
    type: `text`,
    content: `<a href="https://business.dc.gov/research_business_info" target="_blank" rel="noopener noreferrer">Washington DC business name search tool</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
...
export const registeredAgent = [
  ...
  },
  {
    ...
    content: {
      list: [
        `<a href="/research-topics/registered-agent/registered-agent-function/">The Main Functions of a Washington DC Registered Agent</a>`,
        `<a htef="/manage-your-company/change-of-registered-agent/">Changing Your Washington DC Registered Agent</a>`,
        `<a href="/research-topics/registered-agent/registered-agent-tasks/">What a Washington DC Registered Agent Does</a>`,
      ],
    },
    marginBottom: 48,
    color: color.blue2,
  ...
  },
  {
    ...
    content: {
      list: [
        ...
        `Altering the stated business activities of your Washington DC LLC`,
      ],
    },
    marginBottom: 16,
    color: color.purple3,
...
export const businessTaxes = [
  ...
  {
    type: `text`,
    content: `<a href="/washington-dc-llc/business-taxes/" target="_blank">Get details on the Washington DC income tax here.</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
  ...
  },
  {
    ...
    content: {
      items: [
        ...
        {
          question: `Employer Federal and Local Tax Withholding`,
          answer: `You may also choose to withhold federal and Washington DC income tax on the wages you pay to employees. Speak to your accountant for more information.`,
        },
        {
          question: `Employees May Need to File Tax Returns`,
          answer: `Regardless of whether you withhold federal and Washington DC income tax, your employees may need to file their own tax returns.`,
        },
        {
        ...
        {
          question: `Other Taxes and Duties for Your Washington DC LLC`,
          answer: `Depending on the industry you are in, your Washington DC LLC may be liable for certain other taxes and duties. For example, if you sell gasoline you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
        },
        {
          question: `Estimated Taxes for Your Washington DC LLC`,
          answer2: [
            {
              type: `paragraph`,
