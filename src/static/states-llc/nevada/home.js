...
export const top = {
	header: `Forming an LLC in Nevada: Your Complete Guide`,
...
export const howToGuide = [
	...
	{
		type: `text`,
		content: `The NV Secretary of State has plenty of information on forming and running a business in Nevada. These are all the basic steps for forming an LLC in Nevada. You’ll find other useful information below:`,
		marginBottom: 16,
	},
	{
		type: `list-dot`,
...
export const registeredAgent = [
	...
	{
		type: `text`,
		content: `Incfile is authorized to conduct business in Nevada and can legally act as your Registered Agent. Here’s what you need to know about Incfile’s NV Registered Agent service:`,
		marginBottom: 16,
	},
	{
		type: `list-dot`,
...
export const feesAndRequirments = [
	...
	{
		type: `text`,
		content: `Some NV LLCs will need certain business licenses and permits from federal, state and regional organizations. These permits and licenses will have associated fees that you should pay on a one-off or regular basis. Permits and licenses vary based on:`,
		marginBottom: 16,
	},
	{
		type: `list-dot`,
	...
	{
		type: `text`,
		content: `Your business formation documents state certain facts about your Nevada business when it was originally formed. Over time, these facts might change — if they do, you need to file “Articles of Amendment” with the Nevada Secretary of State. You can do this yourself or have Incfile complete the filing on your behalf. Areas you might want to file Nevada Articles of Amendment for include:`,
		marginBottom: 16,
	},
	{
		type: `list-dot`,
...
export const businessTaxes = [
	...
	{
		type: `text`,
		content: `If you sell physical products or certain types of services, you may need to collect sales tax (also known as sales and use tax) and then pay it to the NV Department of Taxation. Nevada sales tax is collected at the point of purchase. Nevada sales tax rates do vary depending on the region, county or city where you are located. You will typically need to collect Nevada sales tax on:`,
		marginBottom: 16,
	},
	{
		type: `list-dot`,
