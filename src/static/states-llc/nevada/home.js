...
export const howToGuide = [
  ...
  {
    type: `text`,
    content: `Briefly, the benefits of starting a Nevada LLC include:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `These are all the basic steps for forming an LLC in Nevada. You’ll find other useful information below:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
    content: {
      list: [
        ...
        `<a href="https://business.nv.gov/" target="_blank" rel="noopener noreferrer">Nevada Department of Business and Industry for NV employers and hiring</a>`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/nevada-llc/how-to-name-your-llc/">Naming Your Nevada LL</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/nevada-llc/registered-agents-nevada-llc/">Nevada Registered Agents for Your LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/nevada-llc/form-filling-permit-requirements/">Fees and Requirements for Your Nevada LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/nevada-llc/business-taxes/">Federal, State, Sales and Other Taxes for Your Nevada LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
...
export const namingYourBusiness = [
  ...
  {
    type: `text`,
    content: `<a href="https://www.nvsos.gov/sosentitysearch/" target="_blank" rel="noopener noreferrer">Nevada Secretary of State business name search tool.</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `It’s not enough for your NV LLC name to be unique; it also cannot be similar to the name of another corporation or LLC in Nevada. For example, you cannot use the following factors to say your name is different from the name of another business:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `In addition to the general rules listed above, the Nevada Secretary of State has some specific business naming rules for your LLC. You will need to follow these rules if you want to name your NV business appropriately:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `<a href="https://www.nvsos.gov/sos/businesses/commercial-recordings/restricted-word-list" target="_blank" rel="noopener noreferrer">More on Nevada Secretary of State business naming rules.</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
...
export const registeredAgent = [
  ...
  {
    type: `text`,
    content: `There are certain rules that you must follow when you’re appointing a Nevada Registered Agent service for your business. They are:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `Your Nevada Registered Agent carries out several valuable services for your business. They accept official communications and documents from the NV Secretary of State on your behalf. This may include:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `Here’s what you need to know about Incfile’s NV Registered Agent service:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `What happens if you choose not to assign or provide details of a Registered Agent to the Nevada Secretary of State? There are several possible ramifications, including:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `If you have an address in Nevada, you can choose to be the Registered Agent for your LLC. We don’t recommend this approach as there can be some drawbacks:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
...
export const feesAndRequirments = [
  ...
  {
    type: `text`,
    content: `Areas you might want to file Nevada Articles of Amendment for include:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
...
export const businessTaxes = [
  ...
  {
    type: `text`,
    content: `You will typically need to collect Nevada sales tax on:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `<a href="https://www.nevadatax.nv.gov/" target="_blank" rel="noopener noreferrer">Get details on the Nevada sales tax online here.</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
  ...
  },
  {
    ...
    content: {
      items: [
        {
          question: `Employer Payroll Tax Withholding for Your Nevada LLC `,
        ...
        {
          question: `Employer Federal Tax Withholding for Your Nevada LLC`,
        ...
        {
          question: `Nevada LLC Employee Insurance and Other Requirements`,
          answer2: [
            {
              type: `paragraph`,
            ...
            {
              type: `text`,
              content: `<a href="https://business.nv.gov/" target="_blank" rel="noopener noreferrer">Get more requirements from the Nevada Department of Business and Industry website.</a>`,
              marginBottom: 48,
            },
          ],
        },
        {
          question: `Other Taxes and Duties for Your Nevada LLC`,
          answer: `Depending on the industry you are in, your Nevada LLC may be liable for certain other taxes and duties. For example, if you sell gasoline you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods, you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
        },
        {
          question: `Estimated Taxes for Your Nevada LLC`,
          answer2: [
            {
              type: `paragraph`,
