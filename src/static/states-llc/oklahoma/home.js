...
export const howToGuide = [
  ...
  {
    type: `text`,
    content: `The Oklahoma Secretary of State has plenty of information on forming and running a business in Oklahoma. Check out the following resources:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/oklahoma-llc/how-to-name-your-llc/">Naming Your Oklahoma LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/oklahoma-llc/registered-agents-oklahoma-llc/">Oklahoma Registered Agents for Your LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/oklahoma-llc/form-filling-permit-requirements/">Fees and Requirements for Oklahoma LLCs</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/oklahoma-llc/business-taxes/">Federal, State, Sales and Other Taxes for Your Oklahoma LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
...
export const namingYourBusiness = [
  ...
  {
    type: `text`,
    content: `<a href="https://www.sos.ok.gov/business/corp/records.aspx/" target="_blank" rel="noopener noreferrer">Oklahoma Secretary of State entity search tool</a>`,
    marginBottom: 48,
  },
  {
    type: `header`,
...
export const registeredAgent = [
  ...
  {
    type: `text`,
    content: `Note that the OK Registered Agent address does not need to be the same as your Oklahoma LLC business address.`,
    marginBottom: 48,
  },
  {
    type: `header`,
...
export const businessTaxes = [
  ...
  {
    type: `text`,
    content: `Get details on the <a href="https://www.ok.gov/tax/Error_404.html" target="_blank" rel="noopener noreferrer" > Oklahoma state tax online here.</a>`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  {
    type: `text`,
    content: `You will typically need to collect Oklahoma sales tax on:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
      ...
      items: [
        ...
        },
        {
          ...
          answer2: [
            ...
            {
              type: `text`,
              content: `<a href="https://www.ok.gov/odol/" target="_blank" rel="noopener noreferrer">Get more requirements from the Oklahoma Department of Labor website.</a>`,
              marginBottom: 48,
            },
          ],
        },
