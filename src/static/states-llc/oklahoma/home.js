...
export const howToGuide = [
        ...
        items: [
          ...
          },
          {
            ...
            answer: `<p>Once you've gathered all the information for your Oklahoma LLC, you’ll need to file a formal document with the OK Secretary of State. This document is known as your “Articles of Organization,” and filing the document establishes your Oklahoma business registration. Here’s what is typically included in an Oklahoma LLC filing:</p></br>
                     ...
                     <a href="/form-order-now.php?entityType=LLC&entityState=OK/"> Form your LLC now </a>`,
          },
        ],
      },
      marginBottom: 48,
    ...
    },
    {
      ...
      content: {
        ...
        list: [`<a href="https://www.sos.ok.gov/business/default.aspx" target="_blank" rel="noopener noreferrer">Oklahoma Secretary of State for forming and running your OK LLC</a>`,
  ...
  export const namingYourBusiness = [
    ...
    },
    {
      ...
      content: {
        header: ``,
        list: [`Are very similar to the name of a federal or OK agency or organization (e.g., FBI, FDA, Oklahoma Tax Commission, Oklahoma Police, Treasury, etc.)`,
  ...
  export const registeredAgent = [
    ...
    },
    {
      ...
      content: {
        header: ``,
        list: [`If the Registered Agent is a person, they must reside in Oklahoma.`,
    ...
    },
    {
      ...
      content: {
        header: ``,
        list: [`Correspondence from the Oklahoma Secretary of State`,
    ...
    },
    {
      ...
      content: {
        header: ``,
        list: [`The OK Registered Agent must have a physical street address in Oklahoma. If you’re forming an LLC outside OK, you will need to use an in-state Registered Agent.`, 
    ...
    },
    {
      ...
      content: {
        ...
        list: [`<a href="/research-topics/registered-agent-help/what-is-the-main-function-of-the-registered-agent/">The Main Functions of an Oklahoma Registered Agent</a>`,
  ...
  export const feesAndRequirments = [
    ...
    {
      type: `text`,
      content: `<b>Due Date:</b> By the anniversary date of organization.`,
      marginBottom: 16,
    },
    {
      type: `text`,
    ...
    },
    {
      ...
      content: {
        ...
        list: [`The industry your Oklahoma LLC operates in (e.g., restaurants will need health permits)`, 
    ...
    },
    {
      ...
      content: {
        header: ``,
        list: [`A complete report on all the licenses, permits and tax registrations your Oklahoma LLC will need`,
    ...
    },
    {
      ...
      content: {
        ...
        list: [`Adding, removing or changing an Oklahoma LLC member or manager`,
  ...
  export const businessTaxes = [
    ...
    {
      type: `header`,
      content: `Employer Payroll Tax Withholding for Your Oklahoma LLC`,
      size: 4,
      marginBottom: 16,
    },
    {
    ...
    {
      type: `header`,
      content: `Employer Federal and State Tax Withholding for Your Oklahoma LLC`,
      size: 4,
      marginBottom: 16,
    },
    {
      type: `text`,
      content: `You may also choose to withhold federal and Oklahoma state income tax on the wages you pay to employees. Speak to your accountant for more information.`,
      marginBottom: 32,
    },
    {
      type: `header`,
    ...
    {
      type: `text`,
      content: `Regardless of whether you withhold federal and Oklahoma state income tax, your employees may need to file their own tax returns.`,
      marginBottom: 32,
    },
    {
      type: `header`,
      content: `Oklahoma LLC Employee Insurance and Other Requirements`,
      size: 4,
      marginBottom: 16,
    },
    {
    ...
    {
      type: `text`,
      content: `Get more requirements from <a href="https://www.ok.gov/odol/" target="_blank" rel="noopener noreferrer"> the Oklahoma Department of Labor website.</a>`,
      marginBottom: 24,
    },
    {
      type: `header`,
    ...
    {
      type: `text`,
      content: `Depending on the industry you are in, your Oklahoma LLC may be liable for certain other taxes and duties. For example, if you sell gasoline, you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods, you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
      marginBottom: 32,
    },
    {
      type: `header`,
