...
export const howToGuide = [
  ...
  {
    type: `text`,
    content: `Briefly, the benefits of starting an Arkansas LLC include:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
  ...
  },
  {
    ...
    content: {
      items: [
        ...
        {
          question: `STEP 4: Assign an Arkansas Registered Agent`,
          ...
          <p>At Incfile, all of our packages include an Arkansas Registered Agent service that is free for the first year and just $119 per year afterward. We also have a dashboard where you can log in and easily view any document your Registered Agent has received on your behalf.</p></br>
  ...
  {
    type: `text`,
    content: `These are all the basic steps for forming an LLC in Arkansas, but the Secretary of State has plenty of additional information. Try these resources below:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/arkansas-llc/how-to-name-your-llc/">Naming Your Arkansas LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `How to search the Arkansas business registry of the Secretary of State and find the right name. Includes information on naming rules, fictitious names, reserving an Arkansas LLC name and more.`,
    marginBottom: 32,
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/arkansas-llc/registered-agents-arkansas-llc/">Arkansas Registered Agents for LLCs</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
    content: `How to appoint a Registered Agent to your new LLC or change to a different Registered Agent. Includes information on Registered Agent rules and searching for Arkansas Registered Agents.`,
    marginBottom: 32,
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/arkansas-llc/form-filling-permit-requirements/">Fees and Requirements for Arkansas LLCs</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
  ...
  },
  {
    type: `header`,
    size: 3,
    content: `<a href="/arkansas-llc/business-taxes/">Federal, State, Sales and Other Taxes for Your Arkansas LLC</a>`,
    marginBottom: 16,
  },
  {
    type: `text`,
...
export const namingYourBusiness = [
  ...
  {
    type: `text`,
    content: `<a href="https://www.sos.arkansas.gov/corps/search_all.php" target="_blank" rel="noopener noreferrer">Arkansas Secretary of State business search tool</a>`,
    marginBottom: 40,
  },
  {
    type: `header`,
...
export const registeredAgent = [
  ...
  {
    type: `text`,
    content: `There are certain rules that you must follow when you’re appointing an Arkansas Registered Agent service for your business. They are:`,
    marginBottom: 16,
  },
  {
    type: `list-dot`,
  ...
  {
    type: `text`,
    content: `Your business needs to have an Arkansas Registered Agent Service as soon as it’s formed. You can achieve this through one of the following methods.`,
    marginBottom: 32,
  },
  {
    type: `header`,
  ...
  },
  {
    ...
    content: {
      list: [
        ...
        `<b>Losing your status as an Arkansas LLC:</b> A Registered Agent “proves” to the state that your business exists. Without it, you could lose your business entity protections and your LLC may be dissolved.`,
      ],
    },
    marginBottom: 40,
    color: color.blue3,
  ...
  },
  {
    ...
    content: {
      items: [
        {
          question: `Do I Need to Appoint an Arkansas Registered Agent?`,
  ...
  },
  {
    ...
    content: {
      list: [
        `<a href="/research-topics/registered-agent-help/what-is-the-main-function-of-the-registered-agent/">The Main Functions of an Arkansas Registered Agent</a>`,
        `<a href="/manage-your-company/change-of-registered-agent/">Changing Your Arkansas Registered Agent</a>`,
        `<a href="/research-topics/registered-agent-help/what-does-a-registered-agent-do/">What an Arkansas Registered Agent Does</a>`,
      ],
    },
    marginBottom: 48,
    color: color.babyblue3,
...
export const feesAndRequirments = [
  ...
  {
    type: `text`,
    content: `Some Arkansas LLCs will need certain business licenses and permits from federal, state and regional organizations. These permits and licenses will have associated fees that you should pay on a one-off or regular basis. Permits and licenses vary based on:`,
    marginBottom: 24,
  },
  {
    type: `list-dot`,
  ...
  },
  {
    ...
    content: {
      list: [
        `A complete report on all the licenses, permits and tax registrations your Arkansas LLC will need`,
        `The application forms you will need to file with the Arkansas, regional and federal licensing authorities`,
      ],
    },
    marginBottom: 24,
    color: color.purple3,
  ...
  },
  {
    ...
    content: {
      list: [
        `Adding, removing or changing an Arkansas LLC member or manager`,
        `Changing the business address of your LLC`,
        `Altering the stated business activities of your Arkansas LLC`,
      ],
    },
    marginBottom: 32,
    color: color.yellow3,
...
export const businessTaxes = [
  ...
  {
    type: `text`,
    content: `The profits of an Arkansas LLC are not taxed at the business level like those of C Corporations. Instead, taxes for an Arkansas LLC work as follows:`,
    marginBottom: 24,
  },
  {
    type: `numeric-list`,
  ...
  {
    type: `text`,
    content: `The Arkansas state tax rates vary between 1.125 percent to 6.925 percent on taxable income. Individual income tax is graduated so higher earnings are taxed at a higher rate.`,
    marginBottom: 16,
  },
  {
    type: `text`,
      ...
      items: [
        ...
        },
        {
          ...
          answer2: [
            ...
            {
              type: `paragraph`,
              content: `Get more requirements from <a href="https://www.labor.arkansas.gov/" target="_blank" rel="noopener noreferrer">the Arkansas Department of Labor</a> website.`,
            },
          ],
        },
        {
          question: `Other Taxes and Duties for Your Arkansas LLC`,
          answer: `Depending on the industry you are in, your Arkansas LLC may be liable for certain other taxes and duties. For example, if you sell gasoline you may need to pay a tax on any fuel you sell. Likewise, if you import or export goods you may need to pay certain duties. Speak to your accountant about any other taxes you may need to withhold or pay.`,
        },
        {
          question: `Estimated Taxes for Your Arkansas LLC`,
          answer2: [
            {
              type: `paragraph`,
