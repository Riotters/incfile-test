export const top = {
  header: `Filing a Foreign Qualification To Do Business Out of State`,
  button: [
    {
      text: "Order Now",
...
export const basics = {
  ...
  faq: {
    items: [
      ...
      {
        question: `How Does the Foreign Qualification Process Work?`,
...
export const faq = {
  ...
  faq: {
    items: [
      {
        question: `When Should I File for My Certificate of Authority?`,
