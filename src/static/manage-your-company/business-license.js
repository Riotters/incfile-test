...
export const about = {
    ...
    text2:
        `At Incfile we take the guesswork out of how to obtain a business license and the necessary permits. Not only do we inform you of the necessities, we offer to do the paperwork for you.`,
    button: {
        text:
