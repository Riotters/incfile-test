export const top = {
  header: `Registered Agent Services: Change of Registered Agent`,
  text: `Incfile is a nationwide Registered Agent service provider you can trust.`,
  button: [
    {
      text: "Order Now",
...
export const about = {
  ...
  box: {
    header: `How to change a Registered Agent?`,
    text: `The process in changing your Registered Agent is fairly simple, requiring you to fill out a "Change of Registered Agent" form in your particular state. 
  ...
  text2: `A Registered Agent is someone who is registered to do business in the same state in which a business entity is established and who is appointed to receive service of process notices, 
  ...
  header2: `What is Required of a Registered Agent?`,
  text3: `A Registered Agent receives tax and legal documents for your business and ensures that you don't miss important notifications regarding tax payments, lawsuits or legal activities involving your business. However, 
      a Registered Agent may or may not have a role in the operation of the business itself.`,
  header3: `What Happens if I Don't Appoint Or Report a Change in Registered Agents?`,
  text4: `All LLCs are required to designate a Registered Agent when they file with their secretary of state. Failing to do so will cause you to fall out of good standing with the state causing hefty fines. 
...
export const help = {
  header: `Help file my Change of Agent`,
  header2: `Save your time. We'll handle the paperwork.`,
  text: `In order to change Registered Agents, you must first complete and submit a change of Registered Agent filing. This filing will allow you to stop using your current Registered Agent service and elect a new Registered Agent.`,
};

export const faq = {
  header: `Common questions about filing a Change of Registered Agent`,
  cards: [
    {
