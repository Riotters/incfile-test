export const top = {
  header: `Filing Articles of Dissolution`,
  button: [
    {
      text: "Order now",
...
export const about = {
  ...
  text3: `Business dissolution is primarily an act of filing Articles of Dissolution with your secretary of state. 
  ...
  header2: `Steps to Dissolving Your LLC or Corporation`,
  text4: `There are three key steps to dissolving a company. Incfile completes these steps in a timely manner on your behalf, making an otherwise cumbersome process simple and stress-free.`,
  list: [
    {
  ...
  text5: `An additional step often recommended at this point is the closing of all credit lines and accounts that pertain to your business. Letting your creditors know that you have dissolved a company 
...
export const faq = {
  header: `Common questions on filing Dissolution`,
  faq: {
    items: [
      {
        question: `What are Articles of Distribution exactly?`,
        answer: `The articles formalize the cessation of activity as an incorporated entity. They define parameters surrounding the dissolution of a company. 
