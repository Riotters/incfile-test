...
export const about = {
  header: `Protect your business name with a trademark`,
...
export const howitworks = {
  header: `Trademark Searches & Registration: How it works?`,
};

export const faq = {
  header: `Common questions about Registering a Trademark`,
  faq: {
    items: [
      {
