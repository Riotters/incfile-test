...
export const about = {
    ...
    box: {
      header:
        `Why Should You Incorporate with Incfile`,
      text:
        `Signing up for the Incfile Registered Agent service also gives you access to your own business dashboard, so when you’re ready to form your business, or even just register a DBA, it’s all at your fingertips! 
...
export const includes = {
    header:
      `Incfile’s Resident Agent Service Includes`,
    cards: [
        {
            header:
        ...
        },
        {
            header:
                `First Year Free`,
            text:
                `The first year free ($119 a year after), when you incorporate with Incfile through any of our business packages.`
        },
    ],
    header2:
      `Registered Agent Service`,
...
export const faq = {
    header: 
        `Common questions about establishing Registered Agent service`,
    faq: {
        items: [
            {
                question:
                ...
                answer:
                    `Your service will be managed through the Registered Agent Dashboard any service of process that is received by us will be uploaded to the dashboard and an email 
            ...
            },
            {
                ...
                answer:
                    `The Registered Agent service is renewed annually. An email with renewal instructions will be sent one month prior to the due date. The service may be renewed anytime through the Registered Agent Dashboard.`,
            },
            {
                question:
            ...
            },
            {
                ...
                answer:
                    `Filing the Change of Agent for your company will be offered within the order process. If you select this option the state fee will be added to the cost of the Registered Agent service. 
            ...
            },
            {
                ...
                answer:
                    `The Registered Agent information will be listed in the confirmation email. It may also be obtained by logging into the Registered Agent Dashboard after the order is placed.`,
            },
            {
                question:
                    `What happens if I require the signature of the Registered Agent?`,
                answer:
                    `If the signature of the Registered Agent is required please contact our support staff for assistance. We are typically able to return the signed documents to our clients electronically however some states require original signatures on official documents. 
