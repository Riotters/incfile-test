export const top = {
  header: `Filing Your Certificate of Good Standing`,
  // text:
...
export const about = {
  header: `What is a Certificate of Good Standing?`,
  text: `A Certificate of Good Standing is an official document issued by your state’s secretary of state office to verify that your business is compliant within the state of incorporation and therefore is in “good standing.” 
  ...
  header2: `Other names for a Certificate of Good Standing`,

  text2: `Also known as a Certificate of Existence, Certificate of Authorization, or a Certificate of Status, the Good Standing Certificate is a one-page document provided by the secretary of state and provides 
        conclusive evidence of the status of your business entity. In many cases it can be valid up to three months.`,
  header3: `When do you need a Certificate of Good Standing?`,
  text3: `In certain situations, you may be required to prove that your business exists and is in compliance with relevant laws and regulations. A Certificate of Good Standing from your state serves as this proof. 
  ...
  box: {
    header: `There are a few key reasons why your company might need a Certificate of Good Standing:`,
    list: [
  ...
  text4: `Simply put, the Certificate of Good Standing helps you prove that your business exists, and that you are a law-abiding business owner who complies with the rules. 
  ...
  header4: `How do I get a Certificate of Good Standing?`,
  text5: `After you form your LLC or corporation, it’s important to stay up-to-date on filing your annual report, biennial report, or other required forms and compliance paperwork. 
        To stay in good standing, your business needs to meet a few key requirements, depending on your <a href="/llc-state-information/">company’s home state</a>. These typically include:`,
  box2: {
    header: ``,
    list: [`Being up-to-date on annual or biennial fees to the secretary of state to register or renew your business`, `Filing annual or biennial reports`, `Paying any other necessary business fees or franchise taxes to state regulators`],
  },
  text6: `To get a Certificate of Good Standing, you’ll need to file the appropriate form with your state, or you can have Incfile file for you.`,
};

export const help = {
  header: `Help to Obtain a Certificate of Good Standing`,
  header2: `Save your time. We'll handle the paperwork.`,
  text: `To obtain a Good Standing Certificate, the business entity must be registered as a legal entity with the secretary of state, and cannot be in default of corporate regulations, suspended or revoked by the state.`,
  link: {
...
export const faq = {
  header: `Common questions about filing a Certificate of Good Standing`,
  faq: {
    items: [
      {
        question: `Why do I need a Certificate of Good Standing?`,
        answer: `A Certificate of Good Standing is typically needed in the normal course of business by another organization (business partner, bank, lender, investor or regulatory authority) to prove that your business entity is legally 
      ...
      },
      {
        ...
        answer: `If the entity that the certificate is being requested for is not in good standing, we will contact you and provide details as to the status of 
