export const about = {
  ...
  header12: `What Happens If I Fail to Comply with the LLC Publication Requirement?`,
  text11: `The NY Department of State can suspend your authority to do business. Needless to say, this can be very problematic, so it’s important you meet the requirements. Although it can be a burdensome cost for an LLC, you do need to comply.`,
  header13: `How Much Does It Cost to Meet Publication Requirements?`,
