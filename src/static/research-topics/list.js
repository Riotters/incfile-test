export const pages = [
  ...
  { header: `S-Corporation`, text: `Can a foreign resident be a shareholder in an S Corporation?`, url: `/research-topics/s-corporation-info/foreign-resident-shareholder/#answers` },
  {
    header: `S-Corporation`,
    text: `Is there a limit to the amount of shareholders an S Corporat…`,
    url: `/research-topics/s-corporation-info/amount-of-shareholders/#answers`,
  },
  {
    header: `S-Corporation`,
    text: `Which entity offers the best tax advantages?`,
    url: `/research-topics/s-corporation-info/tax-advantages/#answers`,
  },
  ...
  { header: `Individual State Information`, text: `Meeting the New York Publication Requirement`, url: `/research-topics/state-info/ny-publication-requirement/#answers` },
  {
