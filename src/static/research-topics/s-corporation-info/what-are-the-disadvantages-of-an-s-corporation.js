export const about = {
  ...
  list: {
    ...
    list: [`S Corporations cannot have more than 100 individual (not entity) shareholders`, `S Corporations must have shareholders who are US Citizens or US Residents`, `S Corporations may only have one class of stock`],
  },
