export const about = {
  ...
  header4: `How LLCs and S Corps Differ: Profits and Voting Power`,
  text3: `An S Corporation divides profits between its shareholders evenly. Someone with 30 percent of the stock would receive 30 percent of the profits while another with 10 percent of the stock would receive 10 percent of the profits, and so on.`,
  text4: `This is not the case with the LLC. In an LLC, the members (akin to stockholders, although LLC’s usually issue “member units” as opposed to common stock) decide how profits should be divided. There may be someone with 10 percent of the “stock”, but they put in 30 percent of the work. This stockholder can receive more than what they have invested if the other members agree that they deserve it.`,
  ...
  header6: `The Benefits Of An S Corp`,
  text7: `Forming an S Corp does offer benefits not available to LLCs. If you have employees that you provide benefits to, an S Corporation will get better deductions in regards to benefits (health insurance, disability, and more.)`,
  text8: `In addition, the status of the pass through income is a little different as well for the personal service principals (the principals that are employees.) It is considered “passive income” and not “earned income (like it is with an LLC.) Thus, Social Security and Medicare taxes (at this writing) are not levied.`,
  text9: `Have you been in business for a long time, with no end in sight? An S Corp may be a better choice for you as LLC’s may have a limited shelf-life. Some states have a cap on how long they can stay in business (30 years, etc.)`,
  header7: `Choose The Right Business Entity To Protect Yourself (And Your Profits)`,
  text10: `Overall, S Corporations allow for more shareholder uniformity and tax savings, while an LLC allows more free negotiations and possibilities for ownership and accountability. Choosing which one is right for you depends on the unique needs and goals of your business.`,
};
