export const about = {
    ...
    text3: `For more information on the process of opening a business bank account,
      <a href="/" target="_blank">read our guide.</a>`,
      //https://www.incfile.com/blog/post/open-business-bank-account-for-llc/

    header3: `Paperwork Needed to Open a Business Account`,
    text4: `It’s important to get all your documents in order. That will minimize the time it takes to get your business bank account up and running.`,
    list3: {
      header: `Most banks will typically ask for the following information when you’re opening a business account:`,
      list: [
    ...
    text6: `Most businesses should have an Employer Identification Number (EIN), and LLCs and corporations must have one. You can get an EIN directly from the IRS, or Incfile can
      <a href="/manage-your-company/tax-id-ein" target="_blank">get you an EIN on your behalf.</a>
      You will need to provide the EIN as part of your account creation. Some businesses, like sole proprietors, can use the Social Security number of the owner instead.`,
    ...
    text8: `Many states and local municipalities require you to have a business license to operate in your area. If that’s the case, banks will want to know that you have the proper authorization. If you’re not sure what business licenses you need, Incfile can help. We offer a
      <a href="/manage-your-company/business-license" target="_blank">complete Business License Research package</a>
      that will tell you exactly what permits and licenses are required to run your business.`,
    ...
    text11: `These filings are variously known as trade names, assumed names, fictitious names or doing business as (DBA) names. You typically file an assumed name with your Secretary of State, although rules do vary between states. If you need to file an assumed name for your business,
      <a href="/manage-your-company/fictitious-business" target="_blank">Incfile can do that on your behalf.</a>
      If you’re operating under a name that’s different from your business name, you will need to provide the relevant document to the bank.`,
    ...
    text14: `Banks will want to see these documents as they demonstrate that you have proper governance in place to run the business. We’ve got
      <a href="/" target="_blank">plenty of information</a>
      on
      <a href="/research-topics/llc-info/llc-operating-agreement" target="_blank">Operating Agreements</a>
      and corporate bylaws.`,
      //https://www.incfile.com/blog/tag/form-a-business/entity-requirements/operating-agreement/
    text15: `Incfile can help you create an Operating Agreement tailored to your business, and this service is included with our
      <a href="/" target="_blank">Gold and Platinum business formation packages.</a>`,
      //https://www.incfile.com/form-order-now.php
    ...
    text17: `Do you need to form an LLC, S Corporation, C Corporation or nonprofit?
      <a href="/" target="_blank">We can help.</a>`,
      //https://www.incfile.com/form-order-now.php
    link: {
