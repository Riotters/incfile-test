export const about = {
  ...
  text3: `LLCs and corporations are formed on a “by state” basis. The business formation bodies in these states (typically the Secretary of State or Corporation Division) insist that <a href="https://www.incfile.com/blog/post/rules-for-naming-your-llc-an-entire-state-guide/" target="_blank" >every business has a unique name.</a> If your business doesn’t have a unique name, your formation documents will be rejected.`,
  ...
  text9: `The quickest and easiest way to learn if there’s an existing business with your proposed name in your state is to use our <a href="/business-name-search/" target="_blank">business name search tool.</a> It’s completely free, and you can search the business registry of any state and search for corporation and LLC names. We always recommend <a href="https://www.incfile.com/blog/post/find-out-business-name-already-registered/" target="_blank">checking for business name availability.</a> If the name is not available, try making it unique by changing the wording, adding additional words or changing the name entirely.`,
