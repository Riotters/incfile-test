export const about = {
    ...
    text3: `LLCs and corporations are formed on a “by state” basis. The business formation bodies in these states (typically the Secretary of State or Corporation Division) insist that
        <a href="/" target="_blank">every business has a unique name.</a>
        If your business doesn’t have a unique name, your formation documents will be rejected.`,
        //https://www.incfile.com/blog/post/rules-for-naming-your-llc-an-entire-state-guide/
    ...
    text7: `It’s common for business formation bodies to accept a name as unique if it differs only slightly from an existing name. This could be as small as adding another word or changing a word slightly. We’ve got some helpful hints on
        <a href="/" target="_blank">creating a good business name.</a>`,
        //https://www.incfile.com/blog/post/22-creative-business-name-ideas/
    ...
    text9: `The quickest and easiest way to learn if there’s an existing business with your proposed name in your state is to use our
        <a href="/learning-center-entity/business-name-search" target="_blank">business name search tool.</a>
        It’s completely free, and you can search the business registry of any state and search for corporation and LLC names. We always recommend
        <a href="/" target="_blank">checking for business name availability.</a>
        If the name is not available, try making it unique by changing the wording, adding additional words or changing the name entirely.`,
    ...
    text14: `If you want to protect your business name throughout the U.S., you can do that by filing a trademark.`,
    list3: {
        header: `You might think a copyright or patent is appropriate, but they’re used for different purposes:`,
        list: [
    ...
    text15: `You can trademark your business name, though.`,
    list4: {
        header: `Here’s what the 
        <a href="https://www.uspto.gov/" rel="noopener noreferrer nofollow" target="_blank">U.S. Patent and Trademark Office says:</a>`,
        list: [
    ...
    text17: `Here at Incfile, we provide a
        <a href="/manage-your-company/trademark-name-search" target="_blank">complete Trademark Search and Registration service</a>
        that you can use to protect your business name in the U.S.`,
    ...
    list5: {
        list: [
          ...
          `You should check if other businesses have the same or similar names
          <a href="/learning-center-entity/business-name-search" target="_blank">using our tool.</a>`,
          ...
          `If you want to protect your name across all 50 states, 
          <a href="/manage-your-company/trademark-name-search" target="_blank">use our Trademark Search and Registration service.</a>`,
        ],
      },
