    ...
    content: [
      {
        ...
        text:
          `A C Corporation is one of several ways to legally recognize a business for tax, regulatory and official reasons. 
        ...
        box: {
          ...
          text:
            `This is particularly true if they intend to publicly trade shares, through having an Initial Public Offering, or IPO. 
...
export const differences = {
  ...
  text:
    `See how a C Corporation compares to other entities:`,
  box: {
          header: 
