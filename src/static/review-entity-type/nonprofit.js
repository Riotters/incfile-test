export const top = {
  header: `Starting a nonprofit can truly help make the world better`,
  text: `Start for $0 + state fee. Learn how forming an LLC, an S-Corporation, an C-Corporation, or a Non Profit will impact both your liability and taxation.`,
  button: [
    {
      text: "Start Now",
      url: "/",
