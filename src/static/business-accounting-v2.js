...
export const cards2 = [
    {
        ...
        content: "Every accounting package includes a free tax consultation. A small business accountant will review your business finances and help you understand where you could be saving money. They will offer practical advice on your expenses, tax commitments and other areas to help you reduce the tax you owe.",
        imageName: "headphones-helpdesk-service-4597"
    },
    {
        backgroundColor: color.green3,
        title: "Professional Small Business Bookkeeping",
        content: "You get access to easy-to-use bookkeeping software and monthly reports, so you’ll always know how your business is doing. You also get support from a professional, qualified bookkeeper as part of your expert bookkeeping team. Many new business owners miscategorize transactions, which can result in missing out on possible tax savings. A professional bookkeeper can help you avoid these mistakes and maximize your tax deductions.",
...
export const ins_and_outs = {
    ...
    text: "With small business accounting, it’s important to understand the unique tax requirements of different types of business entities. Incfile’s business accountants take the confusion out of tax filing and help you ensure your business follows the right procedures, whether you’re an LLC, S Corp or C Corp.",
        ...
        items: [
            {
                ...
                answer: "A C Corporation is required to pay corporate income tax. Unlike an LLC or S Corporation, this type of business structure is not a pass-through entity. This means your C Corporation will have to pay taxes on the business’s income, and then the business owners will also have to pay personal income tax upon the taxable dividends paid to the owners by the business. This is known as “double taxation” because your company has to pay corporate income tax first, and then you as the business owner have to pay personal income tax.",
                list: [
