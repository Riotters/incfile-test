...
export const top = {
	...
	text:
		"Every small business owner wants to make accounting easier. That’s why Incfile offers complete business accounting and bookkeeping services \n" +
...
export const accounting = {
	header:
		"We take care of all your accounting and tax needs without you having to search for the right accountant \n" +
		"or bookkeeper elsewhere.",
	text:
		"<span>We take care of all your accounting and tax needs without you having to search for the right accountant or bookkeeper elsewhere.</span>It’s all part of our aim to become your trusted business partner, providing the support, services and expertise you need to make running your organization a breeze.",
...
export const cards = [
	...
	},
	{
		...
		text:
			"Mobile-friendly bookkeeping software allows you \n" +
	...
	},
	{
		...
		text:
			"Access to accountants for any IRS notices \n" +
	...
	faq: {
		items: [
			...
			},
			{
				...
				answer: `<p>If you set up your company to be an S Corporation, or elect to have your LLC file taxes as an S Corporation, this may provide you with some tax advantages to reduce your self-employment tax liability.</p></br>
