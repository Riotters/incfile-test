...
export const states = {
    ...
    table: {
        ...
        rows: [
            ...
            [`Arizona`, `check-red`, `-`, `-`],
            [`California`, `check-red`, `-`, `-`],
            [`Colorado`, `check-red`, `-`, `-`],
            [`Connecticut`, `check-red`, `-`, `-`],
            [`Washington DC`, `check-red`, `-`, `-`],
            [`Delaware`, `check-red`, `-`, `-`],
            [`Georgia`, `check-red`, `-`, `-`],
            [`Hawaii`, `check-red`, `-`, `-`],
            [`Iowa`, `check-red`, `-`, `-`],
            ...
            [`Minnesota`, `check-red`, `-`, `-`],
            [`Missouri`, `check-red`, `-`, `-`],
            [`Mississippi`, `check-red`, `-`, `-`],
            [`Montana`, `check-red`, `-`, `-`],
            [`North Carolina`, `check-red`, `-`, `-`],
            [`North Dakota`, `check-red`, `-`, `-`],
            [`Nebraska`, `check-red`, `-`, `-`],
            [`New Hampshire`, `check-red`, `-`, `-`],
            [`New Jersey`, `check-red`, `-`, `-`],
            ...
            [`Oklahoma`, `check-red`, `-`, `-`],
            [`Oregon`, `check-red`, `-`, `-`],
            [`Pennsylvania`, `check-red`, `-`, `-`],
            [`Rhode Island`, `check-red`, `-`, `-`],
            [`South Carolina`, `check-red`, `-`, `-`],
            [`South Dakota`, `check-red`, `-`, `-`],
            [`Tennessee`, `check-rgreen`, `Assumed name`, `$20`],
            [`Texas`, `check-rgreen`, `Certificate of assumed business name`, `-`],
