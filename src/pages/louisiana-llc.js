...
function LLCIndex() {
  return (
    <Layout>
      <SEO title="LLCs in Lousiana | Guide to Forming an LLC in Louisiana" description="Ready to form your Louisiana LLC? Here are the steps you need to take, plus helpful tips and resources to make it easy. Read more." />
      <LLCLayout>
