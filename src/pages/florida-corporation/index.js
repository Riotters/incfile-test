...
//Texts
import { top, tabPages, corporation, launchBusiness, requirements, learnMore, quickLinks, variants, subscription } from "../../static/learning-center-entity/state-information-florida";
...
const StateInformation = () => (
    <Layout>
        <SEO title="Florida Corporations & Other Business Entities " description="Thinking of starting an S Corp, C Corp, or LLC in Florida? Learn about corporations in FL and decide which business type is right for you." />
