...
import {
  ...
  calculator,
  compare,
} from "../static/learning-center-entity/s-corp-tax-calculator";

const SCorpTaxCalculator = () => (
  <Layout>
    <SEO
      title="S Corporation Tax Calculator"
      description="Use the S Corporaton Tax Calculator to compare self employment tax savings over a sole proprietorship"
    />
    <Top
      imageName="mr-bulb-s-corp-tax-0214"
      imageAlt="s corporation tax calculator"
      ovalColor="darkblue"
      contentWidth="55"
      headlineWidth="700"
