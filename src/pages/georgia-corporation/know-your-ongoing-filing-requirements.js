...
const GeorgiaCorporation = () => {
	...
	return (
		<Layout>
			<SEO
				title="Managing Your Georgia S Corp or C Corp After Formation"
				description="Learn about the taxes and fees you&#039;ll be required to pay for your Georgia corporation, plus find out the tax differences between GA S Corps and C Corps."
			/>
			<Top
