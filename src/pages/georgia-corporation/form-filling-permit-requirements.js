...
const GeorgiaCorporation = () => {
	...
	return (
		<Layout>
			<SEO
				title="Forms & Filing Rules for Georgia S Corps & C Corps"
				description="From annual reports to business licenses and permits, learn about the forms and filing requirements for your Georgia corporation."
			/>
			<Top
