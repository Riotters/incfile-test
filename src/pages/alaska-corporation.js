  ...
  return (
    <Layout>
      <SEO
        ...
        description="Incorporating a business in Alaska doesn't have to be hard. Get info on everything from operating agreements to state filing times, taxes and fees."
      />
      <Top
        ...
        <ReactTabs content={tabs}>
          ...
          <TabPanel>
            <PanelWrapper>
              ...
              />
              <Paragraph big>
                Some other provisions that aren’t required-but which may be
            ...
            <PanelWrapper>
              ...
              <TextBoxed style={{ marginBottom: "8px" }}>
                <Paragraph bottomMargin={0}>
                  The corporation’s name and state or country of original
                  incorporation
                </Paragraph>
              </TextBoxed>
