...
import {advantages, faqs, top} from "../static/learning-center-entity/nevada-virtual-mailboxes";
...
const VirtualMailBoxes = () => (
    <Layout>
        <SEO title="Nevada Virtual Mailbox & Mail Scanning Service" description="Need a business address in NE? Our virtual mailbox service gives you a real street address and lets you get your mail no matter where you are. Learn more." />
