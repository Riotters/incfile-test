...
import {
	...
	startBusiness,
	faq,
} from "../static/entity-search/new-york-entity-search";

const GeneralResearchTopics = () => {
	return (
		<Layout>
			<SEO
				title="New York Business Entity Search | Is Your Name Available?"
				description="Starting a new business in NY? Check to see if your preferred business name is available with Incfile’s easy name search tool. Try it now."
			/>
			<Top
