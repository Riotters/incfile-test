...
const GeneralResearchTopics = () => {
    return (
        <Layout>
            <SEO title="New York Entity Search" description="Starting a new business in NY? Check to see if your preferred business name is available with Incfile’s easy name search tool. Try it now." />
