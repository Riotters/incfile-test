...
import { info, questions, service, top, articlesOfIncorporation} from "../static/learning-center-entity/hawaii-corporation";
...
const AlaskaCorporation = () => {
    ...
    return (
        <Layout>
            <SEO title="Form a Corporation or LLC in Hawai Today | Incfile" description="Incorporating in Hawaii is easy. Get access to articles of incorporation requirements, filing times and fees, and answers to FAQs." />
                ...
                <TabsSection>
                    ...
                    <CollapseWrapper>
                        ...
                        <PanelWrapper>
                            ...
                            <TextBoxed style={{ marginBottom: "8px" }}>
                                <Paragraph bottomMargin={0}>The corporation’s name and where (state or country) it was incorporated.</Paragraph>
                            </TextBoxed>
                            <TextBoxed style={{ marginBottom: "8px" }}>
                                <Paragraph bottomMargin={0}>The company’s principal office mailing address, its registered office address in Hawaii, and the name of its registered agent at its registered office in Hawaii.</Paragraph>
                            </TextBoxed>
                            <TextBoxed style={{ marginBottom: "8px" }}>
                                <Paragraph bottomMargin={0}>The names and business addresses of its directors and officers.</Paragraph>
                            </TextBoxed>
                            <TextBoxed style={{ marginBottom: "8px" }}>
                        ...
                        <PanelWrapper>
                            ...
                            <Paragraph big>The corporate tax rate for Hawaii varies based on taxable net income.</Paragraph>
                        </PanelWrapper>
                    </CollapseWrapper>
                </TabsSection>
            </TabsWrapper>
