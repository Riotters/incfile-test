    ...
    <Layout>
        ...
        <Container>
            <Wrapper>
                ...
                <h3>Primary</h3>
                <FlexWrapper>
                    <Button theme="primary40" arrow="yes" margin="0 0 30px 0"
                            marginMD="auto 30px auto 0">Subscribe</Button>
                    <Button theme="primary48" arrow="yes" margin="0 0 30px 0" marginMD="auto 30px auto 0">Start
                        Now</Button>
                    <Button theme="primary56" arrow="yes">Start Now</Button>
                </FlexWrapper>
                <h3>Secondary</h3>
                <FlexWrapper>
                    <Button theme="secondary40" arrow="yes" margin="0 0 30px 0"
                            marginMD="auto 30px auto 0">Subscribe</Button>
                    <Button theme="secondary48" arrow="yes" margin="0 0 30px 0" marginMD="auto 30px auto 0">Start
                        Now</Button>
            ...
            <Wrapper>
                ...
                <GridWrapper columns="2">
                    <GreyWrapper>
                        <CheckText>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque faucibus volutpat nisi
                                sed faucibus. Quisque luctus orci nec nisl vestibulum ultrices.
                            </p>
                        </CheckText>
                    </GreyWrapper>
                    <DarkGreyWrapper>
                ...
                <GreyWrapper>
                    <TextBlockWithImage SvgImage={OkIcon} imageBackgroundColor="#fce7d0" imageShadowColor="#fce7d0">
                        ...
                        <Paragraph>
                            You might want to target your listings to a particular type of guest, so if you know there’s
                            a market, make sure your accommodation reflects what might be of value to them. For example,
                            younger people might want vibrant nightlife and a very modern place to stay, while older
                            people could want more peace and quiet, with natural outside space.
                        </Paragraph>
                    </TextBlockWithImage>
                </GreyWrapper>
