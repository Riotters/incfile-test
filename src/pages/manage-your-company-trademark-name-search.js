...
const ChangeOfRegisteredAgent = () => (
  <Layout>
    ...
    <BusinessOwnerResponsibilities>
      <ImageContent image="shield" paddingTop="60">
        <h3>Protect your business name with a trademark</h3>
        <p>
            Protecting your trademark can really pay dividends. 
            Not only is it a valuable property asset, but it’s also your brand, your reputation. 
        ...
        <Colorbox className="purplebox" theme="icon" Icon={ShieldSVG} color={color.orange3} curve curveColor={color.yellow1}>
          ...
          <p>
            ...
            Our partnered attorneys will do the research to make sure the mark isn't already taken, ensure the filing gets 
            accepted by the government office, and provide sound legal advice throughout the entire process.
          </p>
        </Colorbox>
      </ImageContent>
    </BusinessOwnerResponsibilities>
