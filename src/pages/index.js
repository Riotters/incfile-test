    ...
    <Layout>
        <Container>
            <Wrapper>
                ...
                <Link to="/learning-center-entity/state-information-california">State Information California
                    (WIP)</Link>
                <Link to="/learning-center-entity/ongoing-filing-requirements">Ongoing Filing Requirements (no
                    details)</Link>
                ...
                <Link to="/type-of-business/restaurant-business">Restaurant Business (no details)</Link>
                <Link to="/type-of-business/summer-business">Summer Business (no details)</Link>
