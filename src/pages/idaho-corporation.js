...
import { info,  questions, service, top, articlesOfIncorporation } from "../static/learning-center-entity/idaho-corporation";
...
const AlaskaCorporation = () => {
    ...
    return (
        <Layout>
            <SEO title="Form a Corporation or LLC in Idaho Today | Incfile" description="Are you incorporating in Idaho? Learn everything you need to know about choosing a business name, filing times and prices, taxation, bylaws and more." />
