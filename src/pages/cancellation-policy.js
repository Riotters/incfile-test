...
const CompareStateTimes = () => (
	<Layout>
		<SEO
			title="Incfile Cancellation Policy | How Do I Cancel my Incfile Order"
			description="To cancel your Incfile order, contact customer service with 24 hrs of your order. Learn more. "
		/>
		<Top content={top} />
