	...
	<Layout>
		<Container>
			<Wrapper>
				...
				<Link to="/manage-your-company/certificate-of-good-standing/">
					Certificate of good standing
				</Link>
				<Link to="/manage-your-company/change-of-registered-agent/">
				...
				<Link to="/manage-your-company/dissolution/">
					Filing Articles of Dissolution
				</Link>
				<Link to="/manage-your-company/foreign-qualification/">
				...
				<Link to="/manage-your-company/corporatellc-kit/">
					Corporate LLC Kit
				</Link>
				<Link to="/business-accounting/">Filling Business Taxes</Link>
				<Link to="/fictitious-business-or-trade-name/">
					Fictitious Business
				</Link>
				<Link to="/home-page-v3/">Home Page v3</Link>
				<Link to="/compare-state-filling-times/">
					Compare State Filling Time
				</Link>
				...
				<Link to="/california-virtual-mailbox/">
				...
				<Link to="/massachusetts-virtual-mailbox/">
					Massachusetts Virtual mailbox
				</Link>
				<Link to="/nevada-virtual-mailbox/">Nevada Virtual mailbox</Link>
				<Link to="/new-york-virtual-mailbox/">New York Virtual mailbox</Link>
				<Link to="/new-mexico-virtual-mailbox/">
					New Mexico Virtual mailbox
				</Link>
				<Link to="/new-jersey-virtual-mailbox/">
					New Jersey Virtual mailbox
				</Link>
				<Link to="/north-carolina-virtual-mailbox/">
					North Carolina Virtual mailbox
				</Link>
				<Link to="/ohio-virtual-mailbox/">Ohio Virtual mailbox</Link>
				<Link to="/south-carolina-virtual-mailbox/">
					South Carolina Virtual mailbox
				</Link>
				<Link to="/oregon-virtual-mailbox/">Oregon Virtual mailbox</Link>
				<Link to="/south-dakota-virtual-mailbox/">
					South Dakota Virtual mailbox
				</Link>
				<Link to="/texas-virtual-mailbox/">Texas Virtual mailbox</Link>
				<Link to="/pennsylvania-virtual-mailbox/">
					Pennsylvania Virtual mailbox
				</Link>
				<Link to="/utah-virtual-mailbox/">Utah Virtual mailbox</Link>
				<Link to="/virginia-virtual-mailbox/">Virginia Virtual mailbox</Link>
				<Link to="/washington-virtual-mailbox/">
					Washington Virtual mailbox
				</Link>

				<h2>Search your name availability</h2>
				<Link to="/new-york-entity-search">
					New York Business Entity Search | Is Your Name Available?
				</Link>
				...
				<Link to="/arizona-publication-newspaper-list/">
					Arizona Publication Newspaper List
				</Link>
				...
				<Link to="/research-topics/business-taxes/sellers-permit">
					How to Get a Seller's Permit?
				</Link>
				<Link to="/research-topics/business-taxes/minimizing-tax-expenses">
					Minimizing tax expenses
				</Link>
				<Link to="/research-topics/business-taxes/tax-advantages">
					Which entity offers the best tax advantages?
				</Link>
				<Link to="/research-topics/business-taxes/s-corp-taxing">
					How is an S Corporation Taxed?
				</Link>
				<Link to="/research-topics/business-taxes/nonprofit-tax-exempt">
					Is nonprofit the same as tax exempt?
				</Link>
				<Link to="/research-topics/business-taxes/c-corp-taxing">
					How is a C Corporation Taxed?
				</Link>

				<Link to="/research-topics/c-corporation-info">C-Corporation</Link>
				<Link to="/research-topics/c-corporation-info/corp-seal">
					What is a Corporate Seal?
				</Link>
				<Link to="/research-topics/c-corporation-info/tax-advantages">
					Which entity offers the best tax advantages?
				</Link>
				<Link to="/research-topics/c-corporation-info/filing-a-c-corporation">
					The benefits of filing a C-corporation
				</Link>
				<Link to="/research-topics/c-corporation-info/llcs-vs-c-corporation">
					LLCs vs C-Corporation: Which Is Best for Your Business?
				</Link>
				<Link to="/research-topics/c-corporation-info/corp-managing">
					How is a Corporation Managed?
				</Link>
				<Link to="/research-topics/c-corporation-info/c-corp-taxing">
					How is a C Corporation Taxed?
				</Link>
				<Link to="/research-topics/c-corporation-info/corporate-meetings">
					Am I Required to Hold Corporate Meetings?
				</Link>
				<Link to="/research-topics/c-corporation-info/corporation-need">
					How Many Shares of Stock will my Corporation Need?
				</Link>
				<Link to="/research-topics/c-corporation-info/what-are-bylaws">
					What are Bylaws?
				</Link>
				<Link to="/research-topics/c-corporation-info/stock-par-value">
					What is Stock Par Value?
				</Link>
				<Link to="/research-topics/c-corporation-info/form-2553">
					What is the Form 2553?
				</Link>
				<Link to="/research-topics/c-corporation-info/directors-and-shareholders">
					What are the Differences Between Officers, Directors and Shareholders?
				</Link>
				<Link to="/research-topics/c-corporation-info/own-a-corporation-or-llc">
					Are Non-U.S. Residents Allowed to Own a Corporation or LLC?
				</Link>
				<Link to="/research-topics/c-corporation-info/require-an-attorney">
					Does Forming an LLC (Limited Liability Company) or Corporation Require
					an Attorney?
				</Link>
				<Link to="/research-topics/c-corporation-info/publication-requirement">
					What is a Publication Requirement?
				</Link>
				<Link to="/research-topics/c-corporation-info/customized-corp-llc-kit">
					What is the Customized Corporate/LLC Kit?
				</Link>

				<Link to="/research-topics/s-corporation-info">S-Corporation</Link>
				<Link to="/research-topics/s-corporation-info/corporate-meetings">
					Am I Required to Hold Corporate Meetings?
				</Link>
				<Link to="/research-topics/s-corporation-info/foreign-resident-shareholder">
					Can a foreign resident be a shareholder in an S Corporation?
				</Link>
				<Link to="/research-topics/s-corporation-info/require-an-attorney">
					Does Forming an LLC (Limited Liability Company) or Corporation Require
					an Attorney?
				</Link>
				<Link to="/research-topics/s-corporation-info/corp-managing">
					How is a Corporation Managed?
				</Link>
				<Link to="/research-topics/s-corporation-info/s-corp-taxing">
					How is an S Corporation Taxed?
				</Link>
				<Link to="/research-topics/s-corporation-info/amount-of-shareholders">
					Is there a limit to the amount of shareholders an S Corporation can
					have?
				</Link>
				<Link to="/research-topics/s-corporation-info/llc-vs-s-corporation">
					LLC vs. S Corporation
				</Link>
				<Link to="/research-topics/s-corporation-info/s-corp-form-advantages">
					The Advantages of Forming an S Corporation
				</Link>
				<Link to="/research-topics/s-corporation-info/what-are-bylaws">
					What are Bylaws?
				</Link>
				<Link to="/research-topics/s-corporation-info/s-corp-advantages">
					What are the Advantages of an S Corporation?
				</Link>
				<Link to="/research-topics/s-corporation-info/directors-and-shareholders">
					What are the Differences Between Officers, Directors and Shareholders?
				</Link>
				<Link to="/research-topics/s-corporation-info/s-corp-disadvantages">
					What are the Disadvantages of an S Corporation?
				</Link>
				<Link to="/research-topics/s-corporation-info/publication-requirement">
					What is a Publication Requirement?
				</Link>
				<Link to="/research-topics/s-corporation-info/customized-corp-llc-kit">
					What is the Customized Corporate/LLC Kit?
				</Link>
				<Link to="/research-topics/s-corporation-info/s-corporation-status">
					Who Will Typically Elect the S Corporation Status?
				</Link>
				<Link to="/research-topics/s-corporation-info/s-corp-distribution">
					How to Take a Distribution from an S Corp?
				</Link>
				<Link to="/research-topics/s-corporation-info/corporation-need">
					How Many Shares of Stock will my Corporation Need?
				</Link>
				<Link to="/research-topics/s-corporation-info/corp-seal">
					What is a Corporate Seal?
				</Link>
				<Link to="/research-topics/s-corporation-info/tax-advantages">
					Which entity offers the best tax advantages?
				</Link>
				...
				<Link to="/research-topics/llc-info/require-an-attorney">
					Does Forming an LLC (Limited Liability Company) or Corporation Require
					an Attorney?
				</Link>
				...
				<Link to="/research-topics/llc-info/llc-without-listing-members">
					Can an LLC be formed without listing the member on the articles of
					organization?
				</Link>
				<Link to="/research-topics/llc-info/llc-for-your-entity">
					Is an LLC the best fit for your entity?
				</Link>
				<Link to="/research-topics/llc-info/llc-vs-c-corporation">
					LLC vs. C Corporation
				</Link>
				<Link to="/research-topics/llc-info/llc-vs-s-corporation">
					LLC vs. S Corporation
				</Link>
				...
				<Link to="/research-topics/llc-info/llc-operating-agreement">
					The LLC Operating Agreement
				</Link>
				<Link to="/research-topics/llc-info/llc-meaning">
					What Does LLC Mean?
				</Link>
				<Link to="/research-topics/llc-info/publication-requirement">
					What is a Publication Requirement?
				</Link>
				<Link to="/research-topics/llc-info/what-is-an-llc">
					What is an LLC (Limited Liability Company)?
				</Link>
				<Link to="/research-topics/llc-info/customized-corp-llc-kit">
					What is the Customized Corporate/LLC Kit?
				</Link>
				<Link to="/research-topics/llc-info/changing-llc-name">
					What is the process involved in changing the name of an LLC?
				</Link>
				<Link to="/research-topics/llc-info/tax-advantages">
					Which entity offers the best tax advantages?
				</Link>
				<Link to="/research-topics/llc-info/choosing-entity-type">
					Which entity type should I choose?
				</Link>
				<Link to="/research-topics/llc-info/llc-members-operating-agreement">
					Why it’s important for the members on an LLC to have an operating
					agreement in place?
				</Link>

				<Link to="/research-topics/ein-info">
					Employer Identification Number (EIN)
				</Link>
				<Link to="/research-topics/ein-info/identification-number">
					Employer Identification Number
				</Link>

				<Link to="/research-topics/nonprofit-info">Nonprofit</Link>
				<Link to="/research-topics/nonprofit-info/what-is-a-nonprofit">
					What is a Nonprofit Corporation?
				</Link>
				<Link to="/research-topics/nonprofit-info/corporate-meetings">
					Am I Required to Hold Corporate Meetings?
				</Link>
				<Link to="/research-topics/nonprofit-info/profit-from-nonprofit">
					Can a Nonprofit Corporation Make a Profit?
				</Link>
				<Link to="/research-topics/nonprofit-info/require-an-attorney">
					Does Forming an LLC (Limited Liability Company) or Corporation Require
					an Attorney?
				</Link>
				<Link to="/research-topics/nonprofit-info/forming-nonprofit-corp">
					Forming a Nonprofit Corporation
				</Link>
				<Link to="/research-topics/nonprofit-info/nonprofit-corp-name">
					How do I Choose a Name for my Nonprofit Corporation?
				</Link>
				<Link to="/research-topics/nonprofit-info/corp-managing">
					How is a Corporation Managed?
				</Link>
				<Link to="/research-topics/nonprofit-info/directors-and-officers-in-nonprofit">
					How many Directors or Officers are Nonprofit Corporations required to
					have?
				</Link>
				<Link to="/research-topics/nonprofit-info/nonprofit-tax-exempt">
					Is “Nonprofit” the Same as “Tax-Exempt”?
				</Link>
				<Link to="/research-topics/nonprofit-info/nonprofit-compensation">
					May a Nonprofit Corporation Pay Compensation to its Officers,
					Directors and/or Employees?
				</Link>
				<Link to="/research-topics/nonprofit-info/not-for-profit-vs-nonprofit">
					Not-for-Profit and Nonprofit: What’s the Difference?
				</Link>
				<Link to="/research-topics/nonprofit-info/what-are-bylaws">
					What are Bylaws?
				</Link>
				<Link to="/research-topics/nonprofit-info/directors-and-shareholders">
					What are the Differences Between Officers, Directors and Shareholders?
				</Link>
				<Link to="/research-topics/nonprofit-info/customized-corp-llc-kit">
					What is the Customized Corporate/LLC Kit?
				</Link>
				<Link to="/research-topics/nonprofit-info/non-profit-by-steps">
					What Steps Need to be Taken to Form a Nonprofit Corporation?
				</Link>
				<Link to="/research-topics/nonprofit-info/where-to-form-nonprofit">
					Where Should I Form my Nonprofit Corporation?
				</Link>

				<Link to="/research-topics/general-research">General</Link>
				<Link to="/research-topics/general-research/require-an-attorney">
					Does Forming an LLC (Limited Liability Company) or Corporation Require
					an Attorney?
				</Link>
				<Link to="/research-topics/general-research/incfile-discount-coupon">
					Does Incfile have a Discount or Coupon Code?
				</Link>
				<Link to="/research-topics/general-research/llc-inc-designator-companies-name">
					Does the designator “LLC” or “Inc.” always need to be included in your
					companies name?
				</Link>
				<Link to="/research-topics/general-research/how-to-get-trademark">
					How to Get a Trademark: A Complete Guide?
				</Link>
				<Link to="/research-topics/general-research/forming-llc-or-corp">
					In Which State Should I Form my LLC or Corporation?
				</Link>
				<Link to="/research-topics/general-research/llc-and-corporation-requirements">
					LLC and Corporation Ongoing Compliance Requirements
				</Link>
				<Link to="/research-topics/general-research/llc-incorporate-name">
					Should I assume that if I form an LLC or incorporate that no one else
					can use the same name?
				</Link>
				<Link to="/research-topics/general-research/corp-seal">
					What is a Corporate Seal?
				</Link>
				<Link to="/research-topics/general-research/what-is-a-nonprofit">
					What is a Nonprofit Corporation?
				</Link>
				<Link to="/research-topics/general-research/publication-requirement">
					What is a Publication Requirement?
				</Link>
				<Link to="/research-topics/general-research/what-is-an-llc">
					What is an LLC (Limited Liability Company)?
				</Link>
				<Link to="/research-topics/general-research/customized-corp-llc-kit">
					What is the Customized Corporate/LLC Kit?
				</Link>
				...
				<Link to="/research-topics/general-research/entity-remains-compliant">
					What steps do I need to take to ensure that my entity remains
					compliant?
				</Link>
				<Link to="/research-topics/general-research/tax-advantages">
					Which entity offers the best tax advantages?
				</Link>
				<Link to="/research-topics/general-research/choosing-entity-type">
					Which entity type should I choose?
				</Link>

				<Link to="/research-topics/state-info">
					Individual State Information
				</Link>
				<Link to="/research-topics/state-info/publish-inc-notice-georgia">
					How To Publish Your Notice Of Incorporation In Georgia?
				</Link>
				<Link to="/research-topics/state-info/ny-publication-requirement">
					How to Meet New York LLC Publication Requirements?
				</Link>

				<Link to="/research-topics/registered-agent-info-update">
					Registered Agent
				</Link>
				<Link to="/research-topics/registered-agent/own-registered-agent">
					Can I Be My Own Registered Agent?
				</Link>
				<Link to="/research-topics/registered-agent/registered-agent-company">
					Can the registered agent be a company?
				</Link>
				<Link to="/research-topics/registered-agent/service-cost">
					How much will it cost to renew my Registered Agent service?
				</Link>
				<Link to="/research-topics/registered-agent/service-process-notify">
					How will I be notified if service of process is received?
				</Link>
				<Link to="/research-topics/registered-agent/registered-agent-renew">
					How will I know when it is time to renew my Registered Agent?
				</Link>
				<Link to="/research-topics/registered-agent/registered-agent-tasks">
					What does a Registered Agent do?
				</Link>
				<Link to="/research-topics/registered-agent/registered-agent-signature">
					What happens if I require the signature of my Registered Agent?
				</Link>
				<Link to="/research-topics/registered-agent/registered-agent-function">
					What is the main function of the Registered Agent?
				</Link>
				<Link to="/research-topics/registered-agent/registered-agent-address">
					What is the name and address of my Registered Agent?
				</Link>
				<Link to="/research-topics/registered-agent/registered-agent-resigns">
					What will happen to my company if the registered agent resigns?
				</Link>
				<Link to="/research-topics/registered-agent/registered-agent-info-update">
					Who will be responsible for updating the Registered Agent information
					with the state?
				</Link>

				<Link to="/research-topics/video-library">Video Library</Link>
				<Link to="/research-topics/video-library/forming-llc-or-corp">
					How Easy Is Forming an LLC or Corporation
				</Link>
				<Link to="/research-topics/video-library/save-with-incfile">
					Learn How To Save Money With Incfile
				</Link>
				<Link to="/research-topics/video-library/protect-assets">
				...
				<Link to="/start-a-business/boutique-clothing-business">
					Boutique Clothing Business
				</Link>
				<Link to="/start-a-business/social-media-influencer">
				...
				<Link to="/start-a-business/construction-company">
					Construction Company
				</Link>
				<Link to="/start-a-business/publishing-company-business">
				...
				<Link to="/start-a-business/real-estate-business">
					Real Estate Business
				</Link>
				<Link to="/start-a-business/digital-nomad-business/">
					Digital Nomad
				</Link>
				...
				<Link to="/start-a-business/franchise-business">
					Franchise Business
				</Link>
				...
				<Link to="/start-a-business/consulting-business">
					Consulting Business
				</Link>
				<Link to="/start-a-business/with-no-money-business">
					With No Money Business
				</Link>
				<Link to="/start-a-business/photography-business">
					Photography Business
				</Link>
				<Link to="/start-a-business/women-business">Women Business</Link>
				<Link to="/start-a-business/restaurant-business">
					Restaurant Business
				</Link>
