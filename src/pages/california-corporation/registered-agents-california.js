...
//Texts
import { top, tabPages, agents, launchBusiness, subscription } from "../../static/learning-center-entity/state-information-california";
...
const CaliforniaCorporation = () => {
    ...
    return (
        <Layout>
            <SEO title="Registered Agent Rules for California S Corps & C Corps" description="Do you need a registered agent for your California corporation? Learn about the rules, requirements, and how a registered agent can benefit your business." />
