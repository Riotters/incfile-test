...
const TexasCorporation = () => {
	...
	return (
		<Layout>
			<SEO
				title="Taxes & Fees for Texas S Corps & C Corps"
				description="Learn about the taxes and fees you'll be required to pay for your Texas corporation, plus find out the tax differences between TX S Corps and C Corps."
			/>
			<Top
