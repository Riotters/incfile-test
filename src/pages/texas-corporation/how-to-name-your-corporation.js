...
const TexasCorporation = () => {
	...
	return (
		<Layout>
			<SEO
				title="Naming a Texas Corporation | TX Business Name Rules"
				description="Choosing the right name for your business helps you get off on the right foot. Learn about the rules for naming a business in Texas."
			/>
			<Top
