...
import {
  ...
  launchBusiness,
  subscription,
} from "../../static/learning-center-entity/state-information-texas";
...
const TexasCorporation = () => {
  ...
  return (
    <Layout>
      <SEO
        title="Registered Agent Rules for Texas S Corps & C Corps"
        description="Do you need a Registered Agent for your Texas corporation? Learn about the rules, requirements, and how a Registered Agent can benefit your business."
      />
      <Top
        imageName="mr-bulb-corporation-california-8302"
        imageAlt="registered agent in texas"
        ovalColor="purple-2"
        textWidth="530"
      >
        <h1>{top.header}</h1>
