...
import { info, questions, service, top, articlesOfIncorporation} from "../static/learning-center-entity/kansas-corporation";
...
const AlaskaCorporation = () => {
    ...
    return (
        <Layout>
            <SEO title="Form a Corporation or LLC in Kansas Today | Incfile" description="Want to know how to incorporate in Kansas? Find information on filing schedules and fees, taxation, management structure and more." />
