...
const OregonCorporation = () => {
  ...
  return (
    <Layout>
          ...
          <TabPanel>
            <PanelWrapper>
              ...
              <Paragraph big>
                ...
                articles of incorporation with the Secretary of State, including
                the following:
              </Paragraph>
              ...
              <Paragraph big>
                Oregon also permits optional provisions to be included in the
      ...
      <Rocket urlParams="?entityType=CCorporation&entityState=OR" />
