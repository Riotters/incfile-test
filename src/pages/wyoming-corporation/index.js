...
const WyomingCorporation = () => {
	...
	return (
		<Layout>
			<SEO
				title="Form a Corporation or LLC in Wyoming Today | Incfile"
				description="Incfile makes incorporating in Wyoming easy. Learn how to structure your business, choose a name, what documents are required and more."
			/>
			<Top
