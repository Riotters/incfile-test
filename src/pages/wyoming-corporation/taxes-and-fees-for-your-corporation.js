...
const WyomingCorporation = () => {
	...
	return (
		<Layout>
			<SEO
				title="Wyoming Taxes and Fees for Your Corporation | Incfile.com"
				description="What&#039;s it going to cost to incorporate your business in Wyoming? Learn about the state&#039;s business taxes and fees here."
			/>
			<Top
