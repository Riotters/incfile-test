...
const WyomingCorporation = () => {
	...
	return (
		<Layout>
			<SEO
				title="How to Name Your Wyoming Corporation | GA Business Name Registration"
				description="Choosing the right name for your business is vitally important. Read Incfile&#039;s guide to naming corporations in Wyoming for everything you need to know."
			/>
			<Top
