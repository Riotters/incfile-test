...
import {advantages, faqs, top} from "../static/learning-center-entity/colorado-virtual-mailboxes";
...
const VirtualMailBoxes = () => (
    <Layout>
        <SEO title="Colorado Virtual Mailbox & Mail Scanning Service" description="Need a business address in CO? Our virtual mailbox service gives you a real street address and lets you get your mail no matter where you are. Learn more." />
        <VirtualMailboxTopSection
            content={top}
            state="Colorado"
        />
