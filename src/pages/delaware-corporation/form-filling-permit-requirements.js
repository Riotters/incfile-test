...
//Texts
import { top, tabPages, filing, launchBusiness, requirements, learnMore, quickLinks, variants, subscription } from "../../static/learning-center-entity/state-information-delaware";
...
const StateInformation = () => (
    <Layout>
        <SEO title="Forms & Filing Rules for Delaware S Corps & C Corps" description="From annual reports to business licenses and permits, learn about the forms and filing requirements for your Delaware corporation." />
