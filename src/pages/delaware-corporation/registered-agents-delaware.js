...
//Texts
import { top, tabPages, agents, launchBusiness, requirements, learnMore, quickLinks, variants, subscription } from "../../static/learning-center-entity/state-information-delaware";
...
const StateInformation = () => (
    <Layout>
        <SEO title="Registered Agent Rules for Delaware S Corps & C Corps" description="Do you need a registered agent for your Delaware corporation? Learn about the rules, requirements, and how a registered agent can benefit your business." />
