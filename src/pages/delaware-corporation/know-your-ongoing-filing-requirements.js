...
//Texts
import { top, tabPages, afterFormation, launchBusiness, requirements, learnMore, quickLinks, variants, subscription } from "../../static/learning-center-entity/state-information-delaware";
...
const StateInformation = () => (
    <Layout>
        <SEO title="Business Taxes & Fees for Delaware S Corps & C Corps" description="Learn about the taxes and fees you&#039;ll be required to pay for your Delaware corporation, plus find out the tax differences between DE S Corps and C Corps." />
        ...
        <CorporationLayout>
            ...
            <MainPageContent>
                <ContentMap content={afterFormation} />
            </MainPageContent>
        </CorporationLayout>
