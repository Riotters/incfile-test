...
import { info,  questions, service, top, articlesOfIncorporation} from "../static/learning-center-entity/louisiana-corporation";
...
const AlaskaCorporation = () => {
    ...
    return (
        <Layout>
            <SEO title="Form a Corporation or LLC in Louisiana Today | Incfile" description="Forming a corporation in Louisiana takes five minutes. Learn how to choose a name, structure your business and what docments are needed to register." />
