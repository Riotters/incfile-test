...
const SouthCarolinaCorporation = () => {
	...
	return (
		<Layout>
			<SEO
				title="Form a Corporation or LLC in South Carolina Today | Incfile"
				...
				<ReactTabs content={tabs}>
					<TabPanel>
						<PanelWrapper>
							...
							<Paragraph big>
								Choosing a name for your new South Carolina corporation is one
								of the first official steps toward actually conducting business
								in the state. The corporate name you choose must be readily
								distinguishable from all other registered and reserved business
								entities on the South Carolina state rolls.
							</Paragraph>
							<Paragraph big>
					...
					<TabPanel>
						<PanelWrapper>
							...
							<Paragraph big>
								...
								new South Carolina corporation must file articles of
								incorporation with the Corporations Department of the state
								Secretary of State’s office. The articles must be executed
								(signed) and delivered by at least one incorporator, who is not
								required to be an officer, director, or shareholder of the
								corporation. An incorporator may be any natural person or legal
								entity.
							</Paragraph>
							<Paragraph big>
								The articles must be accompanied by a filing fee of $135, an
								Initial Annual Report form (with a $25 fee), and a certificate
								signed by a South Carolina attorney that all requirements of
								applicable state law have been met. The attorney’s signature
								certifies that your articles contain the required information
								listed in Section 33-2-102 of the South Carolina Business
								Corporation Act.
							</Paragraph>
							<Paragraph big>
							...
							/>
							<Paragraph big>
								South Carolina law also allows (but does not require) optional
							...
							<Paragraph big>
								Some types of corporations, such as real estate and health care,
								are also required to obtain a license and pay an additional fee
								to operate in the Palmetto State.
							</Paragraph>
						</PanelWrapper>
					</TabPanel>
					<TabPanel>
					...
					<TabPanel>
						<PanelWrapper>
							...
							<Paragraph big>
								...
								Carolina corporations must keep a copy of their bylaws at their
					...
					<TabPanel>
						<PanelWrapper>
							...
							<Paragraph big style={{ marginBottom: "48px" }}>
								South Carolina corporations must file a report with the South
								Carolina Department of Revenue each year by the 15th day of the
								third month after the end of the corporation’s fiscal year.
							</Paragraph>
							...
							<TextBoxed style={{ marginBottom: "8px" }}>
								<Paragraph bottomMargin={0}>
									The total number of authorized, issued, and outstanding shares
									of stock, itemized by class and series (if any) within each
									class
								</Paragraph>
							</TextBoxed>
							<Paragraph big>
								Within 120 days after the close of the fiscal year, the
								corporation must send its shareholders a financial report that
								includes a year-end balance sheet, an income statement, and a
								statement of changes in shareholders’ equity for the year.
							</Paragraph>
							<Paragraph big>
								The corporation must also report in writing to the shareholders
								if it issues or authorizes promissory notes or other future
								obligations. If these promises consist of shares of corporate
								stock, the report must specify the number of shares issued or
								authorized, and the benefit received by the corporation, either
					...
					<TabPanel>
						<PanelWrapper>
							...
							<Paragraph big>
								“S corporation” status is recognized by the South Carolina
			...
			<Rocket urlParams="?entityType=CCorporation&entityState=SC" />
