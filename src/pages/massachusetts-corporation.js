...
const AlaskaCorporation = () => {
  ...
  return (
    <Layout>
        ...
        <ReactTabs content={tabs}>
          ...
          <TabPanel>
            <PanelWrapper>
              ...
              />
              <Paragraph big>
                Massachusetts law also permits additional provisions to be
                included in the corporation’s articles of organization, such as:
              </Paragraph>
          ...
          <TabPanel>
            <PanelWrapper>
              ...
              <Paragraph big style={{ marginBottom: "48px" }}>
                ...
                of 9.5 percent on all corporate income. Among states levying
                corporate income taxes, Massachusetts’ rate ranks fourth highest
                nationally.
              </Paragraph>
            </PanelWrapper>
          </TabPanel>
      ...
      <Rocket urlParams="?entityType=CCorporation&entityState=MA" />
