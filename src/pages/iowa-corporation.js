...
import {
	...
	tabs,
	top,
} from "../static/learning-center-entity/iowa-corporation";
...
const IowaCorporation = () => {
	...
	return (
		<Layout>
			...
			<Rocket urlParams="?entityType=CCorporation&entityState=IA" />
...
export default IowaCorporation;
