...
import { info, questions, service, top, articlesOfIncorporation } from "../static/learning-center-entity/iowa-corporation";
...
const AlaskaCorporation = () => {
    ...
    return (
        <Layout>
            <SEO title="Form a Corporation or LLC in Iowa Today | Incfile" description="Incorporating in Iowa? Get your business off the ground with info on filing times and fees, management structure, taxation and more." />
