...
const AnnualReport = () => {
    return (
        <Layout>
            <SEO title="When is my filing due? Business Filing Deadline Tool | Incfile" description="Need to know your next due date with your state's business department? Use Incfile's easy tool to stay on top of your filing requirements. Learn more." />
            <Top imageName="mr-bulb-annual-report-due-date-tool" imageAlt="Mrs Bulb and with checklist" ovalColor="sun" headlineWidth="560">
                <h1>{top.header}</h1>
                <p>{top.text}</p>
                <Buttonsbox>
                    <Button onClick={e => scrollToElement(e, 'js-check-duedate-form')} content={top.buttons[0]} theme="primary56" />
                </Buttonsbox>
            </Top>
            <About content={about} />
