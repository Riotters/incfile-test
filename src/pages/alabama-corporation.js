...
const AlabamaCorporation = () => {
  ...
  return (
    <Layout>
      <SEO
        title="Form a Corporation or LLC in Alabama Today | Incfile"
        ...
        <ReactTabs content={tabs}>
          ...
          <TabPanel>
            <PanelWrapper>
              ...
              <Paragraph big>
                Alabama’s corporate tax structure consists of a flat rate of 6.5
                percent on all corporate income. Among states with corporate
                income taxes, Alabama’s rate ranks 30th in the nation. Alabama
                also assesses a business privilege tax, which is an annual tax
                on corporate shares based on the net worth of the corporation.
              </Paragraph>
              <Paragraph big>
