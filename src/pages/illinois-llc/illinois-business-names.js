...
const IllinoisBusinessNames = () => (
	<Layout>
		<SEO
			title="Illinois Business Search | Naming Your Illinois LLC"
			description="Learn what you need to know about naming an LLC in Illinois with Incfile's helpful resources. Pick your perfect business name today!"
		/>
