...
import { info, questions, service, top, articlesOfIncorporation } from "../static/learning-center-entity/utah-corporation";
...
const AlaskaCorporation = () => {
    ...
    return (
        <Layout>
            <SEO title="Form a Corporation or LLC in Utah Today | Incfile" description="Want to incorporate in Utah? Learn how to structure your business, file the required documents, choose a name, and more." />
