  ...
  return (
    <Layout>
      ...
      <ProductSchema
        ...
        productDescription="Forming an official business entity helps provide liability protection for your company. Start an LLC, S Corporation, C Corporation or Nonprofit by having Incfile file and manage the correct paperwork for you."
      />
      <Top
          ...
          <Flex>
            ...
            >
              <OutsideImage width="218px" top="-96px">
                <Image
                  filename="complete-business-entity-guide-3401"
                  alt="The Complete Business Entity Guide"
                />
              </OutsideImage>
            </Column>
            <Column width={65}>
              <Heading size={6} bottomMargin={4} className="header-top">
                DOWNLOAD
              </Heading>
              <Heading size={4} bottomMargin={16}>
                The Complete Business Entity Guide.
              </Heading>

              {formSubmitted ? (
                <>
                  <Paragraph bottomMargin={32}>
                    Thanks for downloading The Complete Business Entity Guide.
                ...
                <Paragraph bottomMargin={32}>
                  We’ll help you choose the right business structure for your
                  company.
                </Paragraph>
              )}
                  ...
                  >
                    <Input
                      ...
                      inputRef={register({
                        ...
                        validate: (value) =>
                          validEmail(value) || `Email is not valid`,
                      })}
                    />
                    {errors.email && (
