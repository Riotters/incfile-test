...
import { info, questions, service, top, articlesOfIncorporation } from "../static/learning-center-entity/washington-corporation";
...
const AlaskaCorporation = () => {
    ...
    return (
        <Layout>
            <SEO title="Form a Corporation or LLC in Washington Today | Incfile" description="Want to form a corporation in Washington? Learn how to choose a name, structure management and where to submit required documents." />
