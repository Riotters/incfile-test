...
import {advantages, faqs, top} from "../static/learning-center-entity/florida-virtual-mailboxes";
...
const VirtualMailBoxes = () => (
    <Layout>
        <SEO title="Florida Virtual Mailbox & Mail Scanning Service" description="Need a business address in FL? Our virtual mailbox service gives you a real street address and lets you get your mail no matter where you are. Learn more." />
        <VirtualMailboxTopSection content={top} state="Florida" />
