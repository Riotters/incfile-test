...
const ManageYourCompany = () => (
  <Layout>
    ...
    <BusinessOwnerResponsibilities>
        <ImageContent image="registered-agents" paddingTop="60">
            ...
            <ul className="numericlist">
                <li>
                    <CircleIcon className="circleicon" circleColor={color.blue1} iconColor={color.white}>1</CircleIcon>
                    You'll need to get a license for a small fee to operate a business at the address of location.
                </li>
                <li>
                    <CircleIcon className="circleicon" circleColor={color.blue1} iconColor={color.white}>2</CircleIcon>
                ...
                <li>
                    <CircleIcon className="circleicon" circleColor={color.blue1} iconColor={color.white}>3</CircleIcon>
                    Then, if you operate from home or plan to remodel a space, for example, you'll need to obtain permits to do so. 
                    Other permits covering serving alcohol, displaying a sign on the building exterior and even parking for your business might also be a requirement. 
                ...
                <li>
                    <CircleIcon className="circleicon" circleColor={color.blue1} iconColor={color.white}>4</CircleIcon>
    ...
    <WhatYouGet>
        <Container>
            <TextCenterLayout
                headline="What comes with the Business License Research Package?"
                headlineWidth="770"
            />
            <ImageContent image="registered-agents-2" paddingTop="60">
                <p>
                    To make it easier, our trusted licensing partner will provide you with a comprehensive package of all the licenses, 
                    permits and tax registrations required for your business as well as the application forms to file with the appropriate licensing authorities.
                </p>
                <h3>
                    What you'll get
                </h3>
    ...
    <ResearchPackage>
        <Container>
            <TextCenterLayout
                headline="As part of the Business License Research Package, a licensing expert will..."
                headlineWidth="890"
            />
            <Boxes>
                    <div className="box">
    ...
    <OrderNow>
        <Container>
            <LeftImageRightContent image="registered-agents-3" imageWidth="515" textWidth="570">
                ...
                <p>With Incfile's Business License Research Package, you'll have everything 
                    you need to apply for your licenses and meet the requirements for your business.</p>
                <Buttonsbox>
