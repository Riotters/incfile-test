...
const NebraskaCorporation = () => {
	...
	return (
		<Layout>
					...
					<TabPanel>
						<PanelWrapper>
							...
							<Paragraph big>
								...
								legal age or a business entity. The articles must include:
							</Paragraph>
							...
							<Paragraph big>
								...
								shares. The stock fee increases if your corporation’s capital
								stock exceeds $10,000, as follows:
							</Paragraph>
							<Colorbox
								color={color.orange3}
			...
			<Rocket urlParams="?entityType=CCorporation&entityState=NE" />
