...
import { info,  questions, service, top, articlesOfIncorporation } from "../static/learning-center-entity/maryland-corporation";
...
const AlaskaCorporation = () => {
    ...
    return (
        <Layout>
            <SEO title="Maryland Corporation | How to Incorporate in Maryland | Learn About Incorporating in Maryland" description="Want to incorporate in Maryland? We&#039;ll show you everything you need to know, from filing times and fees, to documents required and much more." />
