...
const HelpCenter = () => {
	...
	return (
		<Layout>
			<SEO
				title="How to Get and File a Trademark: A Complete Guide"
				description="Want to know how to get something trademarked? We’ll walk you through the process for protecting specific words, phrases or logos. Learn more."
			/>
			<Top
