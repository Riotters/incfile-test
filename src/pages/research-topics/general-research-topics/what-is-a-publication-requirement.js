...
import { about } from "../../../static/research-topics/general-research/publication-requirement";
...
const HelpCenter = () => {
    ...
    return (
        <Layout>
            <SEO title="What is a Publication Requirement?" description="Q & A for LLC and other forms of corporations. Learning Center for Incorporating in every state." />
