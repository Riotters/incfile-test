...
import About from "../../../atomic/sections/research-topics/general-research-topics/publication-requirement";
...
import { about, related } from "../../../static/research-topics/general-research-topics/publication-requirement";
...
const HelpCenter = () => (
  <Layout>
    ...
    <Top imageName="mrs-bulb-help-center-article" imageAlt="Mss Bulb answering a question" ovalColor="green">
      <h1>{top.header}</h1>
      <p>{top.text}</p>
      <Searchbar />
    </Top>
