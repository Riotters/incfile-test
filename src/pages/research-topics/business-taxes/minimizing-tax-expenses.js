...
import { about } from "../../../static/research-topics/business-taxes/minimizing-tax-expenses";
...
const HelpCenter = () => {
	...
	return (
		<Layout>
			<SEO
				title="Small Business Tax Deductions | Minimizing Tax Expenses"
				description="Every entrepreneur wants to maximize business earnings, and one way to do that is through applying the proper business tax deductions. Learn more."
			/>
			<Top
