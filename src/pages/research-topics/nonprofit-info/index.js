...
const HelpCenter = () => (
	<Layout>
		<SEO
			title="Nonprofit Resources & Articles | Incfile Help Center"
			description="Starting or running a nonprofit? Find helpful information here, from instructions on officially forming your company to how to pay business taxes. Learn more."
		/>
		<Top
