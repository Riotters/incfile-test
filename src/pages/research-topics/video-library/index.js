...
const VideoLibrary = () => {
	return (
		<Layout>
			<SEO
				title="Business Videos & Resources | Incfile Video Library"
				description="Find helpful videos on a variety of business topics, from starting an LLC to getting a business license."
			/>
			<Top
				headline="Help Center"
				text="Instant answers. What can we help with?"
				imageName="mrs-bulb-main-header-object-business-checklist-8435.png"
				bgColor="orange"
			/>
			<Wrapper>
				<Container>
