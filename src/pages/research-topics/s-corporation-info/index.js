...
const HelpCenter = () => (
	<Layout>
		<SEO
			title="S Corporation Articles & Resources | Incfile Help Center"
			description="Find useful information on s corporations, including how to form one, tax benefits, and legal requirements."
		/>
		<Top
