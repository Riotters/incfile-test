...
const HelpCenter = () => {
    ...
    return (
        <Layout>
            <SEO title="Can Limited Liability Copmany (LLC) be taxed as an S Corporation?" description="Q & A for LLC and other forms of corporations. Learning Center for Incorporating in every state." />
            ...
            <Helmet>
                <script type="application/ld+json">
                    {`{
                        ...
                        income is subject to self employment taxes currently around 15.2% ordinary income is taxed at
