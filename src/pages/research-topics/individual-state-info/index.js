...
const HelpCenter = () => (
	<Layout>
		<SEO
			title="State Business Information | Incfile"
			description="Find individual resources for forming a business in your specific state. Learn how to start a business today!"
		/>
		<Top
