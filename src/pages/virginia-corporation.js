...
import { info, questions, service, top, articlesOfIncorporation } from "../static/learning-center-entity/virginia-corporation";
...
const AlaskaCorporation = () => {
    ...
    return (
        <Layout>
            <SEO title="Virginia Corporation | How to Incorporate in Virginia | Learn About Incorporating in Virginia" description="Information on Virginia incorporation is a click away. Find filing times and fees, what documents are required, how to choose a name, and more." />
