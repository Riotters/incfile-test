...
import { info, questions, service, top, articlesOfIncorporation } from "../static/learning-center-entity/rhode-island-corporation";
...
const AlaskaCorporation = () => {
    ...
    return (
        <Layout>
            <SEO title="Form a Corporation or LLC in Rhode Island Today | Incfile" description="Incorporating in Rhode Island is simple. Get access to filing times and fees, read state bylaws, finda list of required documents, and much more." />
                ...
                <TabsSection>
                    ...
                    <CollapseWrapper>
                        ...
                        <PanelWrapper>
                            ...
                            <TextBoxed style={{ marginBottom: "8px" }}>
                                <Paragraph bottomMargin={0}>A statement as to the nature of the corporation’s business in the state</Paragraph>
                            </TextBoxed>
                            <TextBoxed style={{ marginBottom: "8px" }}>
                                <Paragraph bottomMargin={0}>The names and addresses of the corporation’s directors and officers</Paragraph>
                            </TextBoxed>
                            <TextBoxed style={{ marginBottom: "8px" }}>
                                <Paragraph bottomMargin={0}>A statement of the aggregate number of shares the corporation has authority to issue, itemized by classes, par value of shares, shares without par value, and series, if any, within a class;</Paragraph>
                            </TextBoxed>
                            <TextBoxed style={{ marginBottom: "8px" }}>
