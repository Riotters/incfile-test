...
import { info, questions, service, top, articlesOfIncorporation } from "../static/learning-center-entity/ohio-corporation";
...
const AlaskaCorporation = () => {
    ...
    return (
        <Layout>
            <SEO title="Form a Corporation or LLC in Ohio Today | Incfile" description="Incorporating in Ohio has never been easier. Get access to filing schedules and fees, how to structure your business, and what documents are needed." />
