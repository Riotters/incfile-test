...
import {advantages, faqs, top} from "../static/learning-center-entity/massachusetts-virtual-mailboxes";
...
const VirtualMailBoxes = () => (
    <Layout>
        <SEO title="Massachusett Virtual Mailbox & Mail Scanning Service" description="Need a business address in MA? Our virtual mailbox service gives you a real street address and lets you get your mail no matter where you are. Learn more." />
