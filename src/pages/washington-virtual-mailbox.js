...
import {advantages, faqs, top} from "../static/learning-center-entity/washington-virtual-mailboxes";
...
const VirtualMailBoxes = () => (
    <Layout>
        <SEO title="Washington Virtual Mailbox & Mail Scanning Service" description="Need a business address in WA? Our virtual mailbox service gives you a real street address and lets you get your mail no matter where you are. Learn more." />
