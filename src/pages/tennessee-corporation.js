...
import { info, questions, service, top, articlesOfIncorporation } from "../static/learning-center-entity/tennessee-corporation";
...
const AlaskaCorporation = () => {
    ...
    return (
        <Layout>
            <SEO title="Form a Corporation or LLC in Tennessee Today | Incfile" description="Learn how to incorporate in Tennesse. Access filing times and fees, document requirements, FAQs and much more." />
                ...
                <TabsSection>
                    ...
                    <CollapseWrapper>
                        <PanelWrapper>
                            ...
                            <TextBoxed style={{ marginBottom: "8px" }}>
                                <Paragraph bottomMargin={0}>Its state or country of incorporation</Paragraph>
                            </TextBoxed>
                            <TextBoxed style={{ marginBottom: "8px" }}>
                                <Paragraph bottomMargin={0}>The intention to transact business under an assumed corporate name</Paragraph>
                            </TextBoxed>
                            <TextBoxed style={{ marginBottom: "8px" }}>
                                <Paragraph bottomMargin={0}>The assumed corporate name it proposes to use.</Paragraph>
                            </TextBoxed>
                        </PanelWrapper>
                        <PanelWrapper>
                            <Heading size={3} style={{ marginBottom: "24px" }}>
                            ...
                            <Paragraph big>Tennessee law also requires that a copy of the charter is filed in the Office of the Register of Deeds in the county where the corporation’s principal office is located.</Paragraph>
                        </PanelWrapper>
                        <PanelWrapper>
                            <Heading size={3} style={{ marginBottom: "24px" }}>
