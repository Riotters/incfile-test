...
import { info, questions, service, top, articlesOfIncorporation } from "../static/learning-center-entity/south-dakota-corporation";
...
const AlaskaCorporation = () => {
    ...
    return (
        <Layout>
            <SEO title="Form a Corporation or LLC in South Dakota Today | Incfile" description="Want to start a business in South Dakota? With access to filing times and fees, state bylaws and required documents, Incfile makes incorporation easy." />
