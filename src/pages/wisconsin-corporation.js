...
import {
	...
	tabs,
	top,
} from "../static/learning-center-entity/wisconsin-corporation";
...
const WisconsinCorporation = () => {
	...
	return (
		<Layout>
			<SEO
				title="Form a Corporation or LLC in Wisconsin Today | Incfile"
				description="Want to learn more about incorporating in Wisconsin? Get info on filing times and fees, taxes and bylaws, required docments and more. "
			/>
			<Top
				...
				<ReactTabs content={tabs}>
					<TabPanel>
						<PanelWrapper>
							...
							<Paragraph big>
								Selecting the name of your new Wisconsin corporation is one of
								the first official steps toward actually conducting business in
								the Badger State. The business name you choose must be
								distinguishable from all other business entities registered or
								reserved in Wisconsin, and it may not include language stating
								or implying that it is organized for a purpose other than that
								permitted by state law and its articles of incorporation.
							</Paragraph>
							<Paragraph big style={{ marginBottom: "32px" }}>
								The name must also end with one of the following terms or its
								abbreviation: “Incorporated,” “Corporation,” “Company,” or
								“Limited.” You can reserve an available LLC name for up to 120
								days for $15 by mail or $30 by phone.
							</Paragraph>
							<LightBoxVideo
					...
					<TabPanel>
						<PanelWrapper>
							...
							<Paragraph big>
								Before conducting business in the state, Wisconsin corporations
								must file articles of incorporation with the state and pay a
								$100 filing fee. The articles must be delivered by at least one
								of the incorporators, who must be a natural person at least 18
								years old. The incorporator is not required to be a director,
							...
							<Paragraph big>
								Wisconsin law allows a corporation to be formed for any lawful
								business activity; the exact purpose does not have to be stated
								in the articles.
							</Paragraph>
							<Paragraph big>
								The state also permits optional provisions to be integrated into
					...
					<TabPanel>
						<PanelWrapper>
							...
							<Paragraph big>
								...
								operating principles. The corporation’s initial bylaws should be
								adopted by its incorporators or its board of directors.
							</Paragraph>
							<Paragraph big>
								A Wisconsin corporation should keep a copy of its bylaws at its
					...
					<TabPanel>
						<PanelWrapper>
							...
							<Paragraph big>
								...
								directors. Officers may appoint other officers in compliance
								with the bylaws. The same natural person may simultaneously hold
								more than one office in a corporation.
							</Paragraph>
							<Paragraph big>
					...
					<TabPanel>
						<PanelWrapper>
							...
							<Paragraph big style={{ marginBottom: "48px" }}>
								A report must be filed annually with the Wisconsin Department of
								Financial Institutions in the same quarter in which the company
								was incorporated.
							</Paragraph>
							...
							<Paragraph big>
								Additionally, Wisconsin corporations must prepare and mail
								annual financial statements to each shareholder within 120 days
								after the close of the corporate fiscal year.
							</Paragraph>
						</PanelWrapper>
					</TabPanel>
					<TabPanel>
						<PanelWrapper>
							...
							<Paragraph big>
								Wisconsin’s corporate tax structure takes a flat bite of 7.9
								percent out of all corporate income. Among states levying
								corporate income taxes, Wisconsin’s rate ranks 18th highest
								nationally.
							</Paragraph>
							<Paragraph big>
								A “subchapter S” or “S corporation” (frequently referred to as
								an “S corp”) is treated as a pass-through entity for tax
								purposes in the same way as a sole proprietorship or
								partnership. S corp status is recognized by the state of
								Wisconsin. The S corp does not file a tax return on its own
								behalf. All tax-related information for the S corp is filed as
			...
			<Rocket urlParams="?entityType=CCorporation&entityState=WI" />
