...
const NewYorkCorporation = () => {
	...
	return (
		<Layout>
			<SEO
				title="New York Corporations & Other Business Entities "
				description="Thinking of starting an S Corp, C Corp, or LLC in New York? Learn about corporations in FL and decide which business type is right for you."
			/>
			<Top
