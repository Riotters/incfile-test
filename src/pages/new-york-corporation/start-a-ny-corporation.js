...
//Texts
import { top, tabPages, startCaCorp, launchBusiness, requirements, learnMore, quickLinks, variants, subscription } from "../../static/learning-center-entity/state-information-new-york";
...
const StateInformation = () => (
    <Layout>
        <SEO title="How to Start a Corporation in New York - 6 Easy Steps" description="Forming a legal corporation in New York doesn&#039;t have to be complicated. Learn the steps you need to take to start your business today." />
