...
const NewYorkCorporation = () => {
	...
	return (
		<Layout>
			<SEO
				title="How to Start a Corporation in New York - 6 Easy Steps"
				description="Forming a legal corporation in New York doesn&#039;t have to be complicated. Learn the steps you need to take to start your business today."
			/>
			<Top
