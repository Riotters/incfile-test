...
//Texts
import { top, tabPages, taxes, launchBusiness, requirements, learnMore, quickLinks, variants, subscription } from "../../static/learning-center-entity/state-information-new-york";
...
const StateInformation = () => (
    <Layout>
        <SEO title="Business Taxes & Fees for New York S Corps & C Corps" description="Learn about the taxes and fees you&#039;ll be required to pay for your New York corporation, plus find out the tax differences between FL S Corps and C Corps." />
