...
import {
	...
	faqs,
	top,
} from "../static/learning-center-entity/south-carolina-virtual-mailboxes";
...
const VirtualMailBoxes = () => (
	<Layout>
		<SEO
			title="South Carolina Virtual Mailbox & Mail Scanning Service"
			description="Need a business address in SC? Our virtual mailbox service gives you a real street address and lets you get your mail no matter where you are. Learn more."
		/>
		<VirtualMailboxTopSection content={top} state="South Carolina" />
