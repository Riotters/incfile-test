...
import { RingText, RingText2, toolsList } from "../../static/type-of-business/landscaping-business";
...
const LandscapingBusiness = () => (
  <Layout>
    <SEO title="How to Start a Landscaping Business" description="There can be few things more thrilling than seeing someone wearing a piece of art that you have created. One way to achieve this is to go into the T-shirt business, create amazing designs and then sell them to people online." />

    <Top ovalColor="green" imageName="landscaping-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
      <h1>How to Start a Landscaping Business</h1>
      <p>We all want to live in a beautiful environment, and part of that is ensuring our yards and gardens are properly designed, maintained and looked after. This provides landscape business entrepreneurs with a great opportunity</p>
      <ButtonsBox>
      ...
      <TabsSection>
        ...
        <CollapseWrapper>
          <PanelWrapper>
            ...
            <Paragraph big>
              We all want to live in a beautiful environment, and part of that is ensuring our yards and gardens are properly designed, maintained and looked after. This provides landscape business entrepreneurs with a great opportunity — if you can provide excellent yard and garden services, you
              can build a thriving local landscaping business.
            </Paragraph>
            <Paragraph big>
              Whether you want to get involved in wholesale design and yard makeovers or you want to provide maintenance and beautification services, there are plenty of opportunities in landscaping. However, because of the expertise, equipment and staff needed, landscaping design has quite a high
              barrier to entry.
            </Paragraph>
            <Paragraph big>Conversely, simple lawn maintenance businesses can be started by almost anyone. This means that a landscaping business is suitable for entrepreneurs of varying skills, experience and expertise.</Paragraph>

            <Heading size={3} style={{ marginTop: "48px", fontSize: "20px" }}>
              Landscaping Business formation guide
            </Heading>
            <Paragraph big>In this guide we’ll explore everything you need to do to set up your Etsy business and maximize your chances for success. We’ll cover:</Paragraph>

            <ListWrapper>
              <ListBox>
                <CkeckText>
                  <Paragraph big>Understanding the world of the landscaping</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Paying taxes and for your landscaping business</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Deciding if you’re ready to start a landscaping business</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Hiring employees, managing finances and administering your landscaping business</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Planning out your landscaping business</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Locating other resources for your landscaping business</Paragraph>
                </CkeckText>
              </ListBox>
            ...
            <Paragraph big>By the time you’ve read through our complete landscaping business guide, you will have all the information you need to set up and manage a thriving landscaping business. Let’s get into it</Paragraph>
          </PanelWrapper>
          ...
          <PanelWrapper>
            ...
            <ColorFulCircleWithTextAndList CircleSVG={ColorfulRing} title={RingText.title} list={RingText.list} withBg={true} />
            ...
            <div style={{ marginBottom: "10px", marginTop: "48px" }}>
              <Adventages headline="There are around half a million landscaping businesses in the U.S. that employ around 1 million people" width="100%" />
            </div>

            <div style={{ marginBottom: "10px" }}>
              <Adventages headline="Commercial landscaping services account for about 50% of industry revenue, while residential services account for about 30%" width="100%" />
            </div>

            <div style={{ marginBottom: "30px" }}>
              <Adventages headline="57% of businesses made $300,000 or less per year, while 19% made between $300,000 and $1 million and 24% $1 million or more" width="100%" />
            </div>

            <Paragraph big>
              This all points to the landscaping industry being ripe with new opportunities for focused entrepreneurs, so now might be the perfect time to dive into starting your landscaping business. Incfile is here to help you form your landscaping business and understand the ins and outs of
          ...
          <PanelWrapper>
            ...
            <Paragraph big>What your customers need will depend on the type of services you provide and the types of clients you plan to work for. Here are some examples based on what you decide to specialize in:</Paragraph>
            ...
            >
              ...
              <Paragraph big>A solid portfolio of work combined with a strong, reliable work ethic and good word-of-mouth recommendations</Paragraph>
            </TextBlockWithImage>
            ...
            >
              ...
              <Paragraph big>Reliable, well-priced services provided on a regular basis by skilled, polite workers</Paragraph>
            </TextBlockWithImage>
            ...
            >
              ...
              <Paragraph big>Competitively-priced services that provide a high value for money</Paragraph>
            </TextBlockWithImage>
            ...
            >
              ...
              <Paragraph big>Reliable, trustworthy services provided quickly and efficiently</Paragraph>
            </TextBlockWithImage>

            <Heading size={3}>What Are the Main Skills, Expertise and Experience Needed to be a Successful Landscaping Entrepreneur?</Heading>

            <Paragraph big>There are a variety of skills you will need as a landscape entrepreneur, depending on where you want to focus your business services. Here are some of the main skills necessary:</Paragraph>

            <div style={{ marginBottom: "30px" }}>
              <Adventages headline="Hiring" text="Finding, interviewing and hiring great landscaping employees who can provide the right design, maintenance, installation and other services" width="100%" />
            </div>
            ...
            <div style={{ marginBottom: "30px" }}>
              <Adventages headline="Marketing" text="Promoting your landscaping business against a competitive field; local marketing expertise is essential" width="100%" />
            </div>
            ...
            <div style={{ marginBottom: "30px" }}>
              <Adventages headline="Business creation" text="Setting up the landscaping business in the first place and finding equipment, staff, vehicles, etc." width="100%" />
            </div>

            <div style={{ marginBottom: "30px" }}>
              <Adventages headline="Operational management" text="Ensuring customers are treated well and yard services are provided to the standards you expect" width="100%" />
            </div>
    ...
    <BlueContainer>
      ...
      <Container>
        <CenterBox>
          ...
          <Paragraph big>
            Before you start your business, there are a few key areas you need to focus on. You will need to establish whether there’s a demand for your landscaping business services, look at potential benefits and pitfalls, understand how your business finances might work and ensure everything is
            in order.
          </Paragraph>
          <Paragraph big>In short, you need a business plan — here’s how to think about your business idea.</Paragraph>

          <Paragraph big style={{ marginTop: "48px", fontFamily: "MarkPro", fontSize: "24px", color: color.black }}>
            Do Market Research and Validate Your Landscaping Products and Services
          </Paragraph>
          <Paragraph big>Here’s a selection of advice on building and making money from an Instagram business.</Paragraph>
        </CenterBox>
        ...
        <GridSectionList>
          <TextBlockWithImage width={100} widthUnit="%" SvgImage={IdentifyIcon} imageBackgroundColor={color.babyblue2} imageShadowColor={color.babyblue2}>
            ...
            <Paragraph bottomPadding={0} bottomMargin={0}>
              These are the areas that will set you apart from competitors and encourage customers to come to you. You might have better pricing, a higher-quality service, faster delivery or some other special feature. Early on, think about offering work at a better price so you can start to build
              up a portfolio.
            </Paragraph>
          </TextBlockWithImage>
          ...
          <TextBlockWithImage width={100} widthUnit="%" SvgImage={MarketIcon} imageBackgroundColor={color.orange2} imageShadowColor={color.orange2}>
        ...
        <CenterBox>
          <Heading size={3}>Understand Your Landscaping Business Model and Financial Projections</Heading>
          ...
          <Paragraph big>
            You will also need to look at financial projections for your landscaping business. What are your expected sales and revenues? What is your profitability? How much money will you keep in the business to grow it? How much will you pay yourself and others? If you can, try to plan your
            revenue for the next month, three months, year and two years.
          </Paragraph>
          <Paragraph big>One of the best ways to build a successful financial future is to sign clients on for recurring services, so you can bill them on a periodic basis. This is especially useful if you provide regular lawn care and yard maintenance.</Paragraph>
        </CenterBox>
      </Container>
    </BlueContainer>
    ...
    <OrangeContainer>
      ...
      <BusinessOwnerResponsibilities>
        <ImageContent image="unique-business-2" paddingTop="60">
          ...
          <Paragraph big>Now that you have all the background information for your landscaping business, it’s time to make it into a reality. Starts by choosing the right structure or “legal entity” for your business. In the U.S., there are five main business structures. They are:</Paragraph>
          ...
          <Paragraph big style={{ paddingTop: "48px", paddingBottom: 0 }} mixed={true}>
            ...
            <Link to="/form-an-llc/">got a complete guide</Link> to everything you need to do. <Link to="/llc-state-information/">LLC formation does vary from state to state</Link>, but we’ve got you covered, wherever you are.
          </Paragraph>
    ...
    <Conclusion to="/" buttonTitle="Start your Landscaping Business with us, today">
      ...
      <Paragraph big>
        As you can see, there are several different types of landscaping service, and with the right approach and expertise you can make a splash in your local marketplace. Look into the types of maintenance and design you want to offer, and you can build a sustainable, thriving business that helps
        clients keep their grounds looking beautiful.
      </Paragraph>
    </Conclusion>
  </Layout>
);
