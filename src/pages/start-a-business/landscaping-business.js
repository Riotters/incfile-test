...
import {RingText, RingText2, tabs, toolsList} from "../../static/type-of-business/landscaping-business";
...
const LandscapingBusiness = () => (
    <Layout>
        <SEO title="How to Start a Landscaping Business"
        ...
        <Top ovalColor="green" imageName="landscaping-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
            ...
            <p>We all want to live in a beautiful environment, and part of that is ensuring our yards and gardens are
                properly designed, maintained and looked after. This provides landscape business entrepreneurs with a
                great opportunity</p>
            <ButtonsBox>
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Paragraph big>
                            ...
                            provide maintenance and beautification services, there are plenty of opportunities in
                            landscaping. However, because of the expertise, equipment and staff needed, landscaping
                            design has quite a high
                            barrier to entry.
                        </Paragraph>
                        <Paragraph big>Conversely, simple lawn maintenance businesses can be started by almost anyone.
                            This means that a landscaping business is suitable for entrepreneurs of varying skills,
                            experience and expertise.</Paragraph>

                        <Heading size={3} style={{marginTop: "48px", fontSize: "20px"}}>
                            Landscaping Business formation guide
                        </Heading>
                        <Paragraph big>In this guide we’ll explore everything you need to do to set up your Etsy
                        ...
                        <ListWrapper>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Hiring employees, managing finances and administering your
                                        landscaping business</Paragraph>
                                </CkeckText>
                            </ListBox>
                        ...
                        <Paragraph big>By the time you’ve read through our complete landscaping business guide, you will
                            have all the information you need to set up and manage a thriving landscaping business.
                            Let’s get into it</Paragraph>
                    </PanelWrapper>
                </TabPanel>
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Paragraph big>
                            ...
                            business. Incfile is here to help you form your landscaping business and understand the ins
                            and outs of
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        >
                            ...
                            <Paragraph big>A solid portfolio of work combined with a strong, reliable work ethic and
                                good word-of-mouth recommendations</Paragraph>
                        </TextBlockWithImage>
                        ...
                        >
                            ...
                            <Paragraph big>Reliable, well-priced services provided on a regular basis by skilled, polite
                                workers</Paragraph>
                        </TextBlockWithImage>
                        ...
                        <Heading size={3}>What Are the Main Skills, Expertise and Experience Needed to be a Successful
                            Landscaping Entrepreneur?</Heading>

                        <Paragraph big>There are a variety of skills you will need as a landscape entrepreneur,
                            depending on where you want to focus your business services. Here are some of the main
                            skills necessary:</Paragraph>

                        <div style={{marginBottom: "30px"}}>
                            <Adventages headline="Hiring"
            ...
            <Container>
                <CenterBox>
                    ...
                    <Paragraph big>
                        ...
                        benefits and pitfalls, understand how your business finances might work and ensure everything is
                        in order.
                    </Paragraph>
                    ...
                    <Paragraph big>Here’s a selection of advice on building and making money from an Instagram
                        business.</Paragraph>
                </CenterBox>
                ...
                <GridSectionList>
                    <TextBlockWithImage width={100} widthUnit="%" SvgImage={IdentifyIcon}
                        ...
                        <Paragraph bottomPadding={0} bottomMargin={0}>
                            ...
                            other special feature. Early on, think about offering work at a better price so you can
                            start to build
                            up a portfolio.
                        </Paragraph>
                    </TextBlockWithImage>
                ...
                <CenterBox>
                    ...
                    <Paragraph big>
                        You will also need to look at financial projections for your landscaping business. What are your
                    ...
                    <Paragraph big>One of the best ways to build a successful financial future is to sign clients on for
                        recurring services, so you can bill them on a periodic basis. This is especially useful if you
                        provide regular lawn care and yard maintenance.</Paragraph>
                </CenterBox>
            </Container>
        </BlueContainer>
            ...
            <BusinessOwnerResponsibilities>
                <ImageContent image="unique-business-2" paddingTop="60">
                    ...
                    <Paragraph big>Now that you have all the background information for your landscaping business, it’s
                        ...
                        your business. In the U.S., there are five main business structures. They are:</Paragraph>
                    ...
                    >
                        ...
                        <Paragraph big>This is the "default" business structure and is what your influencer business
                    ...
                    <Paragraph big style={{paddingTop: "48px", paddingBottom: 0}} mixed={true}>
                        ...
                        <Link to="/form-an-llc/">got a complete guide</Link> to everything you need to do. <Link
                    ...
                    <Paragraph big>For more information on the advantages and disadvantages of different types of
                        businesses, please see our in-depth guide on business entities. If you still have
                        questions, <Link
                            to="https://grasshopper.com/blog/llc-vs-corporation-8-entrepreneur-questions-answered/">we’ve
                            answered them to help you choose the right business structure</Link>.</Paragraph>
                    <Paragraph big mixed>In most cases our recommendation would be to create an LLC. We have <Link
                        to="/form-an-llc/">a complete guide to everything you need to do</Link>, and we can set one up
                        for your landscaping business. <Link to="/llc-state-information/">LLC formation does vary from
                            state to state</Link>, but we’ve got you covered, wherever you are.</Paragraph>
        ...
        <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"}
            ...
            <Paragraph big>
                ...
                design you want to offer, and you can build a sustainable, thriving business that helps
