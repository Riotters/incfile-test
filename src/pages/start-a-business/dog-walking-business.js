  ...
  <Layout>
    ...
    <TabsWrapper>
      ...
      <TabsSection>
        ...
        <CollapseWrapper>
          <PanelWrapper>
            <Paragraph big>With this huge love of animals across the nation, there's plenty of need for trustworthy, capable and caring people to become dog walkers or pet sitters.</Paragraph>
            <Paragraph big>
            ...
            <Colorbox className="box" theme="icon" Icon={MegafornIcon} color={color.green3} curve curveColor={color.orange2}>
              <Heading size={4}>We want to help you get your business off the ground.</Heading>
              <Paragraph>Since 2004, we’ve helped over 500,000 people start exciting businesses and bring their ideas to life. We’ll give you the support, guidance and advice you need to create a woman-owned business and make it into a success.</Paragraph>
              <Paragraph bottomPadding={0} bottomMargin={0}>
                Here is our simple guide to starting up a successful dog walking, pet sitting or related canine business. From exploring the types of business you can start, to doing research, to learning about the legalities of setting up your business and the realities of your day to day
                operations- this guide is here to help.{" "}
              </Paragraph>
            </Colorbox>
            ...
            <ListWrapper>
              <ListBox>
                <CkeckText>
                  <Paragraph big>Statistics on why you should start a dog walking, pet sitting or similar business</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Choose the right business structure for your dog walking or pet sitting company</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Learn if a canine-related business could be right for you</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Ideas for the type of dog business that you could form</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Proving your dog walking or pet sitting business can work</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Business plans for dog walking and related companies</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Setting up your canine business, including location, equipment, employees, taxes, finances, licenses and more</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Where to find dog walking or pet sitting business groups, forums and support</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Helpful software for pet business owners</Paragraph>
                </CkeckText>
              </ListBox>
            </ListWrapper>
          </PanelWrapper>
          ...
          <PanelWrapper>
            <Heading size={3}>Why You Should Start a New Dog Walking, Pet Sitting or Similar Business</Heading>
            <Paragraph big>
            ...
            <BlueBoxWithAbsoluteText absoluteText="20M" text="Approximate number of dogs in households in the U.S." />
            <BlueBoxWithAbsoluteText absoluteText="$70B" text="Americans spends on their pets each year, which includes food, medicine, vet care, grooming and boarding" />
            <BlueBoxWithAbsoluteText absoluteText="$6B" text="Americans spends just over a year on grooming and boarding" />

            <CircleWithText textInsideCircle="71" textLine="Of people in the U.S. who own a pet have a dog" SvgChart={CircleSvg} withBg={true} symbol="%" />

            <div style={{ marginBottom: "30px", marginTop: "80px" }}>
              <Adventages headline="A little over 10 percent of that ($130) is spent per pet every year on sitting, walking and kennels" width="100%" />
            </div>

            <div style={{ marginBottom: "30px" }}>
              <Adventages headline="On average, the total cost of a dog is around $1,200 a year" width="100%" />
            </div>

            <div style={{ marginBottom: "30px" }}>
              <Adventages headline="High-income households account for around 60 percent of all spending on animals" width="100%" />
            </div>

            <Paragraph big>This is why dog walking, pet sitting and similar businesses are so exciting - how can you be part of that success? We're here to help you figure that out.</Paragraph>
          </PanelWrapper>
          ...
          <PanelWrapper>
            ...
            <Heading size={3}>A Day in the Life of a Dog Walking or Pet Sitting Business Owner</Heading>
            <Paragraph big>Here are some of the typical tasks you’ll be performing for your dog walking or pet sitting business on a daily basis:</Paragraph>
            ...
            <Heading size={3}>Skills Needed by a Dog Walking or Pet Sitting Business Entrepreneur</Heading>
            <Paragraph big>The following skills will be very useful in your role as a dog walking or pet sitting small business owner.</Paragraph>
            ...
            <Heading size={3}>What Your Dog Walking or Pet Sitting Customers Are Looking For</Heading>
            <Paragraph big>
              Your customers are trusting you with the well-being and happiness of their animal companions. This means demonstrating some expertise in animal handling and behavior, and having a good track record of caring for canines. Pet owners will want to make sure that their dogs are kept safe,
    ...
    <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"} buttonTitle="Start your Dog Walking Business with us, today">
      <Heading size={3} style={{ fontSize: "48px" }}>
        Conclusion
      </Heading>
      <Paragraph big>If you can find a unique approach and open your canine business in the right area, there’s every chance of success. Explore different ideas for a pet sitting, dog walking, grooming, kennel or other business, and you’ll find the right one for you. Good luck!</Paragraph>
    </Conclusion>
  </Layout>
);
