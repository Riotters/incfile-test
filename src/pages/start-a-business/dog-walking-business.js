...
const DogWalkingBusiness = () => (
    <Layout>
        ...
        <Top ovalColor="sun" imageName="dog-walking-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
            ...
            <p>Everyone loves their furry friends, with almost 70 percent of U.S. families (or 85 million households)
                owning a pet. Dogs are the most popular choice: over 60 million households are home to a canine
                companion.</p>
            <ButtonsBox>
        ...
        <TabsWrapper>
            ...
            <ReactTabs content={tabs}>
                <TabPanel>
                    <PanelWrapper>
                        <Paragraph big>With this huge love of animals across the nation, there's plenty of need for
                            trustworthy, capable and caring people to become dog walkers or pet sitters.</Paragraph>
                        <Paragraph big>
                            You might not think of dog walking or pet sitting as a formal business, but with enough
                            effort it could become an excellent way for you to make money as an animal lover. It’s not
                            just dog walking or pet sitting either - doggy day cares, grooming studios and kennels are
                            all in demand.
                        </Paragraph>
                        ...
                        <Colorbox className="box" theme="icon" Icon={MegafornIcon} color={color.green3} curve
                            ...
                            <Paragraph bottomPadding={0} bottomMargin={0}>
                                ...
                                to learning about the legalities of setting up your business and the realities of your
                                day to day
                        ...
                        <Paragraph big style={{
                            ...
                            becoming an entrepreneur. In this guide we will cover:
                        </Paragraph>

                        <ListWrapper>
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Statistics on why you should start a dog walking, pet sitting or
                                        similar business</Paragraph>
                                </CkeckText>
                            </ListBox>

                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Choose the right business structure for your dog walking or pet
                                        sitting company</Paragraph>
                                </CkeckText>
                            </ListBox>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Where to find dog walking or pet sitting business groups, forums and
                                        support</Paragraph>
                                </CkeckText>
                            </ListBox>
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Paragraph big>
                            ...
                            companions. Here are some amazing statistics across the pet industry as a whole and on dogs
                            in particular:
                        </Paragraph>
                        ...
                        <div style={{marginBottom: "30px"}}>
                            <Adventages headline="On average, the total cost of a dog is around $1,200 a year"
                                        width="100%"/>
                        </div>
                        ...
                        <Paragraph big>This is why dog walking, pet sitting and similar businesses are so exciting - how
                            can you be part of that success? We're here to help you figure that out.</Paragraph>
                    </PanelWrapper>
                </TabPanel>
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Paragraph big>Here are some of the typical tasks you’ll be performing for your dog walking or
                            pet sitting business on a daily basis:</Paragraph>
                        ...
                        <Paragraph big>The following skills will be very useful in your role as a dog walking or pet
                            sitting small business owner.</Paragraph>

                        <div style={{marginBottom: "10px"}}>
                            <TextBoxed>
                                <Paragraph big bottomMargin={0}>
                                    You will need to have a good understanding of animal behavior and how to deal with
                                    furry friends
                                </Paragraph>
                            </TextBoxed>
                        </div>
                        ...
                        <Paragraph big>
                            ...
                            companions. This means demonstrating some expertise in animal handling and behavior, and
                            having a good track record of caring for canines. Pet owners will want to make sure that
        ...
        <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"}
            ...
            <Paragraph big>If you can find a unique approach and open your canine business in the right area, there’s
                every chance of success. Explore different ideas for a pet sitting, dog walking, grooming, kennel or
                other business, and you’ll find the right one for you. Good luck!</Paragraph>
        </Conclusion>
    </Layout>
);
