...
const DogWalkingBusiness = () => (
  <Layout>
    ...
    >
      ...
      <p>
        Everyone loves their furry friends, with almost 70 percent of U.S.
        families (or 85 million households) owning a pet. Dogs are the most
        popular choice: over 60 million households are home to a canine
        companion.
      </p>
      <ButtonsBox>
                <Button
    ...
    <TabsWrapper>
      ...
      <ReactTabs content={tabs}>
        <TabPanel>
          <PanelWrapper>
            <Paragraph big>
              With this huge love of animals across the nation, there's plenty
              of need for trustworthy, capable and caring people to become dog
              walkers or pet sitters.
            </Paragraph>
            <Paragraph big>
              You might not think of dog walking or pet sitting as a formal
              business, but with enough effort it could become an excellent way
              for you to make money as an animal lover. It’s not just dog
              walking or pet sitting either - doggy day cares, grooming studios
              and kennels are all in demand.
            </Paragraph>
            ...
            >
              ...
              <Paragraph bottomPadding={0} bottomMargin={0}>
                Here is our simple guide to starting up a successful dog
                walking, pet sitting or related canine business. From exploring
                the types of business you can start, to doing research, to
                learning about the legalities of setting up your business and
                the realities of your day to day operations- this guide is here
                to help.{" "}
              </Paragraph>
            </Colorbox>
            ...
            >
              Read on for some insight into creating your own dog walking or pet
              sitting business and becoming an entrepreneur. In this guide we
              will cover:
            </Paragraph>
            ...
            <ListWrapper>
              <ListBox>
                <CkeckText>
                  <Paragraph big>
                    Statistics on why you should start a dog walking, pet
                    sitting or similar business
                  </Paragraph>
                </CkeckText>
              </ListBox>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>
                    Choose the right business structure for your dog walking or
                    pet sitting company
                  </Paragraph>
                </CkeckText>
              </ListBox>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>
                    Where to find dog walking or pet sitting business groups,
                    forums and support
                  </Paragraph>
                </CkeckText>
              </ListBox>
        ...
        <TabPanel>
          <PanelWrapper>
            <Heading size={2} template={3} left>
              Why You Should Start a New Dog Walking, Pet Sitting or Similar
              Business
            </Heading>
            <Paragraph big>
              The fact is that pets (and dogs in particular) are more than just
              animals - they’re family members. As a result, doggy parents
              lavish lots of love and money on their faithful companions. Here
              are some amazing statistics across the pet industry as a whole and
            ...
            <CircleWithText
              textInsideCircle="71"
              textLine="Of people in the U.S. who own a pet have a dog"
              SvgChart={CircleSvg}
              withBg={true}
              symbol="%"
            />
            ...
            <Paragraph big>
              This is why dog walking, pet sitting and similar businesses are so
        ...
        <TabPanel>
          <PanelWrapper>
            ...
            <Paragraph big style={{ marginBottom: "48px" }}>
              Although it can be exciting to form a dog walking or pet sitting
            ...
            <Paragraph big>
              ...
              dog walking or pet sitting business on a daily basis:
            </Paragraph>

            <div style={{ marginBottom: "10px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  Visiting the homes of pet owners and forming relationships
                  with them and their animals
                </Paragraph>
              </TextBoxed>
            </div>
            ...
            <div style={{ marginBottom: "10px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  Understanding any unique needs, likes or dislikes of specific
                  animals
                </Paragraph>
              </TextBoxed>
            </div>
            ...
            <div style={{ marginBottom: "10px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  Managing your schedule so you can get to all your clients in
                  time
                </Paragraph>
              </TextBoxed>
            </div>
            ...
            <Paragraph big>
              The following skills will be very useful in your role as a dog
              walking or pet sitting small business owner.
            </Paragraph>

            <div style={{ marginBottom: "10px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  You will need to have a good understanding of animal behavior
                  and how to deal with furry friends
                </Paragraph>
              </TextBoxed>
            </div>
            ...
            <div style={{ marginBottom: "10px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  You must be able to manage multiple dogs in close proximity
                  with each other and deal with any potential issues
                </Paragraph>
              </TextBoxed>
            </div>
            ...
            <div style={{ marginBottom: "10px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  You should have excellent interpersonal skills so you can
                  reassure and talk with pet owners
                </Paragraph>
              </TextBoxed>
            </div>
            ...
            <div style={{ marginBottom: "10px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  You will need to be prompt and have excellent timekeeping
                  skills
                </Paragraph>
              </TextBoxed>
            </div>
            ...
            <div style={{ marginBottom: "10px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  You will need to build flexibility into your schedule — dogs
                  and owners can be unpredictable creatures
                </Paragraph>
              </TextBoxed>
            </div>
            ...
            <div style={{ marginBottom: "10px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  You must be able to handle pet-related emergencies (they’re
            ...
            <Paragraph big>
              ...
              of their animal companions. This means demonstrating some
              expertise in animal handling and behavior, and having a good track
              record of caring for canines. Pet owners will want to make sure
              that their dogs are kept safe, that they won’t escape and that you
              will be able to deal with any special doggy needs or issues.
            </Paragraph>
          </PanelWrapper>
        </TabPanel>
      </ReactTabs>
    ...
    >
      ...
      <Paragraph big>
        If you can find a unique approach and open your canine business in the
        right area, there’s every chance of success. Explore different ideas for
        a pet sitting, dog walking, grooming, kennel or other business, and
        you’ll find the right one for you. Good luck!
      </Paragraph>
    </Conclusion>
  </Layout>
);
