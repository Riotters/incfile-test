...
const FoodTruck = () => (
  <Layout>
    ...
    <Top ovalColor="yellow" imageName="food-truck-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
      ...
      <p>Starting a food truck can be an excellent introduction to the world of running your own business.</p>
      <ButtonsBox>
    ...
    <TabsWrapper>
      ...
      <TabsSection>
        ...
        <CollapseWrapper>
          <PanelWrapper>
            <Paragraph big>Food trucks are self-contained ventures that will give you plenty of exposure to essential business skills. From creating a great menu to sourcing ingredients, and preparing meals to making a profit, you’ll need to get up to speed quickly.</Paragraph>

            <Colorbox className="box" theme="icon" Icon={MegafornIcon} color={color.green3} curve curveColor={color.green1}>
              <Heading size={4}>We know it can be daunting to start a food truck business, and we’re here to help.</Heading>
              <Paragraph bottomPadding={0} bottomMargin={0}>
                We’ve supported over 100,000 people to form their business and provided answers, guidance and support to transform them into entrepreneurs. We’ll guide you through what you need to know to start your food truck business and get it off the ground.
              </Paragraph>
            </Colorbox>
            ...
            <ListWrapper>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>Deciding whether a food truck business could be right for you</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Groups, forums and support for food truck business owners</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Ideas for the type of food business you could form</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Helpful software for food truck businesses</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Statistics on why you should start a food truck business selling meals to the public</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Setting up your food truck business including location, equipment, employees, taxes, finances, licenses and more</Paragraph>
                </CkeckText>
              </ListBox>
            </ListWrapper>
          </PanelWrapper>
          ...
          <PanelWrapper>
            ...
            <BlueBoxWithAbsoluteText absoluteText="$2B" text="Estimated worth of food truck industry in the U.S per year." />
            <BlueBoxWithAbsoluteText absoluteText="$1000K" text="The average startup cost for a food truck business." />

            <CircleWithText style={{ marginBottom: "80px" }} withBg={true} SvgChart={SvgChart} textInsideCircle="7" symbol="%" textLine="Is the annual growth in food truck revenue as a whole" />
          ...
          <PanelWrapper>
            <Heading size={3}>Is Running a Food Truck Business Right for You?</Heading>
            ...
            <Paragraph big>Here are some of the typical tasks you’ll be performing for your food truck business on a daily basis.</Paragraph>
            ...
            <Heading size={3}>Skills Needed When You’re Opening and Operating a Food Truck</Heading>
            <Paragraph big>The following skills will be very useful in your role as a food truck small business owner:</Paragraph>
            ...
            <Heading size={3}>What Your Food Truck Customers Are Looking For</Heading>
            <Paragraph big>Although the needs of your food truck customers may vary, they might expect:</Paragraph>
            ...
            <Paragraph big>Understanding who your customers are and what they want will be a big part of the success of your food truck business.</Paragraph>
          </PanelWrapper>
        </CollapseWrapper>
      </TabsSection>
    </TabsWrapper>
    ...
    <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"} buttonTitle="Start your Foodtrack Business with us, today">
      <Heading size={3} style={{ fontSize: "48px" }}>
        Conclusion
      </Heading>
      <Paragraph big>Find the right niche, and your food truck business could be an enormous success. You’ll certainly learn quickly if it’s right for you, and with perseverance you can turn a food truck into a very profitable venture.</Paragraph>
    </Conclusion>
  </Layout>
);
