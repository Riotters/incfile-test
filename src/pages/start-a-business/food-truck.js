...
import ValidatingBusinessIdea from "../../atomic/sections/type-of-business/food-truck-business/validating-business-idea";
...
const FoodTruck = () => (
  <Layout>
    ...
    >
      ...
      <p>
        Starting a food truck can be an excellent introduction to the world of
    ...
    <TabsWrapper>
      ...
      <ReactTabs content={tabs}>
        <TabPanel>
          <PanelWrapper>
            <Paragraph big>
              Food trucks are self-contained ventures that will give you plenty
              of exposure to essential business skills. From creating a great
              menu to sourcing ingredients, and preparing meals to making a
              profit, you’ll need to get up to speed quickly.
            </Paragraph>
            ...
            >
              ...
              <Paragraph bottomPadding={0} bottomMargin={0}>
                ...
                start your food truck business and get it off the ground.
              </Paragraph>
            </Colorbox>

            <Paragraph big style={{ marginTop: "48px" }}>
              Here’s our simple guide to opening up your successful food truck
              business. From exploring the types of food trucks you can start to
              the legalities of setting up your business and the realities of
              your day to day operations, this guide is here to help.
            </Paragraph>
            ...
            >
              Read on for some insight into creating your own food truck
              business and becoming a food-based entrepreneur. In this guide
              we’ll cover:
            </Paragraph>
            ...
            <ListWrapper>
              <ListBox>
                <CkeckText>
                  <Paragraph big>Food truck business planning</Paragraph>
                </CkeckText>
              </ListBox>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>
                    Deciding whether a food truck business could be right for
                    you
                  </Paragraph>
                </CkeckText>
              </ListBox>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>
                    Statistics on why you should start a food truck business
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>
                    Setting up your food truck business including location,
        ...
        <TabPanel>
          <PanelWrapper>
            ...
            <Paragraph big style={{ marginBottom: "80px" }}>
              ...
              low, which makes them an ideal starting point for food-based
              entrepreneurs. Here are some statistics on the growth and staying
              power of food truck businesses:
            </Paragraph>
            ...
            <Paragraph big>
              This is why food truck businesses are so exciting — how can you be
        ...
        <TabPanel>
          <PanelWrapper>
            ...
            <Paragraph big style={{ marginBottom: "48px" }}>
              Although it can be exciting to form a food truck business, there
              will be significant demands on you as a small business owner. Here
              are some of the things you can expect.
            </Paragraph>

            <Heading size={3}>A Day in the Life of a Food Truck Owner</Heading>
            <Paragraph big>
              Here are some of the typical tasks you’ll be performing for your
              food truck business on a daily basis.
            </Paragraph>

            <div style={{ marginBottom: "10px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  Checking you have enough ingredients for all the meals you’re
                  offering and ordering food to build up your stock
                </Paragraph>
              </TextBoxed>
            </div>
            ...
            <div style={{ marginBottom: "10px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  Refining your menu so you can make good food at a reasonable
                  cost and sell it for a profit
                </Paragraph>
              </TextBoxed>
            </div>
            ...
            <div style={{ marginBottom: "10px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  Talking with venue owners and event organizers to see if you
                  can sell food at certain locations
                </Paragraph>
              </TextBoxed>
            </div>
            ...
            <div style={{ marginBottom: "10px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  Preparing food before you start your day to reduce preparation
                  time later
                </Paragraph>
              </TextBoxed>
            </div>
            ...
            <div style={{ marginBottom: "10px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  Working long hours to meet diner demands throughout the day
                  and night
                </Paragraph>
              </TextBoxed>
            </div>
            ...
            <div style={{ marginBottom: "10px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  Keeping up to date with all the licenses and permits you need
                  to run a healthy, hygienic food truck
                </Paragraph>
              </TextBoxed>
            </div>
            ...
            <div style={{ marginBottom: "10px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  Marketing your business through social media and other
                  channels
                </Paragraph>
              </TextBoxed>
            </div>
            ...
            <div style={{ marginBottom: "10px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  Managing your finances so you have enough profits to pay
                  yourself and stay operating
                </Paragraph>
              </TextBoxed>
            </div>
            ...
            <div style={{ marginBottom: "10px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  Maintaining your food truck and equipment so it stays in good
                  repair
                </Paragraph>
              </TextBoxed>
            </div>
            ...
            <Paragraph big>
              The following skills will be very useful in your role as a food
              truck small business owner:
            </Paragraph>

            <div style={{ marginBottom: "10px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  Inspiration to think up interesting food combinations, flavors
                  and meals
                </Paragraph>
              </TextBoxed>
            </div>
            ...
            <div style={{ marginBottom: "10px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  Good understanding of your ingredients costs, your operating
                  expenses and your profits
                </Paragraph>
              </TextBoxed>
            </div>
            ...
            <div style={{ marginBottom: "10px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  Strong interpersonal and customer service skills for
                  negotiating venues and serving food
                </Paragraph>
              </TextBoxed>
            </div>
            ...
            <div style={{ marginBottom: "10px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  Ability to work in a small, confined space for many hours a
                  day
                </Paragraph>
              </TextBoxed>
            </div>
            ...
            <div style={{ marginBottom: "48px" }}>
              <TextBoxed>
                <Paragraph big bottomMargin={0}>
                  Excellent administration skills to stay on top of ordering
                  ingredients, managing cash, profit margins, getting permits,
                  etc.
                </Paragraph>
              </TextBoxed>
            </div>
            ...
            <Paragraph big>
              Although the needs of your food truck customers may vary, they
              might expect:
            </Paragraph>
            ...
            <Paragraph big>
              Understanding who your customers are and what they want will be a
              big part of the success of your food truck business.
            </Paragraph>
          </PanelWrapper>
        </TabPanel>
      </ReactTabs>
    ...
    >
      ...
      <Paragraph big>
        Find the right niche, and your food truck business could be an enormous
        success. You’ll certainly learn quickly if it’s right for you, and with
        perseverance you can turn a food truck into a very profitable venture.
      </Paragraph>
    </Conclusion>
  </Layout>
);
