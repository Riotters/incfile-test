...
import {
  ...
  RingText,
  tabs,
} from "../../static/type-of-business/consulting-business";
    ...
    <Layout>
      ...
      >
        ...
        <p>
          ...
          starting a consulting business is a great way to monetize your
          strategic approach, skills and experience. Consultants come in many
          different types with specialists in hundreds of niches using thousands
          ...
          <TabPanel>
            <PanelWrapper>
              <Paragraph big style={{ marginBottom: "48px" }}>
                Other businesses hire consulting experts because they want to
                “buy in” expert opinions, ideas and resources that don’t exist
                in their organization already. If you have a proven track record
                of transforming businesses for the better, you can turn that
                into paid insight, exchanging your time and skill set for
                well-paid consulting jobs. Consulting provides deep insight to
                an organization without them having to hire expert staff on a
              ...
              <Paragraph big style={{ marginTop: "40px" }}>
                Due to the expertise offered by consultants, the rates charged
                are normally high. So a consulting business is a great business
                to start if you want to make a great income and not work very
                many hours.
              </Paragraph>

              <Paragraph big>
                {" "}
                But where do you start? In this guide we’ll explore everything
                you need to do to set up your consulting business and maximize
          ...
          <TabPanel>
            <PanelWrapper>
              ...
              <Paragraph big style={{ marginBottom: "52px" }}>
                ...
                including PwC, Deloitte, Ernst and Young, Boston Consulting
                Group, McKinsey, Accenture, IBM and KPMG. But don't be deterred
                — there is still room for a small boutique consulting firm to do
                very well.
              </Paragraph>
          ...
          <TabPanel>
            <PanelWrapper>
              ...
              <Paragraph big>
                ...
                understanding of an organization's problems, spend time
                analyzing those issues and come up with practical examples of
                how to make changes.
              </Paragraph>
              <Paragraph big style={{ marginBottom: "48px" }}>
                Being a consultant is all about “demonstrating your value.”
                Businesses will be expecting excellent results for the fees they
                are paying, so it’s all about delivering in accordance with
                those expectations.
              </Paragraph>
              ...
              <Paragraph big>
                Consultants come across many challenges. These start with
                finding clients — consultant services can be expensive, so
                building up a network of good leads and opportunities is vital.
                You will want to build up a robust pipeline of work to ensure
              ...
              <Paragraph big>
                As business needs change, you must be flexible and adaptable.
                You will have to use your experience to understand what is going
                on below the surface of an issue and then use tools and
      ...
      >
        ...
        <Paragraph big>
          If you have experience and insight into a particular industry, sector
          or niche, then consulting could be a viable business option for you.
          Combine your experience with an innovative approach, strong skills,
          and proven results, and you will be off to a great start in your new
