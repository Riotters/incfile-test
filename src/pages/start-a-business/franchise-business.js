...
import {RingText, tabs} from "../../static/type-of-business/franchise-business";
...
const FranchiseBusiness = () => (
    <Layout>
        ...
        <Top ovalColor="sun-2" imageName="franchise-business-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
            ...
            <p>
                What do household names like Subway, Cinnabon, Jiffy Lube, Ace Hardware, Hertz, Marriott, Dunkin’
                Donuts, 7-Eleven, Jimmy Johns and H&R Block all have in common? They’re all franchises — businesses that
                license out their name, backing, branding and processes to entrepreneurs who want to own
            ...
            <ReactTabs content={tabs} style={{marginTop: "75px"}}>
                <TabPanel>
                    <PanelWrapper>
                        <Paragraph big>
                            ...
                            their own and their employees’ future. It gives entrepreneurs an opportunity to partner with
                            some of the biggest brands in the U.S. and provides built-in resources, training and
                            expertise. In
                            exchange for a franchise fee and royalties, they will provide you with support, training,
                        ...
                        <ListWrapper>
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Questions you should ask to see if you’re ready to start a franchise
                                        business</Paragraph>
                                </CkeckText>
                            </ListBox>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>How to plan out your franchise business and the best legal structure
                                        for your new organization</Paragraph>
                                </CkeckText>
                            </ListBox>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Information on taxes and finances for your franchise
                                        business</Paragraph>
                                </CkeckText>
                            </ListBox>
                        ...
                        <Paragraph big>By the time you’ve read through our complete franchise business guide, you will
                            have all the information you need to set up and manage a thriving franchise business. Let’s
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <BlueBoxWithAbsoluteText absoluteText="800K"
                        ...
                        <Paragraph big style={{marginTop: "48px"}}>
                            In other words, franchising is a significant, successful and diverse part of the U.S.
                            economy. Franchise businesses do very well in the U.S.
                        </Paragraph>
                    </PanelWrapper>
                </TabPanel>
            </ReactTabs>
        ...
        <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"}
            ...
            <Paragraph big>
                ...
                benefits from their branding, market reach and support. With a vast array of franchises
