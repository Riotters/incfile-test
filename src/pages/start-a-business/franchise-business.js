...
const FranchiseBusiness = () => (
  <Layout>
    ...
    <Top ovalColor="sun-2" imageName="franchise-business-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
      ...
      <p>
        What do household names like Subway, Cinnabon, Jiffy Lube, Ace Hardware, Hertz, Marriott, Dunkin’ Donuts, 7-Eleven, Jimmy Johns and H&R Block all have in common? They’re all franchises — businesses that license out their name, backing, branding and processes to entrepreneurs who want to own
        a piece of the pie and grow a business without worrying about things like branding and marketing.
      </p>
      <ButtonsBox>
    ...
    <TabsWrapper>
      ...
      <TabsSection style={{ marginTop: "75px" }}>
        ...
        <CollapseWrapper>
          <PanelWrapper>
            <Paragraph big>
              A franchise can be a great opportunity for a business owner with some capital to invest in their own and their employees’ future. It gives entrepreneurs an opportunity to partner with some of the biggest brands in the U.S. and provides built-in resources, training and expertise. In
              exchange for a franchise fee and royalties, they will provide you with support, training, stock, expertise and marketing to launch your franchise quickly.
            </Paragraph>
            ...
            <ListBox>
                <CkeckText>
                  <Paragraph big>How you can understand the world of franchises</Paragraph>
                </CkeckText>
              </ListBox>
            ...
            <ListWrapper>
              <ListBox>
                <CkeckText>
                  <Paragraph big>Questions you should ask to see if you’re ready to start a franchise business</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>How to plan out your franchise business and the best legal structure for your new organization</Paragraph>
                </CkeckText>
              </ListBox>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>Information on taxes and finances for your franchise business</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>How to hire employees, marketing and administration</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Resources for your franchise business</Paragraph>
                </CkeckText>
              </ListBox>
            ...
            <Paragraph big>By the time you’ve read through our complete franchise business guide, you will have all the information you need to set up and manage a thriving franchise business. Let’s get into it.</Paragraph>
          </PanelWrapper>
          ...
          <PanelWrapper>
            ...
            <BlueBoxWithAbsoluteText absoluteText="800K" text="Franchise establishments across the country employing nearly 9 million people." />
            <BlueBoxWithAbsoluteText absoluteText="$900B" text="Total revenue generated by franchise businesses every year." />

            <Adventages headline="Around one in seven franchise businesses are owned by U.S. military veterans." width="100%" />

            <Adventages headline="Franchises exist across many sectors — fast food, restaurants, convenience stores, retailers, financial advice, hotels, car rentals, service providers and many more." width="100%" />

            <Adventages headline="There are over 3,000 franchisors licensing out partnerships to entrepreneurs who can benefit from the support they provide." width="100%" />
    ...
    <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"} buttonTitle="Start your Franchise Business with us, today">
      ...
      <Paragraph big>
        Starting a franchise business is an amazing opportunity for many entrepreneurs. Provided you have the capital to back you up and you can meet the franchisor’s rules and regulations, you will see huge benefits from their branding, market reach and support. With a vast array of franchises
        available, you’re sure to find something that meets your vision for the future.
      </Paragraph>
    </Conclusion>
  </Layout>
);
