                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Paragraph big style={{marginBottom: "40px"}}>
                            ...
                            the ideal experience, then opening a travel agency could be a great business move.
                        </Paragraph>
                        ...
                        <Colorbox className="box" theme="icon" Icon={TravelIconColorBox} color={color.blue3} curve
                            ...
                            <Paragraph bottomMargin={0}>We’ve helped over 100,000 people form their business and
                                ...
                                you through what you need to know to start your travel agency business and get it off
                                the ground.</Paragraph>
                        </Colorbox>

                        <Paragraph big style={{marginBottom: "40px", marginTop: "48px"}}>
                            To get you started on the right foot, here’s our simple guide on how to become a travel
                            agent. From highlighting important facts to validating your ideas, and from choosing the
                            right structure to managing and running your business, you’ll find the answers you need.
                        </Paragraph>
                        ...
                        <ListWrapper>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Choose the right business structure for your travel
                                        agency</Paragraph>
                                </CkeckText>
                            </ListBox>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Learning if a travel agency business could be right for
                                        you</Paragraph>
                                </CkeckText>
                            </ListBox>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>How to start your travel agency, with information on equipment,
                                        employees, location, permits, finances, taxes and more</Paragraph>
                                </CkeckText>
                            </ListBox>
                        </ListWrapper>
                    </PanelWrapper>
...
in the U.S. by 2020"
                        ...
                        <Adventages headline="Travel agency profits have also doubled from around 6% of revenue to 12%"
                                    width="100%"/>
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <TextBoxed style={{marginBottom: "8px"}}>
                            <Paragraph bottomMargin={0}>Creating itineraries, destinations and activities for
                                customers</Paragraph>
                        </TextBoxed>

                        <TextBoxed style={{marginBottom: "8px"}}>
                            <Paragraph bottomMargin={0}>Keeping up to date with the latest offers from tour
                                operators</Paragraph>
                        </TextBoxed>

                        <TextBoxed style={{marginBottom: "8px"}}>
                            <Paragraph bottomMargin={0}>Understanding available activities and travel options for
                                specific locations</Paragraph>
                        </TextBoxed>

                        <TextBoxed style={{marginBottom: "8px"}}>
                            <Paragraph bottomMargin={0}>Booking and administering travel and other vacation
                                plans</Paragraph>
                        </TextBoxed>

                        <TextBoxed style={{marginBottom: "48px"}}>
                            <Paragraph bottomMargin={0}>Answering questions and providing information to
                                customers</Paragraph>
                        </TextBoxed>
                        ...
                        <TextBoxed style={{marginBottom: "8px"}}>
                            <Paragraph bottomMargin={0}>Amazing administration skills to stay on top of every customer’s
                                travel plans</Paragraph>
                        </TextBoxed>

                        <TextBoxed style={{marginBottom: "8px"}}>
                            <Paragraph bottomMargin={0}>Great interpersonal skills for dealing with customers, tourism
                                operators, airlines, hotels and more</Paragraph>
                        </TextBoxed>

                        <TextBoxed style={{marginBottom: "8px"}}>
                            <Paragraph bottomMargin={0}>The ability to take in and analyze large amounts of information
                                to help customers make the right choice</Paragraph>
                        </TextBoxed>

                        <TextBoxed style={{marginBottom: "8px"}}>
                            <Paragraph bottomMargin={0}>Understanding the vacation experience from the customer’s
                                perspective and working to make that as good as possible</Paragraph>
                        </TextBoxed>

                        <TextBoxed style={{marginBottom: "8px"}}>
                            <Paragraph bottomMargin={0}>Willingness to spend lots of time on travel research and
                                destination websites finalizing details</Paragraph>
                        </TextBoxed>
                    </PanelWrapper>
                </TabPanel>
            </ReactTabs>
        ...
        <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"}
            ...
            <Paragraph big>The internet has lowered the barriers to finding the perfect vacation, but many people still
                need the experience and expertise that a great travel agent provides. Find the right niche, get your
                marketing right and you could see huge success as a travel agent.</Paragraph>
        </Conclusion>
    </Layout>
);
