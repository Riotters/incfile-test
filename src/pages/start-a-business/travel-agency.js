...
const TravelAgency = () => (
  <Layout>
    <SEO title="How to Start a Travel Agency" description="Everyone likes traveling — new horizons, beautiful destinations and unique experiences mean we love packing our bags and spending time away from work and home." />
        ...
        <CollapseWrapper>
          <PanelWrapper>
            <Paragraph big style={{ marginBottom: "40px" }}>
              That’s why travel agents are so important: they help bring our vacation dreams to life and build memories that will stay with us forever.
            </Paragraph>

            <Heading size={3}>Even with the rise of online travel booking, many vacationers want the reassurance of a travel expert to talk them through countries, destinations, hotels, flights, tours and more.</Heading>
            ...
            <Colorbox className="box" theme="icon" Icon={TravelIconColorBox} color={color.blue3} curve curveColor={color.blue1}>
              <Heading size={4}>Here’s how social media influencers make money:</Heading>

              <Paragraph bottomMargin={0}>We’ve helped over 100,000 people form their business and provided answers, guidance and support to transform them into entrepreneurs. We’ll guide you through what you need to know to start your travel agency business and get it off the ground.</Paragraph>
            </Colorbox>
            ...
            <ListWrapper>
              <ListBox>
                <CkeckText>
                  <Paragraph big>Facts and figures on the success of travel agencies</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Choose the right business structure for your travel agency</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Learning if a travel agency business could be right for you</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Ideas for the type of travel agency that you could form</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Groups, forums and support for travel agency owners</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Helpful software for travel agency business owners</Paragraph>
                </CkeckText>
              </ListBox>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>How to start your travel agency, with information on equipment, employees, location, permits, finances, taxes and more</Paragraph>
                </CkeckText>
              </ListBox>
            </ListWrapper>
          </PanelWrapper>
          ...
          <PanelWrapper>
            ...
            <BlueBoxWithAbsoluteText absoluteText="900B" text="Is spent on private construction in the U.S. every year" />
            <BlueBoxWithAbsoluteText
              absoluteText="$17B"
              text="Projected revenue a year for the travel agency industry
in the U.S. by 2020"
            />
            <BlueBoxWithAbsoluteText absoluteText="$15BT" text="Significant growth of annual revenue in 2015" />

            <CircleWithText style={{ marginBottom: "48px" }} withBg={true} textInsideCircle="60" symbol="%" textLine="Of travel agents report an increase in sales year over year" />

            <Adventages headline="Travel agency profits have also doubled from around 6% of revenue to 12%" width="100%" />

            <Adventages headline="Just over three-quarters of travel agent business revenue comes from commission, with the remainder from service fees" width="100%" />

            <Adventages headline="Over the last five years, the number of travel agency businesses has grown by almost 4 percent" width="100%" />
          </PanelWrapper>
          ...
          <PanelWrapper>
            ...
            <TextBoxed style={{ marginBottom: "8px" }}>
              <Paragraph bottomMargin={0}>Dealing with inquiries through your website</Paragraph>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <Paragraph bottomMargin={0}>Creating itineraries, destinations and activities for customers</Paragraph>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <Paragraph bottomMargin={0}>Keeping up to date with the latest offers from tour operators</Paragraph>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <Paragraph bottomMargin={0}>Understanding available activities and travel options for specific locations</Paragraph>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <Paragraph bottomMargin={0}>Booking and administering travel and other vacation plans</Paragraph>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "48px" }}>
              <Paragraph bottomMargin={0}>Answering questions and providing information to customers</Paragraph>
            </TextBoxed>

            <Heading size={3}>Skills Needed by a Travel Agent Entrepreneur</Heading>
            ...
            <TextBoxed style={{ marginBottom: "8px" }}>
              <Paragraph bottomMargin={0}>Amazing administration skills to stay on top of every customer’s travel plans</Paragraph>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <Paragraph bottomMargin={0}>Great interpersonal skills for dealing with customers, tourism operators, airlines, hotels and more</Paragraph>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <Paragraph bottomMargin={0}>The ability to take in and analyze large amounts of information to help customers make the right choice</Paragraph>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <Paragraph bottomMargin={0}>Understanding the vacation experience from the customer’s perspective and working to make that as good as possible</Paragraph>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <Paragraph bottomMargin={0}>Willingness to spend lots of time on travel research and destination websites finalizing details</Paragraph>
            </TextBoxed>
          </PanelWrapper>
        </CollapseWrapper>
      </TabsSection>
    ...
    <Conclusion to="/" buttonTitle="Start your Travel Agency Business with us, today">
      ...
      <Paragraph big>The internet has lowered the barriers to finding the perfect vacation, but many people still need the experience and expertise that a great travel agent provides. Find the right niche, get your marketing right and you could see huge success as a travel agent.</Paragraph>
    </Conclusion>
  </Layout>
);
