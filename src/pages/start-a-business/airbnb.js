...
import CircleSvg from "../../images/chart-airbnb.inline.svg";
...
const Airbnb = () => (
  <Layout>
    <SEO
      title="How to Start an Airbnb | A Guide to Airbnb Businesses"
      description="More than two million people stay at an Airbnb on any given day. Could starting an Airbnb business be right for you? Learn more."
    />
    ...
    >
      ...
      <p>
        Airbnb has only been with us since 2008, but over the last few years,
        it’s turned over half a million people into entrepreneurs.
      </p>
      <ButtonsBox>
        <Button
            externalLink
      ...
      <ReactTabs content={tabs}>
        <TabPanel>
          <PanelWrapper>
            ...
            <Paragraph big>
              ...
              straightforward, but setting yourself up for success requires a
              little more work.
            </Paragraph>
            <Paragraph big style={{ marginBottom: "48px" }}>
              We don’t think that creating an Airbnb business needs to be
              daunting, and we’re here to help. We’ve supported over 500,000
              people to form a business and provided answers, guidance and
              support to transform them into entrepreneurs. We’ll guide you
            ...
            <Paragraph big>
              ...
              out. Read on for some insight into creating your own Airbnb
        ...
        <TabPanel>
          <PanelWrapper>
            ...
            <Paragraph big style={{ marginBottom: "76px" }}>
              ...
              hosts—people that rent out property for others to stay at. Airbnb
              is a ready-made marketplace for guests, with millions of listings
              around the world. Here are some statistics on the power of the
              Airbnb industry:
            </Paragraph>
            ...
            <CircleWithText
              textInsideCircle="45"
              textLine="Increase in U.S. bookings year-to-year"
              withBg={true}
              SvgChart={CircleSvg}
              symbol="%"
            ...
            <Paragraph big>
              This is why Airbnb businesses are so exciting — how can you be a
              part of that success? We're here to help you figure that out.
            </Paragraph>
            <Paragraph big mixed>
              Want to start an Airbnb business?{" "}
        ...
        <TabPanel>
          <PanelWrapper>
            ...
            <Paragraph big style={{ marginBottom: "48px" }}>
              Before deciding to start an Airbnb business, it’s important to
            ...
            <Paragraph big style={{ marginBottom: "24px" }}>
              ...
              Airbnb business on a daily basis.
            </Paragraph>
            ...
            <CountingTextBoxed number={5}>
              <Paragraph bottomPadding={0} bottomMargin={0}>
                Getting information and photos to create compelling Airbnb
                listings
              </Paragraph>
            </CountingTextBoxed>
            ...
            <Paragraph big style={{ marginBottom: "48px" }}>
              The following skills will be very useful in your role as an Airbnb
