...
const GymPersonalTraining = () => (
	<Layout>
		...
		>
			...
			<p>
				Breweries are one of the most exciting types of businesses to be
				involved with. You get to create delicious drinks, host a community of
				people, indulge in the craft of brewing and provide all sorts of
		...
		<TabsWrapper>
			...
			<ReactTabs content={tabs}>
				<TabPanel>
					<PanelWrapper>
						<Paragraph big>
							Brewery tourism is on the rise - from beer-centric cities like
							Portland, Seattle, Denver or Asheville, to places where beer is
							just another great reason to go there, like Chicago, New York or
							San Diego. Remember, too, that breweries encompass all sorts of
							different types of brewing operations - from the traditional craft
							beer microbrewery to cideries, distilleries or winemakers, there’s
							a brewery for every style and palate.
						</Paragraph>
						...
						>
							<Heading size={2} template={4} left>
								We know it can be daunting to start a brewery business, and
								we’re here to help.
							</Heading>
							<Paragraph>
							...
							<Paragraph bottomPadding={0} bottomMargin={0}>
								...
								starting up a successful brewery business. From highlighting
								important facts to validating your ideas, and from choosing the
								right structure to learning your options for managing and
						...
						>
							Read on for some insight into creating your own brewery business
						...
						<ListWrapper>
							...
							<ListBox>
								<CkeckText>
									<Paragraph big>
										Choosing the right business structure for your brewery
										company
									</Paragraph>
								</CkeckText>
							</ListBox>
				...
				<TabPanel>
					<PanelWrapper>
						...
						<Paragraph big>
							So, just how popular are breweries in the U.S.? You’d be
							surprised.
						</Paragraph>

						<BlueBoxWithAbsoluteText
							absoluteText="6,200"
							text="Number of craft breweries across the U.S."
						/>
						<BlueBoxWithAbsoluteText
							absoluteText="30M"
						...
						<div style={{ marginBottom: "30px", marginTop: "80px" }}>
							<Adventages
								headline="Craft beer volumes are growing by 5 percent a year."
								width="100%"
							/>
						</div>
						...
						<div style={{ marginBottom: "30px" }}>
							<Adventages
								headline="Craft breweries employ over 130,000 people."
								width="100%"
							/>
						</div>

						<Paragraph big>
							Cideries, distilleries and winemakers have also seen excellent
							growth and good future business prospects.
						</Paragraph>
						<Paragraph big>
							As you can see, there are plenty of opportunities to start up your
							own brewery business. We’ll help you be part of that success.
						</Paragraph>
					</PanelWrapper>
				</TabPanel>
				...
				<TabPanel>
					<PanelWrapper>
						...
						<Paragraph big style={{ marginBottom: "48px" }}>
							Although it can be exciting to form a brewery business, there will
						...
						<Paragraph big>
							...
							brewery business on a daily basis:
						</Paragraph>
						...
						<div style={{ marginBottom: "10px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									Working with product manufacturers, marketers and other
									organizations
								</Paragraph>
							</TextBoxed>
						</div>
						...
						<div style={{ marginBottom: "10px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									Making financial decisions, paying bills and reconciling
									accounts
								</Paragraph>
							</TextBoxed>
						</div>
						...
						<div style={{ marginBottom: "10px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									You will probably manage staff, so you will need to be a good
									people manager
								</Paragraph>
							</TextBoxed>
						</div>
						...
						<div style={{ marginBottom: "10px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									It’s possible you will interact with the public, so
						...
						<div style={{ marginBottom: "10px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									You will need to conduct market research to learn what to brew
									and what to sell
								</Paragraph>
							</TextBoxed>
						</div>
						...
						<div style={{ marginBottom: "10px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									You will work with product manufacturers on merchandise,
									glasses, packaging and more
								</Paragraph>
							</TextBoxed>
						</div>
						...
						<div style={{ marginBottom: "10px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									Marketing is essential to a successful brewery, so expect to
									spend plenty of time on that
								</Paragraph>
							</TextBoxed>
						</div>
						...
						<div style={{ marginBottom: "10px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									Capital expenses can be high, so you’ll need to be a good
						...
						<div style={{ marginBottom: "48px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									If you have adjunct businesses like a brewpub, bar or
									restaurant, you will need to manage those as well
								</Paragraph>
							</TextBoxed>
						</div>
						...
						<Paragraph big>
							Your brewery customers are looking for a variety of unique
							features in your brewery, including:
						</Paragraph>
						...
						<div style={{ marginBottom: "10px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									An excellent selection of styles and flavors of beers or other
									alcoholic beverages
								</Paragraph>
							</TextBoxed>
						</div>
						...
						<div style={{ marginBottom: "10px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									Helpful information on the tastes, brewing process and origin
									of beers
								</Paragraph>
							</TextBoxed>
						</div>
						...
						<div style={{ marginBottom: "10px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									Friendly and knowledgeable staff to help them choose the right
									drink
								</Paragraph>
							</TextBoxed>
						</div>
						...
						<div style={{ marginBottom: "10px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									Unique and distinctive branding and packaging of your
									beverages
								</Paragraph>
							</TextBoxed>
						</div>
		...
		>
			...
			<Paragraph big>
				Although starting a brewery can be tough and requires plenty of money,
				the rewards can be even bigger. Profit margins on beer are typically
				very good, and with sound financial management, you can turn a good
				brewery into a thriving business.
			</Paragraph>
		</Conclusion>
	</Layout>
);
