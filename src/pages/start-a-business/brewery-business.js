...
import Tab1Icon from "../../images/icons/brewery-business-icon.inline.svg";
...
const GymPersonalTraining = () => (
  <Layout>
    ...
    <Top ovalColor="sun" imageName="brewery-business-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
      ...
      <p>Breweries are one of the most exciting types of businesses to be involved with. You get to create delicious drinks, host a community of people, indulge in the craft of brewing and provide all sorts of additional benefits like a bar, food, music and more.</p>
      <ButtonsBox>
    ...
    <TabsWrapper>
      ...
      <TabsSection>
        <TabHeading>
          <TabTitle title="Brewery" SvgIcon={Tab1Icon} />
        ...
        <CollapseWrapper>
          <PanelWrapper>
            <Paragraph big>
              Brewery tourism is on the rise - from beer-centric cities like Portland, Seattle, Denver or Asheville, to places where beer is just another great reason to go there, like Chicago, New York or San Diego. Remember, too, that breweries encompass all sorts of different types of brewing
              operations - from the traditional craft beer microbrewery to cideries, distilleries or winemakers, there’s a brewery for every style and palate.
            </Paragraph>

            <Colorbox className="box" theme="icon" Icon={CupIcon} color={color.green3} curve curveColor={color.blue1}>
              <Heading size={4}>We know it can be daunting to start a brewery business, and we’re here to help.</Heading>
              <Paragraph>We’ve supported over 100,000 people to form their business and provided answers, guidance and support to transform them into entrepreneurs. We’ll guide you through what you need to know to start your brewery business.</Paragraph>
              <Paragraph bottomPadding={0} bottomMargin={0}>
                To get you off on the right foot, here’s our simple guide to starting up a successful brewery business. From highlighting important facts to validating your ideas, and from choosing the right structure to learning your options for managing and running your business, you’ll find the
                answers you need.
              </Paragraph>
            </Colorbox>
            ...
            <ListWrapper>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>Choosing the right business structure for your brewery company</Paragraph>
                </CkeckText>
              </ListBox>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>Ideas for the type of brewery business that you could form</Paragraph>
                </CkeckText>
              </ListBox>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>Setting up your brewery business, including location, equipment, employees, taxes, finances, licenses and more</Paragraph>
                </CkeckText>
              </ListBox>
          ...
          <PanelWrapper>
            ...
            <BlueBoxWithAbsoluteText absoluteText="30M" text="Barrels of beer breweries collectively produce every year." />
            <BlueBoxWithAbsoluteText absoluteText="$25B" text="Total worth of beer craft breweries sold every year." />

            <CircleWithText textInsideCircle="98" textLine="Of all U.S. breweries are independently owned craft breweries" SvgChart={CircleSvg} withBg={true} symbol="%" />
            ...
            <div style={{ marginBottom: "30px" }}>
              <Adventages headline="Millennials are the group most familiar with and most likely to consume craft beer." width="100%" />
            </div>
            ...
            <Paragraph big>Cideries, distilleries and winemakers have also seen excellent growth and good future business prospects.</Paragraph>
            <Paragraph big>As you can see, there are plenty of opportunities to start up your own brewery business. We’ll help you be part of that success.</Paragraph>
          </PanelWrapper>
          ...
          <PanelWrapper>
            ...
            <Paragraph big>Here are some of the typical tasks you’ll be performing for your brewery business on a daily basis:</Paragraph>
            ...
            <Paragraph big>The following skills will be very useful in your role as a brewery small business owner:</Paragraph>
            ...
            <Paragraph big>Your brewery customers are looking for a variety of unique features in your brewery, including:</Paragraph>
    ...
    <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"} buttonTitle="Start your Brewery Business with us, today">
      <Heading size={3} style={{ fontSize: "48px" }}>
        Conclusion
      </Heading>
      <Paragraph big>Although starting a brewery can be tough and requires plenty of money, the rewards can be even bigger. Profit margins on beer are typically very good, and with sound financial management, you can turn a good brewery into a thriving business.</Paragraph>
    </Conclusion>
  </Layout>
);
