...
const Handyman = () => (
  <Layout>
    <SEO title="How to Start a Home Handyman Business" description="If you have some skill with home improvement, DIY or fixing things, then running a home handyman business could be right for you." />
    ...
    <TabsWrapper>
      ...
      <TabsSection>
        ...
        <CollapseWrapper>
          <PanelWrapper>
            <Heading size={3}>A handyman business has several advantages over other types of business:</Heading>
            ...
            <Colorbox curveColor={color.blue1} color={color.blue3} curve theme="icon" Icon={QuestionIcon}>
              ...
              <Paragraph>Here at Incfile, we know the answer, and we’ve shared it with more than 100,000 people who we've helped form their businesses. Since 2004, we’ve supported tradesmen just like you.</Paragraph>
            ...
            <ListWrapper>
              <ListBox>
                <CkeckText>
                  <Paragraph big>Facts and figures about the success of handyman businesses</Paragraph>
                </CkeckText>
              </ListBox>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>Where to find handyman business groups, forums and support</Paragraph>
                </CkeckText>
              </ListBox>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>How to start your handyman business with information on equipment, employees, location, permits, finance, taxes and more</Paragraph>
                </CkeckText>
              </ListBox>
          ...
          <PanelWrapper>
            ...
            <BlueBoxWithAbsoluteText absoluteText="$4 Bilion" text="The overall revenues of handyman service franchise industry (groups of various types of tradesmen working together) a year in the U.S." />

            <CircleWithText symbol="%" textInsideCircle="6" textLine="Annual growth in the franchise part of a handyman business a year" withBg={true} />

            <div style={{ marginBottom: "30px", marginTop: "48px" }}>
              <Adventages headline="A successful handyman could earn as much as $3,000 a week" width="100%" />
            </div>

            <div style={{ marginBottom: "30px" }}>
              <Adventages headline="The most popular home handyman specializations include maintenance, plumbing, painting, flooring, landscaping and electrical" width="100%" />
            </div>
          </PanelWrapper>

          <PanelWrapper>
            <Heading size={3}>Is a Handyman Business Right for You?</Heading>
            <Paragraph big>Although it can be exciting to form a handyman business, there will be significant demands on you as a small business owner. Here are some of the things you can expect.</Paragraph>

            <Paragraph big style={{ fontWeight: "bold" }}>
              A Day in the Life of a Handyman
            </Paragraph>

            <Paragraph big>Here are some of the typical tasks you’ll be performing for your handyman business on a daily basis:</Paragraph>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <Paragraph bottomMargin={0}>Deal with phone calls, emails and other contacts from potential clients</Paragraph>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <Paragraph bottomMargin={0}>Travel to job sites to assess work and estimate costs</Paragraph>
            </TextBoxed>
            ...
            <TextBoxed style={{ marginBottom: "8px" }}>
              <Paragraph bottomMargin={0}>Market your business using local promotions, your website, social media and other means</Paragraph>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <Paragraph bottomMargin={0}>Send out invoices, take payment and manage your finances</Paragraph>
            </TextBoxed>
            ...
            <Paragraph big>The following skills will be very useful in your role as a handyman small business owner:</Paragraph>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <Paragraph bottomMargin={0}>Ability to quickly understand the amount of work and materials needed to complete a job</Paragraph>
            </TextBoxed>
            ...
            <TextBoxed style={{ marginBottom: "8px" }}>
              <Paragraph bottomMargin={0}>Good vocational skills in your chosen home handyman area (painting, landscaping, carpentry, plumbing, etc.)</Paragraph>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <Paragraph bottomMargin={0}>Excellent interpersonal skills for dealing with potential customers and existing clients</Paragraph>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <Paragraph bottomMargin={0}>Networking skills so you can connect with other tradesmen and commercial clients</Paragraph>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <Paragraph bottomMargin={0}>Strong understanding of financial management and cash flow</Paragraph>
            </TextBoxed>
            ...
            <Paragraph big>
              Clients who hire a home handyman want reliability, quality and value. Reliability means you turn up when you say you will and you’ll complete the job to the agreed scope, timeline and price. Quality means you’ll approach the work with a careful eye, complete it with skill and deliver a
              finished product that meets your customers' needs. Value means that you charge fairly for your time, you don’t add unexpected fees and that your quote is reasonable for the work you’re doing.
            </Paragraph>
            <Paragraph big>It’s also important to note that not every customer is looking for the lowest quote — some clients are happy to pay more for higher quality work.</Paragraph>
          </PanelWrapper>
        </CollapseWrapper>
      </TabsSection>
    </TabsWrapper>
    ...
    <SimpleSection>
      ...
      <Container>
        <CenterBox>
          ...
          <Paragraph big>If you’re a home handyman business, you might be wondering if you really need a business plan? Yes, you do.</Paragraph>
          ...
          <Paragraph big style={{ marginTop: "48px" }}>
            You will also need to look at customer and financial projections for your handyman business. What are your expected sales and revenues? What is your profitability? How much money will you keep in the business to grow it? How much will you pay yourself? What will be the costs of your
            materials, advertising and everything else that goes into running a successful tradesman business?
          </Paragraph>
    ...
    <Conclusion to="/" buttonTitle="Start your Handyman Business with us, today">
      ...
      <Paragraph big>
        With the right attitude, skills and approach, you can build a very successful home handyman business. Identify your areas of expertise, market yourself well and put together a business plan. This will help you build good word-of-mouth and grow your client base. Whatever type of tradesman you
