...
const BedAndBreakfast = () => (
    <Layout>
        ...
        <Top ovalColor="purple-2" imageName="bed-and-breakfast-main" imageAlt="Mr Bulb with seedling"
            ...
            <p>What could be better than creating the perfect location and ambiance for people to enjoy their vacation?
                A bed and breakfast or hotel business is a great way to provide a desirable destination for travelers
                and a sustainable income for yourself.</p>
            <ButtonsBox>
        ...
        <TabsWrapper>
            ...
            <ReactTabs content={tabs} style={{marginTop: "100px"}}>
                <TabPanel>
                    <PanelWrapper>
                        <Paragraph big>We all want to broaden our horizons — and as travel keeps becoming easier, your
                            hotel could be perfectly positioned to take advantage.</Paragraph>
                        <Paragraph big>There’s a lot of thinking that goes into creating a boutique hotel or B&B
                            business. You need to decide the type of B&B experience you want to create, make the
                            day-to-day running as efficient as possible and market yourself to the right
                            vacationers.</Paragraph>
                        ...
                        <Paragraph big style={{
                            ...
                            To get you off on the right foot, here’s our simple guide to starting up a successful bed
                        ...
                        <ListWrapper>
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Facts and figures about the success of bed and breakfast
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Where to find bed and breakfast business groups, forums and
                                        support</Paragraph>
                                </CkeckText>
                            </ListBox>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Setting up your hotel business, including location, equipment,
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>How to choose whether your hospitality business should be an LLC or
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <CircleWithText styles={{marginBottom: "80px"}} textInsideCircle="44"
                                        textLine="Average occupancy rate of B&Bs in the U.S." SvgChart={CircleSvg}
                                        withBg={true} symbol="%"/>

                        <Adventages headline="The average daily rate for a room is around $150" width="100%"/>

                        <Adventages headline="Most B&Bs have between four and eleven rooms, with six being the average"
                                    width="100%"/>
                        ...
                        <Adventages
                            ...
                            width="100%"/>
                        <Paragraph big>As you can see, there are plenty of opportunities to start up your own bed and
                            breakfast business. We’ll help you be part of that success.</Paragraph>
                    </PanelWrapper>
                </TabPanel>
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Paragraph big>The following skills will be very useful in your role as a bed and breakfast
                            small business owner:</Paragraph>
                        ...
                        <Paragraph big>The needs of your vacationers will change depending on where you’re located, the
                            type of experience you offer, their expectations and several other factors. For example,
                            guests might want a combination of the following:</Paragraph>
                        ...
                        <Paragraph big>Ultimately, your guests want a combination of comfort, interest and value for
                            money. The balance between these will vary widely depending on the type of vacationer you’re
                            trying to attract.</Paragraph>
                    </PanelWrapper>
                </TabPanel>
            </ReactTabs>
        </TabsWrapper>
        ...
        <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"}
            ...
            <Paragraph big>The B&B or boutique hotel industry is the perfect choice if you love hospitality and want to
                provide an amazing experience for your guests. We hope this guide has inspired you to find the right
                idea for the type of hospitality you want to provide. Good luck!</Paragraph>
        </Conclusion>
    </Layout>
);
