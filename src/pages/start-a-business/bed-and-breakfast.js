...
const BedAndBreakfast = () => (
  <Layout>
    <SEO
      title="How to Start a Bed and Breakfast or Hotel Business"
    ...
    <Top ovalColor="purple-2" imageName="bed-and-breakfast-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
      <h1>How to Start a Bed and Breakfast or Hotel Business</h1>
      <p>What could be better than creating the perfect location and ambiance for people to enjoy their vacation? A bed and breakfast or hotel business is a great way to provide a desirable destination for travelers and a sustainable income for yourself.</p>
      <ButtonsBox>
    ...
    <TabsWrapper>
      ...
      <TabsSection style={{ marginTop: "100px" }}>
        ...
        <CollapseWrapper>
          <PanelWrapper>
            <Paragraph big>We all want to broaden our horizons — and as travel keeps becoming easier, your hotel could be perfectly positioned to take advantage.</Paragraph>
            <Paragraph big>There’s a lot of thinking that goes into creating a boutique hotel or B&B business. You need to decide the type of B&B experience you want to create, make the day-to-day running as efficient as possible and market yourself to the right vacationers.</Paragraph>

            <Colorbox className="box" theme="icon" Icon={QuestionIcon} color={color.green3} curve curveColor={color.blue1}>
              <Heading size={4}>The question is, just where do you start?</Heading>
              <Paragraph bottomPadding={0} bottomMargin={0}>
                Here at Incfile, we know the answer, and we’ve shared it with more than 100,000 people who we've helped to form their businesses. Since 2004, we’ve supported hospitality entrepreneurs just like you, and we’re proud to have been a part of the bed and breakfast business revolution.
              </Paragraph>
            </Colorbox>
            ...
            <ListWrapper>
              <ListBox>
                <CkeckText>
                  <Paragraph big>Facts and figures about the success of bed and breakfast businesses</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Business plans for hotel and B&B companies</Paragraph>
                </CkeckText>
              </ListBox>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>Where to find bed and breakfast business groups, forums and support</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>How to validate your bed and breakfast business idea</Paragraph>
                </CkeckText>
              </ListBox>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>Useful online tools for hospitality business owners</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Setting up your hotel business, including location, equipment, employees, taxes, finances, licenses and more</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>How to choose whether your hospitality business should be an LLC or corporation</Paragraph>
                </CkeckText>
              </ListBox>
          ...
          <PanelWrapper>
            ...
            <BlueBoxWithAbsoluteText absoluteText="$3B" text="Revenue of the industry per year as a whole" />

            <CircleWithText styles={{ marginBottom: "80px" }} textInsideCircle="44" textLine="Average occupancy rate of B&Bs in the U.S." SvgChart={CircleSvg} withBg={true} symbol="%" />

            <Adventages headline="The average daily rate for a room is around $150" width="100%" />

            <Adventages headline="Most B&Bs have between four and eleven rooms, with six being the average" width="100%" />
          ...
          <PanelWrapper>
            ...
            <Paragraph big>Here are some of the typical tasks you’ll be performing for your bed and breakfast business on a daily basis:</Paragraph>
            ...
            <Paragraph big>The following skills will be very useful in your role as a bed and breakfast small business owner:</Paragraph>
            ...
            <Paragraph big>The needs of your vacationers will change depending on where you’re located, the type of experience you offer, their expectations and several other factors. For example, guests might want a combination of the following:</Paragraph>
            ...
            <Paragraph big>Ultimately, your guests want a combination of comfort, interest and value for money. The balance between these will vary widely depending on the type of vacationer you’re trying to attract.</Paragraph>
          </PanelWrapper>
        </CollapseWrapper>
      </TabsSection>
    </TabsWrapper>
    ...
    <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"} buttonTitle="Start your Bed and Breakfast Business with us, today">
      <Heading size={3} style={{ fontSize: "48px" }}>
        Conclusion
      </Heading>
      <Paragraph big>The B&B or boutique hotel industry is the perfect choice if you love hospitality and want to provide an amazing experience for your guests. We hope this guide has inspired you to find the right idea for the type of hospitality you want to provide. Good luck!</Paragraph>
    </Conclusion>
  </Layout>
);
