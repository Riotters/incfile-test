...
import Tab1Icon from "../../images/icons/beauty-salon.inline.svg";
...
import { RingText, toolsList } from "../../static/type-of-business/beauty-salon";
...
const BeautySalon = () => (
  <Layout>
    <SEO title="How to Start a Beauty Salon Business" description="Personal care and pampering is something we all need. If you’re an entrepreneur, the world of the beauty salon has some surprising advantages. " />

    <Top ovalColor="sun-2" imageName="beauty-salon-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
      ...
      <TabsSection>
        ...
        <CollapseWrapper>
          <PanelWrapper>
            ...
            <Paragraph big>To begin with, it’s largely immune to the trend toward ecommerce since beauty salons provide hyper-localized personalized services. Secondly, if you provide great service, you will quickly develop an excellent reputation that will lead to repeat bookings.</Paragraph>
            <Paragraph big>
            ...
            <Paragraph big>In this guide we’ll explore everything you need to do to set up your beauty salon business and maximize your chances for success. We’ll cover:</Paragraph>

            <ListWrapper>
              <ListBox>
                <CkeckText>
                  <Paragraph big>Understanding the world of a beauty salon</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Paying taxes for your beauty salon business</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Deciding if you’re ready to start a beauty salon business</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Hiring employees, managing finances and administering your beauty salon business</Paragraph>
                </CkeckText>
              </ListBox>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>Locating other resources for your beauty salon business</Paragraph>
                </CkeckText>
              </ListBox>
            ...
            <Paragraph big>By the time you’ve read through our complete beauty salon business guide, you will have all the information you need to set up and manage a thriving beauty salon business. Let’s get into it.</Paragraph>
          </PanelWrapper>
          ...
          <PanelWrapper>
            ...
            <BlueBoxWithAbsoluteText absoluteText="2.8%" text="Revenue increase by year, while job growth is expected to increase by 0.6 percent a year" />
            ...
            <Adventages headline="The biggest expenses for beauty salons are employee compensation, real estate and rental, manufacturing and professional and business services." width="100%" />

            <Adventages headline="There are nearly 270,000 beauty salons, hairdressers and barber shops in the U.S." width="100%" />

            <Adventages headline="Wages paid to workers are typically low, with many earning around $22,000-$25,000 a year." width="100%" />

            <Adventages headline="The industry is very fragmented, with the largest 50 salon chains only contributing 15 percent to overall revenue" width="100%" />

            <Paragraph big>
              This all points to the beauty salon industry being ripe with new opportunities for focused entrepreneurs, so now might be the perfect time to dive into starting your beauty salon business. Incfile is here to help you form your beauty salon business and understand the ins and outs of
            ...
            <Paragraph big>
              If you want to run a successful beauty salon, you need to build your entire suite of services around customer needs. When it comes to offering beauty and hairdressing services, that means providing a great range of services at an extraordinarily high quality combined with reasonable
              pricing.
            </Paragraph>
            <Paragraph big>
              Your beauty salon will rely on word-of-mouth marketing, so you want to help customers become an advocate for your business. You can do this by offering personalized service and ensuring your staff provides extensive beauty treatments that leave your customers feeling pampered and
              wonderful.
            </Paragraph>
            <Paragraph big>When it comes to providing beauty treatments, you will want to ensure you’re providing the right niche of services. You have plenty of options:</Paragraph>
          ...
          <PanelWrapper>
            <Heading size={3}>What Are the Main Skills, Expertise and Experience Needed to be a Successful Beauty Salon Entrepreneur?</Heading>
            <Paragraph big>When it comes to skill sets, you need wide-ranging expertise to be a successful beauty salon owner. These skills should include:</Paragraph>

            <Adventages headline="Hiring" text="Finding, interviewing and hiring great beauty salon employees who can provide awesome beauty treatments and hairstyling services" width="100%" />

            <Adventages headline="People management" text="Dealing with staff schedules, coverage, internal issues and other people management areas" width="100%" />
            ...
            <Adventages headline="Treatment design and pricing" text="Working with employees to create luxurious treatments with good profit margins" width="100%" />

            <Adventages headline="Salon creation" text="Setting up the salon in the first place, which includes finding equipment, furniture, fixtures and fittings" width="100%" />

            <Adventages headline="Operational management" text="Ensuring customers are served well and beauty treatments are provided to the standards you expect" width="100%" />
    ...
    <BlueContainer>
      ...
      <Container>
        ...
        <GridSectionList>
          <TextBlockWithImage width={100} widthUnit="%" className="containerMargin" SvgImage={IdentifyIcon} imageBackgroundColor={color.babyblue2} imageShadowColor={color.babyblue2}>
          ...
          <TextBlockWithImage width={100} widthUnit="%" className="containerMargin" SvgImage={LookIcon} imageBackgroundColor={color.green2} imageShadowColor={color.green2}>
          ...
          <TextBlockWithImage width={100} widthUnit="%" className="containerMargin" SvgImage={InvolvedIcon} imageBackgroundColor={color.red2} imageShadowColor={color.red2}>
          ...
          <TextBlockWithImage width={100} widthUnit="%" className="containerMargin" SvgImage={TalkIcon} imageBackgroundColor={color.purple2} imageShadowColor={color.purple2}>
          ...
          <TextBlockWithImage width={100} widthUnit="%" className="containerMargin" SvgImage={ValidateIcon} imageBackgroundColor={color.orange2} imageShadowColor={color.orange2}>
        ...
        <CenterBox>
          ...
          <Paragraph big>
            You will also need to look at financial projections for your beauty salon business. What are your expected sales and revenues? What is your profitability? How much money will you keep in the business to grow it? How much will you pay yourself and others? If you can, try to plan your
            revenue for the next month, three months, year and two years.
          </Paragraph>
          <Paragraph big>You might start by just offering one or two high-demand beauty treatments and then expanding later as you build your reputation and clientele.</Paragraph>
        </CenterBox>
      </Container>
    </BlueContainer>
    ...
    <OrangeContainer>
      ...
      <BusinessOwnerResponsibilities>
        <ImageContent image="unique-business-2" paddingTop="60">
          ...
          <Paragraph big>Now that you have all the background information for your beauty salon business, it’s time to make it into a reality. Starts by choosing the right structure or “legal entity” for your business. In the U.S., there are five main business structures. They are:</Paragraph>
...
<Paragraph big style={{ color: color.blue1, fontWeight: "bold" }} mixed={true}>
    ...
    <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"} buttonTitle="Start your Beauty Salon Business with us, today">
      <Heading size={3} style={{ fontSize: "40px" }}>
        Conclusion
      </Heading>
      <Paragraph big>As you can see, starting a beauty salon can be a great way to grow a thriving business. A strong focus on the best treatments, understanding your clientele and local marketing will position you for success. Good luck!</Paragraph>
    </Conclusion>
  </Layout>
);
