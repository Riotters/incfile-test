...
const HomeBusiness = () => (
    <Layout>
        ...
        <Top ovalColor="green" imageName="home-business-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
            ...
            <p>
                Starting a new business can be a major undertaking, so for entrepreneurs wanting to start off
                small, <Link to="/blog/post/how-start-home-business/">a home-based business is a great idea</Link>.
                You’ll learn a great deal about running a business successfully, while avoiding many of the costs
                associated with larger businesses, like office rental,
                ...
                <TabPanel>
                    <PanelWrapper>
                        <Paragraph big style={{marginBottom: "40px"}}>
                            If you find a good niche for your home-based business, it can even grow to provide a
                            full-time income for you and your family. These types of “lifestyle” businesses are becoming
                            increasingly popular, and provide the freedom and satisfaction of running your own business
                            while avoiding
                            much of the risk that a larger-scale venture would create.
                        </Paragraph>

                        <Colorbox className="box" theme="icon" Icon={MegafonIcon} color={color.purple3} curve
                                  curveColor={color.purple1}>
                            <Heading size={4}>We want to help you get your home-based business off the ground.</Heading>

                            <Paragraph bottomMargin={0}>
                                Since 2004, we’ve helped over 500,000 people to become entrepreneurs, starting exciting
                                businesses and bringing their ideas to life. We’ll give you the support, guidance and
                                advice you need to start a business from home and make it into a success.
                            </Paragraph>
                        </Colorbox>

                        <Paragraph big style={{marginTop: "40px"}}>
                            From validating your ideas and doing the research to filing your paperwork and running your
                            business, this guide will help you out. We’ll talk you through the main things you need to
                            do to get your home-based business off of the ground.
                        </Paragraph>

                        <Paragraph big>Read on for some insight into starting a business from home and becoming an
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Paragraph big style={{marginBottom: "52px"}}>
                            ...
                            surprising statistics that suggest it’s a growing and lucrative type of business to run:
                        </Paragraph>
                        ...
                        <Adventages headline="Almost half of home-based businesses are started for less than $5,000"
                                    width="100%"/>

                        <Adventages headline="Women start more home-based businesses than men" width="100%"/>
                    </PanelWrapper>
                </TabPanel>
            </ReactTabs>
        </TabsWrapper>
        ...
        <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"} buttonTitle="Start your business with us, today">
            ...
            <Paragraph big>
                The world of home-based businesses is extremely diverse. With the right intent and purpose, you can
                start a home-based business and turn it into something that could earn you more than $100,000 a year.
                Use this guide to start your search, form your business and the sky's the limit!
            </Paragraph>
        </Conclusion>
    </Layout>
);
