...
const HomeBusiness = () => (
  <Layout>
    ...
    <TabsWrapper>
      ...
      <TabsSection>
        <TabHeading>
          <TabTitle title="Home-Based Business" SvgIcon={ConstructionIcon} />
        ...
        <CollapseWrapper>
          <PanelWrapper>
            <Paragraph big style={{ marginBottom: "40px" }}>
              If you find a good niche for your home-based business, it can even grow to provide a full-time income for you and your family. These types of “lifestyle” businesses are becoming increasingly popular, and provide the freedom and satisfaction of running your own business while avoiding
              much of the risk that a larger-scale venture would create.
            </Paragraph>

            <Colorbox className="box" theme="icon" Icon={MegafonIcon} color={color.purple3} curve curveColor={color.purple1}>
            ...
            <Paragraph big>Read on for some insight into starting a business from home and becoming an entrepreneur.</Paragraph>
          </PanelWrapper>
          ...
          <PanelWrapper>
            ...
            <BlueBoxWithAbsoluteText absoluteText="400M" text="Businesses in the U.S. that were started from home" />
            <BlueBoxWithAbsoluteText absoluteText="$400B" text="Total revenue of the 40M businesses per year" />
            <BlueBoxWithAbsoluteText absoluteText="100K" text="A fifth of home-based businesses make over a year" />

            <div style={{ marginTop: "28px" }}>
              <Adventages headline="Nearly three-quarters of home-based businesses are still operating after three years, compared with only a third of traditional businesses" width="100%" />
            </div>

            <Adventages headline="Almost half of home-based businesses are started for less than $5,000" width="100%" />
