...
const UniqueBusiness = () => (
    <Layout>
        ...
        <Top
            ovalColor="purple-2"
            imageName="unique-business-main"
            imageAlt="how to start a unique business"
            headlineWidth={700}
        >
            <h1>How to Start a Unique Business</h1>
            <p>
                Some of us like to do things a little differently, and that’s also true
                of business owners and entrepreneurs. If you’ve looked at some standard
                business ideas and thought “that’s not for me,” perhaps you need
                something a more unique.
      </p>
            <ButtonsBox>
                <Button
                    externalLink
        ...
        <SimpleContainer>
            ...
            <ImageContent image="business-startup-guides" paddingTop="60">
                ...
                <Paragraph big bottomMargin={0}>
                    You’ll be creating products or services that people can’t easily get
                    elsewhere, and you’ll be able to identify your target market and build
                ...
                >
                    <Paragraph big style={{ fontWeight: "bold", marginBottom: "16px" }}>
                        The question is, just where do you start? How do you find a unique
                        business idea, test it out and bring it to life?
          </Paragraph>
                    <Paragraph bottomMargin={0}>
                        We can help. Since 2004, we’ve helped over 500,000 people like you
                        become entrepreneurs, starting exciting businesses and bringing
                        their ideas to life. We’ll give you the support, guidance and advice
                        you need to create a unique business and make it into a success.
          </Paragraph>
                </Colorbox>

                <Paragraph big style={{ marginTop: "48px" }}>
                    To get you off on the right foot, here’s our simple guide to starting
                    up a successful unique business. From highlighting important facts to
                    validating your ideas, and from choosing the right structure to
                    managing and running your business, you’ll find the answers you need.
        </Paragraph>
                <Paragraph big>
                    Read on for some insight into creating your own unique business and
        ...
        <Conclusion
            ...
            buttonTitle="Start your Unique Business with us, today"
        >
            <Heading size={3} style={{ fontSize: "40px" }}>
                Conclusion
      </Heading>
            <Paragraph big>
                The internet has made it possible to pursue most business ideas, no
                matter how unique. If you can find a great niche, understand your
