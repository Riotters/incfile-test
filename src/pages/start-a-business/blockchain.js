...
const Blockchain = () => (
    <Layout>
        <SEO title="How to Make Your Business a Blockchain Startup"
        ...
        <Top ovalColor="blue" imageName="blockchain-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
            ...
            <p>Blockchain is one of the most popular buzzwords in business right now, but unless you have a good
                understanding of “immutable, publicly distributed ledgers,” it can be difficult to understand what it
                could do for you.</p>
            <ButtonsBox>
            ...
            <ReactTabs content={tabs}>
                    ...
                    <PanelWrapper>
                        ...
                        <Colorbox className="box" theme="icon" Icon={MegafornIcon} color={color.green3} curve
                            ...
                            <Paragraph bottomPadding={0} bottomMargin={0}>
                                Well, every time a transaction is captured, recorded and completed it forms a new
                                “block.” Each new block is connected to the previous one to create a “chain,” hence
                                “blockchain.”
                            </Paragraph>
                        </Colorbox>
                    </PanelWrapper>
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Paragraph big>
                            ...
                            blockchain has far wider utility and more use cases than virtual money. We recommend staying
                            away from
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Paragraph big>Fortunately, blockchain technology and ledgers have plenty of value outside
                            cryptocurrencies. Using blockchain technology in your business could be right for you
                            if:</Paragraph>
                        ...
                        <Paragraph big>Software applications that you develop and use across the blockchain are known as
                            “Distributed Applications” or DAPPS.</Paragraph>

                        <Heading size={3}>Advantages of Using Blockchain Technology for Your Startup Business</Heading>
                        <Paragraph big>Blockchain technology does provide some advantages to a startup business, which
                        ...
                        <Paragraph big>There’s still plenty of room for innovation in the blockchain space, and your
                            business could take advantage.</Paragraph>

                        <Heading size={3}>Disadvantages of Using Blockchain Technology for Your Startup
                            Business</Heading>
                        <Paragraph big>Though there are many ways blockchain can help your business, it’s important to
                            consider the disadvantages of blockchain technology when deciding if it's right for your
                            company. Here are some examples:</Paragraph>
                        ...
                        <div style={{marginBottom: "10px"}}>
                            <TextBoxed>
                                <Paragraph big bottomMargin={0}>
                                    Everything about your business will need to be engineered to support a blockchain
                                    application, as it’s a different approach to software development and usage
                                </Paragraph>
                            </TextBoxed>
                        </div>
                        ...
                        <Paragraph big>It’s best to choose a blockchain solution for your business startup if there are
                            not already other better options.</Paragraph>
                    </PanelWrapper>
                </TabPanel>
            </ReactTabs>
        </TabsWrapper>
