...
const GymPersonalTraining = () => (
  <Layout>
    ...
    <Top ovalColor="blue" imageName="blockchain-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
      ...
      <p>Blockchain is one of the most popular buzzwords in business right now, but unless you have a good understanding of “immutable, publicly distributed ledgers,” it can be difficult to understand what it could do for you.</p>
      <ButtonsBox>
    ...
    <TabsWrapper>
      ...
      <TabsSection>
        ...
        <CollapseWrapper>
          <PanelWrapper>
            <Paragraph big>We’ll cut through the hype and mystery, explain what blockchain is, and help you understand if your business could benefit from becoming a blockchain startup.</Paragraph>
            <Heading size={3}>Blockchain Business Technology, Briefly Explained</Heading>
            <Paragraph big>
              At its simplest, blockchain technology allows for the sharing of information and transactions between multiple people, businesses, software and others. Blockchain technology is exciting because it’s a digitized, decentralized, verifiable, immutable ledger. Let’s dig into what each of
              those terms means.
            </Paragraph>

            <div style={{ marginBottom: "30px" }}>
              <Adventages headline="Digitized" text="All blockchain frameworks run digitally, typically across the internet and cloud-based services. All the technology involved with a specific blockchain will send, receive, process and verify information digitally." width="100%" />
            </div>
            ...
            <Colorbox className="box" theme="icon" Icon={MegafornIcon} color={color.green3} curve curveColor={color.orange2}>
              <Heading size={4}>Where does the name blockchain come from?</Heading>
          ...
          <PanelWrapper>
            ...
            <Paragraph big>
              It’s likely that you’ve heard blockchain mentioned in the same breath as cryptocurrencies like Bitcoin. While blockchain is the underlying technology that powers cryptocurrencies, blockchain has far wider utility and more use cases than virtual money. We recommend staying away from
              cryptocurrency-related blockchain businesses for several reasons:
            </Paragraph>

            <CircleWithText textInsideCircle="80" textLine="The cryptocurrency market is extremely volatile. Bitcoin alone fell in value by over 80% in a year, and other cryptocurrencies also saw massive devaluation." SvgChart={CircleSvg} withBg={true} symbol="%" />

            <div style={{ marginBottom: "30px", marginTop: "80px" }}>
              <Adventages headline="Many Initial Coin Offerings (ICOs) used to start cryptocurrency and some blockchain businesses were identified as scams or fraudulent, meaning that potential investors have lost trust in ICOs as a way to get funding" width="100%" />
            </div>

            <div style={{ marginBottom: "30px" }}>
              <Adventages headline="The Securities and Exchange Commission (SEC) in the U.S. and other regulatory agencies around the world are putting more controls in place around cryptocurrency assets" width="100%" />
            </div>

            <div style={{ marginBottom: "30px" }}>
              <Adventages headline="Many cryptocurrencies have no “inherent value,” meaning that any changes in price are purely speculative and based on demand, rather than the revenue or profits generated by a well-run, underlying business" width="100%" />
            </div>

            <Paragraph big>
              This combination of a lack of trust and legitimacy, unpredictable valuation and finances, increasing regulatory controls and speculation means the cryptocurrency marketplace isn’t a reliable way to build a blockchain business. Instead, we recommend building and using business
              blockchain applications that have utility and value outside virtual currency.
            </Paragraph>
          </PanelWrapper>
          ...
          <PanelWrapper>
            ...
            <Paragraph big>Fortunately, blockchain technology and ledgers have plenty of value outside cryptocurrencies. Using blockchain technology in your business could be right for you if:</Paragraph>
            ...
            <Paragraph big>Software applications that you develop and use across the blockchain are known as “Distributed Applications” or DAPPS.</Paragraph>

            <Heading size={3}>Advantages of Using Blockchain Technology for Your Startup Business</Heading>
            <Paragraph big>Blockchain technology does provide some advantages to a startup business, which can include:</Paragraph>
            ...
            <Paragraph big>There’s still plenty of room for innovation in the blockchain space, and your business could take advantage.</Paragraph>

            <Heading size={3}>Disadvantages of Using Blockchain Technology for Your Startup Business</Heading>
            <Paragraph big>Though there are many ways blockchain can help your business, it’s important to consider the disadvantages of blockchain technology when deciding if it's right for your company. Here are some examples:</Paragraph>
            ...
            <Paragraph big>It’s best to choose a blockchain solution for your business startup if there are not already other better options.</Paragraph>
          </PanelWrapper>
        </CollapseWrapper>
      </TabsSection>
    </TabsWrapper>
