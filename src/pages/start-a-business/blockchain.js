...
import { tabs } from "../../static/type-of-business/blockchain";
import { TabPanel } from "react-tabs";

const Blockchain = () => (
	<Layout>
		<SEO
			title="How to Start a Blockchain Startup or Cryptocurrency Business"
			description="Interested in the cryptocurrency trend? Learn about blockchain technology and whether making your business a blockchain startup is the right move."
		/>

		<Top
			ovalColor="blue"
			imageName="blockchain-main"
		...
		>
			...
			<p>
				...
				distributed ledgers,” it can be difficult to understand what it could do
				for you.
			</p>
			<ButtonsBox>
				<Button
		...
		<TabsWrapper>
			...
			<ReactTabs content={tabs}>
				<TabPanel>
					<PanelWrapper>
						<Paragraph big>
							We’ll cut through the hype and mystery, explain what blockchain
						...
						<Paragraph big>
							At its simplest, blockchain technology allows for the sharing of
							information and transactions between multiple people, businesses,
							software and others. Blockchain technology is exciting because
							it’s a digitized, decentralized, verifiable, immutable ledger.
							Let’s dig into what each of those terms means.
						</Paragraph>
						...
						>
							...
							<Paragraph bottomPadding={0} bottomMargin={0}>
								Well, every time a transaction is captured, recorded and
								completed it forms a new “block.” Each new block is connected to
								the previous one to create a “chain,” hence “blockchain.”
							</Paragraph>
						</Colorbox>
					</PanelWrapper>
				</TabPanel>
				<TabPanel>
					<PanelWrapper>
						...
						<Paragraph big>
							...
							underlying technology that powers cryptocurrencies, blockchain has
							far wider utility and more use cases than virtual money. We
							recommend staying away from cryptocurrency-related blockchain
						...
						<Paragraph big>
							This combination of a lack of trust and legitimacy, unpredictable
							valuation and finances, increasing regulatory controls and
							speculation means the cryptocurrency marketplace isn’t a reliable
							way to build a blockchain business. Instead, we recommend building
							and using business blockchain applications that have utility and
							value outside virtual currency.
						</Paragraph>
					</PanelWrapper>
				</TabPanel>
				<TabPanel>
					<PanelWrapper>
						...
						<Paragraph big>
							Fortunately, blockchain technology and ledgers have plenty of
							value outside cryptocurrencies. Using blockchain technology in
							your business could be right for you if:
						</Paragraph>

						<div style={{ marginBottom: "10px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									You’re primarily a business that manages or provides access to
						...
						<div style={{ marginBottom: "24px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									Blockchain technology makes a better solution for you than a
									customized database, software as a service or similar
									application
								</Paragraph>
							</TextBoxed>
						</div>
						...
						<Paragraph big>
							Software applications that you develop and use across the
							blockchain are known as “Distributed Applications” or DAPPS.
						</Paragraph>

						<Heading size={3}>
							Advantages of Using Blockchain Technology for Your Startup
							Business
						</Heading>
						<Paragraph big>
							Blockchain technology does provide some advantages to a startup
						...
						<div style={{ marginBottom: "10px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									The ability to freely share data across the blockchain ledger,
									giving authorized users easy, rapid access to the latest
									information
								</Paragraph>
							</TextBoxed>
						</div>
						...
						<div style={{ marginBottom: "10px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									The fact that blockchain applications are secure, transparent
						...
						<div style={{ marginBottom: "10px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									A strong, verifiable audit trail so you can trust the
									information in the blockchain and see a history of how it’s
									been entered, tracked, managed and accessed
								</Paragraph>
							</TextBoxed>
						</div>
						...
						<div style={{ marginBottom: "10px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									The fact that blockchain technology is “hot” right now, which
									might help attract investors, clients or suppliers
								</Paragraph>
							</TextBoxed>
						</div>
						...
						<div style={{ marginBottom: "24px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									An expanding range of blockchain technologies, developers and
									frameworks so you can find the right type of blockchain
						...
						<Paragraph big>
							There’s still plenty of room for innovation in the blockchain
							space, and your business could take advantage.
						</Paragraph>

						<Heading size={3}>
							Disadvantages of Using Blockchain Technology for Your Startup
							Business
						</Heading>
						<Paragraph big>
							Though there are many ways blockchain can help your business, it’s
							important to consider the disadvantages of blockchain technology
							when deciding if it's right for your company. Here are some
							examples:
						</Paragraph>
						...
						<div style={{ marginBottom: "10px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									There may be a better solution for sharing information among
									multiple parties, such as a secure database or a software as a
									service application
								</Paragraph>
							</TextBoxed>
						</div>
						...
						<div style={{ marginBottom: "10px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									Everything about your business will need to be engineered to
									support a blockchain application, as it’s a different approach
						...
						<div style={{ marginBottom: "10px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									Distributed applications on the blockchain are still in an
									early, nascent stage, so it may be hard to get buy-in from all
									parties to use these applications
								</Paragraph>
							</TextBoxed>
						</div>
						...
						<div style={{ marginBottom: "10px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									Due to the fact that every computer on a blockchain has to
									verify every transaction, blockchain applications can be
						...
						<div style={{ marginBottom: "24px" }}>
							<TextBoxed>
								<Paragraph big bottomMargin={0}>
									Developing a blockchain application can be costly, as there
									are not a huge number of skilled blockchain developers at
									present
								</Paragraph>
							</TextBoxed>
						</div>
						...
						<Paragraph big>
							It’s best to choose a blockchain solution for your business
							startup if there are not already other better options.
						</Paragraph>
					</PanelWrapper>
				</TabPanel>
			</ReactTabs>
