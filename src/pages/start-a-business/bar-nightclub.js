...
const BarNightclub = () => (
  <Layout>
      ...
      <TabsSection>
        ...
        <CollapseWrapper>
          <PanelWrapper>
            <Colorbox color={color.blue3} theme="icon" curve curveColor={color.blue1} Icon={StarIcon}>
              <Paragraph big style={{ fontWeight: "bold" }}>
                If you’re interested in starting a bar, club or other business that serves alcohol, there’s plenty to do.
              </Paragraph>
            ...
            <ListWrapper style={{ marginTop: "48px" }}>
              <ListBox>
                <CkeckText>
                  <Paragraph big>Understanding the world of the bar or club</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Finding information on taxes and finances for your bar or club business</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Deciding if you’re ready to start a bar business</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Following the various rules and regulations your business requires</Paragraph>
                </CkeckText>
              </ListBox>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>Managing marketing and administration processes</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Locating resources for your bar or club business</Paragraph>
                </CkeckText>
              </ListBox>
          ...
          <PanelWrapper>
            ...
            <BlueBoxWithAbsoluteText absoluteText="$25B" text="Revenue of bar and nightclub industry in the U.S. every year" />

            <BlueBoxWithAbsoluteText absoluteText="1.1 - 1.4" text="Percent of sales increase each year" />

            <BlueBoxWithAbsoluteText absoluteText="400K" text="People employed in the industry" />

            <BlueBoxWithAbsoluteText absoluteText="200M" text="Barrels of beer are sold every year" />
            ...
            <div style={{ marginBottom: "30px", marginTop: "48px" }}>
              <Adventages headline="There are over 65,000 bars and clubs throughout the U.S." width="100%" />
            </div>

            <div style={{ marginBottom: "30px" }}>
              <Adventages headline="Each establishment employs an average of six to seven people." width="100%" />
            </div>
            ...
            <div style={{ marginBottom: "30px" }}>
              <Adventages headline="Nearly 80 percent of establishments are small businesses employing fewer than 10 people." width="100%" />
            </div>

            <Paragraph big>
              This all points to the bar or club industry being ripe with new opportunities for focused entrepreneurs, so now might be the perfect time to dive into starting your bar or club business. Incfile is here to help you form your business and understand the ins and outs of owning an
            ...
            <Paragraph big>
              The bar and club market is very much driven by your customers’ personal incomes and entertainment needs. It’s vital to look at the competition in your local area and find a niche you can fill. It’s easy for an area to become saturated with bars or clubs, so choosing the right location
            ...
            <Paragraph big>When you’re looking to start a bar or club, you have plenty of options to help you stand out. It’s important to cater to your customers’ needs. There are many different types of bars or clubs you could run; here are some suggestions:</Paragraph>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <div>
                <Paragraph style={{ fontWeight: "bold", marginBottom: 0 }}>Brewhouse and pub</Paragraph>
                <Paragraph style={{ marginBottom: 0 }}>where you make and serve your own beer</Paragraph>
              </div>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <div>
                <Paragraph style={{ fontWeight: "bold", marginBottom: 0 }}>Cocktail bar</Paragraph>
                <Paragraph style={{ marginBottom: 0 }}>mainly serving spirits and mixers</Paragraph>
              </div>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <div>
                <Paragraph style={{ fontWeight: "bold", marginBottom: 0 }}>Nightclub or dance club</Paragraph>
                <Paragraph style={{ marginBottom: 0 }}>where customers can move to the music</Paragraph>
              </div>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <div>
                <Paragraph style={{ fontWeight: "bold", marginBottom: 0 }}>Themed bar</Paragraph>
                <Paragraph style={{ marginBottom: 0 }}>like an Irish, Mexican or British pub</Paragraph>
              </div>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <div>
                <Paragraph style={{ fontWeight: "bold", marginBottom: 0 }}>Wine bar</Paragraph>
                <Paragraph style={{ marginBottom: 0 }}>with plenty of choices for medium- and high-end wine</Paragraph>
              </div>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <div>
                <Paragraph style={{ fontWeight: "bold", marginBottom: 0 }}>Sports bar</Paragraph>
                <Paragraph style={{ marginBottom: 0 }}>where people can enjoy the big game</Paragraph>
              </div>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <div>
                <Paragraph style={{ fontWeight: "bold", marginBottom: 0 }}>Bar</Paragraph>
                <Paragraph style={{ marginBottom: 0 }}>specializing in live music or comedy</Paragraph>
              </div>
            </TextBoxed>
          ...
          <PanelWrapper>
            ...
            <Paragraph big>
              The popularity and profitability of your bar or club will depend on balancing several different areas. You’ll need to have loyal, repeat customers, be good at marketing and provide a unique experience for your patrons. Fortunately, there are no large companies that dominate in the bar
              and nightclub industry — the combined revenue of the 50 largest bar and nightclub companies only accounts for 5 percent of all sales.
            </Paragraph>
            <Paragraph big>
              You’ll also have to work long hours and need to get involved in every aspect of the business, from accepting deliveries to training staff, resolving problems and serving beer. You can compete most effectively by understanding your local customers, providing the right atmosphere and
              experience and focusing on great customer service.
            </Paragraph>
            <Paragraph big>There are low barriers to entry, meaning new bars and clubs open fairly frequently, so there will always be competition. Margins are slim though, so unless a bar or club is well-managed, that competition may not last for long.</Paragraph>
            ...
            <Colorbox color={color.blue3} theme="icon" curve curveColor={color.blue1}>
              ...
              <Paragraph bottomMargin={0}>One of the main issues new bar owners will face is getting the right licenses to serve alcohol and food. The type, cost and availability of alcohol licenses vary widely; you may also need a specialized entertainment license.</Paragraph>
            </Colorbox>
            ...
            <Paragraph big>If you want to run a bar or club, you’re going to need multiple skills:</Paragraph>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <div>
                <Paragraph style={{ fontWeight: "bold", marginBottom: 0 }}>Market research</Paragraph>
                <Paragraph style={{ marginBottom: 0 }}>So you know what your customers want and need</Paragraph>
              </div>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <div>
                <Paragraph style={{ fontWeight: "bold", marginBottom: 0 }}>Employee management</Paragraph>
                <Paragraph style={{ marginBottom: 0 }}>So you can choose, hire and work with the best people</Paragraph>
              </div>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <div>
                <Paragraph style={{ fontWeight: "bold", marginBottom: 0 }}>Marketing</Paragraph>
                <Paragraph style={{ marginBottom: 0 }}>So you can get your name out there and attract customers</Paragraph>
              </div>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <div>
                <Paragraph style={{ fontWeight: "bold", marginBottom: 0 }}>Financial management</Paragraph>
                <Paragraph style={{ marginBottom: 0 }}>So you can get the most out of the thin margins</Paragraph>
              </div>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <div>
                <Paragraph style={{ fontWeight: "bold", marginBottom: 0 }}>Negotiation</Paragraph>
                <Paragraph style={{ marginBottom: 0 }}>To get the best deals from suppliers and distributors</Paragraph>
              </div>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <div>
                <Paragraph style={{ fontWeight: "bold", marginBottom: 0 }}>Customer service</Paragraph>
                <Paragraph style={{ marginBottom: 0 }}>To keep all your patrons happy</Paragraph>
              </div>
            </TextBoxed>

            <TextBoxed style={{ marginBottom: "8px" }}>
              <div>
                <Paragraph style={{ fontWeight: "bold", marginBottom: 0 }}>Time management</Paragraph>
                <Paragraph style={{ marginBottom: 0 }}>So you have enough hours to do everything</Paragraph>
              </div>
            </TextBoxed>
            ...
            <Paragraph big>
              You will be working long hours, often up early in the morning and staying past closing time. No two days will be quite the same, although many of those days are likely to be tiring! You will need to deal with a high staff turnover and be able to spot good servers and bartenders who
              will work well with your patrons.
            </Paragraph>
          </PanelWrapper>
        </CollapseWrapper>
      </TabsSection>
    ...
    <SimpleSection>
      ...
      <Container>
        <CenterBox>
          ...
          <Paragraph big>
            You will also need to look at financial projections for your bar or club business. What are your expected sales and revenues? What is your profitability? How much money will you keep in the business to grow it? How much will you pay yourself and others? If you can, try to plan your
    ...
    <WhiteContainer>
      ...
      <BusinessOwnerResponsibilities>
        <ImageContent image="unique-business-2" paddingTop="60">
          ...
          <Paragraph big>Now that you have all the background information for your bar or club business, it’s time to make it into a reality. That starts by choosing the right structure or “legal entity” for your business. In the US, there are four main business structures. They are:</Paragraph>
          ...
          <Paragraph big style={{ paddingTop: "48px", paddingBottom: 0 }} mixed={true}>
            In most cases our recommendation would be to create an LLC. We’ve got a <Link to="/">complete guide to everything you need to do</Link> and we can set one up for your bar or club business. <Link to="/">LLC formation does vary from state to state</Link>, but we’ve got you covered,
            wherever you are.
          </Paragraph>
    ...
    <Conclusion to="/" buttonTitle="Start your bar business with us, today">
      ...
      <Paragraph big>
        Although there are many challenges in running a bar or club business, they can still be an excellent way to generate revenue and create a great place for your patrons and employees. Find the perfect location, create the right type of bar, hire excellent people and share your establishment's
