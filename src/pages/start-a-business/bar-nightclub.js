...
const BarNightclub = () => (
    <Layout>
        ...
        <Top ovalColor="love" imageName="bar-nightclub-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
            ...
            <p>Opening a bar, nightclub or pub business is a great way to give your customers the perfect place to meet,
                drink and socialize. The combination of a good location, friendly staff, great selection and the right
                ambiance can really help set you apart and make your bar successful.</p>
            <ButtonsBox>
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <ListWrapper style={{marginTop: "48px"}}>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Finding information on taxes and finances for your bar or club
                                        business</Paragraph>
                                </CkeckText>
                            </ListBox>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Following the various rules and regulations your business
                                        requires</Paragraph>
                                </CkeckText>
                            </ListBox>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Determining the best legal structure for your new
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <div style={{marginBottom: "30px", marginTop: "48px"}}>
                            <Adventages headline="There are over 65,000 bars and clubs throughout the U.S."
                                        width="100%"/>
                        </div>

                        <div style={{marginBottom: "30px"}}>
                            <Adventages headline="Each establishment employs an average of six to seven people."
                                        width="100%"/>
                        </div>
                        ...
                        <Paragraph big>
                            ...
                            entertainment needs. It’s vital to look at the competition in your local area and find a
                            niche you can fill. It’s easy for an area to become saturated with bars or clubs, so
                        ...
                        <Paragraph big>When you’re looking to start a bar or club, you have plenty of options to help
                            you stand out. It’s important to cater to your customers’ needs. There are many different
                            types of bars or clubs you could run; here are some suggestions:</Paragraph>
                        ...
                        <TextBoxed style={{marginBottom: "8px"}}>
                            <div>
                                <Paragraph style={{fontWeight: "bold", marginBottom: 0}}>Nightclub or dance
                                    club</Paragraph>
                        ...
                        <TextBoxed style={{marginBottom: "8px"}}>
                            <div>
                                ...
                                <Paragraph style={{marginBottom: 0}}>with plenty of choices for medium- and high-end
                                    wine</Paragraph>
                            </div>
                        </TextBoxed>
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Paragraph big>
                            ...
                            dominate in the bar
                            and nightclub industry — the combined revenue of the 50 largest bar and nightclub companies
                        ...
                        <Paragraph big>There are low barriers to entry, meaning new bars and clubs open fairly
                            frequently, so there will always be competition. Margins are slim though, so unless a bar or
                            club is well-managed, that competition may not last for long.</Paragraph>
                        ...
                        <Colorbox color={color.blue3} theme="icon" curve curveColor={color.blue1}>
                            ...
                            <Paragraph bottomMargin={0}>One of the main issues new bar owners will face is getting the
                                right licenses to serve alcohol and food. The type, cost and availability of alcohol
                                licenses vary widely; you may also need a specialized entertainment license.</Paragraph>
                        </Colorbox>

                        <Paragraph big style={{marginTop: "48px"}}>
                            Bar and club locations must have proper zoning from local government, and you may face
                            issues with community resistance due to patrons and noise. Additionally, local laws will
                            dictate when you are and are not allowed to be open.
                        </Paragraph>
                        ...
                        <Paragraph big>If you want to run a bar or club, you’re going to need multiple
                            skills:</Paragraph>

                        <TextBoxed style={{marginBottom: "8px"}}>
                            <div>
                                <Paragraph style={{fontWeight: "bold", marginBottom: 0}}>Market research</Paragraph>
                                <Paragraph style={{marginBottom: 0}}>So you know what your customers want and
                                    need</Paragraph>
                            </div>
                        </TextBoxed>
                        ...
                        <TextBoxed style={{marginBottom: "8px"}}>
                            <div>
                                ...
                                <Paragraph style={{marginBottom: 0}}>So you can choose, hire and work with the best
                                    people</Paragraph>
                            </div>
                        </TextBoxed>
                        ...
                        <TextBoxed style={{marginBottom: "8px"}}>
                            <div>
                                ...
                                <Paragraph style={{marginBottom: 0}}>So you can get your name out there and attract
                                    customers</Paragraph>
                            </div>
                        </TextBoxed>
                        ...
                        <TextBoxed style={{marginBottom: "8px"}}>
                            <div>
                                <Paragraph style={{fontWeight: "bold", marginBottom: 0}}>Financial
                                    management</Paragraph>
                                <Paragraph style={{marginBottom: 0}}>So you can get the most out of the thin
                                    margins</Paragraph>
                            </div>
                        </TextBoxed>
                        ...
                        <TextBoxed style={{marginBottom: "8px"}}>
                            <div>
                                ...
                                <Paragraph style={{marginBottom: 0}}>To get the best deals from suppliers and
                        ...
                        <TextBoxed style={{marginBottom: "8px"}}>
                            <div>
                                ...
                                <Paragraph style={{marginBottom: 0}}>So you have enough hours to do
                        ...
                        <Paragraph big>
                            ...
                            No two days will be quite the same, although many of those days are likely to be tiring! You
                            will need to deal with a high staff turnover and be able to spot good servers and bartenders
                            who
            ...
            <Container>
                ...
                <CenterBox>
                    ...
                    <Paragraph big mixed={true} style={{marginTop: "50px"}}>
                        We’ve got the perfect <Link to="/blog/post/keys-successful-business-plan/">guide to writing your
                        business plan.</Link>
                    </Paragraph>
                </CenterBox>
            </Container>
            ...
            <BusinessOwnerResponsibilities>
                <ImageContent image="unique-business-2" paddingTop="60">
                    ...
                    <Paragraph big>Now that you have all the background information for your bar or club business, it’s
                        ...
                        for your business. In the US, there are four main business structures. They are:</Paragraph>
                    ...
                    >
                        ...
                        <Paragraph big>This is the "default" business structure and is what your business will be if you
                            decide not to create a more formal structure. We don't recommend this type of business as it
                            doesn't give you the legal protections you need.</Paragraph>
                    </TextBlockWithImage>
                    ...
                    >
                        <Paragraph big style={{color: color.blue1, fontWeight: "bold"}} mixed={true}>
                            <Link to={process.env.ORDER_URL + "/form-order-now.php?entityType=LLC"}>Limited Liability
                                Company or LLC</Link>
                        </Paragraph>

                        <Paragraph big>The Limited Liability Company (LLC) is ideal for most handyman businesses. An LLC
                            is easy and inexpensive to set up, and it has the least administrative requirements of any
                            formal business entity.</Paragraph>
                    </TextBlockWithImage>
                    ...
                    >
                        ...
                        <Paragraph big>This is a special type of LLC entity that's only available in certain states. It
                            allows you to create "mini" LLCs, each with their own limited liability and separate assets,
                            under the umbrella of a master LLC.</Paragraph>
                    </TextBlockWithImage>
                    ...
                    >
                        <Paragraph big style={{color: color.blue1, fontWeight: "bold"}} mixed={true}>
                            <Link to={process.env.ORDER_URL + "/form-order-now.php?entityType=S-Corporation"}>S
                                Corporation</Link>
                        </Paragraph>

                        <Paragraph big>This is a more complex type of business and isn't generally recommended for
                            smaller organization.</Paragraph>
                    </TextBlockWithImage>
                    ...
                    >
                        <Paragraph big style={{color: color.blue1, fontWeight: "bold"}} mixed={true}>
                            <Link to={process.env.ORDER_URL + "/form-order-now.php?entityType=C-Corporation"}>C
                                Corporation</Link>
                        </Paragraph>


                        <Paragraph big>These are the largest and most complex types of businesses and are far more than
                            the average entrepreneur or business owner will need.</Paragraph>
                    </TextBlockWithImage>

                    <Paragraph big style={{paddingTop: "48px", paddingBottom: 0}} mixed={true}>
                        For more information on the advantages and disadvantages of different types of businesses, <Link
                        to="/business-entity-comparison/">please see our in-depth guide</Link>. If you’ve still got
                        questions,{" "}
                        <a href="https://grasshopper.com/blog/llc-vs-corporation-8-entrepreneur-questions-answered/"
                    ...
                    <Paragraph big style={{paddingTop: "48px", paddingBottom: 0}} mixed={true}>
                        In most cases our recommendation would be to create an LLC. We’ve got a <Link
                        to="/form-an-llc/">complete guide to everything you need to do</Link> and we can set one up for
                        your bar or club business. <Link to="/llc-state-information/">LLC formation does vary from state
                        to state</Link>,
                        but we’ve got you covered, wherever you are.
                    </Paragraph>

                    <Button theme="primary48" width="365px" arrow content={{
        ...
        <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"}
            ...
            <Paragraph big>
                ...
                create the right type of bar, hire excellent people and share your establishment's
                uniqueness to really stand out.
            </Paragraph>
            <Paragraph big>
                When you’re ready to start your bar or club business, <Link
                to={`${process.env.ORDER_URL}/form-order-now.php`}>we’re here to help</Link>.
            </Paragraph>
        </Conclusion>
    </Layout>
);
