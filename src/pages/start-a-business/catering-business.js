...
import {RingText, tabs, toolsList} from "../../static/type-of-business/catering-business";
...
const CateringBusiness = () => (
    <Layout>
            ...
            <ReactTabs content={tabs}>
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Paragraph big>A catering business can be a great choice if you don’t want the expense of
                            running a restaurant. You can still earn good margins on the meals you produce without
                            having the overhead of running a restaurant.</Paragraph>
                        ...
                        <Paragraph big>
                            ...
                            delights your customers is doable, so long as you take the right approach. In this guide
                            we’ll cover:
                        </Paragraph>
                        ...
                        <ListWrapper>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Hiring employees, managing finances and administering your catering
                                        business</Paragraph>
                                </CkeckText>
                            </ListBox>
                        ...
                        <Paragraph big>By the time you've read through our complete digital nomad business guide, you
                            will have all the information you need to set up and manage a thriving venture. Let's get
                            into it.</Paragraph>
                    </PanelWrapper>
                </TabPanel>
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Paragraph big>
                            ...
                            the stress out of preparing, cooking and serving food. Good catering businesses can expect
                            repeat bookings, and lucky business owners will get long-term agreements to provide food on
                            a regular
                            basis.
                        </Paragraph>
                        <Paragraph big>Caterers and other food establishments are big business in the U.S. Here are some
                            surprising statistics about their popularity.</Paragraph>
                        ...
                        <ColorFulCircleWithTextAndList style={{marginBottom: "48px"}} list={RingText.list}
                                                       title={RingText.title} CircleSVG={RingSvg} withBg={true}/>
                        ...
                        <Adventages headline="Buffet-style catering is most popular, followed by plated meals"
                                    width="100%"/>

                        <Paragraph big>
                            This makes the catering industry very attractive to aspiring entrepreneurs, but there are
                            big challenges in opening, running and growing a successful catering business. They demand a
                            great deal of work, so expect long hours. Add to that the need for a constantly full
                            pipeline,
                            challenging profit margins and seasonal variation; you will need to work hard to ensure your
                            business is successful.
                        </Paragraph>
                        <Paragraph big>But for those with the discipline, focus and commitment, running a catering
                            business can be a hugely satisfying experience for you, your staff and your
                            patrons.</Paragraph>
                    </PanelWrapper>
                </TabPanel>
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Adventages headline="Friendliness"
                        ...
                        <Adventages headline="Value for money"
                        ...
                        <Paragraph big>
                            ...
                            great marketing with an interesting and accessible menu and competitive pricing. You will
                            need to attract clients in a competitive local marketplace. Then, you must create amazing
                            dishes, hire
                            staff, get chefs and ensure you always have work coming in.
                        </Paragraph>
                        <Paragraph big>
                            You can’t forget about the administrative side of this business either. Sourcing
                            ingredients, sorting out disputes, working out profits and more are all required. In fact,
                            being a cater requires one of the most well-rounded skillsets of any business you might
                            choose to go into. Along
                            the way, you’ll learn amazing skills, develop great people management techniques and build
                        ...
                        <Paragraph big>As we mentioned above, running a catering business requires a huge and diverse
                            range of skills. Among other areas, these skills include:</Paragraph>
                        ...
                        <Paragraph big>
                            There are several major challenges for any catering business owner. These start with
                            competition — your local area only has a certain number of clients, and you’re likely
                            competing with a few other local businesses. Although you will build up a good reputation
                            over time, strong
                            marketing is essential in attracting clients to your business.
                        </Paragraph>
                        <Paragraph big>
                            Another major issue for catering owners is financial management and making a profit. The
                            vast majority of revenues you receive from patrons will go toward food ingredient costs
                            (27-30 percent), staff salaries and wages (20-25 percent), occupancy costs (5-10 percent for
                            utilities, rent,
                            etc.) and other costs. After all expenses are taken into account, overall profit margins
                            typically clock in at around 10 percent, compared to the average restaurant profit margin
                            that runs between 2 and 6 percent.
                        </Paragraph>

                        <Paragraph big>Staff management also comes with is own list of challenges. From unexpected
                            absenteeism to interpersonal conflicts, juggling staffing priorities will take up a lot of
                            your time!</Paragraph>

                        <Paragraph big>
                            No two days are the same for a catering business owner, but all those days will be long.
                            From working out menus, training staff, marketing and administration in the mornings through
                            delivering food and providing services, you can expect to start work before 8 a.m. and not
                            finish until
                            late. If you open a catering business, you need understanding family and friends because
                            they will not be seeing much of you.
                        </Paragraph>
                    </PanelWrapper>
                </TabPanel>
            </ReactTabs>
            ...
            <BusinessOwnerResponsibilities>
                <ImageContent image="unique-business-2" paddingTop="60">
                    ...
                    <Paragraph big>Now that you have all the background information for your catering business, it’s
                        ...
                        for your business. In the U.S., there are four main business structures. They are:</Paragraph>
            ...
            <ContentCenter contentWidth={770}>
                <div>
                    ...
                    <Paragraph big style={{paddingTop: "48px", paddingBottom: 0}} mixed={true}>
                        ...
                        guide to everything you need to do</Link>, and we can set one up for your catering
        ...
        <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"}
                    buttonTitle="Start your Catering Business with us, today">
            ...
            <Paragraph big>
                ...
                and reward, then running a catering company could be right for you. The food you create and the trust
                you build will help set you apart in the minds of your clients and bring joy into
                people’s lives.
            </Paragraph>
        </Conclusion>
    </Layout>
