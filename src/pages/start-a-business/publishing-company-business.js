...
import {
  RingText,
  tabs,
} from "../../static/type-of-business/publishing-company-business";
...
const ConstructionCompany = () => (
    <Layout>
        <SEO
            title="How to Start a Publishing Company | Trends, Tips & Advice"
        ...
        >
            ...
            <p>
                The world of publishing is changing fast, and if you have an interesting
            ...
            <ReactTabs content={tabs}>
                <TabPanel>
                    <PanelWrapper>
                        <Paragraph big style={{ marginBottom: "40px" }}>
                            Consumers are increasingly moving away from traditional publishing
                            formats like paper books and newspapers and consuming more of
                            their content digitally. It’s not just the written word either —
                            videos, radio shows, podcasts and other digital media are becoming
                            increasingly popular.
            </Paragraph>

                        <Heading size={2} template={3} left>
                            For an entrepreneur with the right idea, publishing can be a great
                            industry to get into.
            </Heading>

                        <Paragraph big style={{ marginBottom: "40px" }}>
                            From the solo blog writer to the head of a content publishing
                            agency, there are opportunities for publishers of all types. While
                            it’s true that the internet has lowered barriers to entry, if you
                            can find a good publishing niche, you can build a reputation as a
                            place for entertaining, insightful and trustworthy content.
            </Paragraph>
                        ...
                        >
                            <Heading size={3} template={4}>
                                We know it can be daunting to start a publishing business, and
                                we’re here to help.
              </Heading>
                        ...
                        <Paragraph big style={{ marginBottom: "40px", marginTop: "48px" }}>
                            ...
                            starting a successful publishing business. From highlighting
                            important facts to validating your ideas, and from choosing the
                            right structure to your learning about your options for managing
                            and running your business, you’ll find the answers you need here.
            </Paragraph>

                        <Heading size={3} style={{ fontSize: "20px" }}>
                            Read on for some insight into creating your own publishing
                        ...
                        <ListWrapper>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>
                                        Setting up your publishing business, including location,
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>
                                        How to choose whether your publishing company should be an
                                        LLC or corporation
                  </Paragraph>
                                </CkeckText>
                            </ListBox>
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Paragraph big bottomMargin={52}>
                            Although it can be exciting to form a publishing business, there
                        ...
                        <Paragraph big bottomMargin={52}>
                            ...
                            publishing business on a daily basis:
            </Paragraph>
                        ...
                        <TextBoxed style={{ marginBottom: "8px" }}>
                            <Paragraph bottomMargin={0}>
                                Sharing the latest articles and publications on social media and
                                other forums
              </Paragraph>
                        </TextBoxed>
                        ...
                        <TextBoxed style={{ marginBottom: "8px" }}>
                            <Paragraph bottomMargin={0}>
                                Working with artists, developers and others to add images,
                                context and other interactive content
              </Paragraph>
                        </TextBoxed>
                        ...
                        <Paragraph big bottomMargin={52}>
                            ...
                            publishing small business owner:
            </Paragraph>
                        ...
                        <TextBoxed style={{ marginBottom: "8px" }}>
                            <Paragraph bottomMargin={0}>
                                Developing a strong brand, approach and tone of voice so you
                        ...
                        <TextBoxed style={{ marginBottom: "8px" }}>
                            <Paragraph bottomMargin={0}>
                                Skimming through multiple pitches and ideas to identify those
                                that have commercial appeal and value to consumers
              </Paragraph>
                        </TextBoxed>

                        <TextBoxed style={{ marginBottom: "8px" }}>
                            <Paragraph bottomMargin={0}>
                                Juggling multiple freelancers or employees to present content in
                        ...
                        <TextBoxed style={{ marginBottom: "8px" }}>
                            <Paragraph bottomMargin={0}>
                                Collaborating with media outlets and posting on social media to
                        ...
                        <TextBoxed style={{ marginBottom: "48px" }}>
                            <Paragraph bottomMargin={0}>
                                Deciding on future publishing schedules and content strategies
                                and commissioning relevant work
              </Paragraph>
                        </TextBoxed>
                        ...
                        <Paragraph big bottomMargin={52}>
                            There’s a market for almost all types of publishing, so
                            well-researched, interesting work will likely find an audience.
                            Your content should inform, educate, entertain, or inspire the
                            consumer.
            </Paragraph>
        ...
        <Conclusion
            ...
            <Paragraph big>
                The internet has made publishing entrepreneurship available to everyone.
                If you can find a great niche, understand your audience and put together
                a solid publishing business plan, you will have every chance for
                success.
            </Paragraph>
        </Conclusion>
    </Layout>
