...
import {RingText, RingText2, tabs, toolsList} from "../../static/type-of-business/laundromat";
...
const LandscapingBusiness = () => (
    <Layout>
        ...
        <Top ovalColor="sun" imageName="laundromat-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
            ...
            <p>The most successful businesses in the world are those that meet a genuine personal need. The laundromat
                is a great example of this type of business</p>
            <ButtonsBox>
            ...
            <ReactTabs content={tabs}>
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Paragraph big mixed>
                            ...
                            after. The laundromat is a great example of this type of business, providing a basic but
                            essential service.
                            If <Link to="/start-a-business/amazon-business/">online selling</Link> or being a <Link
                            to="/start-a-business/digital-nomad-business/">digital nomad</Link> isn’t for you, a
                            laundromat is a reliable, sustainable alternative.
                        </Paragraph>
                        <Paragraph big>
                            Like cleaning businesses, laundromats help your customers meet their most basic needs —
                            cleanliness and comfort. It might not have the kudos of consultancy or the flashy screens of
                            the latest consumer device, but people will always need clean clothes. Coin-operated
                            laundromat
                            businesses don’t need a huge amount of administrative overhead either, so they can be a good
                            way to break into the entrepreneurship space.
                        </Paragraph>
                        <Paragraph big>Laundromats are also referred to as coin-op laundries, coin laundries,
                            coin-operated laundries or self-service laundries.</Paragraph>

                        <Heading size={3} style={{marginTop: "48px", fontSize: "20px"}}>
                            Laundromat business formation guide
                        </Heading>
                        <Paragraph big>In this guide we’ll explore everything you need to do to set up your laundromat
                            business and maximize your chances for success. We’ll cover:</Paragraph>
                        ...
                        <ListWrapper>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Hiring employees, managing finances and administering your laundromat
                                        business</Paragraph>
                                </CkeckText>
                            </ListBox>
                        ...
                        <Paragraph big>By the time you’ve read through our complete laundromat business guide, you will
                            have all the information you need to set up and manage a thriving laundromat business. Let’s
                            get into it.</Paragraph>
                    </PanelWrapper>
                </TabPanel>
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <ColorFulCircleWithTextAndList CircleSVG={ColorfulRing2} title={RingText2.title}
                                                       list={RingText2.list} withBg={true} style={{marginTop: "48px"}}/>
                        ...
                        <Paragraph big>
                            ...
                            business. Incfile is here to help you form your laundromat business and understand the ins
                            and outs of owning a
                            laundromat company.
                        </Paragraph>
                        ...
                        <Paragraph big>
                            ...
                            dryers in a retail space and request payment for the usage of the machines. Most laundromats
                            are self-service, simply requiring that the customer purchase a certain amount of time using
                            a washer
                            or dryer.
                        </Paragraph>
                        <Paragraph big>
                            Your customers want simple, easy-to-use machines that provide fast, effective washing and
                            drying of clothes at a reasonable price. Ideally, you will want your laundromat business to
                            be well-located, so placing your business in densely-populated, renter-occupied areas is a
                            very good
                            idea.
                        </Paragraph>
                        <Paragraph big>
                            Access to and from your site needs to be straightforward, and you should have adequate
                            parking for all your customers. Coin-operated machines are the standard in the industry, but
                            card operated machines are also available — you can even combine these with membership
                            schemes and
                            incentives to keep customers loyal.
                        </Paragraph>
                        <Paragraph big>There are two main types of laundromat businesses: standard independent retail
                            laundromats, and laundromats that are located inside apartment buildings to serve the
                            residents. This second type of laundry business is known as the multi-housing laundry
                            business.</Paragraph>
                    </PanelWrapper>
                </TabPanel>
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <div style={{marginBottom: "30px"}}>
                            <Adventages headline="Long hours"
                                        text="Laundromats typically open between 6 a.m. and 10 p.m." width="100%"/>
                        </div>

                        <div style={{marginBottom: "30px"}}>
                            <Adventages headline="People management"
                                        text="Dealing with staff, coverage issues and other people management areas"
                                        width="100%"/>
                        </div>

                        <div style={{marginBottom: "30px"}}>
                            <Adventages headline="Costs"
                                        text="The main operational costs of a laundromat are staff wages and capital expenses"
                                        width="100%"/>
                        </div>

                        <div style={{marginBottom: "30px"}}>
                            <Adventages headline="Capital expenses"
        ...
        <BlueContainer>
            ...
            <CenterBox>
                ...
                <Paragraph big>
                    ...
                    establish whether there’s a demand for your laundromat in your area, look at potential benefits and
            ...
            <CenterBox>
                ...
                <Paragraph big>Before you launch your laundromat business, you need to understand if there’s a demand.
                    That means carrying out market research and “validating” your services. Here’s how to go about
                    it:</Paragraph>
            </CenterBox>
            ...
            <Container>
                <GridSectionList>
                    ...
                    <TextBlockWithImage width={100} widthUnit="%" SvgImage={MarketIcon}
                        ...
                        <Paragraph bottomPadding={0} bottomMargin={0}>
                            ...
                            reports available for the laundromat business in the U.S. You will also want to research
                            demographics in your proposed area — you’re looking for densely-populated areas with lots of
                            renters or students.
                        </Paragraph>
                    </TextBlockWithImage>
                ...
                <CenterBox>
                    ...
                    <Paragraph big>All businesses need a business model, which is how you will generate sales, provide
                        ...
                        in place so you can start acquiring customers and generating revenue from day one.</Paragraph>
                    <Paragraph big>You will also need to look at financial projections for your laundromat business.
                        What are your expected sales and revenues? What is your profitability? How much money will you
                        keep in the business to grow it? How much will you pay yourself and others?</Paragraph>
                    <Paragraph big>If you can, try to plan your revenue for the next month, three months, year and two
                        years. It’s vital to take into account the high capital cost of setting up a laundromat in the
                        first place, also factoring in utility, staff and other costs.</Paragraph>
                </CenterBox>
            </Container>
        </BlueContainer>
            ...
            <BusinessOwnerResponsibilities>
                <ImageContent image="unique-business-2" paddingTop="60">
                    ...
                    <Paragraph big>Now that you have all the background information for your laundromat business, it’s
                        time to make it into a reality. Starts by choosing the right structure or “legal entity” for
                        your business. In the U.S., there are four main business structures. They are:</Paragraph>
                    ...
                    >
                        ...
                        <Paragraph big>The most common type of business entity. An LLC is fast, simple and inexpensive
                            to setup and maintain. It protects your personal finances and assets and is a great way to
                            start your real estate</Paragraph>
                    </TextBlockWithImage>
                    ...
                    <Paragraph big style={{paddingTop: "48px", paddingBottom: 0}} mixed={true}>
                        In most cases our recommendation would be to create an LLC. We have a <Link to="/form-an-llc/">complete
                        guide to everything you need to do</Link>, and we can set one up for your laundromat
                        business. <Link to="/llc-state-information/">LLC formation does vary from state to state</Link>,
                        but
        ...
        <ToolsWrapper>
            ...
            <UsefulTools style={{paddingBottom: "200px"}} toolsList={toolsList.tools}
                         headlineText={toolsList.headlineText} description={toolsList.description}/>
        </ToolsWrapper>
        ...
        <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"}
            ...
            <Paragraph big>
                ...
                in machinery, owning a laundromat could be a great opportunity. There’s not a lot of administrative
                overhead, and with the right location you will have a resilient income stream for years
                to come. Do your research and find the right space; you can develop a thriving laundromat business to
                serve the needs of your local community and provide you with a good living.
            </Paragraph>
        </Conclusion>
    </Layout>
);
