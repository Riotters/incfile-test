...
const OnlineBusiness = () => (
  <Layout>
    ...
    <Top ovalColor="yellow" imageName="online-business-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
      ...
      <p>The internet has revolutionized business — it has broadened marketplaces, made products and services available to every one and lowered the barriers to starting a successful company. With the right approach and understanding, anyone can become a successful online entrepreneur.</p>
      <ButtonsBox>
    ...
    <TabsWrapper>
      ...
      <TabsSection>
        ...
        <CollapseWrapper>
          <PanelWrapper>
            <Paragraph big>
              But turning your idea into a successful business is about much more than launching a website, writing a couple of blog posts and using social media. Just like traditional businesses, business success online requires hard work and dealing with rapidly changing tools and processes. The
              low barrier to entry in owning an online business means that competition is intense; if you want to be a success, you need to plan carefully and execute well.
            </Paragraph>

            <Colorbox className="box" theme="icon" Icon={MegafornIcon} color={color.purple3} curve curveColor={color.purple1}>
              <Heading size={4}>The question is, just where do you start?</Heading>
              <Paragraph bottomPadding={0} bottomMargin={0}>
                Here at Incfile, we know the answer, and we’ve shared it with more 100,000 people who we've helped in forming their business. Since 2004, we’ve supported online entrepreneurs just like you to get into business online, and we’re proud to have been a part of the internet business
                revolution.
              </Paragraph>
            </Colorbox>
          ...
          <PanelWrapper>
            ...
            <Paragraph big style={{ marginBottom: "52px" }}>
              The internet has opened up new frontiers, created amazing technologies and helped us connect with others around the globe. It’s made everything more accessible, allowing us to easily research and compare ideas, products, services and more. Entrepreneurs who can take advantage of these
              trends can do extremely well — here are some statistics on the power of online businesses in the U.S.:
            </Paragraph>

            <BlueBoxWithAbsoluteText absoluteText="$300B" text="Spent on online in the U.S. every year" />
            <BlueBoxWithAbsoluteText absoluteText="$100K" text="Fifth of full-time independent workers earnings a year." />
            ...
            <div style={{ marginBottom: "30px" }}>
              <Adventages headline="Over a third of Americans are now involved in the 'gig economy', providing independent, freelance and contract work through on-demand services" width="100%" />
            </div>

            <div style={{ marginBottom: "48px" }}>
              <Adventages headline="Online businesses are typically less expensive to start than traditional businesses" width="100%" />
            </div>

            <Paragraph big>This is why online businesses are so exciting — how can you be part of that success? We're here to help you figure that out.</Paragraph>
          </PanelWrapper>
        </CollapseWrapper>
      </TabsSection>
    </TabsWrapper>
    ...
    <Conclusion to="/" buttonTitle="Start your Online Business with us, today">
      ...
      <Paragraph big>The internet has made online entrepreneurship available to everyone. If you can find a great niche, understand your competitors and put together a solid business plan, you will have every chance for success</Paragraph>
    </Conclusion>
  </Layout>
);
