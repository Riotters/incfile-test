...
const OnlineBusiness = () => (
    <Layout>
        ...
        <Top ovalColor="yellow" imageName="online-business-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
            ...
            <p>The internet has revolutionized business — it has broadened marketplaces, made products and services
                available to every one and lowered the barriers to starting a successful company. With the right
                approach and understanding, anyone can become a successful online entrepreneur.</p>
            <ButtonsBox>
                ...
                <TabPanel>
                    <PanelWrapper>
                        <Paragraph big>
                            ...
                            website, writing a couple of blog posts and using social media. Just like traditional
                            businesses, business success online requires hard work and dealing with rapidly changing
                            tools and processes. The
                            low barrier to entry in owning an online business means that competition is intense; if you
                            want to be a success, you need to plan carefully and execute well.
                        </Paragraph>
                        ...
                        <Colorbox className="box" theme="icon" Icon={MegafornIcon} color={color.purple3} curve
                            ...
                            <Paragraph bottomPadding={0} bottomMargin={0}>
                                ...
                                just like you to get into business online, and we’re proud to have been a part of the
                                internet business
                                revolution.
                            </Paragraph>
                        </Colorbox>
                        ...
                        <Paragraph big style={{marginTop: "48px"}}>
                            ...
                            types of business you can go into through validation and research, to the legalities of
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Paragraph big style={{marginBottom: "52px"}}>
                            ...
                            advantage of these
                            trends can do extremely well — here are some statistics on the power of online businesses in
                            the U.S.:
                        </Paragraph>
                        ...
                        <Paragraph big>This is why online businesses are so exciting — how can you be part of that
        ...
        <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"}
            ...
            <Paragraph big>The internet has made online entrepreneurship available to everyone. If you can find a great
