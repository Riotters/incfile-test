...
const DigitalNomadBusiness = () => (
    <Layout>
        ...
        <Top ovalColor="darkblue" imageName="digital-nomad-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
            ...
            <p>There's a great appeal to being able to work from anywhere in the world, and those who take advantage of
                this remote-working lifestyle are called "digital nomads."</p>
            <ButtonsBox>
            ...
            <ReactTabs style={{marginTop: "100px"}} content={tabs}>
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Paragraph big>Whether it's running a dropshipping business from Bali, developing a successful
                            software application from Rio De Janeiro or selling digital products from Seoul, there's
                            vast opportunity for those with ideas, vision and an entrepreneurial spirit.</Paragraph>
                        <Paragraph big>
                            Of course, it's not all new horizons and worldwide customers — running a digital nomad
                            business can be a big challenge. That's why we put together this guide to give you all the
                            information you need to start a digital nomad business and enter the world of the
                        ...
                        <Paragraph big>In this guide, we'll explore everything you need to do to work remotely through
                            your own digital nomad business.</Paragraph>
                        ...
                        <ListWrapper>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Information on taxes and finances for your digital nomad
                                        business</Paragraph>
                                </CkeckText>
                            </ListBox>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Questions you should ask to see if you're ready to start a digital
                                        nomad business</Paragraph>
                                </CkeckText>
                            </ListBox>
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Adventages headline="Dropshipping business"
                        ...
                        <Adventages headline="Software as a Service (SaaS) company"
                                    text="You provide an online application that your customers pay a monthly subscription to use."
                                    width="100%"/>

                        <Adventages headline="Affiliate Marketing Website"
                        ...
                        <Adventages headline="Information Product"
                                    text="Like an ebook, online course or other resource that customers pay for."
                                    width="100%"/>

                        <Adventages headline="Freelance Service" text="Like copywriting, web design or graphic design."
                                    width="100%"/>
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Paragraph big>If you want to be successful as a digital nomad, here are the main skills you
                            need to have:</Paragraph>

                        <Adventages headline="A professional expertise/skill"
                                    text="The ability to sell your products or services as a digital nomad. We covered this above."
                                    width="100%"/>

                        <Adventages headline="Excellent communication skills"
                                    text="You need the ability to over-communicate to your clients and keep them happy over email, phone or chat."
                                    width="100%"/>

                        <Adventages headline="Customer relationship nurturer"
                                    text="Keeping clients and customers happy is vital to long-term success."
                                    width="100%"/>

                        <Adventages headline="Ability to work from anywhere"
                                    text="You have to be comfortable with working from the local coffeeshop, the beach, your AirBNB room or somewhere else."
                                    width="100%"/>

                        <Adventages headline="Financial flexibility"
                                    text="Staying on top of finances and ensuring you have enough coming in crucial to your peace-of-mind."
                                    width="100%"/>

                        <Adventages headline="Dealing with change"
        ...
        <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"}
            ...
            <Paragraph big>There's nothing like the freedom and satisfaction of running a successful digital nomad
                business. The combination of location independence, doing awesome work, keeping clients happy and seeing
                the world is a potent mix. Why not get started and ...</Paragraph>
        </Conclusion>
    </Layout>
);
...
export default DigitalNomadBusiness;
