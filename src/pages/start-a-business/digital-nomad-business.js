...
const DigitalNomadBusiness = () => (
	<Layout>
			...
			<ReactTabs style={{ marginTop: "100px" }} content={tabs}>
				<TabPanel>
					<PanelWrapper>
						...
						<Paragraph big>
							The barriers to entry for international travel and starting a
							business are all but gone, and digital nomads are at the forefront
							of combining these two areas to create successful enterprises they
							can operate from anywhere in the world.
						</Paragraph>
						<Paragraph big>
							Whether it's running a dropshipping business from Bali, developing
							a successful software application from Rio De Janeiro or selling
							digital products from Seoul, there's vast opportunity for those
							with ideas, vision and an entrepreneurial spirit.
						</Paragraph>
						<Paragraph big>
							Of course, it's not all new horizons and worldwide customers —
							running a digital nomad business can be a big challenge. That's
							why we put together this guide to give you all the information you
							need to start a digital nomad business and enter the world of the
						...
						<ListWrapper>
							...
							<ListBox>
								<CkeckText>
									<Paragraph big>
										Information on taxes and finances for your digital nomad
										business
									</Paragraph>
								</CkeckText>
							</ListBox>
				...
				<TabPanel>
					<PanelWrapper>
						...
						<Paragraph big>
							So, what is a digital nomad business? There are lots of
							definitions, but we think a digital nomad business is one where
							you can run the business from anywhere in the world with an
						...
						<Paragraph big style={{ marginBottom: "80px" }}>
							So, what are the stats and background information on digital
							nomads and how these changes in business will impact the way we
							work? Glad you asked...
						</Paragraph>
				...
				<TabPanel>
					<PanelWrapper>
						...
						<Paragraph big>
							Being a digital nomad has big risks and big rewards. On the risk
							side you have to deal with a large amount of uncertainty in terms
							of cash flow, projects, clients and more. On the reward side, you
							get to work from anywhere, succeed entirely on your own merits and
							have the satisfaction of creating a business that helps others be
							successful.
						</Paragraph>
						...
						>
							...
							Successful Digital Nomad Entrepreneur?
						</Paragraph>
						<Paragraph big>
							If you want to be successful as a digital nomad, here are the main
							skills you need to have:
						</Paragraph>

						<Adventages
							headline="A professional expertise/skill"
		...
		>
			...
			<Paragraph big>
				There's nothing like the freedom and satisfaction of running a
				successful digital nomad business. The combination of location
				independence, doing awesome work, keeping clients happy and seeing the
				world is a potent mix. Why not get started and ...
			</Paragraph>
		</Conclusion>
	</Layout>
);
