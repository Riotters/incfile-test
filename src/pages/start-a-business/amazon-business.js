...
import {
  ...
  tabs,
  toolsList,
} from "../../static/type-of-business/amazon-business";
    ...
    <Layout>
      ...
      <TabWrapper>
        ...
        <ReactTabs content={tabs}>
          ...
          <TabPanel>
            <PanelWrapper>
              ...
              >
                ...
                <Paragraph bottomPadding={0} bottomMargin={0}>
                  Sellers who source and procure products themselves but then
                  send them to an Amazon warehouse for storage, sale, payment
                  and shipping. Amazon handles all customer service and returns.
                  These are known as “Fulfilled by Amazon (FBA)” sellers
                </Paragraph>
              </Colorbox>

              <Paragraph big style={{ marginTop: "32px" }}>
                The difference is that in FBA, Amazon takes care of storing,
                shipping, customer service and returns. Of course, Amazon does
                charge for these services, and “Sold by Amazon” is less
              ...
              <Paragraph big>
                ...
                marketplaces like Alibaba, Salehoo, Wholesale Central and more.
              </Paragraph>
              <ButtonAction
                theme="primary56"
                marginMD="0 170px 0 0"
              ...
              <Heading size={2} template={3} style={{ marginTop: "40px" }} left>
          ...
          <TabPanel>
            <PanelWrapper>
              <Heading size={3} marginBottom={32}>
      ...
      <LightBoxModal visible={modalVisible} className="modal-overlay">
        ...
        >
          ...
          {formSubmitted && (
            <ThankYouContent
              modalExit={popup}
              fileDownload={hsForm?.fileDownload ? hsForm.fileDownload : false}
            />
          )}
        </LightBoxContent>
      </LightBoxModal>
