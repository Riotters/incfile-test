...
import { RingText, toolsList, hsForm } from "../../static/type-of-business/amazon-business";
...
const AmazonBusiness = () => {
  ...
  return (
      <Layout>
        <SEO title="How to Start an Amazon Business | How to Sell on Amazon"
        ...
        <Top ovalColor="sun" imageName="amazon-business-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
          ...
          <p>Ecommerce is rapidly growing in popularity, with 80 percent of Americans regularly purchasing something
            online. These trends look set to continue, with revenue from ecommerce websites growing over 20 percent year
            on year.year on year.</p>
          <ButtonsBox>
            ...
            <CollapseWrapper>
              <PanelWrapper>
                <Paragraph big style={{marginBottom: "50px"}}>
                  It’s a lucrative space, and there’s money to be made. If you want to get into the world of ecommerce
                  and selling online, you have a few choices.
                </Paragraph>
                ...
                <Paragraph big>
                  Of course, the dominant player in the ecommerce space is Amazon - it’s among the world’s largest
                  ecommerce websites, and it provides some massive opportunities for sellers. As an Amazon business, you
                  can offer your products for sale through Amazon to gain access to their enormous
                  reach, technology and marketplace.
                </Paragraph>

                <Paragraph big>
                  You might think selling on Amazon is easy; they do a good job of setting up sellers for success.
                  Despite this, there are potential pitfalls to selling on Amazon, so we’ve put together this complete
                  guide to tell you exactly how to maximize your chances of creating a thriving Amazon
                ...
                <ListWrapper>
                  <ListBox>
                    <CkeckText>
                      <Paragraph big>Understanding the world of Amazon businesses and what it takes to be an Amazon
                        seller</Paragraph>
                    </CkeckText>
                  </ListBox>
                  ...
                  <ListBox>
                    <CkeckText>
                      <Paragraph big>The various rules and regulations you will need to follow</Paragraph>
                    </CkeckText>
                  </ListBox>

                  <ListBox>
                    <CkeckText>
                      <Paragraph big>Questions you should ask to see if you’re ready to start an Amazon
                        business</Paragraph>
                    </CkeckText>
                  </ListBox>
                  ...
                  <ListBox>
                    <CkeckText>
                      <Paragraph big>The best legal structure for your new organization</Paragraph>
                    </CkeckText>
                  </ListBox>

                  <ListBox>
                    <CkeckText>
                      <Paragraph big>Information on taxes and finances for your Amazon business</Paragraph>
                    </CkeckText>
                  </ListBox>

                  <ListBox>
                    <CkeckText>
                      <Paragraph big>Resources for your Amazon business</Paragraph>
                    </CkeckText>
                  </ListBox>
                ...
                <Paragraph big>By the time you’ve read through our complete Amazon business guide, you will have all the
                  information you need to setup and manage a thriving Amazon business. Let’s get into it.</Paragraph>
              </PanelWrapper>

              <PanelWrapper>
                <Heading size={3}>Understanding the World of the Amazon Business</Heading>
                <Paragraph big>So, what exactly is an Amazon seller? Simply put, they are people and companies who
                  source goods and then sell them on Amazon at a profit. There are two main kinds of Amazon
                  businesses:</Paragraph>

                <Colorbox className="box" theme="icon" Icon={SoldIcon} color={color.orange3} curve
                          curveColor={color.orange2}>
                  <Heading size={4}>"Sold by Amazon" Sellers</Heading>
                  <Paragraph bottomPadding={0} bottomMargin={0}>
                    Sellers who source, procure, store and ship the goods themselves including taking care of customer
                    service and returns. They only use Amazon to list their products, get exposure, sell them and take
                    payment. These are known as "Sold by Amazon” sellers.
                  </Paragraph>
                </Colorbox>
                ...
                <Paragraph big bottomMargin={70}>
                  So, what exactly is an Amazon seller? Simply put, they are people and companies who source goods and
                  then sell them on Amazon at a profit. There are two main kinds of Amazon businesses:
                </Paragraph>

                <BlueBoxWithAbsoluteText absoluteText="$136B" text="Amazon.com's revenue in 2016"/>
                <BlueBoxWithAbsoluteText absoluteText="300M" text="Number of people shops on Amazon.com"/>
                <BlueBoxWithAbsoluteText absoluteText="100K" text="Amazon sellers had sales of $100K or more in 2016"/>
                ...
                <Paragraph big bottomMargin={70}>
                  If you want to be successful on Amazon, finding the right products and buyers is absolutely essential.
                  Due to the success of the platform, there is a vast amount of competition across almost every niche
                  and product. The biggest factors that will decide your success are choosing the
                  right product, understanding the demand for that product and selling it at a profit.
                </Paragraph>
                ...
                <Button theme="primary56" marginMD="0 170px 0 0" onClick={popup} arrow content={{
                  url: `/`,
              ...
              <PanelWrapper>
                ...
                <Paragraph big>
                  Although Amazon does resolve many of the issues facing an e-commerce startup (marketing, acquiring
                  sales, managing distribution, etc.), that doesn't make running an Amazon business easy. You must be
                  able to deal with significant competition, be acutely aware of the state of the
                  marketplace, deal with Amazon’s regulations and policies and be a master administrator.
                </Paragraph>
                <Paragraph big style={{marginBottom: "48px"}}>
                  The profit margins are also likely to be razor-thin. You need to create, buy inventory, manage and
                  maintain a successful business on small profit margins and against a very competitive landscape. But,
                  if you can make it, the upsides are huge. If your product really gets traction, you
                  could make your way into the upper ranks of sellers who make more than $1,000,000 a year on the
                  platform.
                </Paragraph>
                ...
                <Paragraph big>Being a successful Amazon business owner requires a diverse set of skills:</Paragraph>
                ...
                <div style={{marginBottom: "76px"}}>
                  <CountingTextBoxed number={6}>
                    <div>
                      ...
                      <Paragraph bottomPadding={0} bottomMargin={0}>
                        Since often basics such as headline writing, copywriting and call-to-actions can make or break
                        your Amazon listing
                      </Paragraph>
                    </div>
                  </CountingTextBoxed>
                ...
                <Paragraph big mixed={true}>
                  Check out our <a href="/blog/post/fulfillment-by-amazon/">additional guidance in understanding if an
                  Amazon business is the right choice for you.</a> If this blog post, we'll help you analyze if your
                  Amazon business idea is a good one, conduct market research and build a business plan.
                </Paragraph>
              </PanelWrapper>
            </CollapseWrapper>
          </TabsSection>
        ...
        <div style={{marginTop: "200px"}}>
          <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"}
            ...
            <Paragraph big>
              Starting an Amazon business can be both very challenging and very rewarding. Find the right niche, source
              great products and sell them at a profit and you have the makings of a successful business. Eventually,
              you could be among the 15 percent who sell more than $1,000,000 worth of
              products every year.
            </Paragraph>
          </Conclusion>
        </div>
