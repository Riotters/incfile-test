...
import Tab1Icon from "../../images/icons/gym-icon.inline.svg";
...
const GymPersonalTraining = () => (
  <Layout>
    <SEO title="How to Start Your Own Gym, Fitness Center or Personal Training Business" description="Starting a food truck can be an excellent introduction to the world of running your own business." />

    <Top ovalColor="blue" imageName="gym-personal-training-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
      <h1>How to Start Your Own Gym, Fitness Center or Personal Training Business</h1>
      <p>Getting fit, losing weight and living a healthy lifestyle is a priority for many of us. From new diets to innovative exercise regimes, we all want to find interesting ways to be active.</p>
      <ButtonsBox>
    ...
    <TabsWrapper>
      ...
      <TabsSection style={{ marginTop: "100px" }}>
        <TabHeading>
          <TabTitle title="Gym" SvgIcon={Tab1Icon} />
        ...
        <CollapseWrapper>
          <PanelWrapper>
            <Paragraph big>If you’ve got an interest in exercise or personal training and want to turn that expertise into a business, then opening up a fitness-based business could be right for you.</Paragraph>
            <Paragraph big>You’ve got plenty of choices depending on your budget, target clients and ideas for marketing your gym or personal training venture.</Paragraph>

            <Colorbox className="box" theme="icon" Icon={MegafornIcon} color={color.blue3} curve curveColor={color.orange2}>
              <Heading size={4}>The question is, just where do you start?</Heading>
              <Paragraph bottomPadding={0} bottomMargin={0}>
                Here at Incfile, we know the answer, and we’ve shared it with more than 100,000 people who we've helped to form their businesses. Since 2004, we’ve supported gym, fitness or personal training entrepreneurs just like you, and we’re proud to have been a part of the healthy lifestyle
                business revolution.
              </Paragraph>
            </Colorbox>
            ...
            <ListWrapper>
              <ListBox>
                <CkeckText>
                  <Paragraph big>Statistics on why you should start a fitness-based business</Paragraph>
                </CkeckText>
              </ListBox>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>Ideas for the type of healthy lifestyle venture that you could create</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>How to validate your gym or personal training business idea</Paragraph>
                </CkeckText>
              </ListBox>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>Helpful software for gym, fitness or personal training business owners</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>How to start your gym, fitness or personal training business with information on equipment, employees, location, permits, finance, taxes and more</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Learn if a gym, personal training or other type of fitness business could be right for you</Paragraph>
                </CkeckText>
              </ListBox>
            </ListWrapper>
          </PanelWrapper>
          ...
          <PanelWrapper>
            ...
            <Heading size={3}>A Day in the Life of a Gym, Fitness Center or Personal Training Business Owner</Heading>
            <Paragraph big>Here are some of the typical tasks you’ll be performing for your business on a daily basis.</Paragraph>
            ...
            <Paragraph big>The following skills will be very useful in your role as a fitness-based small business owner.</Paragraph>
            ...
            <Paragraph big>Although many people have the same basic needs from a fitness business - losing weight, building endurance, getting stronger and improving general health - your clients' needs can vary widely beyond that. Think about the types of customers you’re appealing to:</Paragraph>
    ...
    <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"} buttonTitle="Start your Gym Personal Training Business with us, today">
      <Heading size={3} style={{ fontSize: "48px" }}>
        Conclusion
      </Heading>
      <Paragraph big>The need for engaging, powerful ways to build our strength, endurance, fitness and well-being isn’t going away. Build on these opportunities by starting your own gym or personal training business and turning it into a success.</Paragraph>
    </Conclusion>
  </Layout>
);
