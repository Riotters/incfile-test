...
import ValidatingBusinessIdea
    from "../../atomic/sections/type-of-business/gym-personal-training/validating-business-idea";
...
const GymPersonalTraining = () => (
    <Layout>
        <SEO title="How to Start Your Own Gym, Fitness Center or Personal Training Business"
             description="Starting a food truck can be an excellent introduction to the world of running your own business."/>

        <Top ovalColor="blue" imageName="gym-personal-training-main" imageAlt="Mr Bulb with seedling"
             headlineWidth={700}>
            <h1>How to Start Your Own Gym, Fitness Center or Personal Training Business</h1>
            <p>Getting fit, losing weight and living a healthy lifestyle is a priority for many of us. From new diets to
                innovative exercise regimes, we all want to find interesting ways to be active.</p>
            <ButtonsBox>
        ...
        <TabsWrapper>
            ...
            <ReactTabs style={{marginTop: "100px"}} content={tabs}>
                <TabPanel>
                    <PanelWrapper>
                        <Paragraph big>If you’ve got an interest in exercise or personal training and want to turn that
                            expertise into a business, then opening up a fitness-based business could be right for
                            you.</Paragraph>
                        <Paragraph big>You’ve got plenty of choices depending on your budget, target clients and ideas
                            for marketing your gym or personal training venture.</Paragraph>
                        ...
                        <Colorbox className="box" theme="icon" Icon={MegafornIcon} color={color.blue3} curve
                            ...
                            <Paragraph bottomPadding={0} bottomMargin={0}>
                                ...
                                personal training entrepreneurs just like you, and we’re proud to have been a part of
                        ...
                        <Paragraph big style={{marginTop: "48px"}}>
                            ...
                            your business, this guide will help you out. We’ll talk you through the main things you need
                        ...
                        <Paragraph big style={{fontFamily: "Avenir", fontWeight: "900", color: color.black}}>
                            Read on for some insight into creating your own gym, fitness center or personal training
                            business and becoming an entrepreneur. In this guide we will cover:
                        </Paragraph>

                        <ListWrapper>
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Statistics on why you should start a fitness-based
                                        business</Paragraph>
                                </CkeckText>
                            </ListBox>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Ideas for the type of healthy lifestyle venture that you could
                                        create</Paragraph>
                                </CkeckText>
                            </ListBox>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>How to validate your gym or personal training business
                                        idea</Paragraph>
                                </CkeckText>
                            </ListBox>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Business plans for fitness companies</Paragraph>
                                </CkeckText>
                            </ListBox>

                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Helpful software for gym, fitness or personal training business
                                        owners</Paragraph>
                                </CkeckText>
                            </ListBox>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>How to start your gym, fitness or personal training business with
                                        information on equipment, employees, location, permits, finance, taxes and
                                        more</Paragraph>
                                </CkeckText>
                            </ListBox>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Learn if a gym, personal training or other type of fitness business
                                        could be right for you</Paragraph>
                                </CkeckText>
                            </ListBox>
                        </ListWrapper>
                    </PanelWrapper>
                    ...
                    <PanelWrapper>
                        ...
                        <TextWithBubbleCounting>
                            <Paragraph big style={{fontWeight: "bold"}} bottomMargin={0}>
                                Around 1 in 5 Americans has a membership to a fitness club, gym or studio
                            </Paragraph>
                        ...
                        <Paragraph big>
                            This is why gym, fitness or personal training businesses are so exciting — how can you be
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Heading size={3}>A Day in the Life of a Gym, Fitness Center or Personal Training Business
                            Owner</Heading>
                        <Paragraph big>Here are some of the typical tasks you’ll be performing for your business on a
                            daily basis.</Paragraph>
                        ...
                        <div style={{marginBottom: "10px"}}>
                            <TextBoxed>
                                <Paragraph big bottomMargin={0}>
                                    Checking out your facilities and equipment to keep everything clean, tidy, hygienic
                                    and safe
                                </Paragraph>
                            </TextBoxed>
                        </div>
                        ...
                        <div style={{marginBottom: "10px"}}>
                            <TextBoxed>
                                <Paragraph big bottomMargin={0}>
                                    Administering your business including paying suppliers, charging customers and other
                                    operations
                                </Paragraph>
                            </TextBoxed>
                        </div>
                        ...
                        <Paragraph big>The following skills will be very useful in your role as a fitness-based small
                        ...
                        <Paragraph big>Although many people have the same basic needs from a fitness business - losing
                            weight, building endurance, getting stronger and improving general health - your clients'
                            needs can vary widely beyond that. Think about the types of customers you’re appealing
                            to:</Paragraph>

                        <div style={{marginBottom: "10px"}}>
                            <TextBoxed>
                                <Paragraph big bottomMargin={0}>
                                    Some might be training for a specific event like a marathon, Ironman or other
                        ...
                        <div style={{marginBottom: "10px"}}>
                            <TextBoxed>
                                <Paragraph big bottomMargin={0}>
                                    Some may want training to deal with particular life circumstances, like recovering
                                    from injury or getting in shape after the birth of a child.
                                </Paragraph>
                            </TextBoxed>
                        </div>
        ...
        <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"}
            ...
            <Paragraph big>The need for engaging, powerful ways to build our strength, endurance, fitness and well-being
                isn’t going away. Build on these opportunities by starting your own gym or personal training business
                and turning it into a success.</Paragraph>
        </Conclusion>
    </Layout>
);
