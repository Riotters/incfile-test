...
const SideBusiness = () => (
	<Layout>
		...
		>
			...
			<p>
				Starting a side business is a great way to dip your toe into the waters
				of entrepreneurship. You can create and manage a side business alongside
				your normal job, so you’re reducing your risk and have a fallback
				...
				<TabPanel>
					<PanelWrapper>
						<Paragraph big>
							...
							you can make an informed decision as to whether you want to focus
							on it full-time.
						</Paragraph>
						<Paragraph big>
							...
							and running a business, which will be incredibly valuable when you
							take your side business to the next level (or start up another new
							business).
						</Paragraph>
						...
						>
							<Paragraph big style={{ fontWeight: "bold" }}>
								If you don’t know how to start a side business, we’re here to
								help.
							</Paragraph>
						...
						<Paragraph big>
							Read on for some insight into creating your own side business and
				...
				<TabPanel>
					<PanelWrapper>
						...
						<Paragraph big>
							...
							addition to your regular job, here are some statistics to inspire
							you.
						</Paragraph>
						...
						<BubblesWrapper>
							...
							<Text>
								Around 6 in 10 people who run a side business have a full-time
								job already
							</Text>
						</BubblesWrapper>
						...
						<Paragraph big>
							If you want to find out whether a side business is right for you,
							the time to start is now. We're here to help you figure out how to
							do that.
						</Paragraph>
					</PanelWrapper>
				</TabPanel>
			...
			<Container>
				<CenterBox>
					...
					<Paragraph big>
						...
						business, but they can give you a surprising number of benefits
						(especially if you want to expand your business). A business plan
						will help you define your side business, market yourself, get sales,
					...
					<CountingTextBoxed number={3}>
						<Paragraph bottomPadding={0} bottomMargin={0}>
							A description of your side business, background information and
							contex
						</Paragraph>
					</CountingTextBoxed>
			...
			<BusinessOwnerResponsibilities>
				<ImageContent image="unique-business-2" paddingTop="60">
					...
					>
						...
						<Paragraph big>
							This is the "default" business structure and is what your side
					...
					>
						...
						<Paragraph big>
							...
							and inexpensive to set up and maintain. It protects your personal
							finances and assets and is a great way to start your side
							business.
						</Paragraph>
					</TextBlockWithImage>
					...
					<Paragraph
						...
						mixed={true}
					>
						Our <Link to="/business-entity-comparison/">in-depth guide</Link>{" "}
						covers more of the advantages and disadvantages of different types
						of business entities, and you’ve still got questions, you can read
						our answers to frequently asked questions on{" "}
						<a
					...
					<Paragraph
						...
						mixed={true}
					>
						In most cases, our recommendation for a side business would be to
						create an LLC. See our
						<Link to="/form-an-llc/">
							{" "}
							complete guide to creating an LLC
						</Link>{" "}
						to learn everything you need to do, or and have Incfile register
						your business for you. No matter what state you’re in, we’ve got you
						covered.
					</Paragraph>
