...
import { RingText, toolsList } from "../../static/type-of-business/cleaning-business";
...
const CleaningBusiness = () => (
  <Layout>
    <SEO title="How to Start a Cleaning Business" description="Starting a cleaning business can be an ideal way to begin your journey as an entrepreneur. Although they may seem simple, cleaning businesses have a lot going for them." />
      ...
      <TabsSection>
        ...
        <CollapseWrapper>
          <PanelWrapper>
            ...
            <Paragraph big>
              Though cleaning may not be the most glamorous type of business in the world, a well-managed and marketed cleaning business can generate good profits and become a trusted part of your client’s lives. Starting up a cleaning business doesn’t have to be complicated, and in this guide we’ll
            ...
            <ListWrapper>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>Deciding if you’re ready to start a cleaning business</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Setting your business up with efficient marketing and administration practices</Paragraph>
                </CkeckText>
              </ListBox>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>Gathering resources for your cleaning business</Paragraph>
                </CkeckText>
              </ListBox>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>Finding information on taxes and finances for your cleaning business</Paragraph>
                </CkeckText>
              </ListBox>
          ...
          <PanelWrapper>
            <Heading size={3}>Understanding the World of a Cleaning Business</Heading>

            <Paragraph big style={{ fontFamily: "Avenir", fontWeight: "900", marginTop: "48px", color: color.black }}>
              Key Cleaning Business and Background Data and Statistics
            </Paragraph>

            <Paragraph big>Cleaning companies provide substantial benefits to the U.S. economy.</Paragraph>
            ...
            <Adventages headline="The commercial office and retail sectors generate the majority of revenue, followed by education and healthcare." width="100%" />

            <Adventages headline="The number of cleaning companies is growing by around 1.7 percent each year" width="100%" />

            <Adventages headline="Around 10 percent of cleaning industry revenues come from franchises." width="100%" />

            <Adventages headline="Commercial cleaning contracts are the most reliable type of income for cleaning businesses, with office buildings accounting for nearly a third of such contracts." width="100%" />

            <Paragraph big>
              This all points to the cleaning industry being ripe with new opportunities for focused entrepreneurs, so now might be the perfect time to dive into starting your cleaning business. Incfile is here to help you form your cleaning business and understand the ins and outs of owning a
              cleaning company.
            </Paragraph>
          </PanelWrapper>

          <PanelWrapper>
            <Heading size={3}>Questions to Ask Before You Start a Cleaning Business</Heading>

            <Paragraph big style={{ fontFamily: "Avenir", fontWeight: "900", marginTop: "48px", color: color.black }}>
              Is Cleaning Entrepreneurship for You?
            </Paragraph>

            <Paragraph big>Running a cleaning business could be a good option if you:</Paragraph>

            <Adventages headline="Have a strong focus on customer service" text="You'll need to make sure all your employees are great at dealing with demanding clients." width="100%" />
            ...
            <Adventages headline="Don’t mind competition" text="The barrier to entry for cleaning businesses is very low, and there are always new entrants into the marketplace." width="100%" />
            ...
            <Adventages headline="Enjoy dealing with people" text="Cleaning is a very people-focused business, so you will constantly be interacting with customers and employees." width="100%" />
            ...
            <Paragraph big>
              Aside from intense competition and employee turnover, the main challenge for a cleaning entrepreneur will be finding new customers and keeping existing ones happy. You’ll also need a rock-solid understanding of pricing and business finances — if you’re paying other people, your margins
              will likely be very thin.
            </Paragraph>
            ...
            <CountingTextBoxed number={1}>
              <Paragraph bottomMargin={0}>Scheduling appointments for cleaning</Paragraph>
            </CountingTextBoxed>

            <CountingTextBoxed number={2}>
              <Paragraph bottomMargin={0}>Negotiating contracts and setting rates</Paragraph>
            </CountingTextBoxed>
            ...
            <CountingTextBoxed number={5}>
              <Paragraph bottomMargin={0}>Planning out optimal routes</Paragraph>
            </CountingTextBoxed>

            <CountingTextBoxed number={6}>
              <Paragraph bottomMargin={0}>Developing training on cleaning and customer service</Paragraph>
            </CountingTextBoxed>

            <CountingTextBoxed number={7}>
              <Paragraph bottomMargin={0}>Collecting payments and managing finances</Paragraph>
            </CountingTextBoxed>
    ...
    <BlueContainer>
      ...
      <Container>
        <CenterBox>
          ...
          <Paragraph big>
            Before you start your business, there are a few key areas you need to focus on. You will need to figure out whether there’s a demand for your cleaning business services, consider potential benefits and pitfalls, understand how your business finances might look and ensure everything is in
            order.
          </Paragraph>
          ...
          <Paragraph big>Before you launch your cleaning business, you need to understand if there’s a demand for what you’re selling. That means carrying out market research and “validating” your services. Here’s how to go about it:</Paragraph>
        </CenterBox>
        ...
        <GridSectionList>
          ...
          <TextBlockWithImage width="100" widthUnit="%" SvgImage={ValidateIcon} imageBackgroundColor={color.orange2} imageShadowColor={color.orange2}>
            <Heading size={4}>Look for market research reports for cleaning businesses</Heading>
            <Paragraph bottomPadding={0} bottomMargin={0}>
        ...
        <CenterBox>
          ...
          <Paragraph big>
            You will also need to look at financial projections for your cleaning business. What are your expected sales and revenues? What is your profitability? How much money will you keep in the business to grow it? How much will you pay yourself and others? If you can, try to plan your revenue
            out for the next month, three months, year and two years. Margins in the cleaning business are slim, so plan with that in mind.
          </Paragraph>
        </CenterBox>
      </Container>
    </BlueContainer>
    ...
    <OrangeContainer>
      ...
      <BusinessOwnerResponsibilities>
        <ImageContent image="unique-business-2" paddingTop="60">
          ...
          <Paragraph big>Now that you have all the background information for your cleaning business, it’s time to make it into a reality. That starts by choosing the right structure or “legal entity” for your business. In the U.S., there are four main business structures. They are:</Paragraph>
          ...
          <Paragraph big mixed={true} style={{ marginBottom: "56px", paddingBottom: 0 }}>
            In most cases our recommendation would be to create an LLC. We have a <Link to="/">complete guide to everything you need to do</Link>, and we can set one up for your T-shirt business. <Link to="/llc-state-information/">LLC formation does vary from state to state</Link>, but we’ve got you
    ...
    <Conclusion to="/" buttonTitle="Start your Cleaning Business with us, today">
      ...
      <Paragraph big>A cleaning business can be a very solid choice for a first-time entrepreneur. The combination of a low barrier to entry, focus on strong customer service and the need for excellent interpersonal skills makes it an ideal choice.</Paragraph>
      <Paragraph big>Although there’s lot of competition and plenty of demanding clients, a cleaning business that's run well can generate excellent revenue. When you’re ready to start up your cleaning business.</Paragraph>
    </Conclusion>
  </Layout>
);
