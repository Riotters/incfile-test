...
const TeenBusiness = () => (
    <Layout>
        ...
        <Top
            ...
            imageAlt="set up a teen business"
            headlineWidth={700}
        >
            <h1>How to Start a Teen Business</h1>
            <p>
                Some entrepreneurs start young, and there are no rules that say you need
                to be in your twenties or older before you start a business. If you’re
                just earning a few dollars a week, there probably aren’t any big
                advantages to creating a formal business right now. But if you’re making
                more than that — or you want other people to take your work seriously -
            ...
            <ReactTabs content={tabs}>
                <TabPanel>
                    <PanelWrapper>
                        <Paragraph big>
                            ...
                            their own company, why not stand out from the crowd and boost your
                        ...
                        <Paragraph big style={{ marginTop: "40px" }}>
                            ...
                            business off the ground. From exploring the types of business you
                            can start to the legalities of setting up your business and the
                            realities of your day-to-day operations, this guide is here to
                            help.
            </Paragraph>
                        <Paragraph big>
                            Read on for some insight into creating your own teen business and
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Paragraph big style={{ marginBottom: "52px" }}>
                            You might be surprised at the number of teen businesses out there.
              ...
              to earn extra money"
                        ...
                        <BubblesWrapper>
                            <Bubbles>
                                <BubbleImage>
                                    <Image filename="mrs-bulb-final-comp-thumb-up-color" alt="teeen business" />
                                </BubbleImage>
                                <BubbleImage>
                                    <Image filename="mrs-bulb-final-comp-thumb-up-color" alt="teeen business" />
                                </BubbleImage>
                                ...
                                <BubbleImage>
                                    <Image filename="mrs-bulb-final-comp-thumb-up-copy-4" alt="teeen business" />
                                </BubbleImage>
                                <BubbleImage>
                                    <Image filename="mrs-bulb-final-comp-thumb-up-copy-4" alt="teeen business" />
                                </BubbleImage>
                        ...
                        <BubblesWrapper>
                            <Bubbles>
                                <BubbleImage>
                                    <Image filename="mrs-bulb-final-comp-thumb-up-color" alt="teen business" />
                                </BubbleImage>
                                <BubbleImage>
                                    <Image filename="mrs-bulb-final-comp-thumb-up-color" alt="teen business" />
                                </BubbleImage>
                                ...
                                <BubbleImage>
                                    <Image filename="mrs-bulb-final-comp-thumb-up-copy-4" alt="teen business" />
                                </BubbleImage>
                                <BubbleImage>
                                    <Image filename="mrs-bulb-final-comp-thumb-up-copy-4" alt="teen business" />
                                </BubbleImage>
                        ...
                        <Paragraph big>
                            This is why teen businesses are so exciting. So how can you be
        ...
        >
            ...
            <Paragraph big>
                The internet has made teen entrepreneurship available to everyone. If
                you can find a great idea, build a niche, develop your reputation and
                put together a solid business plan, you will have every chance for
                success.
    </Paragraph>
        </Conclusion>
    </Layout>
