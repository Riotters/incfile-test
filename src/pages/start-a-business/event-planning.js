...
const EventPlanning = () => (
  <Layout>
        ...
        <TabPanel>
          <PanelWrapper>
            ...
            <div style={{ marginBottom: "30px", marginTop: "48px" }}>
              <Adventages
                headline="The amount of revenue generated by event planning businesses has risen by almost 4 percent each year"
                width="100%"
              />
            </div>
            ...
            <div style={{ marginBottom: "30px" }}>
              <Adventages
                headline="The number of event and party planning businesses has grown by 2.1 percent, and the number of employees is up by 2.4 percent"
                width="100%"
              />
            </div>
    ...
    <Conclusion
      ...
      buttonTitle="Start your Party or Event Planning Business with us, today"
    >
