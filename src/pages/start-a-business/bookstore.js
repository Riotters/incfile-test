...
const GymPersonalTraining = () => (
  <Layout>
    ...
    <Top ovalColor="sun" imageName="bookstore-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
      ...
      <p>A bookstore is one of the most enduring and traditional types of business you could open. Despite this, there have been plenty of challenges to the bookstore model over the last few years, with the increase in ecommerce, the rise of Amazon and the move toward ebooks.</p>
      <ButtonsBox>
    ...
    <TabsWrapper>
      ...
      <TabsSection style={{ marginTop: "100px" }}>
        ...
        <CollapseWrapper>
          <PanelWrapper>
            <Paragraph big>Against this background, you might wonder if it’s worth opening up a book shop — the good news is that with some careful planning and research, you could create a successful store that spreads information, entertainment and delight.</Paragraph>
            <Paragraph big>Of course it might not be easy, but entrepreneurs with the right approach can turn a passion for literature and manuscripts into a center of knowledge that your customers will love.</Paragraph>

            <Colorbox className="box" theme="icon" Icon={BookIcon} color={color.green3} curve curveColor={color.orange2}>
              <Heading size={4}>We know it can be daunting to start a bookstore business, and we’re here to help.</Heading>
              <Paragraph bottomPadding={0} bottomMargin={0}>
                We’ve supported over 100,000 people to form their business and provided answers, guidance and support to transform them into entrepreneurs. We’ll guide you through what you need to know to start your bookstore business and get it off the ground.
              </Paragraph>
            </Colorbox>
            ...
            <ListWrapper>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>Choose the right business structure for your bookstore company</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>How to find out if a boutique hotel business is right for you</Paragraph>
                </CkeckText>
              </ListBox>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>Ideas for the type of bookstore business that you could form</Paragraph>
                </CkeckText>
              </ListBox>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>Setting up your bookstore business (including location, equipment, employees, taxes, finances, licenses and more)</Paragraph>
                </CkeckText>
              </ListBox>
          ...
          <PanelWrapper>
            ...
            <BlueBoxWithAbsoluteText absoluteText="2.7B" text="More than this number are the books sold in the U.S. each year" />
            <BlueBoxWithAbsoluteText absoluteText="2,3000" text="Number of independent" />

            <div style={{ marginBottom: "30px", marginTop: "80px" }}>
              <Adventages headline="The number of independent bookstores grew by 35% between 2009 and 2015, with nearly 600 stores opened" width="100%" />
            </div>
          ...
          <PanelWrapper>
            ...
            <Paragraph big>Here are some of the typical tasks you’ll be performing for your bookstore business on a daily basis.</Paragraph>
            ...
            <Paragraph big>The following skills will be very useful in your role as a bookstore small business owner.</Paragraph>
            ...
            <Paragraph big>
              The secret to running a successful bookstore is to create an excellent customer experience. One of the reasons independent bookshops are growing is that buying online doesn’t provide a sense of personal service or community. Bookstores that can meet those needs by understanding and
          ...
          <PanelWrapper>
            ...
            <Paragraph big>
              You don’t need to limit yourself to just selling books over the counter. You can expand into wider markets by creating an online presence. Whether you sell through a third-party marketplace like Amazon or you have your own ecommerce site, you can create a useful additional revenue
              stream.
            </Paragraph>
          </PanelWrapper>
        </CollapseWrapper>
