...
import {RingText2, tabs, toolsList} from "../../static/type-of-business/bakery";
...
const Bakery = () => (
    <Layout>
        <SEO
            title="How to Start a Bakery Business"
        ...
        <Top ovalColor="sun-2" imageName="bakery-main-header" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
            <h1>How to Start a Bakery Business</h1>
            <p>Bakeries are a growing industry in the US. It’s easy to see why, as people shop for their daily bread or
                seek out cakes and other sweet treats. Specialty baking is on the rise too, with products designed for
                people who have particular dietary choices or digestive issues.</p>
            <ButtonsBox>
            ...
            <ReactTabs content={tabs}>
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Paragraph big style={{marginBottom: "72px"}}>
                            From exploring the types of business you can start, through research, to the legalities of
                        ...
                        <Paragraph big>From exploring the types of business you can start, through research, to the
                            legalities of setting up your business and the realities of your day to day operations, this
                            guide is here to help.</Paragraph>

                        <ListWrapper>
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Facts and figures on the success of bakery businesses</Paragraph>
                                </CkeckText>
                            </ListBox>

                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Learn if a bakery business could be right for you</Paragraph>
                                </CkeckText>
                            </ListBox>

                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Ideas for the type of bakery business that you could form</Paragraph>
                                </CkeckText>
                            </ListBox>

                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Proving your bakery business can work</Paragraph>
                                </CkeckText>
                            </ListBox>

                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Useful online tools for bakery business owners</Paragraph>
                                </CkeckText>
                            </ListBox>

                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Choose the right business structure for your bakery
                                        company</Paragraph>
                                </CkeckText>
                            </ListBox>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Where to find bakery business groups, forums and support</Paragraph>
                                </CkeckText>
                            </ListBox>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>How to start your bakery business with information on equipment,
                                        employees, location, pernits, finance, taxes and more</Paragraph>
                                </CkeckText>
                            </ListBox>
                        </ListWrapper>
                    </PanelWrapper>
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Paragraph big style={{marginBottom: "72px"}}>
                            You might not think of the humble bakery as a powerhouse for business, but the stats say
                            otherwise!
                        </Paragraph>

                        <BlueBoxWithAbsoluteText absoluteText="11K"
                        ...
                        <BlueBoxWithAbsoluteText absoluteText="$350"
                        ...
                        <Adventages headline="Two-thirds of bakeries have fewer than ten employees" width="100%"/>
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Adventages headline="Understanding customer demand for the products you’re intending to make"
                                    width="100%"/>

                        <Adventages headline="Purchasing ingredients for baking products" width="100%"/>

                        <Adventages headline="Preparing ingredients for baking" width="100%"/>

                        <Adventages headline="Working out the costs of ingredients, selling prices and profit margins"
                                    width="100%"/>

                        <Adventages headline="Baking products and putting them out for sale" width="100%"/>
                        ...
                        <Adventages headline="An excellent grasp of the art and science of baking" width="100%"/>

                        <Adventages headline="Good soft skills and talking to customers to find out what they want"
                                    width="100%"/>
                        ...
                        <Adventages headline="Delicious, fresh, high-quality baked products" width="100%"/>

                        <Adventages headline="A good variety of breads, pastries, cakes and more" width="100%"/>

                        <Adventages headline="A place to sit, relax and chat with friends" width="100%"/>

                        <Adventages headline="Reasonable prices for baked goods" width="100%"/>

                        <Adventages headline="Drink options like tea and coffee" width="100%"/>
                    </PanelWrapper>
                </TabPanel>
            </ReactTabs>
        </TabsWrapper>
        ...
        <BlueContainer>
            ...
            <Container>
                <CenterBox>
                    ...
                    <Paragraph big>These areas are just starting points — there are many different types of bakery
                        businesses. Once you’ve identified the type of bakery you’d like to run and what you want to
                        sell, you need to validate your business idea.</Paragraph>
                    <Paragraph big>Start by checking you have the right skillset. Bakers work long hours and need
                        sufficient technical skill to make great products. You’ll need to deal with employees and
                        customers too, and there’s a lot of planning that goes into running a successful
                        bakery.</Paragraph>
                    <Paragraph big>
                    ...
                    <Paragraph big>Before committing too much time, energy and money into your new bakery business, it’s
                        important to test the marketplace.</Paragraph>
                </CenterBox>
                ...
                <GridSectionList>
                    ...
                    <TextBlockWithImage width={100} widthUnit="%" SvgImage={LookIcon}
                        ...
                        <Paragraph bottomPadding={0} bottomMargin={0}>
                            ...
                            Don’t just look at other bakeries, you also need to see how many grocery stores and regular
                            cafes you have
                            in your area.
                        </Paragraph>
                    </TextBlockWithImage>
            ...
            <Container>
                <CenterBox>
                    ...
                    <Paragraph big>
                        ...
                        will help you get your thinking in order and show your commitment to your bakery business.
                    </Paragraph>
                    <Paragraph big>You will also need to look at financial projections for your bakery business. What
                        are your expected sales and revenues? What is your profitability? How much money will you keep
                        in the business to grow it? How much will you pay yourself and others?</Paragraph>
                    <Paragraph big>If you can, try to plan your revenue for the next month, three months, year and two
                        years. It’s vital to take into account the cost of setting up a bakery business in the first
                        place, also factoring in utility, staff and other costs.</Paragraph>
                    ...
                    <CountingTextBoxed number={3}>
                        <Paragraph bottomPadding={0} bottomMargin={0}>
                            A description of your bakery business, background information and context
                        </Paragraph>
                    </CountingTextBoxed>
            ...
            <BusinessOwnerResponsibilities>
                <ImageContent image="unique-business-2" paddingTop="60">
                    ...
                    <Paragraph big>There are five main business structures you can have in the US, and it’s important to
                        choose the right one. We’ve shared your options below. They are:</Paragraph>
                    ...
                    >
                        ...
                        <Paragraph big>If you don’t choose to form a legal business entity for your bakery business, you
                            will be a sole proprietor by default. This won’t give you the legal protections you need, so
                            we do not recommend this.</Paragraph>
                    </TextBlockWithImage>
                    ...
                    >
                        ...
                        <Paragraph big>This is a type of business that is formed when two or more people work together
                            ...
                            you all the protections your bakery business may need.’</Paragraph>
                    </TextBlockWithImage>
                    ...
                    >
                        ...
                        <Paragraph big>The most common type of business entity. An LLC is fast, simple and inexpensive
                            ...
                            start your bakery business.</Paragraph>
                    </TextBlockWithImage>
                    ...
                    <Paragraph big style={{paddingTop: "48px", paddingBottom: 0}} mixed={true}>
                        ...
                        guide to everything you need to do</Link>, and we can set one up for your bakery business. <Link
                        to="/llc-state-information/">LLC formation does vary from state to state</Link>, but
        ...
        <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"}
            ...
            <Paragraph big>A bakery is a great way to provide amazing food to friendly people, and is an industry that’s
                still seeing growth in the US. If you can find a great niche, understand your competitors and put
                together a solid business plan, you will have every chance for success</Paragraph>
        </Conclusion>
    </Layout>
);
