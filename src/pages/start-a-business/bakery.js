...
const Bakery = () => (
    <Layout>
        <SEO title="How to Start a Bakery Business"
        ...
        <Top ovalColor="sun-2" imageName="bakery-main-header" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
            ...
            <p>
                Bakeries are a growing industry in the US. It’s easy to see why,
                as people shop for their daily bread or seek out cakes and other sweet
                treats. Specialty baking is on the rise too, with products designed
                for people who have particular dietary choices or digestive issues.
            </p>
            <ButtonsBox>
            ...
            <TabsSection>
                ...
                <CollapseWrapper>
                    <PanelWrapper>
                        ...
                        <ListWrapper>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>
                                        Learn if a bakery business could
                                        be right for you
                                    </Paragraph>
                                </CkeckText>
                            </ListBox>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>
                                        Useful online tools for bakery
                                        business owners
                                    </Paragraph>
                                </CkeckText>
                            </ListBox>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>
                                        How to start your bakery business with information on equipment, employees,
                                        location, pernits, finance, taxes and more
                                    </Paragraph>
                                </CkeckText>
                            </ListBox>
                    ...
                    <PanelWrapper>
                        ...
                        <Paragraph big style={{marginBottom: "72px"}}>You might not think of the humble bakery as a
                            powerhouse for business, but the stats say otherwise!</Paragraph>
                        ...
                        <Paragraph big style={{
                            ...
                            marginTop: "20px",
                            marginBottom: 0
                        }}>The following products make up the bakery market in the US:</Paragraph>
        ...
        <SimpleSection>
            ...
            <Container>
                <CenterBox>
                    ...
                    <Paragraph big>
                        You will also need to look at financial projections for your bakery business. What are your
                    ...
                    <Paragraph big>
                        ...
                        vital to take into account the cost of setting up a bakery business in the first place, also
