...
const Bakery = () => (
  <Layout>
    ...
    <TabsWrapper>
      ...
      <TabsSection>
        <TabHeading>
          <TabTitle title="Bakery" SvgIcon={Tab1Icon} />
        ...
        <CollapseWrapper>
          <PanelWrapper>
            <Paragraph big>
              We want to help you get your bakery business off the ground. Since 2004, we’ve helped over 100,000 people to become entrepreneurs, starting exciting businesses and bringing their ideas to life. We’ll give you the support, guidance and advice you need to create a business and make it
              into a success.
            </Paragraph>

            <Heading size={3}>Here is our simple guide to starting up a successful bakery business.</Heading>
            ...
            <Heading size={3}>Read on for some insight into creating your own bakery business and becoming an entrepreneur.In this guide we will cover:</Heading>

            <Paragraph big>From exploring the types of business you can start, through research, to the legalities of setting up your business and the realities of your day to day operations, this guide is here to help.</Paragraph>
            ...
            <ListWrapper>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>Choose the right business structure for your bakery company</Paragraph>
                </CkeckText>
              </ListBox>
              ...
              <ListBox>
                <CkeckText>
                  <Paragraph big>How to start your bakery business with information on equipment, employees, location, pernits, finance, taxes and more</Paragraph>
                </CkeckText>
              </ListBox>
            </ListWrapper>
          </PanelWrapper>
          ...
          <PanelWrapper>
            ...
            <BlueBoxWithAbsoluteText absoluteText="11K" text="There are more than 11,000 bakery cafes in the US" />
            <BlueBoxWithAbsoluteText absoluteText="$300B" text="Bakery products make up over two percent of the GDP of the US, which works out to over $300 billion a year" />
            <BlueBoxWithAbsoluteText absoluteText="$350" text="Average spending of each US household on bakery products" />
            ...
            <Adventages headline="Sales from retail bakeries are expected to increase by over five percent a year" width="100%" />

            <Adventages headline="Two-thirds of bakeries have fewer than ten employees" width="100%" />

            <Adventages headline="Gluten-free baking is rapidly increasing in popularity, with almost 30 percent of people purchasing these products" width="100%" />
          </PanelWrapper>
          ...
          <PanelWrapper>
            ...
            <Adventages headline="Understanding customer demand for the products you’re intending to make" width="100%" />
            ...
            <Adventages headline="Working out the costs of ingredients, selling prices and profit margins" width="100%" />
            ...
            <Adventages headline="Good soft skills and talking to customers to find out what they want" width="100%" />

            <Adventages headline="Math skills so you can work out the ingredients you need and what you should sell products for" width="100%" />

            <Adventages headline="People management skills for your behind-the-scenes and front-of-house staff" width="100%" />
    ...
    <BlueContainer>
      ...
      <Container>
        <CenterBox>
          ...
          <Paragraph big>
            The thing to learn here is that it’s okay to say “no” to your first, second or third bakery business ideas. Very few entrepreneurs get it right first time. In fact, getting it wrong is often a badge of honor! Still, you don’t want to waste too much time, energy or money on the wrong
            initiatives, so ask and answer these questions honestly to find the right way forward.
          </Paragraph>
          <Paragraph big>Before committing too much time, energy and money into your new bakery business, it’s important to test the marketplace.</Paragraph>
        </CenterBox>
        ...
        <GridSectionList>
          ...
          <TextBlockWithImage width={100} widthUnit="%" SvgImage={LookIcon} imageBackgroundColor={color.green2} imageShadowColor={color.green2}>
            ...
            <Paragraph bottomPadding={0} bottomMargin={0}>
              Having competitors is a good thing as it shows there’s a market, but if there are too many local challengers, you’re likely to struggle without a really good unique selling point. Don’t just look at other bakeries, you also need to see how many grocery stores and regular cafes you have
              in your area.
            </Paragraph>
          </TextBlockWithImage>

          <TextBlockWithImage width={100} widthUnit="%" SvgImage={TalkIcon} imageBackgroundColor={color.orange2} imageShadowColor={color.orange2}>
          ...
          <TextBlockWithImage width={100} widthUnit="%" SvgImage={InvolvedIcon} imageBackgroundColor={color.purple2} imageShadowColor={color.purple2}>
    ...
    <SimpleSection>
      ...
      <Container>
        <CenterBox>
          ...
          <Paragraph big>You will also need to look at financial projections for your bakery business. What are your expected sales and revenues? What is your profitability? How much money will you keep in the business to grow it? How much will you pay yourself and others?</Paragraph>
          <Paragraph big>If you can, try to plan your revenue for the next month, three months, year and two years. It’s vital to take into account the cost of setting up a bakery business in the first place, also factoring in utility, staff and other costs.</Paragraph>
    ...
    <OrangeContainer>
      ...
      <BusinessOwnerResponsibilities>
        <ImageContent image="unique-business-2" paddingTop="60">
          ...
          <Paragraph big>There are five main business structures you can have in the US, and it’s important to choose the right one. We’ve shared your options below. They are:</Paragraph>
    ...
    <Conclusion to="/" buttonTitle="Start your Bakery Business with us, today">
      ...
      <Paragraph big>A bakery is a great way to provide amazing food to friendly people, and is an industry that’s still seeing growth in the US. If you can find a great niche, understand your competitors and put together a solid business plan, you will have every chance for success</Paragraph>
    </Conclusion>
  </Layout>
);
