...
const TeenBusiness = () => (
  <Layout>
    <SEO title="Business Ideas for Women" description="There are constant demands on your time as a woman - whether you have kids or not, the mix of a job, household chores and all the other responsibilities that creep into your day could lead you to think you don’t have time to run a business." />
    ...
    <TabsWrapper>
      ...
      <TabsSection>
        ...
        <CollapseWrapper>
          <PanelWrapper>
            <Paragraph big>Although starting a new business or running a business on the side can take a fair amount of time and effort, the rewards could be more than worth it.</Paragraph>
            <Paragraph big>
              Of course, as a woman, you know the trick is to have a business that integrates with your life, while still giving you the time you need to meet your commitments. There are many types of businesses a female entrepreneur can start to test the waters — and if you like one of them, you
              can grow it into providing a substantial part- or full-time income.
            </Paragraph>

            <Colorbox className="box" theme="icon" Icon={StarIcon} color={color.purple3} curve curveColor={color.purple1}>
          ...
          <PanelWrapper>
            <Heading size={3}>Why You Should Start a New Woman-Owned Business</Heading>
            ...
            <BlueBoxWithAbsoluteText absoluteText="12M" text="Businesses in the U.S. are owned by women" />
            <BlueBoxWithAbsoluteText absoluteText="$2.5T" text="Generated sales a year of women entrepreneurs as majority or joint business owners" />
            <BlueBoxWithAbsoluteText absoluteText="$1M" text="Sales a year or more by nearly one in 20 firms owned by women" />

            <CircleWithText textInsideCircle="40" textLine="Of privately - held businesses are owned by women" withBg={true} SvgChart={Chart} symbol="%" />

            <div style={{ marginBottom: "30px", marginTop: "48px" }}>
              <Adventages headline="Over the last 10 years, the number of women-owned businesses has grown by 45 percent (five times faster than the national average)" width="100%" />
            </div>

            <div style={{ marginBottom: "30px" }}>
              <Adventages headline="Nearly two-thirds of female entrepreneurs say their business is their main source of income" width="100%" />
            </div>

            <div style={{ marginBottom: "48px" }}>
              <Adventages headline="Women are more likely to start service businesses, especially around healthcare and education" width="100%" />
            </div>

            <Paragraph big>This is why businesses started by female entrepreneurs are so exciting - so how can you be part of that success? We're here to help you figure that out.</Paragraph>
          </PanelWrapper>
        </CollapseWrapper>
      </TabsSection>
    </TabsWrapper>
    ...
    <Conclusion to="/" buttonTitle="Why delay? Start your Business with us, today">
      ...
      <Paragraph big>
        When you’re ready to embark on your new entrepreneurial career, be sure to take a look at our Start a Business Checklist to get your business going in the best possible way. We’re confident you can find the perfect business to fit in with your lifestyle. The speed of growth for woman-owned
        businesses is necessary and inspiring. We hope you’ve found this guide useful, and that it sets you on the path to building the next great business as a female entrepreneur!
      </Paragraph>
    </Conclusion>
  </Layout>
);
