...
const EtsyBusiness = () => (
	<Layout>
		...
		>
			...
			<p>
				Etsy has opened up the world of creativity and ecommerce to a whole new
				generation of entrepreneurs. They make it easy for artisans and crafters
				to create innovative, curious, beautiful products and share them with
				the world.
			</p>
			<ButtonsBox>
				<Button
			...
			<ReactTabs content={tabs}>
				<TabPanel>
					<PanelWrapper>
						...
						<Paragraph big>
							What used to be the purview of craft fairs and market stands can
							now easily be sold online to a whole new audience.
						</Paragraph>
						<Paragraph big style={{ marginBottom: "48px" }}>
							...
							competition in the Etsy marketplace, so having a novel approach,
							creating origina designs and getting proper business discipline in
							place is essential.
						</Paragraph>
						...
						<Paragraph big>
							By the time you’ve read through our complete Etsy business guide,
							you will have all the information you need to set up and manage a
							thriving crafting business. Let’s get into it.
						</Paragraph>
					</PanelWrapper>
				</TabPanel>
				...
				<TabPanel>
					<PanelWrapper>
						...
						<Paragraph big style={{ marginBottom: "76px" }}>
							The size and opportunity in the Etsy marketplace might surprise
							you:
						</Paragraph>
						...
						<Paragraph big style={{ marginTop: "18px" }}>
							This all points to Etsy being ripe with new opportunities for
							focused entrepreneurs, so now might be the perfect time to dive
							into starting your Etsy business. Incfile is here to help you form
							your Etsy business and understand the ins and outs of owning a
							company.
						</Paragraph>
					</PanelWrapper>
				</TabPanel>
				...
				<TabPanel>
					<PanelWrapper>
						...
						<Paragraph big style={{ marginBottom: "48px" }}>
							With nearly 2 million sellers and 50 million products already in
							the Etsy marketplace, you need to stand out from the crowd if you
							want your Etsy business to be a success. This means understanding
							what your Etsy customers want from your products. We recommend
						...
						<Paragraph big style={{ marginBottom: "48px" }}>
							If you can combine these four areas together, you’ll have the
							perfect ingredients for a successful Etsy business.
						</Paragraph>
						...
						<Paragraph big>
							With sellers earning an average of under $2,000 on Etsy in a year,
							it’s clear that for many people Etsy just provides some side
							income. If you want to make Etsy a major revenue stream for you,
							that needs some strong focus and a disciplined approach. Here are
							the challenges and advantages you need to be aware of.
						</Paragraph>
						...
						<div style={{ marginBottom: "10px" }}>
							<AdventagesWithLongText title="Discipline" width="100%">
								...
								>
									You need to think of your Etsy shop as an independent business
									with all the focus that one requires. You should have proper
									plans and processes in place, practice strong financial
									management and have an in-depth understanding of your costs,
									sales prices, revenue and profit margins. Bear in mind that
									there are fees you need to pay to Etsy, as follows:
									<br />
									<br />
									<SpecialList>
										<li>
											Listing fee of 20 cents per item, payable every four
											months
										</li>
										<li>
											Commission of 3.5 percent of the selling price of each
											product
										</li>
										<li>
											Payment processing fee of 3 percent of the item selling
											price plus 20 cents
										</li>
									</SpecialList>
								</Paragraph>
		...
		<BlueContainer>
			...
			<Container>
				<CenterBox>
					...
					<TextCenterLayout
						headlineWidth={770}
						headline="Developing a Plan for Your Etsy Business"
					/>
					<Paragraph big>
						...
						your Etsy products, look at potential benefits and pitfalls,
					...
					<Paragraph big>
						Before you launch your Etsy business, you need to understand if
				...
				<GridSectionList>
					...
					>
						...
						<Paragraph bottomPadding={0} bottomMargin={0}>
							...
							a higher-quality service, faster delivery, unique products or some
							other special feature. Be sure to bring this out in what you do.
						</Paragraph>
					</TextBlockWithImage>
					...
					>
						...
						<Paragraph bottomPadding={0} bottomMargin={0}>
							Carefully review all the possible Etsy sellers who will be
							competing by selling similar products to you. Look at how they
							structure their shops, products and pricing. Think about what you
					...
					>
						...
						<Paragraph bottomPadding={0} bottomMargin={0}>
							...
							you’re offering before over-committing. Create prototypes of key
							products and test them in the marketplace to see if they generate
							interest and sales.
						</Paragraph>
					</TextBlockWithImage>
					...
					>
						...
						<Paragraph bottomPadding={0} bottomMargin={0}>
							...
							your Etsy products. See if you can identify new trends that you
							could take advantage of. Get involved in forums where your likely
					...
					>
						...
						<Paragraph bottomPadding={0} bottomMargin={0}>
							Ask questions about Etsy businesses. You can find links to some
				...
				<CenterBox>
					...
					<Paragraph big>
						You will also need to look at financial projections for your Etsy
						...
						it? How much will you pay yourself? If you can, try to plan your
		...
		<OrangeContainer>
			...
			<BusinessOwnerResponsibilities>
				<ImageContent image="unique-business-2" paddingTop="60">
					...
					<Paragraph big>
						Now that you have all the background information for your Etsy
						business, it’s time to legally form your business entity. Many
						people wonder if they should have an LLC for their Etsy business, or
						if you can run your Etsy shop as a sole proprietor. In most cases,
						our recommendation is to set up an LLC so you can separate your
						business and personal assets—but the right business structure for
						you depends on your business needs. In the U.S., there are five main
					...
					>
						...
						<Paragraph big>
							...
							finances and assets and keeps them separate from those of your
							business.
						</Paragraph>
					</TextBlockWithImage>
					...
					<Paragraph
						...
						mixed={true}
					>
						If you're ready to start your Etsy LLC, you can check out our{" "}
						<Link to="/form-an-llc/">LLC formation guide for your state</Link>,
						or have Incfile take care of all the paperwork for you.
					</Paragraph>
		...
		>
			...
			<Paragraph big>
				Etsy is a very empowering marketplace. In particular it’s a great way
				for female entrepreneurs to get started and with the right approach and
				discipline, it can grow from being a side project to becoming a powerful
				revenue stream. Follow the advice in this Etsy guide, and you’ll be able
				to create an Etsy business selling beautiful and amazing crafted
