...
const EtsyBusiness = () => (
  <Layout>
    <SEO title="How to Start an Etsy Business" description="Etsy has opened up the world of creativity and ecommerce to a whole new generation of entrepreneurs." />
      ...
      <TabsSection>
        ...
        <CollapseWrapper>
          <PanelWrapper>
            ...
            <Paragraph big>What used to be the purview of craft fairs and market stands can now easily be sold online to a whole new audience.</Paragraph>
            ...
            <Heading size={3} style={{ marginBottom: "24px", fontSize: "20px" }}>
            ...
            <ListWrapper>
              <ListBox>
                <CkeckText>
                  <Paragraph big>Understanding the world of Etsy</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Paying taxes for your Etsy business</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Deciding if you’re ready to start an Etsy business</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Hiring employees, managing finances and administering your Etsy business</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Planning out your Etsy business</Paragraph>
                </CkeckText>
              </ListBox>

              <ListBox>
                <CkeckText>
                  <Paragraph big>Locating other resources for your Etsy business</Paragraph>
                </CkeckText>
              </ListBox>
            ...
            <Paragraph big>By the time you’ve read through our complete Etsy business guide, you will have all the information you need to set up and manage a thriving crafting business. Let’s get into it.</Paragraph>
          </PanelWrapper>
          ...
          <PanelWrapper>
            ...
            <BlueBoxWithAbsoluteText absoluteText="1.7M" text="Sellers on Etsy in 2016, making on average $1,800 each" />
            <BlueBoxWithAbsoluteText absoluteText="300M" text="People purchased goods on Etsy in 2016, spending an average of around $100 each" />
            <BlueBoxWithAbsoluteText absoluteText="$3B" text="Worth of goods were sold through Etsy in 2016" />

            <ColorFulCircleWithTextAndList CircleSVG={ColorfulRing2} title={RingText.title} list={RingText.list} withBg={true} />

            <div style={{ marginTop: "48px" }}>
              <Adventages headline="Etsy is in the top 10 most popular e-commerce websites in the U.S." width="100%" />
            </div>

            <Adventages headline="Nearly 55 million people use the platform" width="100%" />

            <Adventages headline="There are around 50 million products listed for sale on Etsy" width="100%" />

            <Paragraph big style={{ marginTop: "18px" }}>
              This all points to Etsy being ripe with new opportunities for focused entrepreneurs, so now might be the perfect time to dive into starting your Etsy business. Incfile is here to help you form your Etsy business and understand the ins and outs of owning a company.
            </Paragraph>
          </PanelWrapper>
          ...
          <PanelWrapper>
            ...
            <Paragraph big>
              With sellers earning an average of under $2,000 on Etsy in a year, it’s clear that for many people Etsy just provides some side income. If you want to make Etsy a major revenue stream for you, that needs some strong focus and a disciplined approach. Here are the challenges and
            ...
            <div style={{ marginBottom: "10px" }}>
              <AdventagesWithLongText title="Discipline" width="100%">
                <Paragraph big mixed={true} style={{ marginBottom: 0, paddingBottom: 0 }}>
                  You need to think of your Etsy shop as an independent business with all the focus that one requires. You should have proper plans and processes in place, practice strong financial management and have an in-depth understanding of your costs, sales prices, revenue and profit margins.
                  Bear in mind that there are fees you need to pay to Etsy, as follows:
                  <br />
                  <br />
                  <SpecialList>
                    ...
                    <li>Payment processing fee of 3 percent of the item selling price plus 20 cents</li>
                  </SpecialList>
                </Paragraph>
    ...
    <BlueContainer>
      ...
      <Container>
        <CenterBox>
          ...
          <Paragraph big>Before you launch your Etsy business, you need to understand if there’s a demand for what you’re selling. That means carrying out market research and “validating” your products and services. Here’s how to go about it:</Paragraph>
        </CenterBox>
        ...
        <CenterBox>
          <Heading size={3}>Understand Your Etsy Business Model and Financial Projections</Heading>
          ...
          <Paragraph big>
            You will also need to look at financial projections for your Etsy business. What are your expected sales and revenues? What is your profitability? How much money will you keep in the business to grow it? How much will you pay yourself? If you can, try to plan your revenue for the next
            month, three months, year and two years.
          </Paragraph>
        </CenterBox>
      </Container>
    </BlueContainer>
    ...
    <OrangeContainer>
      ...
      <BusinessOwnerResponsibilities>
        <ImageContent image="unique-business-2" paddingTop="60">
          ...
          <Paragraph big>
            Now that you have all the background information for your Etsy business, it’s time to legally form your business entity. Many people wonder if they should have an LLC for their Etsy business, or if you can run your Etsy shop as a sole proprietor. In most cases, our recommendation is to
            set up an LLC so you can separate your business and personal assets—but the right business structure for you depends on your business needs. In the U.S., there are five main business structures. They are:
          </Paragraph>
          ...
          >
            ...
            <Paragraph big>The most common type of business entity. An LLC is fast, simple and inexpensive to setup and maintain. It protects your personal finances and assets and keeps them separate from those of your business.</Paragraph>
          </TextBlockWithImage>
...
<Paragraph big style={{ color: color.blue1, fontWeight: "bold" }} mixed={true}>
          ...
          <Button theme="primary48" arrow width="365px" content={{ url: `${process.env.ORDER_URL}/form-order-now.php`, text: `Start your business with us, today!` }}>
    ...
    <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"} buttonTitle="Start your Etsy Business with us, today">
      <Heading size={3} style={{ fontSize: "40px" }}>
        Conclusion
      </Heading>
      <Paragraph big>
        Etsy is a very empowering marketplace. In particular it’s a great way for female entrepreneurs to get started and with the right approach and discipline, it can grow from being a side project to becoming a powerful revenue stream. Follow the advice in this Etsy guide, and you’ll be able to
        create an Etsy business selling beautiful and amazing crafted products to the world.
      </Paragraph>
    </Conclusion>
  </Layout>
);
