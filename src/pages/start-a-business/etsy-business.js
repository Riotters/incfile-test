...
import {RingText, tabs, toolsList} from "../../static/type-of-business/etsy-business";
...
const EtsyBusiness = () => (
    <Layout>
        ...
        <Top ovalColor="yellow" imageName="etsy-bussines" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
            ...
            <p>Etsy has opened up the world of creativity and ecommerce to a whole new generation of entrepreneurs. They
                make it easy for artisans and crafters to create innovative, curious, beautiful products and share them
                with the world.</p>
            <ButtonsBox>
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Paragraph big>What used to be the purview of craft fairs and market stands can now easily be
                            sold online to a whole new audience.</Paragraph>
                        <Paragraph big style={{marginBottom: "48px"}}>
                            If you want to be a successful Etsy entrepreneur, you need a strong, robust plan for your
                            new business. There’s plenty of competition in the Etsy marketplace, so having a novel
                            approach, creating origina designs and getting proper business discipline in place is
                            essential.
                        </Paragraph>
                        ...
                        <ListWrapper>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>Hiring employees, managing finances and administering your Etsy
                                        business</Paragraph>
                                </CkeckText>
                            </ListBox>
                        ...
                        <Paragraph big>By the time you’ve read through our complete Etsy business guide, you will have
                            all the information you need to set up and manage a thriving crafting business. Let’s get
                            into it.</Paragraph>
                    </PanelWrapper>
                </TabPanel>
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <div style={{marginTop: "48px"}}>
                            <Adventages headline="Etsy is in the top 10 most popular e-commerce websites in the U.S."
                                        width="100%"/>
                        </div>

                        <Adventages headline="Nearly 55 million people use the platform" width="100%"/>

                        <Adventages headline="There are around 50 million products listed for sale on Etsy"
                                    width="100%"/>
                        ...
                        <Paragraph big style={{marginTop: "18px"}}>
                            ...
                            you form your Etsy business and understand the ins and outs of owning a company.
                        </Paragraph>
                    </PanelWrapper>
                </TabPanel>
                ...
                <TabPanel>
                    <PanelWrapper>
                        ...
                        <Paragraph big style={{marginBottom: "48px"}}>
                            ...
                            need to stand out from the crowd if you want your Etsy business to be a success. This means
                        ...
                        <Paragraph big>
                            ...
                            for you, that needs some strong focus and a disciplined approach. Here are the challenges
                            and
                        ...
                        <div style={{marginBottom: "10px"}}>
                            <AdventagesWithLongText title="Discipline" width="100%">
                                <Paragraph big mixed={true} style={{marginBottom: 0, paddingBottom: 0}}>
                                    ...
                                    that one requires. You should have proper plans and processes in place, practice
                                    strong financial management and have an in-depth understanding of your costs, sales
                                    prices, revenue and profit margins.
        ...
        <BlueContainer>
            ...
            <Container>
                <CenterBox>
                    ...
                    <Paragraph big>Before you launch your Etsy business, you need to understand if there’s a demand for
                        what you’re selling. That means carrying out market research and “validating” your products and
                        services. Here’s how to go about it:</Paragraph>
                </CenterBox>
            ...
            <BusinessOwnerResponsibilities>
                <ImageContent image="unique-business-2" paddingTop="60">
                    ...
                    <Paragraph big>
                        ...
                        form your business entity. Many people wonder if they should have an LLC for their Etsy
                        business, or if you can run your Etsy shop as a sole proprietor. In most cases, our
                        recommendation is to
                        set up an LLC so you can separate your business and personal assets—but the right business
                        structure for you depends on your business needs. In the U.S., there are five main business
                        structures. They are:
                    </Paragraph>
                    ...
                    >
                        ...
                        <Paragraph big>The most common type of business entity. An LLC is fast, simple and inexpensive
                            to setup and maintain. It protects your personal finances and assets and keeps them separate
                            from those of your business.</Paragraph>
                    </TextBlockWithImage>
                    ...
                    <Paragraph big style={{paddingTop: "48px", paddingBottom: 0}} mixed={true}>
                        If you're ready to start your Etsy LLC, you can check out our <Link to="/form-an-llc/">LLC
                        formation guide for your state</Link>, or have Incfile take care of all the paperwork for you.
                    </Paragraph>

                    <Button theme="primary48" arrow width="365px" content={{
        ...
        <Conclusion to={process.env.ORDER_URL + "/form-order-now.php"}
                    buttonTitle="Start your Etsy Business with us, today">
            ...
            <Paragraph big>
                ...
                powerful revenue stream. Follow the advice in this Etsy guide, and you’ll be able to
