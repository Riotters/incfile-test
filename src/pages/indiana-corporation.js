...
import { info,  questions, service, top, articlesOfIncorporation } from "../static/learning-center-entity/indiana-corporation";
...
const AlaskaCorporation = () => {
    ...
    return (
        <Layout>
            <SEO title="Form a Corporation or LLC in Indiana Today | Incfile" description="Incorporating in Indiana is a snap. Find everything from filing fees and schedules, operating agreements, articles of incorporation and more." />
                ...
                <TabsSection>
                    ...
                    <CollapseWrapper>
                        ...
                        <PanelWrapper>
                            ...
                            <Paragraph big>Since Indiana law does not use the concept of par value for stocks, you do not need to state a par value for your shares. The filing fee is a flat fee, rather than being based on your authorized shares, so you can authorize as many as desired.</Paragraph>
                        </PanelWrapper>
                        <PanelWrapper>
                            <Heading size={3} style={{ marginBottom: "24px" }}>
                        ...
                        <PanelWrapper>
                            ...
                            <TextBoxed style={{ marginBottom: "8px" }}>
                                <Paragraph bottomMargin={0}>The street address of the corporation’s registered office</Paragraph>
                            </TextBoxed>
                            <TextBoxed style={{ marginBottom: "8px" }}>
                                <Paragraph bottomMargin={0}>The name of its registered agent at that in-state office</Paragraph>
                            </TextBoxed>
                            <TextBoxed style={{ marginBottom: "8px" }}>
                        ...
                        <PanelWrapper>
                            ...
                            <Paragraph big>Indiana’s corporate tax structure consists of a flat rate of 8.5 percent on all corporate income. Among states levying corporate income taxes, Indiana’s top rate ranks 13th highest nationally.</Paragraph>
                        </PanelWrapper>
                    </CollapseWrapper>
                </TabsSection>
            </TabsWrapper>
