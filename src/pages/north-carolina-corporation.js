...
import {  info, questions, service, top, articlesOfIncorporation } from "../static/learning-center-entity/north-carolina-corporation";
...
const AlaskaCorporation = () => {
    ...
    return (
        <Layout>
            <SEO title="Form a Corporation or LLC in North Carolina Today | Incfile" description="Incorporating in North Carolina is simple. Get access to filing times and fees, document checklists, FAQs and more." />
