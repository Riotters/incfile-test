...
const VirtualMailBoxes = () => (
    <Layout>
        <SEO title="Pennsylvania Virtual Mailbox & Mail Scanning Service" description="Need a business address in PA? Our virtual mailbox service gives you a real street address and lets you get your mail no matter where you are. Learn more." />
        <VirtualMailboxTopSection content={top} state="Pennsylvania" />
