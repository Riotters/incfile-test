...
import {advantages, faqs, top} from "../static/learning-center-entity/new-york-virtual-mailboxes";
...
const VirtualMailBoxes = () => (
    <Layout>
        <SEO title="New York Virtual Mailbox & Mail Scanning Service" description="Need a business address in NY? Our virtual mailbox service gives you a real street address and lets you get your mail no matter where you are. Learn more." />
        <VirtualMailboxTopSection content={top} state="New York" />
