...
import {advantages, faqs, top} from "../static/learning-center-entity/arizona-virtual-mailboxes";
...
const VirtualMailBoxes = () => (
    <Layout>
        <SEO title="Arizona Virtual Mailbox & Mail Scanning Service" description="Need a business address in AZ? Our virtual mailbox service gives you a real street address and lets you get your mail no matter where you are. Learn more." />
