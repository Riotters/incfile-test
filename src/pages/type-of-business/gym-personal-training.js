    ...
    <Layout>
        ...
        <Top ovalColor="blue" imageName="gym-personal-training-main" imageAlt="Mr Bulb with seedling"
            ...
            <p>
                ...
                for many of us. From new diets to innovative exercise regimes,
        ...
        <TabsWrapper>
            ...
            <TabsSection style={{marginTop: "100px"}}>
                ...
                <CollapseWrapper>
                    <PanelWrapper>
                        <Paragraph big>
                            If you’ve got an interest in exercise or personal training and want to turn that expertise
                            into a business, then opening up a fitness-based business could be right for you.
                        </Paragraph>
                        <Paragraph big>
                            You’ve got plenty of choices depending on your budget, target clients and ideas for
                            marketing your gym or personal training venture.
                        </Paragraph>
                        ...
                        <Colorbox className="box" theme="icon" Icon={MegafornIcon} color={color.blue3} curve
                            ...
                            <Paragraph bottomPadding={0} bottomMargin={0}>
                                ...
                                the healthy lifestyle business revolution.
                            </Paragraph>
                        </Colorbox>
                        ...
                        <ListWrapper>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>
                                        Helpful software for gym, fitness
                                        or personal training business owners
                                    </Paragraph>
                                </CkeckText>
                            </ListBox>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>
                                        How to start your gym, fitness
                                        or personal training business with information on equipment, employees,
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>
                                        Learn if a gym, personal training
                                        or other type of fitness business could be right for you
                                    </Paragraph>
                                </CkeckText>
                            </ListBox>
                        </ListWrapper>
                    ...
                    <PanelWrapper>
                        ...
                        <Paragraph big>
                            You might wonder if now is the right time to open your own gym or get into personal
                            training. The answer is a resounding “yes.” Here’s how the fitness industry
                            is performing:
                        </Paragraph>
                        ...
                        <BlueBoxWithAbsoluteText absoluteText="7%"
                                                 text="Growth of fitness industry in the U.S. a year."/>
                        <BlueBoxWithAbsoluteText absoluteText="$27.5B"
                    ...
                    <PanelWrapper>
                        ...
                        <Paragraph big>
                            The following skills will be very useful in your role as a fitness-based small business
                            owner.
                        </Paragraph>
                        ...
                        <Paragraph big>
                            Although many people have the same basic needs from a fitness business - losing weight,
                            building endurance, getting stronger and improving general health - your clients' needs can
                            vary widely beyond that. Think about the types of customers you’re appealing to:
                        </Paragraph>

                        <div style={{marginBottom: "10px"}}>
                            <TextBoxed>
                                <Paragraph big bottomMargin={0}>
                                    Some might be training for a specific event like a marathon, Ironman
                                    or other medium- to long-term goal.
                                </Paragraph>
                            </TextBoxed>
                        </div>
        ...
        <Conclusion to="/" buttonTitle="Start your Daycare Business with us, today">
            ...
            <Paragraph big>
                The need for engaging, powerful ways to build our strength, endurance, fitness and well-being isn’t
                going away. Build on these opportunities by starting your own gym or personal training business and
