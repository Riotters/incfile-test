    ...
    <Layout>
        ...
        <TabsSection style={{marginTop: "100px"}}>
            ...
            <CollapseWrapper>
                <PanelWrapper>
                    <Paragraph big>
                        If you’ve got an interest in exercise or personal training and want to turn that expertise into a business, then opening up a fitness-based business could be right for you.
                    </Paragraph>
                    <Paragraph big>
                    ...
                    <Colorbox className="box" theme="icon" Icon={MegafornIcon} color={color.blue3} curve
                        ...
                        <Paragraph bottomPadding={0} bottomMargin={0}>
                            Here at Incfile, we know the answer, and we’ve shared it with more than 100,000 people who we've helped to form their businesses. Since 2004, we’ve supported gym, fitness or personal training entrepreneurs just like you, and we’re proud to have been a part of the healthy lifestyle business revolution.
                        </Paragraph>
                    </Colorbox>
                        ...
                        <ListBox>
                            <CkeckText>
                                <Paragraph big>
                                    ...
                                    or personal training business with information on equipment, employees, location, permits, finance, taxes and more
                                </Paragraph>
                            </CkeckText>
                        </ListBox>
                ...
                <PanelWrapper>
                    ...
                    <Paragraph big>
                        You might wonder if now is the right time to open your own gym or get into personal training. The answer is a resounding “yes.” Here’s how the fitness industry
                        is performing:
                    </Paragraph>
