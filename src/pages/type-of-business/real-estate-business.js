...
import TypeBusiness from "../../atomic/sections/type-of-business/real-estate-business/type-business";
import ValidatingBusinessIdea
    from "../../atomic/sections/type-of-business/real-estate-business/validating-business-idea";
import BusinessPlan from "../../atomic/sections/type-of-business/real-estate-business/business-plan";
...
import Regulations from "../../atomic/sections/type-of-business/real-estate-business/regulations";
import InsuranceBusiness from "../../atomic/sections/type-of-business/real-estate-business/insurance-business";
import Taxes from "../../atomic/sections/type-of-business/real-estate-business/taxes";
...
const RealEstateBusiness = () => (
    <Layout>
        ...
        <Top ovalColor="sun" imageName="real-estate-main" imageAlt="Mr Bulb with seedling"
             headlineWidth={700}>
            <h1>How to Start a Real Estate Business</h1>
            <p>
                Whether you want to buy, sell, develop, or rent out real
                estate, there are plenty of opportunities in the residential
            ...
            <CollapseWrapper>
                <PanelWrapper>
                    ...
                    <Paragraph big>
                        ...
                        sell, develop, or rent out real estate, there are plenty of opportunities in the residential and
                        commercial sectors. You can make great money, love your job and provide a home for individuals,
                    ...
                    <Paragraph big>
                        In this guide, we’ll explore everything you need to do to set up your real estate investment
                        business and maximize your chances for success. We’ll cover:
                    </Paragraph>
                    ...
                    <ListWrapper>
                        ...
                        <ListBox>
                            <CkeckText>
                                <Paragraph big>
                                    Questions you should ask to see if you’re ready to start a real estate investing
                                    business
                                </Paragraph>
                            </CkeckText>
                        </ListBox>
                    ...
                    <Paragraph big>
                        By the time you’ve read through our complete real estate investing business guide, you'll have
                        all the information you need to set up and manage a thriving real estate business. Let’s get
                        into it.
                    </Paragraph>
                ...
                <PanelWrapper>
                    ...
                    <Paragraph big>
                        ...
                        focused entrepreneurs, so now might be the perfect time to dive into starting your real estate
                        investment business. Incfile is here to help you form your business and understand the ins and
                        outs of owning a real estate company.
                    </Paragraph>
                    <Paragraph big>
                    ...
                    <Paragraph big>
                        There are several ways to create a real estate investing business, depending on your focus. This
                        might be through buying a property, renovating it and making improvements, then selling it on at
                        a profit. Alternatively, you might buy up a number of units and rent them out or make money in
                        some other way such as vacation accommodation or Airbnb.
                    </Paragraph>
                    ...
                    <Paragraph big>
                        If you want to get into the real estate investing business yourself, you need to decide the
                    ...
                    <Paragraph big>
                        Once you know the type of real estate business you want to run, you need to identify the size of
                        the market and number of customers in your local area. Explore how successful and volatile the
                        property market is and establish the likely number of individuals or businesses buying, renting,
                        developing or selling real estate on a yearly basis.
                    </Paragraph>
                    <Paragraph big>
                        See how many competitors there are in your local real estate markets. A lot of competitors isn’t
                        necessarily a bad thing; it could mean there’s plenty of demand. Get involved in local real
                        estate discussion groups and ask questions about your regional market. You can even offer to
                        take other real estate investors or business owners out to coffee to ask them questions about
                        what it's like to run a real estate investment business in your region.
                    </Paragraph>
                    <Paragraph big>
                        This initial time spent fact-finding will make sure you're pursuing a viable business
                        opportunity.
                    </Paragraph>
                    ...
                    <Paragraph big>
                        When it comes to real estate, your customers will have different needs depending on the type of
                    ...
                    <Paragraph big>
                        If you can get these in place and explain your unique selling points, you'll have a good chance
                ...
                <PanelWrapper>
                    ...
                    <Paragraph big>
                        Running a real estate investment business isn't for everyone — it can be a stressful experience!
                        You will need a combination of resilience, project management and deal-making skills, as well as
                        the ability to manage clients, contractors and high-pressure deadlines.
                    </Paragraph>
                    <Paragraph big>
                        You will often be working long hours or on weekends, especially as you're starting your new
                        business. You need patience, chutzpah and the ability to juggle multiple tasks to succeed. Plus,
                    ...
                    <Paragraph big>
                        Your main challenges will likely involve dealing with real estate property development, handling
                        negotiations, managing a very busy schedule and keeping your clients happy. You will likely have
                        a very full voicemail and email inbox and will need to put aside plenty of time for
                        communications.
                    </Paragraph>
                    <Paragraph big>
                        You will also need effective marketing, especially if your local real estate investing market is
                        very competitive. Look into partnering with other related businesses for mutual benefit.
                    </Paragraph>
                    ...
                    <Paragraph big mixed={true} style={{marginTop: "48px"}}>
                        Check out our additional guidance in <span className="big blue">understanding if a real estate business is right for you</span>.
                        In this blog post, we'll help you analyze your real estate business idea, conduct market
