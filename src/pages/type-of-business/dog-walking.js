...
import ValidatingBusinessIdea
    from "../../atomic/sections/type-of-business/dog-walking/validating-business-idea";
        ...
        <TabsSection style={{marginTop: "100px"}}>
            ...
            <CollapseWrapper>
                <PanelWrapper>
                    ...
                    <Paragraph big>
                        You might not think of dog walking or pet sitting as a formal business, but with enough effort
                        it could become an excellent way for you to make money as an animal lover. It’s not just dog
                        walking or pet sitting either - doggy day cares, grooming studios and kennels are all in demand.
                    </Paragraph>
                    ...
                    <Colorbox className="box" theme="icon" Icon={MegafornIcon} color={color.green3} curve
                        ...
                        <Paragraph bottomPadding={0} bottomMargin={0}>
                            ...
                            canine business. From exploring the types of business you can start, to doing research, to
                            learning about the legalities of setting up your business and the realities of your day to
