    ...
    <Layout>
        ...
        <TabsSection style={{marginTop: "100px"}}>
            ...
            <CollapseWrapper>
                <PanelWrapper>
                    <Paragraph big>
                        We’ll cut through the hype and mystery, explain what blockchain is, and help you understand if your business could benefit from becoming
                    ...
                    <Paragraph big>
                        At its simplest, blockchain technology allows for the sharing of information and transactions between multiple people, businesses, software and others. Blockchain technology is exciting because it’s a digitized, decentralized, verifiable, immutable ledger. Let’s dig into what each
                    ...
                    <Colorbox className="box" theme="icon" Icon={MegafornIcon} color={color.green3} curve
                        ...
                        <Paragraph bottomPadding={0} bottomMargin={0}>
                            ...
                            it forms a new “block.” Each new block is connected to the previous one to create a “chain,” hence “blockchain.”
                        </Paragraph>
                    </Colorbox>
                ...
                <PanelWrapper>
                    ...
                    <Paragraph big>
                        ...
                        as cryptocurrencies like Bitcoin. While blockchain is the underlying technology that powers cryptocurrencies, blockchain has far wider utility and more use cases than virtual money. We recommend staying away from cryptocurrency-related blockchain businesses for several reasons:
                    </Paragraph>
                ...
                <PanelWrapper>
                    ...
                    <Paragraph big>
                        ...
                        it’s important to consider the disadvantages of blockchain technology when deciding if it's right for your company. Here are some examples:
                    </Paragraph>
                    ...
                    <div style={{marginBottom: "10px"}}>
                        <TextBoxed>
                            <Paragraph big bottomMargin={0}>
                                ...
                                a blockchain application, as it’s a different approach to software development and usage
                            </Paragraph>
                        </TextBoxed>
                    </div>
