    ...
    <Layout>
        ...
        <Top ovalColor="babyblue" imageName="side-business-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
            ...
            <p>
                ...
                a side business alongside your normal job, so you’re reducing
                your risk and have a fallback position if the side business
                doesn’t work out.
            </p>
            <ButtonsBox>
        ...
        <SimpleSection>
            ...
            <Container>
                <CenterBox>
                    <Heading>
                        Your Side Business Needs
                        a Business Plan
                    </Heading>

                    <Paragraph big>
                        It’s easy to think you won’t need a business plan for a side business, but they can give you a
                        surprising number of benefits (especially if you want to expand your business). A business plan
                        will help you define your side business, market yourself, get sales, make a profit and grow.
                    </Paragraph>
                    <Paragraph big>
        ...
        <Conclusion to="/" buttonTitle="Start your Etsy Business with us, today">
            ...
            <Paragraph big>
                ...
                overhead, and with the right location you will have a resilient income stream for years to come. Do your
                research and find the right space; you can develop a thriving laundromat business to serve the needs of
                your local community and provide you with a good living.
            </Paragraph>
        </Conclusion>
    </Layout>
);
