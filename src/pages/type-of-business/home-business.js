...
const HomeBusiness = () => (
    <Layout>
        <SEO title="How to Start a Home-Based Business"
        ...
        <Top ovalColor="green" imageName="home-business-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
            ...
            <p>
                Starting a new business can be a major undertaking, so for entrepreneurs wanting to start off small, a
                home-based business is a great idea.
                ...
                <CollapseWrapper>
                    <PanelWrapper>
                        <Paragraph big style={{marginBottom: "40px"}}>
                            ...
                            full-time income for you and your family. These types
                            of “lifestyle” businesses are becoming increasingly popular, and provide the freedom and
                            satisfaction of running your own business while avoiding much of the risk that a
                            larger-scale venture would create.
                        </Paragraph>
                        ...
                        <Colorbox className="box" theme="icon" Icon={MegafonIcon} color={color.purple3} curve
                            ...
                            <Paragraph bottomMargin={0}>
                                Since 2004, we’ve helped over 250,000 people to become entrepreneurs, starting exciting
                                businesses and bringing their ideas
                                to life. We’ll give you the support, guidance and advice you need
                                to start a business from home and make it into a success.
                            </Paragraph>
