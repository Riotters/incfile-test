...
const SummerBusiness = () => (
    <Layout>
        ...
        <Top ovalColor="babyblue" imageName="summer-business-main" imageAlt="Mr Bulb with seedling"
             headlineWidth={700}>
            <h1>How to Start a Summer Business</h1>
            <p>
                If you’re not ready to jump into running your own business full time,
                a summer business could be ideal. These types of ventures are seasonal
                and designed around the warmer times of the year,when tourists travel
