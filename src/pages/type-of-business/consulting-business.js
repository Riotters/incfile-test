...
import ValidatingBusinessIdea from "../../atomic/sections/type-of-business/consulting-business/validating-business-idea";
import BusinessPlan from "../../atomic/sections/type-of-business/consulting-business/business-plan";
...
import Regulations from "../../atomic/sections/type-of-business/consulting-business/regulations";
import InsuranceBusiness from "../../atomic/sections/type-of-business/consulting-business/insurance-business";
import Taxes from "../../atomic/sections/type-of-business/consulting-business/taxes";
    ...
    <Layout>
        ...
        <TabsSection>
            ...
            <CollapseWrapper>
                <PanelWrapper>
                    <Paragraph big>
                        Other businesses hire consulting experts because they want to “buy in” expert opinions, ideas
                        and resources that don’t exist in their organization already. If you have a proven track record
                        of transforming businesses for the better, you can turn that into paid insight, exchanging your
                    ...
                    <Paragraph big style={{marginTop: "48px"}}>
                        ...
                        consulting business is a great business to start if you want to make a great income and not work
                        very many hours.
                    ...
                    <Paragraph big style={{fontWeight: "bold", marginTop: "48px"}}>
                        By the time you’ve read through our complete consulting business guide, you will have all the
                        information you need to set up and manage a thriving consulting business. Let’s get into it.
                    </Paragraph>

                    <Button arrow theme="primary48"
                            content={{text: "Download: Start a Consulting Business Guide", url: "/"}} width="444px"/>
                ...
                <PanelWrapper>
                    ...
                    <Paragraph big>
                        ...
                        entrepreneurs, so now might be the perfect time to dive into starting your consulting business.
                    ...
                    <Paragraph big style={{marginBottom: "52px"}}>
                        The consulting space is dominated by several major businesses including PwC, Deloitte, Ernst and
                        Young, Boston Consulting Group, McKinsey, Accenture, IBM and KPMG. But don't be deterred — there
                ...
                <PanelWrapper>
                    ...
                    <Paragraph big>
                        ...
                        problems, spend time analyzing those issues and come up with practical examples of how to make
                        changes.
                    </Paragraph>
                    <Paragraph big>
                        Being a consultant is all about “demonstrating your value.” Businesses will be expecting
                        excellent results for the fees they are paying, so it’s all about delivering in accordance with
                        those expectations.
                    </Paragraph>
                    ...
                    <Paragraph big>
                        The specific skills, expertise and experience for a consultant depend on the niche you decide to
                    ...
                    <Paragraph big>
                        Consultants come across many challenges. These start with finding clients — consultant services
                        can be expensive, so building up a network of good leads and opportunities is vital. You will
                    ...
                    <Paragraph big>
                        ...
                        experience to understand what is going on below the surface of an issue and then use tools and
                    ...
                    <Paragraph big>
                        ...
                        managers, business analysts and operations experts to check that your recommendations are being
        ...
        <Conclusion to="/" buttonTitle="Start your Event Planning Business with us, today">
            ...
            <Paragraph big>
                If you have experience and insight into a particular industry, sector or niche, then consulting could be a viable business option for you. Combine your experience with an innovative approach, strong skills, and proven results, and you will be off to a great start in your new career as a consultant.
            </Paragraph>
        </Conclusion>
    </Layout>
);
