...
import Tab1Icon from "../../images/icons/bookstore.inline.svg";
import Tab2Icon from "../../images/icons/light.inline.svg";
import Tab3Icon from "../../images/icons/series-is-this-business-for-you.inline.svg";
import Tab4Icon from "../../images/icons/focus.inline.svg";
...
const GymPersonalTraining = () => (
    <Layout>
        <SEO title="How to Open an Independent Bookstore Business"
        ...
        <Top ovalColor="sun" imageName="bookstore-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
            ...
            <p>
                A bookstore is one of the most enduring and traditional types of business
                you could open. Despite this, there have been plenty of challenges to the
                bookstore model over the last few years, with the increase in ecommerce,
                the rise of Amazon and the move toward ebooks.
            </p>
            <ButtonsBox>
        ...
        <TabsSection style={{marginTop: "100px"}}>
            ...
            <CollapseWrapper>
                <PanelWrapper>
                    <Paragraph big>
                        Against this background, you might wonder if it’s worth opening
                        up a book shop — the good news is that with some careful planning and research, you could create
                        a successful store that spreads information, entertainment and delight.
                    </Paragraph>
                    <Paragraph big>
                        Of course it might not be easy, but entrepreneurs with the right approach can turn a passion for
                        literature and manuscripts into a center
                        of knowledge that your customers will love.
                    </Paragraph>
                    ...
                    <Colorbox className="box" theme="icon" Icon={MegafornIcon} color={color.green3} curve
                        ...
                        <Paragraph bottomPadding={0} bottomMargin={0}>
                            We’ve supported over 100,000 people to form their business and provided answers, guidance
                            and support to transform them into entrepreneurs. We’ll guide you through what you need to
                            know
                            to start your bookstore business and get it off the ground.
                        </Paragraph>
                    </Colorbox>

                    <Paragraph big style={{marginTop: "48px", fontWeight: "bold"}}>
                        Read on for some insight into creating your own bookstore business and becoming an entrepreneur.
                    ...
                    <ListWrapper>
                        ...
                        <ListBox>
                            <CkeckText>
                                <Paragraph big>
                                    Setting up your bookstore business (including location, equipment, employees, taxes,
                ...
                <PanelWrapper>
                    ...
                    <Paragraph big>
                        This might be surprising given the size and influence of Amazon and digital media, but people
                        are moving away from their screens to the comfort of the pages of a good story.
                    </Paragraph>
                    <Paragraph big>
                        There are some great reasons to start a new bookstore business in the U.S. Aside from giving
                        life to your interest in great writing, it’s also a good opportunity to build a community around
                        literature and make some money. Here are some of the facts around bookshops:
                    </Paragraph>
                    ...
                    <BlueBoxWithAbsoluteText absoluteText="2,3000"
                ...
                <PanelWrapper>
                    ...
                    <Paragraph big style={{marginBottom: "48px"}}>
                        Although it can be exciting to form a bookstore business, there will
                    ...
                    <Paragraph big>
                        Here are some of the typical tasks you’ll be performing for your bookstore business on a daily
                        basis.
                    </Paragraph>
                    ...
                    <div style={{marginBottom: "10px"}}>
                        <TextBoxed>
                            <Paragraph big bottomMargin={0}>
                                Understanding the types of books that your customers want
                                and ordering them
                            </Paragraph>
                        </TextBoxed>
                    </div>
                    ...
                    <div style={{marginBottom: "10px"}}>
                        <TextBoxed>
                            <Paragraph big bottomMargin={0}>
                                Excellent recordkeeping skills to stay on top of your inventory
                                and your finances
                            </Paragraph>
                        </TextBoxed>
                    </div>
                    ...
                    <Paragraph big>
                        The secret to running a successful bookstore is to create an excellent customer experience. One
                        of the reasons independent bookshops are growing is that buying online doesn’t provide a sense
                        of personal service or community. Bookstores that can meet those needs by understanding and
                ...
                <PanelWrapper>
                    ...
                    <Paragraph big style={{marginBottom: "48px"}}>
                        Here are some ideas for creating personal connections with customers
                    ...
                    <div style={{marginBottom: "10px"}}>
                        <TextBoxed>
                            <Paragraph big bottomMargin={0}>
                                ...
                                for example, you might focus on first editions, foreign language manuscripts or books on
                                particular topics
                            </Paragraph>
                        </TextBoxed>
                    </div>
                    ...
                    <div style={{marginBottom: "10px"}}>
                        <TextBoxed>
                            <Paragraph big bottomMargin={0}>
                                Create personal relationships with regular customers and ask them what types of books
                                they would like you to carry
                            </Paragraph>
                        </TextBoxed>
                    </div>
                    ...
                    <div style={{marginBottom: "10px"}}>
                        <TextBoxed>
                            <Paragraph big bottomMargin={0}>
                                Provide a comfortable ambiance and atmosphere (for example, with comfortable well-lit
                                areas where people can browse books)
                            </Paragraph>
                        </TextBoxed>
                    </div>
                    ...
                    <Paragraph big>
                        ...
                        wider markets by creating an online presence. Whether you sell through a third-party marketplace
                        like Amazon or you have your own ecommerce site, you can create a useful additional revenue
                        stream.
                    </Paragraph>
        ...
        <Conclusion to="/" buttonTitle="Start your Bookstore Business with us, today">
            ...
            <Paragraph big>
                With the right approach and customer relationships, your bookstore could be a huge success. Identify your niche, build your community, provide an excellent service and get your marketing right - that way you’ll get noticed and can share your love
                of books with everyone. Good luck!
            </Paragraph>
        </Conclusion>
    </Layout>
);
