...
const GymPersonalTraining = () => (
    <Layout>
        <SEO title="How to Start a Brewery Business"
        ...
        <Top ovalColor="sun" imageName="brewery-business-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
            ...
            <p>
                Breweries are one of the most exciting types of businesses
                to be involved with. You get to create delicious drinks, host
                a community of people, indulge in the craft of brewing and provide
            ...
            <CollapseWrapper>
                <PanelWrapper>
                    <Paragraph big>
                        ...
                        Asheville, to places where beer is just another great reason to go there, like Chicago, New York
                        or San Diego. Remember,
                        too, that breweries encompass all sorts of different types of brewing operations - from the
                        traditional craft beer microbrewery to cideries, distilleries or winemakers, there’s a brewery
                        for every style and palate.
                    </Paragraph>
                    ...
                    <Colorbox className="box" theme="icon" Icon={MegafornIcon} color={color.green3} curve
                        ...
                        <Paragraph>
                            ...
                            know to start your brewery business.
                        </Paragraph>
                        <Paragraph bottomPadding={0} bottomMargin={0}>
                            ...
                            business, you’ll find the answers you need.
                        </Paragraph>
                    </Colorbox>

                    <Paragraph big style={{marginTop: "48px", fontWeight: "bold"}}>
                        Read on for some insight into creating your own brewery business and becoming an entrepreneur.
                    ...
                    <ListWrapper>
                        ...
                        <ListBox>
                            <CkeckText>
                                <Paragraph big>
                                    Deciding if a brewery business
                        ...
                        <ListBox>
                            <CkeckText>
                                <Paragraph big>
                                    Setting up your canine business, including location, equipment, employees, taxes,
                        ...
                        <ListBox>
                            <CkeckText>
                                <Paragraph big>
                                    Setting up your brewery business, including location, equipment, employees, taxes,
                                    finances, licenses and more
                                </Paragraph>
                            </CkeckText>
                        </ListBox>
                ...
                <PanelWrapper>
                    ...
                    <BlueBoxWithAbsoluteText absoluteText="6,200"
                    ...
                    <Paragraph big>
                        Cideries, distilleries and winemakers have also seen excellent growth
                        and good future business prospects.
                    </Paragraph>
                    <Paragraph big>
                        As you can see, there are plenty of opportunities to start up your own brewery business. We’ll
                        help you be part of that success.
                    </Paragraph>
                ...
                <PanelWrapper>
                    ...
                    <div style={{marginBottom: "10px"}}>
                        <TextBoxed>
                            <Paragraph big bottomMargin={0}>
                                It’s possible you will interact with the public, so interpersonal skills
                                are essential
                            </Paragraph>
                        </TextBoxed>
                    </div>
                    ...
                    <div style={{marginBottom: "10px"}}>
                        <TextBoxed>
                            <Paragraph big bottomMargin={0}>
                                Marketing is essential to a successful brewery, so expect to spend plenty
                                of time on that
                            </Paragraph>
                        </TextBoxed>
                    </div>
                    ...
                    <div style={{marginBottom: "10px"}}>
                        <TextBoxed>
                            <Paragraph big bottomMargin={0}>
                                Capital expenses can be high, so you’ll need to be a good administrator
                    ...
                    <Paragraph big>
                        Your brewery customers are looking for a variety of unique features
                        in your brewery, including:
                    </Paragraph>
        ...
        <Conclusion to="/" buttonTitle="Start your Brewery Business with us, today">
            ...
            <Paragraph big>
                Although starting a brewery can be tough and requires plenty
                of money, the rewards can be even bigger. Profit margins on beer are typically very good, and with sound financial management, you can turn a good brewery into a thriving business.
            </Paragraph>
        </Conclusion>
    </Layout>
);
