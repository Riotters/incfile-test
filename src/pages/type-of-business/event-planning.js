            ...
            <CollapseWrapper>
                <PanelWrapper>
                    ...
                    <Colorbox className="box" theme="icon" Icon={MegafornIcon} color={color.purple3} curve
                        ...
                        <Paragraph bottomPadding={0} bottomMargin={0}>
                            Here is our simple guide to starting up a successful event or party planning business. From
                            exploring the types of business you can start, to researching the legalities of setting up
                ...
                <PanelWrapper>
                    ...
                    <div style={{marginBottom: "10px"}}>
                        <TextBoxed>
                            <Paragraph big bottomMargin={0}>
                                Carrying out day-to-day project management to make sure the right people are completing
                    ...
                    <div style={{marginBottom: "10px"}}>
                        <TextBoxed>
                            <Paragraph big bottomMargin={0}>
                                Managing the budget, scope, vendors, staff, people, timescales and other aspects of the
                                event
                            </Paragraph>
                        </TextBoxed>
                    </div>
                    ...
                    <div style={{marginBottom: "10px"}}>
                        <TextBoxed>
                            <Paragraph big bottomMargin={0}>
                                Dealing with permits, licenses, insurance, transport, lodging, menus, music, security,
                    ...
                    <div style={{marginBottom: "10px"}}>
                        <TextBoxed>
                            <Paragraph big bottomMargin={0}>
                                Good financial and resource management skills so you stay within budget and deliver the
                    ...
                    <Paragraph big>
                        Ultimately, event and party planning clients want two things: for their event to be a success,
                        and for it to run smoothly without any problems. They’re hiring you for peace-of-mind, and to
                        make sure you can manage the event to a good conclusion.
                    </Paragraph>

                    <Paragraph big>
                        Of course, they’ll also want you to deliver the event or party to the budget you’ve agreed, and
                        ...
                        to avoid doing the work themselves — so if you regularly communicate, provide reassurance and
