...
const EventPlanning = () => (
    <Layout>
        <SEO title="How to Start a Party or Event Planning Business"
        ...
        <Top ovalColor="purple-2" imageName="event-planing-main" imageAlt="Mr Bulb with seedling" headlineWidth={700}>
            ...
            <p>
                ...
                a strong need for gathering with like-minded people. If you’re a great organizer, administrator and
                project manager, you can turn this desire
                ...
                <CollapseWrapper>
                    <PanelWrapper>
                        <Paragraph big>
                            ...
                            a business on their event needs or putting together other social gatherings, your skills are
                            essential. Here’s why: Most people don’t have the time, expertise, networks, discipline or
                            desire to coordinate dozens
                            of different moving parts to make an event happen. If you’re great
                            at those tasks, then individuals and businesses will seek you out for your organizational
                            abilities.
                        </Paragraph>
                        ...
                        <Colorbox className="box" theme="icon" Icon={FireworksIcon} color={color.purple3} curve
                            ...
                            <Paragraph bottomPadding={0} bottomMargin={0}>
                                ...
                                From
                                exploring the types of business you can start, to researching the legalities of setting
                                up
                                your business and the realities of your day to day operations, this guide is here to
                                help.
                            </Paragraph>
                        </Colorbox>
                        ...
                        <ListWrapper>
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>
                                        ...
                                        of party or event planning businesses
                                    </Paragraph>
                                </CkeckText>
                            </ListBox>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>
                                        Deciding whether a party or event planning business could be right
                                        for you
                                    </Paragraph>
                                </CkeckText>
                            </ListBox>
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>
                                        How to choose whether your party
                                        or event planning business should
                            ...
                            <ListBox>
                                <CkeckText>
                                    <Paragraph big>
                                        How to start your party or event planning business (with information
                    ...
                    <PanelWrapper>
                        ...
                        <Paragraph big>
                            As you can see, there are plenty of opportunities to start your own party or event planning
                    ...
                    <PanelWrapper>
                        ...
                        <Paragraph big>
                            Here are some of the typical tasks you’ll be performing for your party
                            or event planning business on a daily basis.
                        </Paragraph>

                        <div style={{marginBottom: "10px"}}>
                            <TextBoxed>
                                <Paragraph big bottomMargin={0}>
                                    Negotiating and dealing with individuals and businesses who want
                        ...
                        <div style={{marginBottom: "10px"}}>
                            <TextBoxed>
                                <Paragraph big bottomMargin={0}>
                                    Understanding and gathering overall needs and detailed requirements
                                    for events
                                </Paragraph>
                            </TextBoxed>
                        </div>
                        ...
                        <div style={{marginBottom: "10px"}}>
                            <TextBoxed>
                                <Paragraph big bottomMargin={0}>
                                    Planning out events in detail, including all the third parties you’ll
                                    need to involve
                                </Paragraph>
                            </TextBoxed>
                        </div>
                        ...
                        <div style={{marginBottom: "10px"}}>
                            <TextBoxed>
                                <Paragraph big bottomMargin={0}>
                                    ...
                                    completing
                                    the right activity in the right way at the right time
                                </Paragraph>
                            </TextBoxed>
                        </div>
                        ...
                        <Paragraph big>
                            The following skills will be very useful in your role as a party or event planning small
                            business owner.
                        </Paragraph>
                        ...
                        <div style={{marginBottom: "10px"}}>
                            <TextBoxed>
                                <Paragraph big bottomMargin={0}>
                                    The following skills will be very useful in your role as a party or event planning
                                    small
                                    business owner.
                                </Paragraph>
                            </TextBoxed>
                        ...
                        <Paragraph big>
                            Ultimately, event and party planning clients want two things: for their event to be a
                            success,
                            and for it to run smoothly without any problems. They’re hiring you for peace-of-mind, and
                            to
                            make sure you can manage the event to a good conclusion.
                        </Paragraph>

                        <Paragraph big>
                            Of course, they’ll also want you to deliver the event or party to the budget you’ve agreed,
                            and
                            they’ll expect you to troubleshoot any issues so they don’t need to get involved. Hiring an
                            event planner is a way for clients
                            to avoid doing the work themselves — so if you regularly communicate, provide reassurance
                            and
                            deal with everything on their behalf, they’ll
                            be delighted.
                        </Paragraph>
        ...
        <Conclusion to="/" buttonTitle="Start your Event Planning Business with us, today">
            ...
            <Paragraph big>
                ...
                and event planner could
                be a great idea. The time to start is now — follow this guide, define your business, decide on your
                areas of focus and enjoy your work as you help others celebrate their most important life events.
            </Paragraph>
        </Conclusion>
    </Layout>
);
