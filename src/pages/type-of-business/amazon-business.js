            ...
            <CollapseWrapper>
                ...
                <PanelWrapper>
                    ...
                    <div style={{marginBottom: "10px"}}>
                        <TextBoxed>
                            <Paragraph big bottomMargin={0}>If you’re a traditional, “brick and mortar” store, you can
                                start
                    ...
                    <div style={{marginBottom: "50px"}}>
                        <TextBoxed>
                            <Paragraph big bottomMargin={0}>You can take advantage of marketplaces on existing ecommerce
                    ...
                    <Paragraph big>
                        ...
                        it’s among the world’s largest ecommerce websites, and it provides some massive opportunities
                        for sellers. As an Amazon business, you can offer your products for sale through Amazon to gain
                    ...
                    <Paragraph big>
                        ...
                        complete guide to tell you exactly how to maximize your chances of creating a thriving Amazon
                ...
                <PanelWrapper>
                    ...
                    <Paragraph big>
                        So, what exactly is an Amazon seller? Simply put, they are people and companies who source goods
                    ...
                    <Colorbox className="box" theme="icon" Icon={AmazonIcon} color={color.orange3}
                        ...
                        <Paragraph bottomPadding={0} bottomMargin={0}>
                            Sellers who source, procure, store and ship the goods themselves including taking care of
                    ...
                    <Paragraph big bottomMargin={70}>
                        ...
                        is a vast amount of competition across almost every niche and product. The biggest factors that
                ...
                <PanelWrapper>
                    ...
                    <Paragraph big>
                        ...
                        easy. You must be able to deal with significant competition, be acutely aware of the state of
                        the marketplace, deal with Amazon’s regulations and policies and be a master administrator.
                    </Paragraph>
                    <Paragraph big style={{marginBottom: "48px"}}>
                        The profit margins are also likely to be razor-thin. You need to create, buy inventory, manage
                        and maintain a successful business on small profit margins and against a very competitive
                        landscape. But, if you can make
                        it, the upsides are huge. If your product really gets traction, you could make your way into the
                    ...
                    <div style={{marginBottom: "10px"}}>
                        <TextBoxed>
                            <Paragraph big bottomMargin={0}>
                                Calculating profit margins and selling prices to ensure you can pay all your business
                                expenses
                            </Paragraph>
                        </TextBoxed>
                    </div>
