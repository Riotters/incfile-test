            ...
            <CollapseWrapper>
                <PanelWrapper>
                    ...
                    <Paragraph big style={{marginTop: "48px"}}>
                        Read on for some insight into creating your own food truck business and becoming a food-based
                    ...
                    <ListWrapper>
                        ...
                        <ListBox>
                            <CkeckText>
                                <Paragraph big>
                                    Setting up your food truck business including location, equipment, employees, taxes,
                ...
                <PanelWrapper>
                    ...
                    <Paragraph big>
                        Food trucks are incredibly popular. Aside from the initial cost of the food truck and equipment,
                        the barriers to entry are fairly low, which makes them an ideal starting point for food-based
                    ...
                    <Paragraph big style={{marginBottom: "80px"}}>
                        This is why food truck businesses are so exciting — how can you be part of that success? We're
                    ...
                    <CircleWithText withBg={true} SvgChart={SvgChart} textInsideCircle="7" symbol="%"
                                    textLine="Is the annual frowth in food truck revenue as a whole"/>
                ...
                <PanelWrapper>
                    ...
                    <Paragraph big>
                        Here are some of the typical tasks you’ll be performing for your food truck business on a daily
                        basis.
                    </Paragraph>
                    ...
                    <div style={{marginBottom: "10px"}}>
                        <TextBoxed>
                            <Paragraph big bottomMargin={0}>
                                Checking you have enough ingredients for all the meals you’re offering and ordering food
                    ...
                    <div style={{marginBottom: "10px"}}>
                        <TextBoxed>
                            <Paragraph big bottomMargin={0}>
                                Talking with venue owners and event organizers to see if you can sell food at certain
                                locations
                            </Paragraph>
                        </TextBoxed>
                    </div>
                    ...
                    <div style={{marginBottom: "48px"}}>
                        <TextBoxed>
                            <Paragraph big bottomMargin={0}>
                                Excellent administration skills to stay on top of ordering ingredients, managing cash,
