...
const UniqueBusiness = () => (
    <Layout>
        <SEO title="How to Start a Unique Business"
        ...
        <Top ovalColor="purple-2" imageName="unique-business-main" imageAlt="Mr Bulb with seedling"
             headlineWidth={700}>
            <h1>How to Start a Unique Business</h1>
            <p>
                Some of us like to do things a little differently, and that’s also
                true of business owners and entrepreneurs. If you’ve looked
                at some standard business ideas and thought “that’s not for
