...
import { info, questions, service, top, articlesOfIncorporation } from "../static/learning-center-entity/montana-corporation";
...
const AlaskaCorporation = () => {
    ...
    return (
        <Layout>
            <SEO title="Form a Corporation or LLC in Montana Today | Incfile" description="View our guide to incorporating in Montana. Find filing schedules and fees, learn how to select a name, how to structure your business, and much more." />
