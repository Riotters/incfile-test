...
import {
	...
	about,
	calculator,
} from "../static/learning-center-entity/sales-tax-calculator";
...
const SalesTaxCalculator = () => {
	...
	return (
		<Layout>
			<SEO
				title="Sales Tax Calculator | Check Your State Sales Tax Rate"
			...
			>
				...
				<ArrowLink
					content={top.link}
					onClick={(e) => scrollToElement(e, "sales-calculator")}
					bottomMargin={22}
				/>
