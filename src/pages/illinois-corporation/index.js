...
//Texts
import { top, tabPages, corporation, launchBusiness, requirements, learnMore, quickLinks, variants, subscription } from "../../static/learning-center-entity/state-information-illinois";
...
const StateInformation = () => (
    <Layout>
        <SEO title="Illinois Corporations | How to Incorporate a Business in Illinois" description="Corporations can be complicated to set up. Read Incfile&#039;s helpful incorporation guide to make starting your Illinois business easy." />
