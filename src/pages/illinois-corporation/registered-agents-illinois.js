...
const IllinoisCorporation = () => {
	...
	return (
		<Layout>
			<SEO
				title="Registered Agents for your Illinois Corporation | Incfile.com"
				description="Does your corporation need a registered agent? Learn more about finding a qualified registered agent in Illinois here."
			/>
			<Top
