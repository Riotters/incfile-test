...
//Texts
import { top, tabPages, taxes, launchBusiness, requirements, learnMore, quickLinks, variants, subscription } from "../../static/learning-center-entity/state-information-illinois";
...
const StateInformation = () => (
    <Layout>
        <SEO title="Illinois Taxes and Fees for Your Corporation | Incfile.com" description="What&#039;s it going to cost to incorporate your business in Illinois? Learn about the state&#039;s business taxes and fees here." />
