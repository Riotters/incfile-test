...
import { info, questions, service, top, articlesOfIncorporation} from "../static/learning-center-entity/vermont-corporation";
...
const AlaskaCorporation = () => {
    ...
    return (
        <Layout>
            <SEO title="Form a Corporation or LLC in Vermont Today | Incfile" description="Incorporating in Vermont takes five minutes. Get instant access to filing times and fees, tax information and bylaws, FAQs and more." />
