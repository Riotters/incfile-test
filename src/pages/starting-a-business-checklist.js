...
import {
	...
	checks,
	hsForm,
} from "../static/learning-center-entity/business-checklist";
...
const BusinessChecklist = () => {
	...
	return (
		<Layout>
			<SEO
				title="How to Start a Business | Start a Business Checklist"
				description=" It’s time to bring your ideas and inspiration to life. Our straightforward guide helps you get your business off the ground, fast. Read more."
			/>
			<Top
