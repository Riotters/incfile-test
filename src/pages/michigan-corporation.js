...
import { info, questions, service, top, articlesOfIncorporation } from "../static/learning-center-entity/michigan-corporation";
...
const AlaskaCorporation = () => {
    ...
    return (
        <Layout>
            <SEO title="Michigan Corporation | How to Incorporate in Michigan | Learn About Incorporating in Michigan" description="Incorporating in Michigan is easy with Incfile. Find filing times and fees, how to select a name and structure your business, and so much more." />
