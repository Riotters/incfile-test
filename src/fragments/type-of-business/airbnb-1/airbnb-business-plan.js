    ...
    <div style={{position: "relative"}}>
        ...
        <Container>
            <BusinessOwnerResponsibilities>
                ...
                <Paragraph>
                    You might not think you need a business plan for your Airbnb business—after all, if you’re getting
                    guests
                ...
                <Colorbox className="box" theme="icon" Icon={DominoIcon} color={color.yellow3} curve
                    ...
                    <Paragraph>
                        You need to define how you’re going to run your Airbnb business, market your property, get
                        sales,
                        make a
                        profit and grow. This can only come about through creating a watertight business plan. It will
                        help
                        you
                ...
                <Paragraph>
                    You will also need to look at financial projections for your Airbnb business. What are your expected
                    booking
                    revenues? How much is it costing you to buy and maintain the property? What is your profitability?
                    How
                    much
